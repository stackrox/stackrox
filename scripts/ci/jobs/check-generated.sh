...
function generated_files-are-up-to-date() {
    ...
    # Remove generated comment, it will be regenerated and if source was changed comment should be removed as well.
    find . -type f -name "*.go" -exec sed -i '/^\/\/ Code generated by/d' {} \;
    git checkout HEAD operator migrator/migrations migrator/runner/all.go pkg/migrations/internal/seq_num.go
