...
sudo restorecon -Rv /etc/systemd/system/roxagent-prep.service /etc/systemd/system/roxagent.service /etc/systemd/system/roxagent.timer /etc/systemd/system/roxagent-serve.service 2>/dev/null || true
