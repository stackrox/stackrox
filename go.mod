...
replace (
	...
	// github.com/docker/docker. As of github.com/docker/docker v24.0.0+incompatible,
	// the version of github.com/opencontainers/runc is v1.1.7 (https://github.com/moby/moby/blob/v24.0.0/vendor.mod#L74).
