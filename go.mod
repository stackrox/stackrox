...
require (
	...
	github.com/quay/claircore v1.5.40-0.20250915175018-ec8baf0a4ee5
...
replace (
	...
	github.com/quay/claircore => github.com/lvalerom/claircore v0.0.0-20250917111153-8f16753317da
)
