...
replace (
	...
	// github.com/docker/docker. As of github.com/docker/docker v23.0.1+incompatible,
	// the version of github.com/opencontainers/runc is v1.1.3
	// https://github.com/moby/moby/blob/bc3805a0a0d3b5bd3f0e6c69f46ac08dd53377c7/vendor.mod#L67.
