...
class TestIsNewerVersion(unittest.TestCase):
    ...
    def test_double_digit_minor_version_not_newer(self):
        ...
        self.assertFalse(
            is_newer_version('4.11.x-94-g75a2cb6b34', '4.9.5'),
    ...
    def test_double_digit_minor_version_4_10_vs_4_9(self):
        ...
        self.assertFalse(
            is_newer_version('4.10.x-50-ghash', '4.9.5'),
    ...
    def test_double_digit_minor_version_4_11_vs_4_10(self):
        ...
        self.assertFalse(
            is_newer_version('4.11.x-94-ghash', '4.10.2'),
    ...
    def test_double_digit_minor_version_is_newer(self):
        ...
        self.assertTrue(
            is_newer_version('4.10.x-50-ghash', '4.11.1'),
    ...
    def test_single_digit_minor_version_not_newer(self):
        ...
        self.assertFalse(
            is_newer_version('4.8.x-325-ghash', '4.7.0'),
    ...
    def test_single_digit_minor_version_is_newer(self):
        ...
        self.assertTrue(
            is_newer_version('4.6.x-736-ghash', '4.9.5'),
    ...
    def test_equal_major_minor_versions(self):
        ...
        self.assertFalse(
            is_newer_version('4.9.x-100-ghash', '4.9.0'),
    ...
    def test_major_version_difference(self):
        ...
        self.assertTrue(
            is_newer_version('4.11.x-94-ghash', '5.0.0'),
    ...
    def test_major_version_not_newer(self):
        ...
        self.assertFalse(
            is_newer_version('4.11.x-94-ghash', '3.74.9'),
    ...
    def test_release_candidate_version(self):
        ...
        self.assertTrue(
            is_newer_version('4.11.1-rc.2', '4.12.0'),
    ...
    def test_release_candidate_not_newer(self):
        ...
        self.assertFalse(
            is_newer_version('4.11.1-rc.2', '4.10.5'),
    ...
    def test_patch_version_differences(self):
        ...
        self.assertFalse(
            is_newer_version('4.11.2-10-ghash', '4.11.1'),
    ...
    def test_three_digit_minor_version(self):
        ...
        self.assertFalse(
            is_newer_version('4.100.x-1-ghash', '4.99.0'),
            "4.99 should not be considered newer than 4.100"
        )

    def test_product_version_with_different_patch_levels(self):
        """Test comparison with different patch versions"""
        self.assertFalse(
            is_newer_version('4.9.x-100-ghash', '4.9.10'),
            "4.9.10 should not be considered newer than 4.9"
        )

    def test_plain_release_tag_patch_newer(self):
        """Plain release tag: newer patch should be detected"""
        self.assertTrue(
            is_newer_version('4.11.1', '4.11.5'),
            "4.11.5 should be considered newer than plain release 4.11.1"
        )

    def test_plain_release_tag_patch_not_newer(self):
        """Plain release tag: older patch should not be considered newer"""
        self.assertFalse(
            is_newer_version('4.11.5', '4.11.1'),
            "4.11.1 should not be considered newer than plain release 4.11.5"
        )

    def test_plain_release_tag_same_version(self):
        """Plain release tag: same version is not newer"""
        self.assertFalse(
            is_newer_version('4.11.1', '4.11.1'),
            "Same plain release version should not be considered newer"
        )
