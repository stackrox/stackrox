...
# Substitute ROX_ADMIN_PASSWORD within the shell script that will be used to trigger signature integration updates.
# Deploy the CRON job..
dir="$(dirname "${BASH_SOURCE[0]}")"
script_contents=$(envsubst '${ROX_ADMIN_PASSWORD}' < "${dir}/update.sh")
