...
$(MERGED_API_OPENAPI_SPEC): $(MERGED_API_SWAGGER_SPEC)
	@echo "+ $@"
	SWAGGER_FILE="$(BASE_PATH)/$(MERGED_API_SWAGGER_SPEC)" OPENAPI_FILE="$(BASE_PATH)/$(MERGED_API_OPENAPI_SPEC)" make -C ${BASE_PATH}/ui swagger2openapi

$(MERGED_API_OPENAPI_SPEC_V2): $(MERGED_API_SWAGGER_SPEC_V2)
	@echo "+ $@"
	SWAGGER_FILE="$(BASE_PATH)/$(MERGED_API_SWAGGER_SPEC_V2)" OPENAPI_FILE="$(BASE_PATH)/$(MERGED_API_OPENAPI_SPEC_V2)" make -C ${BASE_PATH}/ui swagger2openapi
