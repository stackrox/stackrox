...
$(GENERATED_BASE_PATH)/%.pb.go: $(PROTO_BASE_PATH)/%.proto $(PROTO_DEPS) $(PROTOC_GEN_GRPC_GATEWAY) $(PROTOC_GEN_GO_BIN) $(ALL_PROTOS)
	@echo "+ $@"
	@echo "GOGO_DIR=$(GOGO_DIR) \
		PROTOC_INCLUDES=$(PROTOC_INCLUDES) \
		GRPC_GATEWAY_DIR=$(GRPC_GATEWAY_DIR)/third_party/googleapis \
		SCANNER_PROTO_BASE_PATH=$(SCANNER_PROTO_BASE_PATH)"
	@mkdir -p $(dir $@)
	@PATH=$(PROTO_GOBIN) $(PROTOC) \
		-I$(GOGO_DIR) \
		-I$(PROTOC_INCLUDES) \
