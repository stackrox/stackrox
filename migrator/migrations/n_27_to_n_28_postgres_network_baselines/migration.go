...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveNetworkBaselines(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("networkbaseline")
	batchSize     = 10000
	schema        = pkgSchema.NetworkBaselinesSchema
	log           = loghelper.LogWrapper{}
)

func moveNetworkBaselines(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.NetworkBaseline) error {
