...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			...
			if err := moveComplianceOperatorProfiles(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB, legacyStore); err != nil {
...
func moveComplianceOperatorProfiles(legacyDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool, legacyStore legacy.Store) error {
	...
	legacyStore.Walk(ctx, func(obj *storage.ComplianceOperatorProfile) error {
		...
		if len(complianceOperatorProfiles) == 10*batchSize {
			if err := store.copyFrom(ctx, complianceOperatorProfiles...); err != nil {
