...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveComplianceOperatorProfiles(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("complianceoperatorprofiles")
	batchSize     = 10000
	schema        = pkgSchema.ComplianceOperatorProfilesSchema
	log           = loghelper.LogWrapper{}
)

func moveComplianceOperatorProfiles(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.ComplianceOperatorProfile) error {
