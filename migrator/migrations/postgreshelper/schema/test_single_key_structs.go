...
var (
	...
	TestSingleKeyStructsSchema = func() *walker.Schema {
		...
		schema.SetOptionsMap(search.OptionsMapFromMap(v1.SearchCategory_SEARCH_UNSET, map[search.FieldLabel]*search.Field{
			"Test Bool":         {FieldPath: "testsinglekeystruct.bool", Type: v1.SearchDataType_SEARCH_BOOL, Category: v1.SearchCategory_SEARCH_UNSET},
			"Test Enum":         {FieldPath: "testsinglekeystruct.enum", Type: v1.SearchDataType_SEARCH_ENUM, Category: v1.SearchCategory_SEARCH_UNSET},
			"Test Enum Slice":   {FieldPath: "testsinglekeystruct.enums", Type: v1.SearchDataType_SEARCH_ENUM, Category: v1.SearchCategory_SEARCH_UNSET},
			"Test Float":        {FieldPath: "testsinglekeystruct.float", Type: v1.SearchDataType_SEARCH_NUMERIC, Category: v1.SearchCategory_SEARCH_UNSET},
			"Test Int64":        {FieldPath: "testsinglekeystruct.int64", Type: v1.SearchDataType_SEARCH_NUMERIC, Category: v1.SearchCategory_SEARCH_UNSET},
			"Test Key":          {FieldPath: "testsinglekeystruct.key", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory_SEARCH_UNSET},
			"Test Labels":       {FieldPath: "testsinglekeystruct.labels", Type: v1.SearchDataType_SEARCH_MAP, Category: v1.SearchCategory_SEARCH_UNSET},
			"Test Name":         {FieldPath: "testsinglekeystruct.name", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory_SEARCH_UNSET},
			"Test String Slice": {FieldPath: "testsinglekeystruct.string_slice", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory_SEARCH_UNSET},
			"Test Timestamp":    {FieldPath: "testsinglekeystruct.timestamp.seconds", Type: v1.SearchDataType_SEARCH_DATETIME, Category: v1.SearchCategory_SEARCH_UNSET},
			"Test TimestampTZ":  {FieldPath: "testsinglekeystruct.timestamptz.seconds", Type: v1.SearchDataType_SEARCH_DATETIME, Category: v1.SearchCategory_SEARCH_UNSET},
			"Test Uint64":       {FieldPath: "testsinglekeystruct.uint64", Type: v1.SearchDataType_SEARCH_NUMERIC, Category: v1.SearchCategory_SEARCH_UNSET},
		}))
		enumregistry.AddValues("testsinglekeystruct.enum", map[string]int32{"ENUM0": 0, "ENUM1": 1, "ENUM2": 2})
		enumregistry.AddValues("testsinglekeystruct.enums", map[string]int32{"ENUM0": 0, "ENUM1": 1, "ENUM2": 2})
