...
var (
	...
	TestParent2Schema = func() *walker.Schema {
		...
		schema.SetOptionsMap(search.OptionsMapFromMap(v1.SearchCategory(68), map[search.FieldLabel]*search.Field{
			"Test Parent2 ID":  {FieldPath: "testparent2.id", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory(68)},
			"Test Parent2 Val": {FieldPath: "testparent2.val", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory(68)},
		}))
