...
func (s *storeImpl) copyFromDeploymentsContainers(ctx context.Context, tx pgx.Tx, deploymentID string, objs ...*storage.Container) error {
...
func (s *storeImpl) copyFromDeploymentsContainersEnvs(ctx context.Context, tx pgx.Tx, deploymentID string, deploymentsContainersIdx int, objs ...*storage.ContainerConfig_EnvironmentConfig) error {
...
func (s *storeImpl) copyFromDeploymentsContainersVolumes(ctx context.Context, tx pgx.Tx, deploymentID string, deploymentsContainersIdx int, objs ...*storage.Volume) error {
...
func (s *storeImpl) copyFromDeploymentsContainersSecrets(ctx context.Context, tx pgx.Tx, deploymentID string, deploymentsContainersIdx int, objs ...*storage.EmbeddedSecret) error {
...
func (s *storeImpl) copyFromDeploymentsPorts(ctx context.Context, tx pgx.Tx, deploymentID string, objs ...*storage.PortConfig) error {
...
func (s *storeImpl) copyFromDeploymentsPortsExposureInfos(ctx context.Context, tx pgx.Tx, deploymentID string, deploymentsPortsIdx int, objs ...*storage.PortConfig_ExposureInfo) error {
