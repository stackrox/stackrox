...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveRisks(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("risk")
	batchSize     = 10000
	schema        = pkgSchema.RisksSchema
	log           = loghelper.LogWrapper{}
)

func moveRisks(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.Risk) error {
