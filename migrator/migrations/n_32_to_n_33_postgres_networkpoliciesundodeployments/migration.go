...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			...
			if err := moveNetworkpoliciesundodeployments(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB, legacyStore); err != nil {
...
func moveNetworkpoliciesundodeployments(legacyDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool, legacyStore legacy.Store) error {
	...
	var err error
	legacyStore.Walk(ctx, func(obj *storage.NetworkPolicyApplicationUndoDeploymentRecord) error {
