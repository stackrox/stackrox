...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			...
			if err := moveAuthProviders(databases.BoltDB, databases.GormDB, databases.PostgresDB, legacyStore); err != nil {
...
func moveAuthProviders(legacyDB *bolt.DB, gormDB *gorm.DB, postgresDB *pgxpool.Pool, legacyStore legacy.Store) error {
