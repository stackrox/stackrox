...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveNetworkGraphConfigs(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("networkgraphconfig")
	batchSize     = 10000
	schema        = pkgSchema.NetworkGraphConfigsSchema
	log           = loghelper.LogWrapper{}
)

func moveNetworkGraphConfigs(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.NetworkGraphConfig) error {
