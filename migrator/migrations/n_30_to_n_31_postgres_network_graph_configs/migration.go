...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			...
			if err := moveNetworkGraphConfigs(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB, legacyStore); err != nil {
...
func moveNetworkGraphConfigs(legacyDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool, legacyStore legacy.Store) error {
	...
	legacyStore.Walk(ctx, func(obj *storage.NetworkGraphConfig) error {
		...
		if len(networkGraphConfigs) == 10*batchSize {
			if err := store.copyFrom(ctx, networkGraphConfigs...); err != nil {
