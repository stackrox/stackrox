...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveApiTokens(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("apiTokens")
	batchSize     = 10000
	schema        = pkgSchema.ApiTokensSchema
	log           = loghelper.LogWrapper{}
)

func moveApiTokens(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.TokenMetadata) error {
