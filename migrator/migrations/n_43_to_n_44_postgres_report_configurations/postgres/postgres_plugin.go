...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ReportConfiguration, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.ReportConfiguration](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.ReportConfiguration, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.ReportConfiguration](ctx, schema, q, s.db)
	if err != nil {
