...
func insertIntoClusters(batch *pgx.Batch, obj *storage.Cluster) error {
	...
	finalStr := "INSERT INTO clusters (Id, Name, Type, Labels, serialized) VALUES($1, $2, $3, $4, $5) ON CONFLICT(Id) DO UPDATE SET Id = EXCLUDED.Id, Name = EXCLUDED.Name, Type = EXCLUDED.Type, Labels = EXCLUDED.Labels, serialized = EXCLUDED.serialized"
