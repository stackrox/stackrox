// This file copied from central/cluster/store/cluster/postgres/store.go before making any changes to the storage.Cluster
// and modified to include only the necessary functions
