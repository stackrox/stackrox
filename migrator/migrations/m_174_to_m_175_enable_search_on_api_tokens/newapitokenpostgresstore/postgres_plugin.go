...
import (
	...
	pkgSchema "github.com/stackrox/rox/migrator/migrations/m_174_to_m_175_enable_search_on_api_tokens/schema"
...
// Only the relevant functions (Walk, DeleteMany and UpsertMany) are kept. GetByQuery is also
