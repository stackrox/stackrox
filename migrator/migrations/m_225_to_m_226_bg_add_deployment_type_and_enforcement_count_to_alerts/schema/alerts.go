...
// Includes bg_deployment_type and bg_enforcementcount columns for background migration testing.
type Alerts struct {
	...
	BgDeploymentType         string                              `gorm:"column:bg_deployment_type;type:varchar"`
	BgEnforcementCount       int32                               `gorm:"column:bg_enforcementcount;type:integer"`
}
