...
func (s *storeImpl) Count(ctx context.Context) (int, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Count, "ActiveComponent")
...
func (s *storeImpl) Exists(ctx context.Context, id string) (bool, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Exists, "ActiveComponent")
...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ActiveComponent, bool, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Get, "ActiveComponent")
...
func (s *storeImpl) GetIDs(ctx context.Context) ([]string, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.GetAll, "storage.ActiveComponentIDs")
	var sacQueryFilter *v1.Query
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.ActiveComponent, []int, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.GetMany, "ActiveComponent")
...
func (s *storeImpl) DeleteMany(ctx context.Context, ids []string) error {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.RemoveMany, "ActiveComponent")
