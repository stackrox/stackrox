...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveClusterInitBundles(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("clusterinitbundles")
	batchSize     = 10000
	schema        = pkgSchema.ClusterInitBundlesSchema
	log           = loghelper.LogWrapper{}
)

func moveClusterInitBundles(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.InitBundleMeta) error {
