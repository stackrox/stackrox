...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveSignatureIntegrations(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("signature_integrations")
	batchSize     = 10000
	schema        = pkgSchema.SignatureIntegrationsSchema
	log           = loghelper.LogWrapper{}
)

func moveSignatureIntegrations(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.SignatureIntegration) error {
