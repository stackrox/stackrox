...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			...
			if err := moveSignatureIntegrations(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB, legacyStore); err != nil {
...
func moveSignatureIntegrations(legacyDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool, legacyStore legacy.Store) error {
	...
	legacyStore.Walk(ctx, func(obj *storage.SignatureIntegration) error {
		...
		if len(signatureIntegrations) == 10*batchSize {
			if err := store.copyFrom(ctx, signatureIntegrations...); err != nil {
