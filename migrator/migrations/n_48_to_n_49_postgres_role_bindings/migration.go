...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveRoleBindings(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("rolebindings")
	batchSize     = 10000
	schema        = pkgSchema.RoleBindingsSchema
	log           = loghelper.LogWrapper{}
)

func moveRoleBindings(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.K8SRoleBinding) error {
