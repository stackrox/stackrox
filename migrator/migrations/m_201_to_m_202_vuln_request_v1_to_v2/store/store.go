...
import (
	...
	migrationSchema "github.com/stackrox/rox/migrator/migrations/m_201_to_m_202_vuln_request_v1_to_v2/schema"
...
func insertIntoVulnerabilityRequests(batch *pgx.Batch, obj *storage.VulnerabilityRequest) error {
	...
	values := []interface{}{
		...
		protocompat.NilOrTime(obj.GetDeferralReq().GetExpiry().GetExpiresOn()),
