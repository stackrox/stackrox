...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveServiceAccounts(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("service_accounts")
	batchSize     = 10000
	schema        = pkgSchema.ServiceAccountsSchema
	log           = loghelper.LogWrapper{}
)

func moveServiceAccounts(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.ServiceAccount) error {
