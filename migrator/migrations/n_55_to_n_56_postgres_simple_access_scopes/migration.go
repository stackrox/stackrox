...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveSimpleAccessScopes(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("simple_access_scopes")
	batchSize     = 10000
	schema        = pkgSchema.SimpleAccessScopesSchema
	log           = loghelper.LogWrapper{}
)

func moveSimpleAccessScopes(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.SimpleAccessScope) error {
