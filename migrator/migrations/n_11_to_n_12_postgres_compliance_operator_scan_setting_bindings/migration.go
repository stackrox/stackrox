...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveComplianceOperatorScanSettingBindings(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("complianceoperatorscansettingbinding")
	batchSize     = 10000
	schema        = pkgSchema.ComplianceOperatorScanSettingBindingsSchema
	log           = loghelper.LogWrapper{}
)

func moveComplianceOperatorScanSettingBindings(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.ComplianceOperatorScanSettingBinding) error {
