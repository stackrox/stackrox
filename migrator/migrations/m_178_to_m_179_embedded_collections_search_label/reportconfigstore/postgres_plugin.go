...
// in the state it had when the migration was written, after changing the proto object format.
// Only the relevant functions (Walk, Count, and UpsertMany) are kept. GetByQuery is also
