...
import (
	...
	legacy "github.com/stackrox/rox/migrator/migrations/n_15_to_n_16_postgres_deployments/legacy"
...
func (s *postgresMigrationSuite) TestMigration() {
	...
	s.NoError(moveDeployments(s.legacyDB, s.gormDB, s.pool, legacyStore))
	var count int64
