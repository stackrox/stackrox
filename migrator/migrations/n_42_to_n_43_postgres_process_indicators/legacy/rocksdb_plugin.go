...
func (b *storeImpl) UpsertMany(_ context.Context, objs []*storage.ProcessIndicator) error {
...
func (b *storeImpl) Walk(_ context.Context, fn func(obj *storage.ProcessIndicator) error) error {
