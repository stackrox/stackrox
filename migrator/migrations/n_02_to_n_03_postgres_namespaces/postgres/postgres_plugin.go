...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.NamespaceMetadata, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.NamespaceMetadata](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.NamespaceMetadata, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.NamespaceMetadata](ctx, schema, q, s.db)
	if err != nil {
