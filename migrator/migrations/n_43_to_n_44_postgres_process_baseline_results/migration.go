...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveProcessBaselineResults(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("processWhitelistResults")
	batchSize     = 10000
	schema        = pkgSchema.ProcessBaselineResultsSchema
	log           = loghelper.LogWrapper{}
)

func moveProcessBaselineResults(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.ProcessBaselineResults) error {
