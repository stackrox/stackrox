...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.IntegrationHealth, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.IntegrationHealth](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.IntegrationHealth, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.IntegrationHealth](ctx, schema, q, s.db)
	if err != nil {
