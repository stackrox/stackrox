...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveIntegrationHealths(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
...
func moveIntegrationHealths(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.IntegrationHealth) error {
