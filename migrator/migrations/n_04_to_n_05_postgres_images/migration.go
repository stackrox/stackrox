...
func move(ctx context.Context, gormDB *gorm.DB, postgresDB postgres.DB, legacyStore store.Store) error {
	...
	pgutils.CreateTableFromModel(ctx, gormDB, frozenSchema.CreateTableImageComponentsStmt)
	pgutils.CreateTableFromModel(ctx, gormDB, frozenSchema.CreateTableImageCvesStmt)
	pgutils.CreateTableFromModel(ctx, gormDB, frozenSchema.CreateTableImageCveEdgesStmt)
	pgutils.CreateTableFromModel(ctx, gormDB, frozenSchema.CreateTableImageComponentEdgesStmt)
	pgutils.CreateTableFromModel(ctx, gormDB, frozenSchema.CreateTableImageComponentCveEdgesStmt)
	pgutils.CreateTableFromModel(ctx, gormDB, frozenSchema.CreateTableImagesStmt)
