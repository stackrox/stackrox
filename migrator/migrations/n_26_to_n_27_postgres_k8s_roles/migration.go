...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := moveK8sRoles(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
	...
	rocksdbBucket = []byte("k8sroles")
	batchSize     = 10000
	schema        = pkgSchema.K8sRolesSchema
	log           = loghelper.LogWrapper{}
)

func moveK8sRoles(rocksDB *rocksdb.RocksDB, gormDB *gorm.DB, postgresDB *pgxpool.Pool) error {
	...
	store.Walk(ctx, func(obj *storage.K8SRole) error {
