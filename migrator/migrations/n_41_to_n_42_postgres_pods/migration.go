...
var (
	migration = types.Migration{
		...
		Run: func(databases *types.Databases) error {
			if err := movePods(databases.PkgRocksDB, databases.GormDB, databases.PostgresDB); err != nil {
