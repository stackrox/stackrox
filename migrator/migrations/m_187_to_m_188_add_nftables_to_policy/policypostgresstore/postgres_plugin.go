...
func New(db postgres.DB) Store {
	return postgreshelper.NewGenericStore[storeType, *storeType](
		db,
		schema,
		pkGetter,
		insertIntoPolicies,
...
func copyFromPolicies(ctx context.Context, s postgreshelper.Deleter, tx *postgres.Tx, objs ...*storage.Policy) error {
