...
export ROX_SCANNER_V4=${ROX_SCANNER_V4:-true}
...
export ROX_CLOUD_CREDENTIALS="${ROX_CLOUD_CREDENTIALS:-false}"
echo "ROX_CLOUD_CREDENTIALS is set to ${ROX_CLOUD_CREDENTIALS}"
