...
export ROX_LANGUAGE_SCANNER=${ROX_LANGUAGE_SCANNER:-true}
echo "ROX_LANGUAGE_SCANNER set to ${ROX_LANGUAGE_SCANNER}"

export SCANNER_V2_SUPPORT=${SCANNER_V2_SUPPORT:-false}
echo "SCANNER_V2_SUPPORT set to $SCANNER_V2_SUPPORT"
...
export ROX_BADGER_DB=${ROX_BADGER_DB:-true}
echo "ROX_BADGER_DB is set to ${ROX_BADGER_DB}"
