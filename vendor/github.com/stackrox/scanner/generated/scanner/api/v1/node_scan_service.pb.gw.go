...
var (
	filter_NodeScanService_GetNodeVulnerabilities_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_NodeScanService_GetNodeVulnerabilities_0(ctx context.Context, marshaler runtime.Marshaler, client NodeScanServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetNodeVulnerabilitiesRequest
...
func RegisterNodeScanServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NodeScanServiceServer) error {
	...
	mux.Handle("GET", pattern_NodeScanService_GetNodeVulnerabilities_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_NodeScanService_GetNodeVulnerabilities_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_NodeScanService_GetNodeVulnerabilities_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// "NodeScanServiceClient" to call the correct interceptors.
func RegisterNodeScanServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client NodeScanServiceClient) error {
	...
	mux.Handle("GET", pattern_NodeScanService_GetNodeVulnerabilities_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_NodeScanService_GetNodeVulnerabilities_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_NodeScanService_GetNodeVulnerabilities_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "nodes", "vulnerabilities"}, "", runtime.AssumeColonVerbOpt(false)))
)
