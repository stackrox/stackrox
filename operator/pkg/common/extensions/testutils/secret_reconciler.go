...
type SecretVerifyFunc func(t *testing.T, data commonExtensions.SecretDataMap)
...
func TestSecretReconciliation(t *testing.T, runFn func(ctx context.Context, central *platform.Central, client ctrlClient.Client, statusUpdater func(statusFunc UpdateStatusFunc), log logr.Logger) error, c SecretReconciliationTestCase) {
