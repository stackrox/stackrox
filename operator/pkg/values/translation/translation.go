...
// AddAdditionalCAs converts common.TLSConfig to a *ValuesBuilder with an "additionalCAs" field.
func AddAdditionalCAs(additionalCAS []common.AdditionalCA) *ValuesBuilder {
	res := NewValuesBuilder()
