...
import (
	...
	"github.com/stackrox/rox/operator/pkg/clientset/stackrox/scheme"
...
func (c *PlatformV1alpha1Client) Centrals(namespace string) CentralInterface {
	return newCentrals(c, namespace)
}

func (c *PlatformV1alpha1Client) SecuredClusters(namespace string) SecuredClusterInterface {
