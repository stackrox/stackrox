<<<<<<< HEAD
FROM registry.access.redhat.com/ubi9/python-39:latest@sha256:822a0c1b758a1d4c4344f50ae2dbcf5df3b7b880cf1e35c43a3a3d1cce764318 AS builder
=======
<<<<<<< HEAD
...
>>>>>>> edc5ecb256 (build: Use PyYAML dependency as RPM in bundle build (#18778))
>>>>>>> b94bcf55c7 (build: Use PyYAML dependency as RPM in bundle build (#18778))
