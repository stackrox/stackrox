...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoLockProcessBaselinesSpec) DeepCopyInto(out *AutoLockProcessBaselinesSpec) {
	*out = *in
	if in.Lock != nil {
		in, out := &in.Lock, &out.Lock
		*out = new(ProcessBaselineLockMode)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoLockProcessBaselinesSpec.
func (in *AutoLockProcessBaselinesSpec) DeepCopy() *AutoLockProcessBaselinesSpec {
	if in == nil {
		return nil
	}
	out := new(AutoLockProcessBaselinesSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecuredClusterSpec) DeepCopyInto(out *SecuredClusterSpec) {
	*out = *in
	...
	if in.AutoLockProcessBaselines != nil {
		in, out := &in.AutoLockProcessBaselines, &out.AutoLockProcessBaselines
		*out = new(AutoLockProcessBaselinesSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Scanner != nil {
