...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoLockProcessBaselineSpec) DeepCopyInto(out *AutoLockProcessBaselineSpec) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoLockProcessBaselineSpec.
func (in *AutoLockProcessBaselineSpec) DeepCopy() *AutoLockProcessBaselineSpec {
	if in == nil {
		return nil
	}
	out := new(AutoLockProcessBaselineSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecuredClusterSpec) DeepCopyInto(out *SecuredClusterSpec) {
	*out = *in
	...
	if in.AutoLockProcessBaseline != nil {
		in, out := &in.AutoLockProcessBaseline, &out.AutoLockProcessBaseline
		*out = new(AutoLockProcessBaselineSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Network != nil {
