...
func (in *CentralDBSpec) DeepCopyInto(out *CentralDBSpec) {
	*out = *in
	...
	if in.AdvancedConfigOverride != nil {
		in, out := &in.AdvancedConfigOverride, &out.AdvancedConfigOverride
		*out = new(DBConfigOverride)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DBConfigOverride) DeepCopyInto(out *DBConfigOverride) {
	*out = *in
	...
	if in.HashMemMultiplier != nil {
		in, out := &in.HashMemMultiplier, &out.HashMemMultiplier
		*out = new(string)
		**out = **in
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DBConfigOverride.
func (in *DBConfigOverride) DeepCopy() *DBConfigOverride {
	if in == nil {
		return nil
	}
	out := new(DBConfigOverride)
