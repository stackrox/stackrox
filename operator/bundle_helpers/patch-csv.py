...
def parse_args():
    handle_related_images_mode_help()
    ...
    add_related_images_argument(parser)
...
def add_related_images_argument(parser):
    parser.add_argument("--related-images-mode", choices=["downstream", "omit", "konflux", "help"],
                        default="downstream",
                        help="Set mode of operation for handling related image settings; specify 'help' for more information.")


def handle_related_images_mode_help():
