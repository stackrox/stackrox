...
MANDATORY:
  --base-index-tag     The base index image tag. Example: quay.io/rhacs-eng/stackrox-operator-index:v1.0.0
  --index-tag          The new index image tag. Example: quay.io/rhacs-eng/stackrox-operator-index:v1.1.0
  --bundle-tag         The bundle image tag that should be appended to base index. Example: quay.io/rhacs-eng/stackrox-operator-bundle:v1.1.0
