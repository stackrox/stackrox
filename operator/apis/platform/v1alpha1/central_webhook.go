...
var centrallog = logf.Log.WithName("central-resource")

// SetupWebhookWithManager sets up a webhook with mgr.
func (c *Central) SetupWebhookWithManager(mgr ctrl.Manager) error {
