...
func (in *CentralSpec) DeepCopyInto(out *CentralSpec) {
	*out = *in
	...
	if in.ScannerV4 != nil {
		...
		*out = new(ScannerV4ComponentSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Egress != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ScannerV4ComponentSpec) DeepCopyInto(out *ScannerV4ComponentSpec) {
	*out = *in
	if in.ScannerComponent != nil {
		in, out := &in.ScannerComponent, &out.ScannerComponent
		*out = new(ScannerComponentPolicy)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ScannerV4ComponentSpec.
func (in *ScannerV4ComponentSpec) DeepCopy() *ScannerV4ComponentSpec {
	if in == nil {
		return nil
	}
	out := new(ScannerV4ComponentSpec)
