...
func (r *createCentralTLSExtensionRun) Execute(ctx context.Context) error {
	...
	if err := r.EnsureSecret(ctx, "central-tls", r.validateAndConsumeCentralTLSData, r.generateCentralTLSData, commonLabels.GetTlsSecretLabels()); err != nil {
...
func (r *createCentralTLSExtensionRun) reconcileInitBundleSecrets(ctx context.Context, shouldDelete bool) error {
	...
	for _, serviceType := range centralsensor.AllSecuredClusterServices {
		...
		if err := r.EnsureSecret(ctx, secretName, validateFunc, generateFunc, commonLabels.GetTlsSecretLabels()); err != nil {
...
func (r *createCentralTLSExtensionRun) reconcileCentralDBTLSSecret(ctx context.Context) error {
	if r.centralObj.Spec.Central.ShouldManageDB() {
		return r.EnsureSecret(ctx, "central-db-tls", r.validateCentralDBTLSData, r.generateCentralDBTLSData, commonLabels.GetTlsSecretLabels())
	}
...
func (r *createCentralTLSExtensionRun) reconcileScannerTLSSecret(ctx context.Context) error {
	if r.centralObj.Spec.Scanner.IsEnabled() {
		return r.EnsureSecret(ctx, "scanner-tls", r.validateScannerTLSData, r.generateScannerTLSData, commonLabels.GetTlsSecretLabels())
	}
...
func (r *createCentralTLSExtensionRun) reconcileScannerDBTLSSecret(ctx context.Context) error {
	if r.centralObj.Spec.Scanner.IsEnabled() {
		return r.EnsureSecret(ctx, "scanner-db-tls", r.validateScannerDBTLSData, r.generateScannerDBTLSData, commonLabels.GetTlsSecretLabels())
	}
...
func (r *createCentralTLSExtensionRun) reconcileScannerV4IndexerTLSSecret(ctx context.Context) error {
	if r.centralObj.Spec.ScannerV4.IsEnabled() {
		return r.EnsureSecret(ctx, "scanner-v4-indexer-tls", r.validateScannerV4IndexerTLSData, r.generateScannerV4IndexerTLSData, commonLabels.GetTlsSecretLabels())
	}
...
func (r *createCentralTLSExtensionRun) reconcileScannerV4MatcherTLSSecret(ctx context.Context) error {
	if r.centralObj.Spec.ScannerV4.IsEnabled() {
		return r.EnsureSecret(ctx, "scanner-v4-matcher-tls", r.validateScannerV4MatcherTLSData, r.generateScannerV4MatcherTLSData, commonLabels.GetTlsSecretLabels())
	}
...
func (r *createCentralTLSExtensionRun) reconcileScannerV4DBTLSSecret(ctx context.Context) error {
	if r.centralObj.Spec.ScannerV4.IsEnabled() {
		return r.EnsureSecret(ctx, "scanner-v4-db-tls", r.validateScannerV4DBTLSData, r.generateScannerV4DBTLSData, commonLabels.GetTlsSecretLabels())
	}
