...
func AssertEqualPathValue(t *testing.T, values chartutil.Values, expected any, path string, msgAndArgs ...any) {
...
func AssertPathValueMatches(t *testing.T, values chartutil.Values, regex *regexp.Regexp, path string, msgAndArgs ...any) {
	v := readPath(t, values, path)
...
func AssertNotNilPathValue(t *testing.T, values chartutil.Values, path string, msgAndArgs ...any) {
	v := readPath(t, values, path)
	assert.NotNil(t, v, msgAndArgs)
}

func readPath(t *testing.T, values chartutil.Values, path string) any {
