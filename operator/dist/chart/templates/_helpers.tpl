...
*/}}
{{- define "rhacs-operator.fullname" -}}
...
*/}}
{{- define "rhacs-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "rhacs-operator.resourceName" -}}
{{- $fullname := include "rhacs-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "rhacs-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "rhacs-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
