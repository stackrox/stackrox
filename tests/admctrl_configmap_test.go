...
func TestAdmissionControllerConfigMapWithPostgres(t *testing.T) {
	if !env.PostgresDatastoreEnabled.BooleanSetting() {
		t.Skip("Skipping because ROX_POSTGRES_DATASTORE is set to false")
	}
...
func TestAdmissionControllerConfigMapWithoutPostgres(t *testing.T) {
	if env.PostgresDatastoreEnabled.BooleanSetting() {
		t.Skip("Skipping because ROX_POSTGRES_DATASTORE is set to true")
	}
