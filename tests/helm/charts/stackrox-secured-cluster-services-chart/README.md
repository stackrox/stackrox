...
|`image.main.registry`| Address of the registry you are using for main image.|`quay.io/rhacs-eng` |
|`image.collector.registry`| Address of the registry you are using for collector image.|`quay.io/rhacs-eng` |
|`sensor.endpoint`| Address of the Sensor endpoint including port number. No trailing slash.|`sensor.stackrox.svc:443` |
|`collector.forceCollectionMethod`|Enabling this setting overrides the default collection method with the content of `collector.collectionMethod` |`false` |
