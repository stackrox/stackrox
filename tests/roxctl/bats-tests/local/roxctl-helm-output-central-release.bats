...
@test "roxctl-release helm output central-services --image-defaults=development_build should fail" {
  ...
  assert_failure
  assert_line --regexp "ERROR:[[:space:]]+unable to get chart meta values: invalid arguments: '--image-defaults': unexpected value 'development_build', allowed values are \[stackrox.io rhacs\]"
}
...
@test "roxctl-release helm output central-services --image-defaults='' should fail with unexpected value of --image-defaults" {
  ...
  assert_failure
  assert_line --regexp "ERROR:[[:space:]]+unable to get chart meta values: invalid arguments: '--image-defaults': unexpected value '', allowed values are \[stackrox.io rhacs\]"
}
