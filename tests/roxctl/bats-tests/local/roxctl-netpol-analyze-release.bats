...
@test "roxctl-release analyze netpol should return error on empty or non-existing directory" {
  run roxctl-release analyze netpol "$out_dir" 
  assert_failure
  assert_line --partial "error in connectivity analysis"
  assert_line --partial "no such file or directory"

  run roxctl-release analyze netpol
  assert_failure
  assert_line --partial "accepts 1 arg(s), received 0"
}

@test "roxctl-release analyze netpol generates connlist output" {
  ...
  run roxctl-release analyze netpol "${test_data}/np-guard/netpols-analysis-example-minimal"
  assert_success
...
@test "roxctl-release analyze netpol stops on first error when run with --fail" {
  mkdir -p "$out_dir"
  ...
  run roxctl-release analyze netpol "$out_dir/" --remove --output-file=/dev/null --fail
  assert_failure
...
@test "roxctl-release analyze netpol produces no output when all yamls are templated" {
  mkdir -p "$out_dir"
...
@test "roxctl-release analyze netpol produces errors when some yamls are templated" {
  mkdir -p "$out_dir"
  write_yaml_to_file "$templated_fragment" "$(mktemp "$out_dir/templated-XXXXXX.yaml")"
  ...
  run roxctl-release analyze netpol "$out_dir/" --remove --output-file=/dev/null
  assert_failure
  assert_output --partial 'YAML document is malformed'
  refute_output --partial 'no relevant Kubernetes resources found'
}

@test "roxctl-release analyze netpol produces errors when yamls are not K8s resources" {
  mkdir -p "$out_dir"
...
@test "roxctl-release analyze netpol should return error on invalid networkpolicy resource" {
  assert_file_exist "${test_data}/np-guard/bad-netpol-example/resources.yaml"  
  run roxctl-release analyze netpol "${test_data}/np-guard/bad-netpol-example"    
  assert_failure
  assert_line --partial "error in connectivity analysis"
  assert_line --partial "selector error"
}

@test "roxctl-release analyze netpol should return error on not supported output format" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  run roxctl-release analyze netpol "${test_data}/np-guard/netpols-analysis-example-minimal" --output-format=docx 
  assert_failure
  assert_line --partial "error in formatting connectivity list"
  assert_line --partial "docx output format is not supported."
}

@test "roxctl-release analyze netpol generates txt connlist output" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-release analyze netpol "${test_data}/np-guard/netpols-analysis-example-minimal" --output-format=txt
  assert_success
...
@test "roxctl-release analyze netpol generates json connlist output" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-release analyze netpol "${test_data}/np-guard/netpols-analysis-example-minimal" --output-format=json
  assert_success
...
@test "roxctl-release analyze netpol generates md connlist output" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-release analyze netpol "${test_data}/np-guard/netpols-analysis-example-minimal" --output-format=md
  assert_success
...
@test "roxctl-release analyze netpol generates dot connlist output" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-release analyze netpol "${test_data}/np-guard/netpols-analysis-example-minimal" --output-format=dot
  assert_success
...
@test "roxctl-release analyze netpol generates csv connlist output" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-release analyze netpol "${test_data}/np-guard/netpols-analysis-example-minimal" --output-format=csv
  assert_success
...
@test "roxctl-release analyze netpol skips unsupported openshift resources" {
  ...
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-release analyze netpol "${test_data}/np-guard/security-frontend-demo"
  assert_success
...
@test "roxctl-release analyze netpol generates focused to workload connlist output" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-release analyze netpol "${test_data}/np-guard/netpols-analysis-example-minimal" --focus-workload=backend
  assert_success
...
@test "roxctl-release analyze netpol generates connlist to specific txt output file" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  run roxctl-release analyze netpol "${test_data}/np-guard/netpols-analysis-example-minimal" --output-file="$out_dir/out.txt"
  assert_success
