...
@test "roxctl-development helm output central-services --image-defaults=dummy should fail" {
  ...
  assert_failure
  assert_line --regexp "ERROR:[[:space:]]+unable to get chart meta values: invalid arguments: '--image-defaults': unexpected value 'dummy', allowed values are \[development_build stackrox.io rhacs\]"
}
