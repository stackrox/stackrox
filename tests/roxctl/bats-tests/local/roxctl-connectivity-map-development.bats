...
@test "roxctl-development connectivity-map generates connlist output" {
  ...
  run roxctl-development connectivity-map "${test_data}/np-guard/netpols-analysis-example-minimal"
  assert_success
...
@test "roxctl-development connectivity-map stops on first error when run with --fail" {
  mkdir -p "$out_dir"
...
@test "roxctl-development connectivity-map produces errors when some yamls are templated" {
  mkdir -p "$out_dir"
  write_yaml_to_file "$templated_fragment" "$(mktemp "$out_dir/templated-XXXXXX.yaml")"
  ...
  run roxctl-development connectivity-map "$out_dir/" --remove --output-file=/dev/null
  assert_failure
  assert_output --partial 'YAML document is malformed'
  refute_output --partial 'no relevant Kubernetes resources found'
}

@test "roxctl-development connectivity-map produces errors when yamls are not K8s resources" {
  mkdir -p "$out_dir"
...
@test "roxctl-development connectivity-map should return error on invalid networkpolicy resource" {
  assert_file_exist "${test_data}/np-guard/bad-netpol-example/resources.yaml"
  run roxctl-development connectivity-map "${test_data}/np-guard/bad-netpol-example"
  assert_failure
  assert_line --partial "error in connectivity analysis"
  assert_line --partial "selector error"
}

@test "roxctl-development connectivity-map should return error on not supported output format" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  run roxctl-development connectivity-map "${test_data}/np-guard/netpols-analysis-example-minimal" --output-format=docx
  assert_failure
  assert_line --partial "error in formatting connectivity list"
  assert_line --partial "docx output format is not supported."
}

@test "roxctl-development connectivity-map generates txt connlist output" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-development connectivity-map "${test_data}/np-guard/netpols-analysis-example-minimal" --output-format=txt
  assert_success
...
@test "roxctl-development connectivity-map generates json connlist output" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-development connectivity-map "${test_data}/np-guard/netpols-analysis-example-minimal" --output-format=json
  assert_success
...
@test "roxctl-development connectivity-map generates md connlist output" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-development connectivity-map "${test_data}/np-guard/netpols-analysis-example-minimal" --output-format=md
  assert_success
...
@test "roxctl-development connectivity-map generates dot connlist output" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-development connectivity-map "${test_data}/np-guard/netpols-analysis-example-minimal" --output-format=dot
  assert_success
...
@test "roxctl-development connectivity-map generates csv connlist output" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-development connectivity-map "${test_data}/np-guard/netpols-analysis-example-minimal" --output-format=csv
  assert_success
...
@test "roxctl-development connectivity-map generates focused to workload connlist output" {
  ...
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing connlist to ${ofile}" >&3
  run roxctl-development connectivity-map "${test_data}/np-guard/netpols-analysis-example-minimal" --focus-workload=backend
  assert_success
...
@test "roxctl-development connectivity-map generates connlist to specific txt output file" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  run roxctl-development connectivity-map "${test_data}/np-guard/netpols-analysis-example-minimal" --output-file="$out_dir/out.txt"
  assert_success
...
@test "roxctl-development connectivity-map generates connlist for acs-security-demo with focus-workload=gateway" {
  check_acs_security_demos_files
  run roxctl-development connectivity-map "${acs_security_demos_dir}" --focus-workload=gateway
  assert_success
  echo "$output" > "$ofile"
  assert_file_exist "$ofile"
...
@test "roxctl-development connectivity-map generates connlist for acs-security-demo with focus-workload=payments/gateway" {
  check_acs_security_demos_files
  run roxctl-development connectivity-map "${acs_security_demos_dir}" --focus-workload=payments/gateway
  assert_success
  echo "$output" > "$ofile"
  assert_file_exist "$ofile"
  assert_output --partial 'backend/checkout[Deployment] => payments/gateway[Deployment] : TCP 8080
...
@test "roxctl-development connectivity-map generates connlist for acs-security-demo with focus-workload that does not exist" {
  check_acs_security_demos_files
  run roxctl-development connectivity-map "${acs_security_demos_dir}" --focus-workload=abc
  assert_success
  echo "$output" > "$ofile"
  assert_file_exist "$ofile"
...
@test "roxctl-development connectivity-map generates connlist for acs-security-demo with focus-workload=ingress-controller" {
  check_acs_security_demos_files
  run roxctl-development connectivity-map "${acs_security_demos_dir}" --focus-workload=ingress-controller
  assert_success
  echo "$output" > "$ofile"
  assert_file_exist "$ofile"
