...
@test "roxctl-release netpol connectivity map generates md exposure output" {
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/backend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/frontend.yaml"
  assert_file_exist "${test_data}/np-guard/netpols-analysis-example-minimal/netpols.yaml"
  echo "Writing exposure report to ${ofile}" >&3
  run roxctl-release netpol connectivity map "${test_data}/np-guard/netpols-analysis-example-minimal" --exposure --output-format=md
  assert_success
...
@test "roxctl-release netpol connectivity map generates exposure from certain Namespace labels and Pod labels specified md format" {
  ...
  assert_file_exist "${test_data}/np-guard/exposure-example/ns_and_deployments.yaml"
  echo "Writing exposure report to ${ofile}" >&3
  run roxctl-release netpol connectivity map "${test_data}/np-guard/exposure-example" --exposure --output-format=md
  assert_success
