...
@test "[zip] roxctl scanner upload-db" {
  run curl --retry 30 --retry-max-time 300 --retry-all-errors --show-error --fail --output "${temp_dir}/test-scanner-vuln-updates.zip" --location 'https://install.stackrox.io/scanner/scanner-vuln-updates.zip'
  assert_success
