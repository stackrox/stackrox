...
export_test_environment() {
    ...
    ci_export ROX_DECLARATIVE_CONFIG_WATCH_INTERVAL "${ROX_DECLARATIVE_CONFIG_WATCH_INTERVAL:-1s}"
    ci_export ROX_DECLARATIVE_RECONCILE_INTERVAL "${ROX_DECLARATIVE_RECONCILE_INTERVAL:-1s}"
