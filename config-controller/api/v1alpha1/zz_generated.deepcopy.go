...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DummyStruct) DeepCopyInto(out *DummyStruct) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DummyStruct.
func (in *DummyStruct) DeepCopy() *DummyStruct {
	if in == nil {
		return nil
	}
	out := new(DummyStruct)
