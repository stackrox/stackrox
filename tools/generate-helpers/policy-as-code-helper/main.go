...
const genateLater = "// TODO(ROX-26318): Codes to be generated later.\n"

// externalize this string because Github thinks that this file is autogenerated
const autogenerated = "// Code generated by policy-as-code-helper generator. DO NOT EDIT."
...
func generateTemplateData(t reflect.Type, visited set.StringSet) []ConvertType {
	...
	for i := 0; i < t.NumField(); i++ {
		...
		needConvertion := !isStringer && !isTimeStamp && checkForConversion(field)
		if needConvertion {
...
func newTemplate(tpl string) func(name string) *template.Template {
	return func(name string) *template.Template {
		return template.Must(template.New(name).Option("missingkey=error").Parse(genateLater + autogenerated + tpl))
	}
}
