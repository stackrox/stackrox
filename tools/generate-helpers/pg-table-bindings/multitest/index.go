...
func (b *indexerImpl) SearchTestMultiKeyStructs(ctx context.Context, q *v1.Query) ([]*v1.SearchResult, error) {
	return nil, nil
}

func (b *indexerImpl) SearchRawTestMultiKeyStructs(ctx context.Context, q *v1.Query) ([]*v1.SearchResult, error) {
	return nil, nil
}

func (b *indexerImpl) SearchListTestMultiKeyStructs(ctx context.Context, q *v1.Query) ([]*v1.SearchResult, error) {
	return nil, nil
}
