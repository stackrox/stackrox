...
func dropTableTestGrandparents(ctx context.Context, db *postgres.Postgres) {
	_, _ = db.Exec(ctx, "DROP TABLE IF EXISTS test_grandparents CASCADE")
	dropTableTestGrandparentsEmbeddeds(ctx, db)

}

func dropTableTestGrandparentsEmbeddeds(ctx context.Context, db *postgres.Postgres) {
...
func dropTableTestGrandparentsEmbeddedsEmbedded2(ctx context.Context, db *postgres.Postgres) {
