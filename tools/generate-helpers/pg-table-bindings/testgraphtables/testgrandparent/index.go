...
func (b *indexerImpl) Count(ctx context.Context, q *v1.Query, opts ...blevesearch.SearchOption) (int, error) {
	...
	return pgSearch.RunCountRequest(ctx, v1.SearchCategory(109), q, b.db)
}
...
func (b *indexerImpl) Search(ctx context.Context, q *v1.Query, opts ...blevesearch.SearchOption) ([]search.Result, error) {
	...
	return pgSearch.RunSearchRequest(ctx, v1.SearchCategory(109), q, b.db)
}

//// Stubs for satisfying interfaces

func (b *indexerImpl) AddTestGrandparent(deployment *storage.TestGrandparent) error {
	return nil
}

func (b *indexerImpl) AddTestGrandparents(_ []*storage.TestGrandparent) error {
	return nil
}

func (b *indexerImpl) DeleteTestGrandparent(id string) error {
	return nil
}

func (b *indexerImpl) DeleteTestGrandparents(_ []string) error {
	return nil
}
