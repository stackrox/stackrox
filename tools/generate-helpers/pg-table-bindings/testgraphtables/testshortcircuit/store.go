...
var (
	...
	schema         = centralSchema.TestShortCircuitsSchema
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TestShortCircuit) error) error {
	var sacQueryFilter *v1.Query
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.TestShortCircuit](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
