...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.TestShortCircuit, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.TestShortCircuit](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.TestShortCircuit, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.TestShortCircuit](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TestShortCircuit) error) error {
	var sacQueryFilter *v1.Query
	fetcher, closer, err := postgres.RunCursorQueryForSchema[storage.TestShortCircuit](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
...
func dropTableTestShortCircuits(ctx context.Context, db *pgxpool.Pool) {
