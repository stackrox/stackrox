...
func (s *storeImpl) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.TestParent3, error) {
	...
	rows, err := pgSearch.RunGetManyQueryForSchema[storage.TestParent3](ctx, schema, query, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TestParent3) error) error {
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.TestParent3](ctx, schema, search.EmptyQuery(), s.db)
	if err != nil {
		return err
	}
	defer closer()
