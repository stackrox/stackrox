...
func insertIntoTestParent3(batch *pgx.Batch, pool pgSearch.BufferPool, obj *storage.TestParent3) (*[]byte, error) {
...
func copyFromTestParent3(ctx context.Context, s pgSearch.Deleter, tx *postgres.Tx, pool pgSearch.BufferPool, objs ...*storage.TestParent3) error {
	if len(objs) == 0 {
		return nil
	}
