...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.TestG3GrandChild1, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.TestG3GrandChild1](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.TestG3GrandChild1, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.TestG3GrandChild1](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TestG3GrandChild1) error) error {
	var sacQueryFilter *v1.Query
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[storage.TestG3GrandChild1](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
