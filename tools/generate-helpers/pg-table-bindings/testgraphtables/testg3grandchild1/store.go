...
func (s *storeImpl) copyFrom(ctx context.Context, objs ...*storage.TestG3GrandChild1) error {
	conn, release, err := s.acquireConn(ctx, ops.Get, "TestG3GrandChild1")
	if err != nil {
		return err
	}
	defer release()
...
func (s *storeImpl) Exists(ctx context.Context, id string) (bool, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Exists, "TestG3GrandChild1")
...
func (s *storeImpl) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.TestG3GrandChild1, error) {
	...
	rows, err := pgSearch.RunGetManyQueryForSchema[storage.TestG3GrandChild1](ctx, schema, query, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TestG3GrandChild1) error) error {
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.TestG3GrandChild1](ctx, schema, search.EmptyQuery(), s.db)
	if err != nil {
		return err
	}
	defer closer()
