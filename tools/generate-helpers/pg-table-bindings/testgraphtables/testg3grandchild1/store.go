...
type Store interface {
	...
	GetMany(ctx context.Context, identifiers []string) ([]*storage.TestG3GrandChild1, []int, error)
	GetIDs(ctx context.Context) ([]string, error)

	Walk(ctx context.Context, fn func(obj *storage.TestG3GrandChild1) error) error
}

type storeImpl struct {
	*pgSearch.GenericStore[storage.TestG3GrandChild1, *storage.TestG3GrandChild1]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		db: db,
		GenericStore: pgSearch.NewGenericStore[storage.TestG3GrandChild1, *storage.TestG3GrandChild1](
			db,
			targetResource,
			schema,
...
func pkGetter(obj *storage.TestG3GrandChild1) string {
	return obj.GetId()
}

func metricsSetPostgresOperationDurationTime(start time.Time, op ops.Op) {
	metrics.SetPostgresOperationDurationTime(start, op, "TestG3GrandChild1")
}

func metricsSetAcquireDBConnDuration(start time.Time, op ops.Op) {
	metrics.SetAcquireDBConnDuration(start, op, "TestG3GrandChild1")
}
...
func (s *storeImpl) copyFromTestG3GrandChild1(ctx context.Context, tx *postgres.Tx, objs ...*storage.TestG3GrandChild1) error {
...
func (s *storeImpl) copyFrom(ctx context.Context, objs ...*storage.TestG3GrandChild1) error {
...
func (s *storeImpl) upsert(ctx context.Context, objs ...*storage.TestG3GrandChild1) error {
	conn, err := s.AcquireConn(ctx, ops.Get)
	if err != nil {
		return err
	}
...
func (s *storeImpl) UpsertMany(ctx context.Context, objs []*storage.TestG3GrandChild1) error {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.UpdateMany, "TestG3GrandChild1")
...
func (s *storeImpl) DeleteMany(ctx context.Context, identifiers []string) error {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.RemoveMany, "TestG3GrandChild1")
...
func (s *storeImpl) Count(ctx context.Context) (int, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Count, "TestG3GrandChild1")
...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.TestG3GrandChild1, bool, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Get, "TestG3GrandChild1")
	...
	data, err := pgSearch.RunGetQueryForSchema[storage.TestG3GrandChild1](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.TestG3GrandChild1, error) {
	...
	rows, err := pgSearch.RunGetManyQueryForSchema[storage.TestG3GrandChild1](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.TestG3GrandChild1, []int, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.GetMany, "TestG3GrandChild1")
	...
	resultsByID := make(map[string]*storage.TestG3GrandChild1, len(rows))
	...
	elems := make([]*storage.TestG3GrandChild1, 0, len(resultsByID))
...
func (s *storeImpl) GetIDs(ctx context.Context) ([]string, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.GetAll, "storage.TestG3GrandChild1IDs")
	var sacQueryFilter *v1.Query
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TestG3GrandChild1) error) error {
	var sacQueryFilter *v1.Query
	sacQueryFilter, err := pgSearch.GetReadSACQuery(ctx, targetResource)
	if err != nil {
		return err
	}
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.TestG3GrandChild1](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
...
func dropTableTestG3GrandChild1(ctx context.Context, db postgres.DB) {
