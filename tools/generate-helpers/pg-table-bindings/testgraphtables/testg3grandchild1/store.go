...
const (
	...
	existsStmt = "SELECT EXISTS(SELECT 1 FROM test_g3_grand_child1 WHERE Id = $1)"

	getStmt     = "SELECT serialized FROM test_g3_grand_child1 WHERE Id = $1"
	deleteStmt  = "DELETE FROM test_g3_grand_child1 WHERE Id = $1"
	...
	deleteManyStmt = "DELETE FROM test_g3_grand_child1 WHERE Id = ANY($1::text[])"
