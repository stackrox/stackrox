...
type storeImpl struct {
	*pgSearch.GenericSingleIDStore[storage.TestParent1, *storage.TestParent1]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		GenericSingleIDStore: pgSearch.NewGenericSingleIDStore[storage.TestParent1, *storage.TestParent1](
			db,
			"TestParent1",
			targetResource,
			schema,
