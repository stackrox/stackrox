...
const (
	...
	existsStmt = "SELECT EXISTS(SELECT 1 FROM test_parent1 WHERE Id = $1)"

	getStmt     = "SELECT serialized FROM test_parent1 WHERE Id = $1"
	deleteStmt  = "DELETE FROM test_parent1 WHERE Id = $1"
	walkStmt    = "SELECT serialized FROM test_parent1"
	getManyStmt = "SELECT serialized FROM test_parent1 WHERE Id = ANY($1::text[])"

	deleteManyStmt = "DELETE FROM test_parent1 WHERE Id = ANY($1::text[])"
