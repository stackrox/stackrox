...
func (b *indexerImpl) Count(ctx context.Context, q *v1.Query, opts ...blevesearch.SearchOption) (int, error) {
	...
	return pgSearch.RunCountRequest(ctx, v1.SearchCategory(108), q, b.db)
}
...
func (b *indexerImpl) Search(ctx context.Context, q *v1.Query, opts ...blevesearch.SearchOption) ([]search.Result, error) {
	...
	return pgSearch.RunSearchRequest(ctx, v1.SearchCategory(108), q, b.db)
}

//// Stubs for satisfying interfaces

func (b *indexerImpl) AddTestGrandChild1(deployment *storage.TestGrandChild1) error {
	return nil
}

func (b *indexerImpl) AddTestGrandChild1s(_ []*storage.TestGrandChild1) error {
	return nil
}

func (b *indexerImpl) DeleteTestGrandChild1(id string) error {
	return nil
}

func (b *indexerImpl) DeleteTestGrandChild1s(_ []string) error {
	return nil
}
