...
const (
	...
	countStmt  = "SELECT COUNT(*) FROM testggrandchild1"
	existsStmt = "SELECT EXISTS(SELECT 1 FROM testggrandchild1 WHERE Id = $1)"
	...
	getIDsStmt  = "SELECT Id FROM testggrandchild1"
...
func (s *storeImpl) Delete(ctx context.Context, id string) error {
	...
	conn, release, err := s.acquireConn(ctx, ops.Remove, "TestGGrandChild1")
	if err != nil {
		return err
	}
	defer release()
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.TestGGrandChild1, []int, error) {
	...
	conn, release, err := s.acquireConn(ctx, ops.GetMany, "TestGGrandChild1")
	if err != nil {
		return nil, nil, err
	}
	defer release()
...
func (s *storeImpl) DeleteMany(ctx context.Context, ids []string) error {
	...
	conn, release, err := s.acquireConn(ctx, ops.RemoveMany, "TestGGrandChild1")
	if err != nil {
		return err
	}
	defer release()
