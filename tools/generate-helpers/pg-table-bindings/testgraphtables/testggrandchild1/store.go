...
func (s *storeImpl) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.TestGGrandChild1, error) {
	...
	rows, err := pgSearch.RunGetManyQueryForSchema[storage.TestGGrandChild1](ctx, schema, query, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TestGGrandChild1) error) error {
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.TestGGrandChild1](ctx, schema, search.EmptyQuery(), s.db)
	if err != nil {
		return err
	}
	defer closer()
