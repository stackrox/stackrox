...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.TestGGrandChild1, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.TestGGrandChild1](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.TestGGrandChild1, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.TestGGrandChild1](ctx, schema, q, s.db)
	if err != nil {
