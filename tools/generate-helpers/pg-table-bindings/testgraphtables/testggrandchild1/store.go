...
type storeImpl struct {
	*pgSearch.GenericSingleIDStore[storage.TestGGrandChild1, *storage.TestGGrandChild1]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		GenericSingleIDStore: pgSearch.NewGenericSingleIDStore[storage.TestGGrandChild1, *storage.TestGGrandChild1](
			db,
			"TestGGrandChild1",
			targetResource,
			schema,
