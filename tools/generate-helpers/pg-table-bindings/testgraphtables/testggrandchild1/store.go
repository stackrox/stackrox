...
func insertIntoTestGGrandChild1(ctx context.Context, batch *pgx.Batch, obj *storage.TestGGrandChild1) error {
	...
	finalStr := "INSERT INTO test_g_grand_child1 (Id, Val, serialized, tenant_id) VALUES($1, $2, $3, $4) ON CONFLICT(Id) DO UPDATE SET Id = EXCLUDED.Id, Val = EXCLUDED.Val, serialized = EXCLUDED.serialized, tenant_id = EXCLUDED.tenant_id"
