...
func New(ctx context.Context, db *pgxpool.Pool, gormDB *gorm.DB) Store {
	pgutils.CreateTableFromModel(ctx, gormDB, pkgSchema.CreateTableTestParent2Stmt)
	pgutils.CreateTableFromModel(ctx, gormDB, pkgSchema.CreateTableTestGrandparentsStmt)
	pgutils.CreateTableFromModel(ctx, gormDB, pkgSchema.CreateTableTestChild2Stmt)
