...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.TestChild2, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.TestChild2](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.TestChild2, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.TestChild2](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TestChild2) error) error {
	var sacQueryFilter *v1.Query
	fetcher, closer, err := postgres.RunCursorQueryForSchema[storage.TestChild2](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
