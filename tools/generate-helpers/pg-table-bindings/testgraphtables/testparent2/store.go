...
type storeImpl struct {
	*pgSearch.GenericSingleIDStore[storage.TestParent2, *storage.TestParent2]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		GenericSingleIDStore: pgSearch.NewGenericSingleIDStore[storage.TestParent2, *storage.TestParent2](
			db,
			"TestParent2",
			targetResource,
			schema,
