...
func (s *storeImpl) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.TestChild1P4, error) {
	...
	rows, err := pgSearch.RunGetManyQueryForSchema[storage.TestChild1P4](ctx, schema, query, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TestChild1P4) error) error {
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.TestChild1P4](ctx, schema, search.EmptyQuery(), s.db)
	if err != nil {
		return err
	}
	defer closer()
