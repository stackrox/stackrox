...
func insertIntoTestChild1P4(ctx context.Context, batch *pgx.Batch, obj *storage.TestChild1P4) error {
...
func (s *storeImpl) copyFromTestChild1P4(ctx context.Context, tx pgx.Tx, objs ...*storage.TestChild1P4) error {
...
func (s *storeImpl) Count(ctx context.Context) (int, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Count, "TestChild1P4")
...
func (s *storeImpl) Exists(ctx context.Context, id string) (bool, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Exists, "TestChild1P4")
...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.TestChild1P4, bool, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Get, "TestChild1P4")
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.TestChild1P4](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetIDs(ctx context.Context) ([]string, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.GetAll, "storage.TestChild1P4IDs")
	var sacQueryFilter *v1.Query
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.TestChild1P4, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.TestChild1P4](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TestChild1P4) error) error {
	var sacQueryFilter *v1.Query
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[storage.TestChild1P4](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
...
func dropTableTestChild1P4(ctx context.Context, db *pgxpool.Pool) {
