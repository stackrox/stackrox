...
func init() {
	...
	for s, r := range map[protocompat.Message]permissions.ResourceHandle{
		...
		&storage.Cluster{}:                                      resources.Cluster,
		...
		&storage.ImageCVEInfo{}:                                 resources.Image,
		&storage.ImageCVEV2{}:                                   resources.Image,
		&storage.ImageIntegration{}:                             resources.Integration,
		&storage.ImageScanV2{}:                                  resources.Image,
		&storage.ImageV2{}:                                      resources.Image,
		&storage.InitBundleMeta{}:                               resources.InitBundleMeta,
		...
		&storage.ScanComponent{}:                                resources.Image,
		&storage.ScanFinding{}:                                  resources.Image,
		&storage.Secret{}:                                       resources.Secret,
		&storage.SecuredUnits{}:                                 resources.Administration,
		&storage.SensorUpgradeConfig{}:                          resources.Administration,
		&storage.ServiceAccount{}:                               resources.ServiceAccount,
