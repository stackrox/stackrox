...
func init() {
	...
	for s, r := range map[protocompat.Message]permissions.ResourceHandle{
		...
		&storage.ComplianceOperatorBenchmark{}:                  resources.Compliance,
		...
		&storage.ComplianceOperatorControl{}:                    resources.Compliance,
		&storage.ComplianceOperatorControlRuleV2Edge{}:          resources.Compliance,
