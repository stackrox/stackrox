...
func (s *storeImpl) Get(ctx context.Context, {{template "paramList" $pks}}) (*{{.Type}}, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[{{.Type}}](ctx, schema, q, s.db)
	if err != nil {
...
{{- end }}
{{- end }}{{/* if not $inMigration */}}
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[{{.Type}}](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
