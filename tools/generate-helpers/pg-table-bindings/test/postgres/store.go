...
func New(db postgres.DB) Store {
	return &storeImpl{
		db: db,
		GenericStore: pgSearch.NewGenericStore[storage.TestSingleKeyStruct, *storage.TestSingleKeyStruct](
			db,
			schema,
			pkGetter,
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TestSingleKeyStruct) error) error {
	...
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.TestSingleKeyStruct](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
