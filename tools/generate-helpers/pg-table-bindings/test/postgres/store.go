...
const (
	...
	getWithRollupStmt = "select row_to_json((select record from (select table0.Key as Key, table0.Name as Name, table0.StringSlice as StringSlice, table0.Bool as Bool, table0.Uint64 as Uint64, table0.Int64 as Int64, table0.Float as Float, table0.Labels as Labels, table0.Timestamp as Timestamp, table0.Enum as Enum, table0.Enums as Enums, table0.Embedded_Embedded as Embedded_Embedded, table0.Oneofstring as Oneofstring, table0.Oneofnested_Nested as Oneofnested_Nested, table0.Oneofnested_Nested2_Nested2 as Oneofnested_Nested2_Nested2, table0.Bytess as Bytess, to_json(join0)->'array' as join0 from singlekey table0 left join lateral (select array(select json_build_object('idx', table1.idx, 'Nested', table1.Nested, 'Nested2_Nested2', table1.Nested2_Nested2) from singlekey_Nested table1 where (table0.Key = table1.singlekey_Key))) join0 on true where (table0.Key = $1)) record ))"
