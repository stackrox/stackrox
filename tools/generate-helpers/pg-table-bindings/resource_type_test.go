...
func TestGetResourceType(t *testing.T) {
	for _, tc := range []struct {
		...
		{typ: &storage.ComponentCVEEdge{}, resourceType: joinTable, joinTable: true},
		{typ: &storage.Config{}, resourceType: globallyScoped},
		{typ: &storage.CVE{}, resourceType: indirectlyScoped},
		{typ: &storage.Deployment{}, resourceType: directlyScoped},
		//{typ: &storage.ListDeployment{}, resourceType: directlyScoped},
		...
		{typ: &storage.NamespaceMetadata{}, resourceType: directlyScoped},
		{typ: &storage.NetworkBaseline{}, resourceType: directlyScoped}, // NO SEARCH FIELDS ?
		...
		{typ: &storage.NetworkPolicy{}, resourceType: directlyScoped}, // NO SEARCH FIELDS ?
		...
		{typ: &storage.ProcessBaselineResults{}, resourceType: directlyScoped}, // NO SEARCH FIELDS ?
