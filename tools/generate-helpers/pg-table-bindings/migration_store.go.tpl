...
import (
    ...
    "github.com/stackrox/rox/migrator/migrations/postgreshelper"
...
{{- define "copyObject"}}
{{- $schema := .schema }}
func {{ template "copyFunctionName" $schema }}(ctx context.Context, s postgreshelper.Deleter, tx *postgres.Tx, {{ range $index, $field := $schema.FieldsReferringToParent }} {{$field.Name}} {{$field.Type}},{{end}} objs ...{{$schema.Type}}) error {
