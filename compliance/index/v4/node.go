...
// NewNodeIndexer creates a new node indexer based on Scanner V4.
func NewNodeIndexer(cfg NodeIndexerConfig) compliance.NodeIndexer {
	return &localNodeIndexer{cfg: cfg}
}

// GetIntervals returns the Scanner V4 node indexer scan intervals.
