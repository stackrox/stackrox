...
func (s *relayTestSuite) TestRelay_StartFailure() {
	...
	relay := New(stream, sender, &mockUMH{}, noThrottlingReportsPerMinute, testStaleAckThreshold, 0, 0)
...
func (s *relayTestSuite) TestRelay_Integration() {
	...
	relay := New(mockIndexReportStream, mockIndexReportSender, &mockUMH{}, noThrottlingReportsPerMinute, testStaleAckThreshold, 0, 0)
...
func (s *relayTestSuite) TestRelay_SenderErrorsDoNotStopProcessing() {
	...
	umh := &mockUMH{}
	relay := New(mockIndexReportStream, mockIndexReportSender, umh, noThrottlingReportsPerMinute, testStaleAckThreshold, 0, 0)
...
func (s *relayTestSuite) TestRelay_RateLimiting() {
	...
	relay := New(mockIndexReportStream, mockIndexReportSender, &mockUMH{}, singleReportPerMinute, testStaleAckThreshold, 0, 0)
...
func (s *relayTestSuite) TestRelay_RunReturnsErrorWhenRetryChannelCloses() {
	...
	r := New(&mockIndexReportStream{}, &mockIndexReportSender{failOnIndex: -1}, umh, noThrottlingReportsPerMinute, testStaleAckThreshold, 0, 0)
...
func (s *relayTestSuite) TestRelay_RetryCommand_CacheHit_Resends() {
	...
	relay := New(stream, mockSender, umh, noThrottlingReportsPerMinute, testStaleAckThreshold, 4, 24*time.Hour)
...
func (s *relayTestSuite) TestRelay_RetryCommand_CacheDisabled_DoesNotResend() {
	...
	relay := New(stream, mockSender, umh, noThrottlingReportsPerMinute, testStaleAckThreshold, 0, 24*time.Hour)
