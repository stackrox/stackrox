// Package sender handles sending index reports to Sensor.
package sender
...
// New creates an IndexReportSender that sends reports to Sensor.
...
// Send sends the VM report to Sensor in a single attempt with a 5-second timeout.
