...
func fakeDockerCreator() (string, types.Creator) {
	return types.DockerType,
		func(integration *storage.ImageIntegration, _ ...types.CreatorOption) (types.Registry, error) {
			return newFakeRegistry(integration.GetName(), "", "", "", integration.GetAutogenerated()), nil
		}
}
...
func TestSetImpl_Clear(t *testing.T) {
	...
	factory := NewFactory(FactoryOptions{
		CreatorFuncs: []types.CreatorWrapper{fakeDockerCreator},
	})
