...
var (
	...
	// region unconventional features

	// The following features are not following the convention.
	// They have to be *disabled* to activate the new behavior.
	...
	// endregion unconventional features
