...
var (
	expectedFormatImageAlertV2 = `Alert ID: ` + fixtureconsts.Alert1 + `
Alert URL: https://localhost:8080/main/vulnerability-management/image/` + utils.NewImageV2ID(fixtures.GetImage().GetName(), fixtures.GetImage().GetId()) + `
Time (UTC): 2021-01-20 22:42:02
Severity: Low
...
func TestFormatAlert(t *testing.T) {
	...
	if features.FlattenImageData.Enabled() {
		runFormatTest(t, imageAlert, expectedFormatImageAlertV2)
	} else {
