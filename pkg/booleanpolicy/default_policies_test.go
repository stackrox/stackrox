...
func (suite *DefaultPoliciesTestSuite) TestFixableCriteriaWithUnsetFixedBy() {
...
func (suite *DefaultPoliciesTestSuite) TestCustomerFixableNotYetFixableOnMixedCVEDeployment() {
	const (
