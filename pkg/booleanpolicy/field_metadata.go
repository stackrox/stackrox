...
func init() {
	...
	registerFieldMetadata(fieldnames.MountPropagation, querybuilders.ForFieldLabel(search.MountPropagation), violationmessages.VolumeContextFields, mountPropagationValueRegex)
	...
	registerFieldMetadata(fieldnames.KubeResource, querybuilders.ForFieldLabel(augmentedobjs.KubernetesResourceCustomTag), nil, kubernetesResourceValueRegex, negationForbidden)
}
