...
var (
	qToFieldValueMappers = map[search.FieldLabel]*fieldNameAndFVB{
		...
		search.Port:                          newMapper(fieldnames.Port, directMap),
		search.Privileged:                    newMapper(fieldnames.Privileged, directMap),
		...
		search.PortProtocol:                  newMapper(fieldnames.Protocol, directMap),
