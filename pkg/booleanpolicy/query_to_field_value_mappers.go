...
var (
	qToFieldValueMappers = map[search.FieldLabel]*fieldNameAndFVB{
		...
		augmentedobjs.KubernetesAPIVerbCustomTag:  newMapper(fieldnames.KubeAPIVerb, directMap),
		augmentedobjs.KubernetesResourceCustomTag: newMapper(fieldnames.KubeResource, directMap),
	}
)
