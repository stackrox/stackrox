...
var (
	policyFieldsToPrinters = map[string][]violationPrinter{
		...
		fieldnames.FirstImageOccuranceAge:       {{required: set.NewStringSet(search.FirstImageOccurrenceTimestamp.String()), printerFuncKey: printer.FirstImageOccuranceAgeKey}},
		...
		fieldnames.RequiredAnnotation:           {{required: set.NewStringSet(search.DeploymentAnnotation.String()), printerFuncKey: printer.RequiredAnnotationKey}},
