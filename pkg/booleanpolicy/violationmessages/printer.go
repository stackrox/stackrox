...
var (
	policyFieldsToPrinters = map[string][]violationPrinter{
		...
		fieldnames.ImageSignatureVerified:       {{required: set.NewStringSet(augmentedobjs.ImageSignatureVerifiedCustomTag), printerFuncKey: printer.ImageSignatureVerifiedKey}},
