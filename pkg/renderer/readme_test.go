...
func TestReadme(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			mustContain:                           []string{"kubectl create -R -f scanner-v4", "kubectl create -R -f central"},
		...
		},
		{
			...
			mustContain:    []string{"kubectl create -R -f scanner-v4"},
		...
		},
		{
			...
			mustContain:    []string{"oc create -R -f scanner-v4"},
