...
// IDV2 creates a CVE ID from the given cve id and image ID.
func IDV2(cve, imageID, componentID, cveIndex string) string {
	return pgSearch.IDFromPks([]string{cve, imageID, componentID, cveIndex})
}
