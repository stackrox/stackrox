...
var (
	// We set the default value to the image flavor to ImageFlavorNameDevelopmentBuild.
	...
	imageFlavorSetting = env.RegisterSetting(imageFlavorEnvName, env.AllowEmpty(), env.WithDefault(ImageFlavorNameDevelopmentBuild))
)
