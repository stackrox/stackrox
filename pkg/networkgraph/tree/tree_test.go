...
func TestNetworkTree(t *testing.T) {
	...
	*/
	...
	e3 := testutils.GetExtSrcNetworkEntityInfo("3", "3", "35.187.144.0/8", false) // 35.0.0.0 - 35.255.255.255
	...
	e6 := testutils.GetExtSrcNetworkEntityInfo("6", "6", "36.188.144.0/16", true) // 36.188.0.0 - 36.188.255.255

	networkTree, err := NewNetworkTree(pkgNet.IPv4, []*storage.NetworkEntityInfo{e1, e2, e3, e4, e5, e6})
	...
	e7 := testutils.GetExtSrcNetworkEntityInfo("7", "7", "36.188.144.0/31", false)
	e8 := testutils.GetExtSrcNetworkEntityInfo("8", "8", "35.188.144.0/5", false) // 32.0.0.0 - 39.255.255.255
	...
	*/
	...
	// Invalid CIDR
	assert.Error(t, networkTree.Insert(testutils.GetExtSrcNetworkEntityInfo("9", "9", "0:0:0:0:0:ffff:0:0/0", false)))
	...
	// Existing CIDR
	assert.Error(t, networkTree.Insert(testutils.GetExtSrcNetworkEntityInfo("88", "88", "35.188.144.0/5", false)))
	...
	*/
	...
	assert.Nil(t, networkTree.GetSupernetForCIDR("0.0.0.0/0"))
