...
func callerFileToPackage(skip int) string {
	callers := [1]uintptr{}
	// To the alert reader (and my future self): the skip parameter passed to Caller and Callers is
	// interpreted differently for historical reasons (citing the Golang runtime documentation).
