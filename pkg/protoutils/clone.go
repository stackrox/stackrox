...
//go:generate genny -in=$GOFILE -imp=github.com/stackrox/rox/generated/storage -imp=github.com/stackrox/rox/generated/api/v1 -out=gen-$GOFILE gen "ProtoCloneType=*storage.Policy,*storage.Deployment,*storage.Alert,*v1.Query,*storage.Cluster,*storage.ImageIntegration"
