...
// MockNodeMatcher is a mock of NodeMatcher interface.
type MockNodeMatcher struct {
	ctrl     *gomock.Controller
	recorder *MockNodeMatcherMockRecorder
}

// MockNodeMatcherMockRecorder is the mock recorder for MockNodeMatcher.
type MockNodeMatcherMockRecorder struct {
	mock *MockNodeMatcher
}

// NewMockNodeMatcher creates a new mock instance.
func NewMockNodeMatcher(ctrl *gomock.Controller) *MockNodeMatcher {
	mock := &MockNodeMatcher{ctrl: ctrl}
	mock.recorder = &MockNodeMatcherMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockNodeMatcher) EXPECT() *MockNodeMatcherMockRecorder {
	return m.recorder
}

// GetNodeVulnerabilityReport mocks base method.
func (m *MockNodeMatcher) GetNodeVulnerabilityReport(node *storage.Node, indexReport *v4.IndexReport) (*v4.VulnerabilityReport, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNodeVulnerabilityReport", node, indexReport)
	ret0, _ := ret[0].(*v4.VulnerabilityReport)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetNodeVulnerabilityReport indicates an expected call of GetNodeVulnerabilityReport.
func (mr *MockNodeMatcherMockRecorder) GetNodeVulnerabilityReport(node, indexReport any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNodeVulnerabilityReport", reflect.TypeOf((*MockNodeMatcher)(nil).GetNodeVulnerabilityReport), node, indexReport)
}

// MaxConcurrentNodeMatchSemaphore mocks base method.
func (m *MockNodeMatcher) MaxConcurrentNodeMatchSemaphore() *semaphore.Weighted {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MaxConcurrentNodeMatchSemaphore")
	ret0, _ := ret[0].(*semaphore.Weighted)
	return ret0
}

// MaxConcurrentNodeMatchSemaphore indicates an expected call of MaxConcurrentNodeMatchSemaphore.
func (mr *MockNodeMatcherMockRecorder) MaxConcurrentNodeMatchSemaphore() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MaxConcurrentNodeMatchSemaphore", reflect.TypeOf((*MockNodeMatcher)(nil).MaxConcurrentNodeMatchSemaphore))
}

// Name mocks base method.
func (m *MockNodeMatcher) Name() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Name")
	ret0, _ := ret[0].(string)
	return ret0
...
// Name indicates an expected call of Name.
func (mr *MockNodeMatcherMockRecorder) Name() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Name", reflect.TypeOf((*MockNodeMatcher)(nil).Name))
}

// Type mocks base method.
func (m *MockNodeMatcher) Type() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Type")
	ret0, _ := ret[0].(string)
	return ret0
...
// Type indicates an expected call of Type.
func (mr *MockNodeMatcherMockRecorder) Type() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Type", reflect.TypeOf((*MockNodeMatcher)(nil).Type))
}

// MockNodeMatcherWithDataSource is a mock of NodeMatcherWithDataSource interface.
type MockNodeMatcherWithDataSource struct {
	ctrl     *gomock.Controller
	recorder *MockNodeMatcherWithDataSourceMockRecorder
}

// MockNodeMatcherWithDataSourceMockRecorder is the mock recorder for MockNodeMatcherWithDataSource.
type MockNodeMatcherWithDataSourceMockRecorder struct {
	mock *MockNodeMatcherWithDataSource
}

// NewMockNodeMatcherWithDataSource creates a new mock instance.
func NewMockNodeMatcherWithDataSource(ctrl *gomock.Controller) *MockNodeMatcherWithDataSource {
	mock := &MockNodeMatcherWithDataSource{ctrl: ctrl}
	mock.recorder = &MockNodeMatcherWithDataSourceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockNodeMatcherWithDataSource) EXPECT() *MockNodeMatcherWithDataSourceMockRecorder {
	return m.recorder
}

// DataSource mocks base method.
func (m *MockNodeMatcherWithDataSource) DataSource() *storage.DataSource {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DataSource")
	ret0, _ := ret[0].(*storage.DataSource)
	return ret0
...
// DataSource indicates an expected call of DataSource.
func (mr *MockNodeMatcherWithDataSourceMockRecorder) DataSource() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DataSource", reflect.TypeOf((*MockNodeMatcherWithDataSource)(nil).DataSource))
}

// GetNodeMatcher mocks base method.
func (m *MockNodeMatcherWithDataSource) GetNodeMatcher() types.NodeMatcher {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNodeMatcher")
	ret0, _ := ret[0].(types.NodeMatcher)
	return ret0
}

// GetNodeMatcher indicates an expected call of GetNodeMatcher.
func (mr *MockNodeMatcherWithDataSourceMockRecorder) GetNodeMatcher() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNodeMatcher", reflect.TypeOf((*MockNodeMatcherWithDataSource)(nil).GetNodeMatcher))
}
