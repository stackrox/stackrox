...
func TestNodeScan(t *testing.T) {
	...
	actual := nodeScan(mockVulnReport, "Red Hat Enterprise Linux CoreOS 417.94.202409121747-0")
...
func TestNodeScan_EmptyVulnerabilityReport(t *testing.T) {
	...
	assert.NotPanics(t, func() {
		actual = nodeScan(r, "Red Hat Enterprise Linux CoreOS 417.94.202409121747-0")
	})
