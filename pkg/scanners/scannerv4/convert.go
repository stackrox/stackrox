...
// Deprecated: Callers should use setScoresAndScoreVersions instead, as it covers the case when we have
// multiple CVSS scores.
// This function is currently used for Node Scanning, though.
