...
func View(resource Resource) *v1.Permission {
	return &v1.Permission{Resource: string(resource), Access: v1.Access_READ_PERMISSION}
}

// Modify returns the permission struct for modifying resource r.
func Modify(resource Resource) *v1.Permission {
	return &v1.Permission{Resource: string(resource), Access: v1.Access_READ_WRITE_PERMISSION}
}
