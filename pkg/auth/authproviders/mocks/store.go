...
func (mr *MockStoreMockRecorder) AddAuthProvider(ctx, authProvider interface{}) *gomock.Call {
...
func (mr *MockStoreMockRecorder) GetAllAuthProviders(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) GetAuthProvider(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) GetAuthProvidersFiltered(ctx, filter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) RemoveAuthProvider(ctx, id, force interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) UpdateAuthProvider(ctx, authProvider interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
