...
func CreateIssuerFactoryAndValidator(issuerID string, privateKeyGetter jwt.PrivateKeyStore, publicKeyGetter jwt.KeyGetter, keyID string, options ...Option) (IssuerFactory, Validator) {
	srcs := newSourceStore()
