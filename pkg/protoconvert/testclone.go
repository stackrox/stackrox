...
// ConvertSliceTestTestClone_Int32ToTest2TestClone_Int32 converts a slice of *test.TestClone_Int32 to a slice of *test2.TestClone_Int32
func ConvertSliceTestTestClone_Int32ToTest2TestClone_Int32(p1 []*test.TestClone_Int32) []*test2.TestClone_Int32 {
  if p1 == nil {
    return nil
  }
...
// ConvertSliceTestTestClone_MsgToTest2TestClone_Msg converts a slice of *test.TestClone_Msg to a slice of *test2.TestClone_Msg
func ConvertSliceTestTestClone_MsgToTest2TestClone_Msg(p1 []*test.TestClone_Msg) []*test2.TestClone_Msg {
  if p1 == nil {
    return nil
  }
...
func ConvertTestTestCloneToTest2TestClone(p1 *test.TestClone) *test2.TestClone {
  ...
  if p1.Primitive != nil {
    if val, ok := p1.Primitive.(*test.TestClone_Int32); ok {
      p2.Primitive = ConvertTestTestClone_Int32ToTest2TestClone_Int32(val)
    }
    if val, ok := p1.Primitive.(*test.TestClone_String_); ok {
      p2.Primitive = ConvertTestTestClone_String_ToTest2TestClone_String_(val)
    }
    if val, ok := p1.Primitive.(*test.TestClone_Msg); ok {
      p2.Primitive = ConvertTestTestClone_MsgToTest2TestClone_Msg(val)
    }
  }
  p2.Any = p1.Any.Clone()
  if p1.BytesMap != nil {
...
// ConvertSliceTest2TestClone_Int32ToTestTestClone_Int32 converts a slice of *test2.TestClone_Int32 to a slice of *test.TestClone_Int32
func ConvertSliceTest2TestClone_Int32ToTestTestClone_Int32(p1 []*test2.TestClone_Int32) []*test.TestClone_Int32 {
  if p1 == nil {
    return nil
  }
...
// ConvertSliceTest2TestClone_String_ToTestTestClone_String_ converts a slice of *test2.TestClone_String_ to a slice of *test.TestClone_String_
func ConvertSliceTest2TestClone_String_ToTestTestClone_String_(p1 []*test2.TestClone_String_) []*test.TestClone_String_ {
  if p1 == nil {
    return nil
  }
...
func ConvertTest2TestCloneToTestTestClone(p1 *test2.TestClone) *test.TestClone {
  ...
  if p1.Primitive != nil {
    if val, ok := p1.Primitive.(*test2.TestClone_Int32); ok {
      p2.Primitive = ConvertTest2TestClone_Int32ToTestTestClone_Int32(val)
    }
    if val, ok := p1.Primitive.(*test2.TestClone_String_); ok {
      p2.Primitive = ConvertTest2TestClone_String_ToTestTestClone_String_(val)
    }
    if val, ok := p1.Primitive.(*test2.TestClone_Msg); ok {
      p2.Primitive = ConvertTest2TestClone_MsgToTestTestClone_Msg(val)
    }
  }
  p2.Any = p1.Any.Clone()
  if p1.BytesMap != nil {
