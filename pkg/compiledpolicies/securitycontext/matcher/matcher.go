...
type Matcher func(*v1.SecurityContext) []*v1.Alert_Violation
...
func (f orMatcherImpl) do(sc *v1.SecurityContext) []*v1.Alert_Violation {
	violations1 := f.p1(sc)
	violations2 := f.p2(sc)
...
func (f andMatcherImpl) do(sc *v1.SecurityContext) []*v1.Alert_Violation {
	violations1 := f.p1(sc)
	if violations1 == nil {
		return nil
	}
