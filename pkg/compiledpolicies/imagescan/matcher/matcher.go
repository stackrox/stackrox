...
type Matcher func(*v1.ImageScan) []*v1.Alert_Violation
...
func (f orMatcherImpl) do(imageScan *v1.ImageScan) []*v1.Alert_Violation {
...
func (f andMatcherImpl) do(imageScan *v1.ImageScan) []*v1.Alert_Violation {
	violations1 := f.p1(imageScan)
	if violations1 == nil {
		return nil
	}
