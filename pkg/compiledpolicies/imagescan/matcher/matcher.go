...
type Matcher func(*storage.ImageScan) []*storage.Alert_Violation
...
func (f orMatcherImpl) do(imageScan *storage.ImageScan) []*storage.Alert_Violation {
	violations1 := f.p1(imageScan)
	violations2 := f.p2(imageScan)
...
func (f andMatcherImpl) do(imageScan *storage.ImageScan) []*storage.Alert_Violation {
	violations1 := f.p1(imageScan)
	if violations1 == nil {
		return nil
	}
