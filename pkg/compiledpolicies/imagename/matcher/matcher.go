...
type Matcher func(*storage.ImageName) []*storage.Alert_Violation
...
func (f orMatcherImpl) do(imageName *storage.ImageName) []*storage.Alert_Violation {
	violations1 := f.p1(imageName)
	violations2 := f.p2(imageName)
...
func (f andMatcherImpl) do(imageName *storage.ImageName) []*storage.Alert_Violation {
	violations1 := f.p1(imageName)
	if violations1 == nil {
		return nil
	}
