...
func MatchResources(policy *storage.ResourcePolicy, resource *storage.Resources, identifier string) []*storage.Alert_Violation {
	matchFunctions := []func(*storage.ResourcePolicy, *storage.Resources, string) ([]*storage.Alert_Violation, bool){
...
func matchCPUResourceRequest(rp *storage.ResourcePolicy, resources *storage.Resources, id string) (violations []*storage.Alert_Violation, policyExists bool) {
...
func matchCPUResourceLimit(rp *storage.ResourcePolicy, resources *storage.Resources, id string) (violations []*storage.Alert_Violation, policyExists bool) {
	violations, policyExists = matchNumericalPolicy("CPU resource limit",
		id, resources.GetCpuCoresLimit(), rp.GetCpuResourceLimit())
	return
}

func matchMemoryResourceRequest(rp *storage.ResourcePolicy, resources *storage.Resources, id string) (violations []*storage.Alert_Violation, policyExists bool) {
...
func matchMemoryResourceLimit(rp *storage.ResourcePolicy, resources *storage.Resources, id string) (violations []*storage.Alert_Violation, policyExists bool) {
...
func matchNumericalPolicy(prefix, id string, value float32, p *storage.NumericalPolicy) (violations []*storage.Alert_Violation, policyExists bool) {
	if p == nil {
		return
	}
	policyExists = true
