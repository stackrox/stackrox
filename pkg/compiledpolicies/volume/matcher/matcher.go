...
type Matcher func(*v1.Volume) []*v1.Alert_Violation
...
func (f orMatcherImpl) do(volume *v1.Volume) []*v1.Alert_Violation {
...
func (f andMatcherImpl) do(volume *v1.Volume) []*v1.Alert_Violation {
	violations1 := f.p1(volume)
	if violations1 == nil {
		return nil
	}
