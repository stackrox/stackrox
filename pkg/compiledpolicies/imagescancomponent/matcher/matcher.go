...
type Matcher func(*v1.ImageScanComponent) []*v1.Alert_Violation
...
func (f orMatcherImpl) do(isc *v1.ImageScanComponent) []*v1.Alert_Violation {
...
func (f andMatcherImpl) do(isc *v1.ImageScanComponent) []*v1.Alert_Violation {
	violations1 := f.p1(isc)
	if violations1 == nil {
		return nil
	}
