...
type Predicate func(*storage.Container) bool
...
func (f orPredicateImpl) do(container *storage.Container) bool {
...
func (f andPredicateImpl) do(container *storage.Container) bool {
	return f.p1(container) && f.p2(container)
}
