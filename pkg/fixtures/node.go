...
// GetNodeForSerializationTest returns a Mock Node for serialization testing purpose.
func GetNodeForSerializationTest(_ testing.TB) *storage.Node {
	var joinedDate = time.Date(2020, time.December, 24, 23, 59, 59, 999999999, time.UTC)
	var updatedDate = time.Date(2020, time.December, 31, 23, 59, 59, 999999999, time.UTC)
	var scanDate = time.Date(2021, time.January, 1, 1, 1, 1, 111111111, time.UTC)
	node := &storage.Node{
		Id:          fixtureconsts.Node1,
...
// GetExpectedJSONSerializedTestNode returns the protoJSON serialized form
// of the Image returned by GetNodeForSerializationTest
func GetExpectedJSONSerializedTestNode(_ testing.TB) string {
	return `{
	"id": "bbaaaaaa-bbbb-4011-0000-111111111111",
	"name": "fp-3-14-rethorical-hhg-h2g2-worker-b-abcde",
	...
	"joinedAt": "2020-12-24T23:59:59.999999999Z",
	"internalIpAddresses": [
		"192.168.0.1"
	],
	"containerRuntime": {
	...
	"kubeletVersion": "v3.14.2",
	"kubeProxyVersion": "v3.14.2",
	"lastUpdated": "2020-12-31T23:59:59.999999999Z",
	"k8sUpdated": "2020-12-31T23:59:59.999999999Z",
	"scan": {
		"scanTime": "2021-01-01T01:01:01.111111111Z",
		"operatingSystem": "linux-5.6.7-89.0",
		"components": [
			{
				"name": "NetworkManager",
				...
				"vulnerabilities": [
					{
						"cveBaseInfo": {
							...
							"summary": "DOCUMENTATION: A flaw was found in NetworkManager. Setting match.path and activating a profile crashes NetworkManager. The highest threat from this vulnerability is to system availability.",
							"link": "https://access.redhat.com/security/cve/CVE-2021-20297",
							"createdAt": "2021-01-01T01:01:01.111111111Z",
							"lastModified": "2020-12-31T23:59:59.999999999Z",
							"scoreVersion": "V3",
							"cvssV3": {
								"vector": "CVSS:3.1/AV:L/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H",
								"exploitabilityScore": 1.8,
				...
				"vulnerabilities": [
					{
						"cveBaseInfo": {
							...
							"summary": "DOCUMENTATION: The MITRE CVE dictionary describes this issue as: An issue was discovered in Oniguruma 6.2.0, as used in Oniguruma-mod in Ruby through 2.4.1 and mbstring in PHP through 7.1.5. A heap out-of-bounds write or read occurs in next_state_val() during regular expression compilation. Octal numbers larger than 0xff are not handled correctly in fetch_token() and fetch_token_in_cc(). A malformed regular expression containing an octal number in the form of '\\\\700' would produce an invalid code point value larger than 0xff in next_state_val(), resulting in an out-of-bounds write memory corruption.",
							"link": "https://access.redhat.com/security/cve/CVE-2017-9226",
							"createdAt": "2020-12-31T23:59:59.999999999Z",
							"lastModified": "2020-12-24T23:59:59.999999999Z",
							"scoreVersion": "V3",
							"cvssV3": {
								"vector": "CVSS:3.0/AV:N/AC:H/PR:N/UI:N/S:U/C:N/I:L/A:L",
								"exploitabilityScore": 2.2,
