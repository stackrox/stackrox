...
//go:generate genny -in=$GOFILE -imp=github.com/stackrox/rox/generated/storage -out=rolebindings_$GOFILE gen "Resource=*storage.K8SRoleBinding"
//go:generate genny -in=$GOFILE -imp=github.com/stackrox/rox/generated/storage -out=role_$GOFILE gen "Resource=*storage.K8SRole"
//go:generate genny -in=$GOFILE -imp=github.com/stackrox/rox/generated/storage -out=serviceaccount_$GOFILE gen "Resource=*storage.ServiceAccount"
