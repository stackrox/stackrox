...
func GetEmbeddedImageCVE_2009_5155() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2009-5155",
		Cvss:         7.5,
...
func GetEmbeddedImageCVE_2016_10228() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2016-10228",
		Cvss:         5.9,
		...
		PublishedOn:       &types.Timestamp{Seconds: 1488419940},
...
func GetEmbeddedImageCVE_2016_10739() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2016-10739",
		Cvss:         5.3,
		...
		PublishedOn:       &types.Timestamp{Seconds: 1548098940},
		LastModified:      &types.Timestamp{Seconds: 1565111700},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
...
func GetEmbeddedImageCVE_2018_6551() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2018-6551",
		Cvss:         9.8,
		...
		PublishedOn:       &types.Timestamp{Seconds: 1517581740},
		LastModified:      &types.Timestamp{Seconds: 1598290620},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
		Severity:          storage.VulnerabilitySeverity_CRITICAL_VULNERABILITY_SEVERITY,
	}
...
func GetEmbeddedImageCVE_2019_7309() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2019-7309",
		Cvss:         5.5,
		...
		PublishedOn:       &types.Timestamp{Seconds: 1549160940},
		LastModified:      &types.Timestamp{Seconds: 1598290620},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
		Severity:          storage.VulnerabilitySeverity_LOW_VULNERABILITY_SEVERITY,
	}
...
func GetEmbeddedImageCVE_2019_9192() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2019-9192",
		Cvss:         7.5,
		...
		PublishedOn:       &types.Timestamp{Seconds: 1551205740},
		LastModified:      &types.Timestamp{Seconds: 1598290620},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
		Severity:          storage.VulnerabilitySeverity_LOW_VULNERABILITY_SEVERITY,
	}
...
func GetEmbeddedImageCVE_2019_19126() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2019-19126",
		Cvss:         3.3,
		Summary:      "On the x86-64 architecture, the GNU C Library (aka glibc) before 2.31 fails to ignore the LD_PREFER_MAP_32BIT_EXEC environment variable during program execution after a security transition, allowing local attackers to restrict the possible mapping addresses for loaded libraries and thus bypass ASLR for a setuid program.",
		Link:         "https://security-tracker.debian.org/tracker/CVE-2019-19126",
		SetFixedBy:   &storage.EmbeddedVulnerability_FixedBy{FixedBy: ""},
		ScoreVersion: storage.EmbeddedVulnerability_V3,
		CvssV2: &storage.CVSSV2{
		...
		PublishedOn:       &types.Timestamp{Seconds: 1574201700},
		LastModified:      &types.Timestamp{Seconds: 1651004160},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
		Severity:          storage.VulnerabilitySeverity_LOW_VULNERABILITY_SEVERITY,
	}
}
...
func GetEmbeddedImageCVE_2019_25013() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2019-25013",
		Cvss:         5.9,
		...
		Link:         "https://security-tracker.debian.org/tracker/CVE-2019-25013",
		SetFixedBy:   &storage.EmbeddedVulnerability_FixedBy{FixedBy: ""},
		ScoreVersion: storage.EmbeddedVulnerability_V3,
		CvssV2: &storage.CVSSV2{
		...
		PublishedOn:       &types.Timestamp{Seconds: 1609784100},
		LastModified:      &types.Timestamp{Seconds: 1650413700},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
		Severity:          storage.VulnerabilitySeverity_MODERATE_VULNERABILITY_SEVERITY,
	}
...
func GetEmbeddedImageCVE_2019_1010022() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2019-1010022",
		Cvss:         9.8,
		Summary:      "** DISPUTED ** GNU Libc current is affected by: Mitigation bypass. The impact is: Attacker may bypass stack guard protection. The component is: nptl. The attack vector is: Exploit stack buffer overflow vulnerability and use this bypass vulnerability to bypass stack guard. NOTE: Upstream comments indicate \"this is being treated as a non-security bug and no real threat.\"",
		...
		PublishedOn:       &types.Timestamp{Seconds: 1563164100},
		LastModified:      &types.Timestamp{Seconds: 1623345300},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
		Severity:          storage.VulnerabilitySeverity_LOW_VULNERABILITY_SEVERITY,
	}
}

func GetEmbeddedImageCVE_2019_1010023() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		...
		PublishedOn:       &types.Timestamp{Seconds: 1563164100},
		LastModified:      &types.Timestamp{Seconds: 1605557700},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
		Severity:          storage.VulnerabilitySeverity_LOW_VULNERABILITY_SEVERITY,
	}
}

func GetEmbeddedImageCVE_2019_1010024() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2019-1010024",
		Cvss:         5.3,
		Summary:      "** DISPUTED ** GNU Libc current is affected by: Mitigation bypass. The impact is: Attacker may bypass ASLR using cache of thread stack and heap. The component is: glibc. NOTE: Upstream comments indicate \"this is being treated as a non-security bug and no real threat.\"",
...
func GetEmbeddedImageCVE_2019_1010025() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2019-1010025",
		Cvss:         5.3,
		Summary:      "** DISPUTED ** GNU Libc current is affected by: Mitigation bypass. The impact is: Attacker may guess the heap addresses of pthread_created thread. The component is: glibc. NOTE: the vendor's position is \"ASLR bypass itself is not a vulnerability.\"",
...
func GetEmbeddedImageCVE_2020_1751() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2020-1751",
		Cvss:         7.0,
		...
		PublishedOn:       &types.Timestamp{Seconds: 1587150900},
		LastModified:      &types.Timestamp{Seconds: 1594325700},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
		Severity:          storage.VulnerabilitySeverity_IMPORTANT_VULNERABILITY_SEVERITY,
	}
}
...
func GetEmbeddedImageCVE_2021_33574() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2021-33574",
		Cvss:         9.8,
		Summary:      "The mq_notify function in the GNU C Library (aka glibc) versions 2.32 and 2.33 has a use-after-free. It may use the notification thread attributes object (passed through its struct sigevent parameter) after it has been freed by the caller, leading to a denial of service (application crash) or possibly unspecified other impact.",
		Link:         "https://security-tracker.debian.org/tracker/CVE-2021-33574",
		SetFixedBy:   &storage.EmbeddedVulnerability_FixedBy{FixedBy: ""},
		ScoreVersion: storage.EmbeddedVulnerability_V3,
		CvssV2: &storage.CVSSV2{
			Vector:              "AV:N/AC:L/Au:N/C:P/I:P/A:P",
		...
		PublishedOn:       &types.Timestamp{Seconds: 1621980900},
		LastModified:      &types.Timestamp{Seconds: 1643403480},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
		Severity:          storage.VulnerabilitySeverity_CRITICAL_VULNERABILITY_SEVERITY,
	}
}

func GetEmbeddedImageCVE_2021_35942() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2021-35942",
		Cvss:         9.1,
		Summary:      "The wordexp function in the GNU C Library (aka glibc) through 2.33 may crash or read arbitrary memory in parse_param (in posix/wordexp.c) when called with an untrusted, crafted pattern, potentially resulting in a denial of service or disclosure of information. This occurs because atoi was used but strtoul should have been used to ensure correct calculations.",
		Link:         "https://security-tracker.debian.org/tracker/CVE-2021-35942",
		SetFixedBy:   &storage.EmbeddedVulnerability_FixedBy{FixedBy: ""},
		ScoreVersion: storage.EmbeddedVulnerability_V3,
		CvssV2: &storage.CVSSV2{
		...
		PublishedOn:       &types.Timestamp{Seconds: 1626977700},
		LastModified:      &types.Timestamp{Seconds: 1632248160},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
		Severity:          storage.VulnerabilitySeverity_CRITICAL_VULNERABILITY_SEVERITY,
	}
}
...
func GetEmbeddedImageCVE_2022_23218() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2022-23218",
		Cvss:         9.8,
		Summary:      "The deprecated compatibility function svcunix_create in the sunrpc module of the GNU C Library (aka glibc) through 2.34 copies its path argument on the stack without validating its length, which may result in a buffer overflow, potentially resulting in a denial of service or (if an application is not built with a stack protector enabled) arbitrary code execution.",
		Link:         "https://security-tracker.debian.org/tracker/CVE-2022-23218",
		SetFixedBy:   &storage.EmbeddedVulnerability_FixedBy{FixedBy: ""},
		ScoreVersion: storage.EmbeddedVulnerability_V3,
		CvssV2: &storage.CVSSV2{
			Vector:              "AV:N/AC:L/Au:N/C:P/I:P/A:P",
		...
		PublishedOn:       &types.Timestamp{Seconds: 1642144500},
		LastModified:      &types.Timestamp{Seconds: 1642736760},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
		Severity:          storage.VulnerabilitySeverity_CRITICAL_VULNERABILITY_SEVERITY,
	}
}

func GetEmbeddedImageCVE_2022_23219() *storage.EmbeddedVulnerability {
	return &storage.EmbeddedVulnerability{
		Cve:          "CVE-2022-23219",
		Cvss:         9.8,
		Summary:      "The deprecated compatibility function clnt_create in the sunrpc module of the GNU C Library (aka glibc) through 2.34 copies its hostname argument on the stack without validating its length, which may result in a buffer overflow, potentially resulting in a denial of service or (if an application is not built with a stack protector enabled) arbitrary code execution.",
		Link:         "https://security-tracker.debian.org/tracker/CVE-2022-23219",
		SetFixedBy:   &storage.EmbeddedVulnerability_FixedBy{FixedBy: ""},
		ScoreVersion: storage.EmbeddedVulnerability_V3,
		CvssV2: &storage.CVSSV2{
			Vector:              "AV:N/AC:L/Au:N/C:P/I:P/A:P",
		...
		PublishedOn:       &types.Timestamp{Seconds: 1642144500},
		LastModified:      &types.Timestamp{Seconds: 1642783680},
		VulnerabilityType: storage.EmbeddedVulnerability_IMAGE_VULNERABILITY,
		Severity:          storage.VulnerabilitySeverity_CRITICAL_VULNERABILITY_SEVERITY,
	}
}
