...
func _() {
	...
	_ = x[ComplianceOperatorSuite-29]
}

const _Resource_name = ""

var _Resource_index = [...]uint16{0, 5, 15, 31, 53, 58, 64, 73, 86, 90, 103, 119, 135, 151, 165, 178, 182, 193, 212, 215, 244, 269, 305, 327, 349, 371, 402, 426, 453, 477, 500}
