...
func TestSubject(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			ou:       "CENTRAL_SERVICE",
			name: pkix.Name{
				OrganizationalUnit: []string{"CENTRAL_SERVICE"},
			},
		},
		{
			...
			ou:       "SENSOR_SERVICE",
			name: pkix.Name{
				OrganizationalUnit: []string{"SENSOR_SERVICE"},
			},
		},
		{
			...
			name: pkix.Name{
				OrganizationalUnit: []string{"COLLECTOR_SERVICE"},
			},
		},
		{
			...
			name: pkix.Name{
				OrganizationalUnit: []string{"SCANNER_DB_SERVICE"},
			},
		},
		{
			...
			name: pkix.Name{
				OrganizationalUnit: []string{"ADMISSION_CONTROL_SERVICE"},
			},
		},
		{
			...
			name: pkix.Name{
				OrganizationalUnit: []string{"CENTRAL_DB_SERVICE"},
			},
		},
	}
