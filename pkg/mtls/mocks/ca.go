...
// Source: github.com/stackrox/rox/pkg/mtls (interfaces: CA)
...
func (m *MockCA) ValidateAndExtractSubject(arg0 *x509.Certificate) (mtls.Subject, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateAndExtractSubject", arg0)
...
func (mr *MockCAMockRecorder) ValidateAndExtractSubject(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidateAndExtractSubject", reflect.TypeOf((*MockCA)(nil).ValidateAndExtractSubject), arg0)
}
