...
func (mr *MockCAMockRecorder) IssueCertForSubject(subj interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockCAMockRecorder) ValidateAndExtractSubject(cert interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
