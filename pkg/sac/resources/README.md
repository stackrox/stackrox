...
the access to services and data.

## Creating a new resource

In general, we strive to avoid adding new resources, especially user-facing ones.
Sometimes it is necessary, but most of the times an existing resource is a better fit.
We avoid adding more resources, especially global ones, and strive to re-use existing
authorization patterns and reuse existing resource, e.g., by editing
...
1. Review the existing to find a fit for the object type being added.
