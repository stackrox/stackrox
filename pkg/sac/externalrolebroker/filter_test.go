...
func TestFilterUserPermissionsForSupportedK8sResources(t *testing.T) {
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			result := FilterUserPermissionsForSupportedK8sResources(tc.permissions)
			assert.Len(t, result, tc.expected, "Expected %d permissions to be filtered, got %d", tc.expected, len(result))
		})
	}
}

func TestHasSupportedK8sResources(t *testing.T) {
	tests := map[string]struct {
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			result := hasSupportedK8sResources(tc.permission)
			assert.Equal(t, tc.expected, result)
		})
	}
}

func TestRuleHasSupportedK8sResource(t *testing.T) {
	tests := map[string]struct {
	...
	for name, tc := range tests {
		t.Run(name, func(t *testing.T) {
			result := ruleHasSupportedK8sResource(tc.rule)
			assert.Equal(t, tc.expected, result)
		})
	}
}
