...
// NewACMClientForConfig creates a new client for the ACM clusterview API using the provided config.
func NewACMClientForConfig(config *rest.Config) (*ACMClient, error) {
...
func (c *ACMClient) ListUserPermissions(
	ctx context.Context,
