...
func TestSearchHelper_TestApply_WithFilter(t *testing.T) {
	...
	mockSearchFunc := func(ctx context.Context, q *v1.Query, opts ...blevesearch.SearchOption) ([]search.Result, error) {
		return []search.Result{
...
func TestSearchHelper_TestApply_WithAllAccess(t *testing.T) {
	...
	mockSearchFunc := func(ctx context.Context, q *v1.Query, options ...blevesearch.SearchOption) ([]search.Result, error) {
		return []search.Result{
			fakeResult("1", "cluster1", "nsA"),
			fakeResult("2", "cluster1", "nsB"),
			fakeResult("3", "cluster2", "nsA"),
