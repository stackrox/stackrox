...
type Detector interface {
	...
	Detect(ctx DetectionContext, deployment *storage.Deployment, images []*storage.Image, netpol *augmentedobjs.NetworkPolicyAssociation, policyFilters ...detection.FilterOption) ([]*storage.Alert, error)
}
