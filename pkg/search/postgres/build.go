...
func build(q *v1.Query, baseSchema *walker.Schema, optionsMap search.OptionsMap) (*searchRequestSpec, error) {
	// Otherwise, we need to walk the tree and separate which query parts refer to which spec.
	return buildMultiSpec(q, optionsMap)
}

func buildDefaultSpec(query *v1.Query, baseSchema *walker.Schema) (*searchRequestSpec, error) {
	if query == nil {
...
func buildMultiSpec(q *v1.Query, optionsMap search.OptionsMap) (*searchRequestSpec, error) {
...
func (tb treeBuilder) walkSpecsRec(q *v1.Query, baseSchema *walker.Schema) (*searchRequestSpec, error) {
