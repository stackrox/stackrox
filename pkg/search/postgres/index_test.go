...
func (s *IndexSuite) getStruct(i int, f func(s *storage.TestOneKeyStruct)) *storage.TestOneKeyStruct {
	out := &storage.TestOneKeyStruct{
...
func getID(s *storage.TestOneKeyStruct) string {
...
type testCase struct {
	desc            string
	q               *v1.Query
	expectedResults []*storage.TestOneKeyStruct
	expectErr       bool
}
...
func (s *IndexSuite) TestString() {
	testStruct0 := s.getStruct(0, func(s *storage.TestOneKeyStruct) {
		s.String_ = "first"
		s.Nested = append(s.Nested, &storage.TestOneKeyStruct_Nested{
			Nested: "nested_first",
			Nested2: &storage.TestOneKeyStruct_Nested_Nested2{
				Nested2: "nested2_first",
			},
		})
	})
	testStruct1 := s.getStruct(1, func(s *storage.TestOneKeyStruct) {
		s.String_ = "second"
		s.Nested = append(s.Nested, &storage.TestOneKeyStruct_Nested{
	...
	testStruct2 := s.getStruct(2, func(s *storage.TestOneKeyStruct) {
		s.String_ = "fir"
		s.Nested = append(s.Nested, &storage.TestOneKeyStruct_Nested{
			Nested: "nested_fir",
			Nested2: &storage.TestOneKeyStruct_Nested_Nested2{
	...
	s.runTestCases([]testCase{
		{
			...
			expectedResults: []*storage.TestOneKeyStruct{testStruct2},
		},
		{
		...
		},
		{
			...
			expectedResults: []*storage.TestOneKeyStruct{testStruct0, testStruct2},
		},
		{
			desc:            "regex",
		...
		},
		{
			desc:            "negated prefix",
			q:               search.NewQueryBuilder().AddStrings(search.TestString, "!fir").ProtoQuery(),
			expectedResults: []*storage.TestOneKeyStruct{testStruct1},
		},
		{
			desc:            "negated regex",
	...
	s.runTestCases([]testCase{
		{
			...
			expectedResults: []*storage.TestOneKeyStruct{testStruct0},
		},
		{
			desc:            "true",
...
func (s *IndexSuite) TestStringSlice() {
	...
	s.runTestCases([]testCase{
		...
		},
		{
			...
			expectedResults: []*storage.TestOneKeyStruct{testStruct0, testStruct1},
		},
		{
...
func (s *IndexSuite) TestMap() {
	...
	s.runTestCases([]testCase{
		...
		},
		{
			...
			q:               search.NewQueryBuilder().AddMapQuery(search.TestLabels, "!foo", "").ProtoQuery(),
			expectedResults: []*storage.TestOneKeyStruct{testStruct1, testStruct2},
		},
		{
...
func (s *IndexSuite) TestOneofNested() {
	testStruct0 := s.getStruct(0, func(s *storage.TestOneKeyStruct) {
		s.Oneof = &storage.TestOneKeyStruct_Oneofnested{Oneofnested: &storage.TestOneKeyStruct_OneOfNested{Nested: "one"}}
		s.String_ = "matching"
	})
	testStruct1 := s.getStruct(1, func(s *storage.TestOneKeyStruct) {
		s.Oneof = &storage.TestOneKeyStruct_Oneofnested{Oneofnested: &storage.TestOneKeyStruct_OneOfNested{Nested: "53941897-5c22-40ed-8e45-739683449e46"}}
	})
	testStruct2 := s.getStruct(2, func(s *storage.TestOneKeyStruct) {
		s.Oneof = &storage.TestOneKeyStruct_Oneofnested{Oneofnested: &storage.TestOneKeyStruct_OneOfNested{Nested: "d2040f62-c781-40c0-a17d-455820bc05f8"}}
	})
	testStruct3 := s.getStruct(3, func(s *storage.TestOneKeyStruct) {
		s.Oneof = &storage.TestOneKeyStruct_Oneofnested{Oneofnested: &storage.TestOneKeyStruct_OneOfNested{Nested: "one"}}
		s.String_ = "nonsense"
	})
	...
	s.runTestCases([]testCase{
		{
			...
			expectedResults: []*storage.TestOneKeyStruct{testStruct0, testStruct3},
		},
		{
			desc: "conjunction",
			q: search.NewQueryBuilder().
...
func (s *IndexSuite) TestTime() {
	testStruct2029Mar09Noon := s.getStruct(0, func(s *storage.TestOneKeyStruct) {
		s.Timestamp = ts2029Mar09Noon
	})
	testStruct2022Mar09Noon := s.getStruct(1, func(s *storage.TestOneKeyStruct) {
		s.Timestamp = ts2022Mar09Noon
	})
	testStruct2022Feb09Noon := s.getStruct(2, func(s *storage.TestOneKeyStruct) {
		s.Timestamp = ts2022Feb09Noon
	})
	testStruct2021Mar09Noon := s.getStruct(3, func(s *storage.TestOneKeyStruct) {
		s.Timestamp = ts2021Mar09Noon
	})
	testStruct2020Mar09Noon := s.getStruct(4, func(s *storage.TestOneKeyStruct) {
	...
	s.runTestCases([]testCase{
		{
			...
			expectedResults: []*storage.TestOneKeyStruct{testStruct2022Mar09Noon},
		},
		{
		...
		},
		{
			...
			expectedResults: []*storage.TestOneKeyStruct{testStruct2021Mar09Noon, testStruct2020Mar09Noon, testStruct2022Feb09Noon},
		},
		{
			...
			expectedResults: []*storage.TestOneKeyStruct{testStruct2021Mar09Noon, testStruct2020Mar09Noon, testStruct2022Feb09Noon, testStruct2022Mar09Noon},
		},
		{
		...
		},
		{
			...
			expectedResults: []*storage.TestOneKeyStruct{testStruct2029Mar09Noon},
		},
	})
}
...
func (s *IndexSuite) TestEnum() {
	testStruct0 := s.getStruct(0, func(s *storage.TestOneKeyStruct) {
		s.Enum = storage.TestOneKeyStruct_ENUM0
	})
	testStruct1 := s.getStruct(1, func(s *storage.TestOneKeyStruct) {
		s.Enum = storage.TestOneKeyStruct_ENUM1
	})
	testStruct2 := s.getStruct(2, func(s *storage.TestOneKeyStruct) {
		s.Enum = storage.TestOneKeyStruct_ENUM2
	})
...
func (s *IndexSuite) TestEnumArray() {
	testStruct0 := s.getStruct(0, func(s *storage.TestOneKeyStruct) {
		s.Enums = []storage.TestOneKeyStruct_Enum{storage.TestOneKeyStruct_ENUM0}
	})
	testStruct1 := s.getStruct(1, func(s *storage.TestOneKeyStruct) {
		s.Enums = []storage.TestOneKeyStruct_Enum{storage.TestOneKeyStruct_ENUM1}
	})
	testStruct01 := s.getStruct(2, func(s *storage.TestOneKeyStruct) {
		s.Enums = []storage.TestOneKeyStruct_Enum{storage.TestOneKeyStruct_ENUM0, storage.TestOneKeyStruct_ENUM1}
	})
	testStruct012 := s.getStruct(3, func(s *storage.TestOneKeyStruct) {
		s.Enums = []storage.TestOneKeyStruct_Enum{storage.TestOneKeyStruct_ENUM0, storage.TestOneKeyStruct_ENUM1, storage.TestOneKeyStruct_ENUM2}
	})
	testStruct12 := s.getStruct(4, func(s *storage.TestOneKeyStruct) {
		s.Enums = []storage.TestOneKeyStruct_Enum{storage.TestOneKeyStruct_ENUM1, storage.TestOneKeyStruct_ENUM2}
	})
	...
	s.runTestCases([]testCase{
		{
			...
			expectedResults: []*storage.TestOneKeyStruct{testStruct1, testStruct01, testStruct012, testStruct12},
		},
		{
			desc:            "negation",
			q:               search.NewQueryBuilder().AddStrings(search.TestEnumSlice, "!ENUM1").ProtoQuery(),
			expectedResults: []*storage.TestOneKeyStruct{testStruct0, testStruct01, testStruct012, testStruct12},
		},
		{
			desc:            "regex",
		...
		},
		{
			desc:            ">",
			q:               search.NewQueryBuilder().AddStrings(search.TestEnumSlice, ">ENUM1").ProtoQuery(),
			expectedResults: []*storage.TestOneKeyStruct{testStruct012, testStruct12},
		},
		{
			desc:            "<=",
			q:               search.NewQueryBuilder().AddStrings(search.TestEnumSlice, "<=ENUM1").ProtoQuery(),
			expectedResults: []*storage.TestOneKeyStruct{testStruct0, testStruct1, testStruct12, testStruct012, testStruct01},
		},
	})
}
...
type highlightTestCase struct {
	desc            string
	q               *v1.Query
	expectedResults map[*storage.TestOneKeyStruct]map[string][]string
	expectErr       bool
}
	...
	s.runHighlightTestCases([]highlightTestCase{
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct0: {
					"TestOneKeyStruct.string_slice": {"yeah"},
				},
			},
		},
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				...
				testStruct1: {
					"TestOneKeyStruct.string_slice": {"whatever", "yeahyeah"},
				},
			},
		},
	})
	...
	s.runHighlightTestCases([]highlightTestCase{
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct2022Mar09Noon: {"TestOneKeyStruct.timestamp.seconds": {"2022-03-09 12:00:00"}},
			},
		},
		{
			desc:            "exact match (should evaluate if it's within the day) - no match",
		...
		},
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct2021Mar09Noon: {"TestOneKeyStruct.timestamp.seconds": {"2021-03-09 12:00:00"}},
				testStruct2020Mar09Noon: {"TestOneKeyStruct.timestamp.seconds": {"2020-03-09 12:00:00"}},
				testStruct2022Feb09Noon: {"TestOneKeyStruct.timestamp.seconds": {"2022-02-09 12:00:00"}},
			},
		},
		{
			desc: "< date time (this time, includes Mar 10th at noon)",
	...
	s.runHighlightTestCases([]highlightTestCase{
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct1: {"TestOneKeyStruct.enum": {"ENUM1"}},
			},
		},
		{
			desc: "negation",
			q:    search.NewQueryBuilder().AddStringsHighlighted(search.TestEnum, "!ENUM1").ProtoQuery(),
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct0: {"TestOneKeyStruct.enum": {"ENUM0"}},
				testStruct2: {"TestOneKeyStruct.enum": {"ENUM2"}},
			},
		},
		{
			desc: "regex",
	...
	s.runHighlightTestCases([]highlightTestCase{
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct0: {"TestOneKeyStruct.uint64": {"2"}},
			},
		},
		{
			desc: ">",
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct1: {"TestOneKeyStruct.uint64": {"7"}},
			},
		},
		{
			desc: ">=",
	...
	s.runHighlightTestCases([]highlightTestCase{
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct0: {"TestOneKeyStruct.int64": {"-2"}},
			},
		},
		{
			desc: ">",
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct1: {"TestOneKeyStruct.int64": {"7"}},
			},
		},
		{
			desc: ">=",
		...
		},
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct0: {"TestOneKeyStruct.nested.int64": {"-100"}},
			},
		},
		{
			desc: "nested and nested2",
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct1: {"TestOneKeyStruct.nested.nested2.int64": {"-200"}, "TestOneKeyStruct.nested.int64": {"100"}},
			},
		},
	})
}
	...
	s.runHighlightTestCases([]highlightTestCase{
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct0: {"TestOneKeyStruct.float": {"-2"}},
			},
		},
		{
			desc: ">",
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct1: {"TestOneKeyStruct.float": {"7.5"}},
			},
		},
		{
			desc: ">=",
	...
	s.runHighlightTestCases([]highlightTestCase{
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct0: {"TestOneKeyStruct.int32_slice": {"-2"}},
			},
		},
		{
			desc: ">",
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct1: {"TestOneKeyStruct.int32_slice": {"7"}},
			},
		},
		{
			desc: ">=",
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct0: {"TestOneKeyStruct.int32_slice": {"-2"}},
				testStruct1: {"TestOneKeyStruct.int32_slice": {"7", "3"}},
			},
		},
	})
}
	...
	s.runHighlightTestCases([]highlightTestCase{
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct1:   {"TestOneKeyStruct.enums": {"ENUM1"}},
				testStruct01:  {"TestOneKeyStruct.enums": {"ENUM1"}},
				testStruct012: {"TestOneKeyStruct.enums": {"ENUM1"}},
				testStruct12:  {"TestOneKeyStruct.enums": {"ENUM1"}},
			},
		},
		{
			desc: "negation",
			q:    search.NewQueryBuilder().AddStringsHighlighted(search.TestEnumSlice, "!ENUM1").ProtoQuery(),
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct0:   {"TestOneKeyStruct.enums": {"ENUM0"}},
				testStruct01:  {"TestOneKeyStruct.enums": {"ENUM0"}},
				testStruct012: {"TestOneKeyStruct.enums": {"ENUM0", "ENUM2"}},
				testStruct12:  {"TestOneKeyStruct.enums": {"ENUM2"}},
			},
		},
		{
			desc: "regex",
		...
		},
		{
			...
			q:    search.NewQueryBuilder().AddStringsHighlighted(search.TestEnumSlice, ">ENUM1").ProtoQuery(),
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct012: {"TestOneKeyStruct.enums": {"ENUM2"}},
				testStruct12:  {"TestOneKeyStruct.enums": {"ENUM2"}},
			},
		},
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				...
				testStruct1:   {"TestOneKeyStruct.enums": {"ENUM1"}},
				testStruct12:  {"TestOneKeyStruct.enums": {"ENUM1"}},
				testStruct012: {"TestOneKeyStruct.enums": {"ENUM0", "ENUM1"}},
				testStruct01:  {"TestOneKeyStruct.enums": {"ENUM0", "ENUM1"}},
			},
		},
	})
}
	...
	s.runHighlightTestCases([]highlightTestCase{
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct0: {"TestOneKeyStruct.labels": {"new=old"}},
			},
		},
		{
			desc: "key does not exist",
		...
		},
		{
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct0: {"TestOneKeyStruct.labels": {"foo=bar", "new=old"}},
				testStruct1: {"TestOneKeyStruct.labels": {"foo=car", "one=two", "three=four"}},
			},
		},
		{
			desc: "value only",
			...
			expectedResults: map[*storage.TestOneKeyStruct]map[string][]string{
				testStruct0: {"TestOneKeyStruct.labels": {"foo=bar"}},
			},
		},
		{
			desc: "negated value only",
...
func (s *IndexSuite) TestPagination() {
	var testStructs []*storage.TestOneKeyStruct
	for i := 0; i < 8; i++ {
		testStructs = append(testStructs, s.getStruct(i, func(s *storage.TestOneKeyStruct) {
