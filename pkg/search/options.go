...
var (
	...
	KnownRansomwareCampaign = newFieldLabel("Known Ransomware Campaign")
	...
	DeploymentDeleted            = newFieldLabel("Deployment Deleted")
	...
	DeploymentState              = newFieldLabel("Deployment State")
