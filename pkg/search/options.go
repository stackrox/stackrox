...
var (
	...
	EPSSPercentile      = newFieldLabel("EPSS Percentile")
	...
	RepositoryCPE       = newFieldLabel("Repository CPE")
	CVEComponentName    = newFieldLabel("CVE Component Name")
	CVEComponentVersion = newFieldLabel("CVE Component Version")
	...
	EPSSPercentileMax                = newDerivedFieldLabel("EPSS Percentile Max", EPSSPercentile, MaxDerivationType)
