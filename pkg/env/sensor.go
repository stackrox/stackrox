...
var (
	...
	ContinuousProfilerEnabled = RegisterBooleanSetting("CONTINUOUS_PROFILER", false)
	ContinuousProfilerAddress = RegisterSetting("CONTINUOUS_PROFILER", WithDefault("http://localhost:4040"))
	PprofServerEnabled        = RegisterBooleanSetting("PPROF_SERVER_ENABLED", true)
	PprofAddress              = RegisterSetting("PPROF_ADDRESS", WithDefault(":6060"))
)
