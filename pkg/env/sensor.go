...
var (
	...
	ClusterID = NewSetting("ROX_PREVENT_CLUSTER_ID")
	...
	AdvertisedEndpoint = NewSetting("ROX_PREVENT_ADVERTISED_ENDPOINT", WithDefault("sensor.prevent_net:443"))
	// Image is the image that should be launched for new benchmarks.
	Image = NewSetting("ROX_PREVENT_IMAGE", WithDefault("stackrox/prevent:latest"))
)
