...
var (
	...
	APITokenExpirationStaleNotificationAge = registerDurationSetting("ROX_TOKEN_EXPIRATION_NOTIFIER_BACKOFF_INTERVAL" /* default: 1 day  */, 24*time.Hour)
	...
	APITokenExpirationExpirationWindow = registerDurationSetting("ROX_TOKEN_EXPIRATION_DETECTION_WINDOW" /* default: 1 week */, 7*24*time.Hour)
	// APITokenExpirationExpirationSlice is the duration of the slice used to generate the expiration log
	APITokenExpirationExpirationSlice = registerDurationSetting("ROX_TOKEN_EXPIRATION_LOG_SLICE_DURATION" /* default: 1 day */, 24*time.Hour)
