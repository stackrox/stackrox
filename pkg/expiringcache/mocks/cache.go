...
func (m *MockCache) Add(key, value interface{}) {
	m.ctrl.T.Helper()
...
func (m *MockCache) GetAll() []interface{} {
	m.ctrl.T.Helper()
...
func (m *MockCache) GetOrSet(key, value interface{}) interface{} {
	m.ctrl.T.Helper()
...
func (mr *MockCacheMockRecorder) GetOrSet(key, value interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
