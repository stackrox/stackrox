...
func TestGeneratedCertificateAttributes(t *testing.T) {
	...
	expectedSubject := pkix.Name{Country: []string{"US"}, Organization: []string{"StackRox"}, OrganizationalUnit: []string{"StackRox"}, Locality: []string{"Mountain View"}, Province: []string(nil), StreetAddress: []string(nil), PostalCode: []string(nil), SerialNumber: "", CommonName: "SSO SP Cert", Names: []pkix.AttributeTypeAndValue{{Type: asn1.ObjectIdentifier{2, 5, 4, 6}, Value: "US"}, {Type: asn1.ObjectIdentifier{2, 5, 4, 7}, Value: "Mountain View"}, {Type: asn1.ObjectIdentifier{2, 5, 4, 10}, Value: "StackRox"}, {Type: asn1.ObjectIdentifier{2, 5, 4, 11}, Value: "StackRox"}, {Type: asn1.ObjectIdentifier{2, 5, 4, 3}, Value: "SSO SP Cert"}}, ExtraNames: []pkix.AttributeTypeAndValue(nil)}
