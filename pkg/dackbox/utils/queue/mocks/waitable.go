...
func (mr *MockAcceptsKeyValueMockRecorder) Push(key, value interface{}) *gomock.Call {
...
// Push indicates an expected call of Push.
func (mr *MockWaitableQueueMockRecorder) Push(key, value interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWaitableQueueMockRecorder) PushSignal(signal interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
