...
// Source: pkg/scannerv4/client/client.go
//
// Generated by this command:
//
//	mockgen -package mocks -destination pkg/scannerv4/client/mocks/client.go -source pkg/scannerv4/client/client.go
//
...
func (m *MockScanner) GetOrCreateImageIndex(ctx context.Context, ref name.Digest, auth client.RegistryAuth, opt client.ImageRegistryOpt, callOpts ...client.CallOption) (*v4.IndexReport, error) {
	m.ctrl.T.Helper()
...
func (m *MockScanner) IndexAndScanImage(arg0 context.Context, arg1 name.Digest, arg2 client.RegistryAuth, arg3 client.ImageRegistryOpt, arg4 ...client.CallOption) (*v4.VulnerabilityReport, error) {
	m.ctrl.T.Helper()
