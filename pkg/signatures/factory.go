...
// FetchImageSignaturesFromImage will try and fetch signatures for the given image from the given registry and return them.
// It will retry on transient errors at most 2 times and return the fetched signatures.
func FetchImageSignaturesFromImage(ctx context.Context, fetcher SignatureFetcher, image *storage.Image,
