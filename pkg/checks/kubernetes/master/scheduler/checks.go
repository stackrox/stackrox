...
const process = "kube-scheduler"

var configFunc = utils.GetKubeSchedulerConfig
...
// NewProfiling implements CIS Kubernetes v1.2.0 1.2.1
func NewProfiling() utils.Check {
	return newKubernetesSchedulerCheck(&utils.CommandCheck{
		Name:        "CIS Kubernetes v1.2.0 - 1.2.1",
