...
func init() {
	...
	RegisterTableStmt("compliance_operator_remediation_v2", CreateTableComplianceOperatorRemediationV2Stmt, ComplianceOperatorRemediationV2Schema, features.ComplianceEnhancements.Enabled)
}
