...
var (
	...
	NodeComponentEdgesSchema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("node_component_edges", CreateTableNodeComponentEdgesStmt, NodeComponentEdgesSchema)
}
