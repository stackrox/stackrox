...
type ServiceAccounts struct {
	...
	Namespace   string            `gorm:"column:namespace;type:varchar;index:serviceaccounts_sac_filter,type:btree,option:CONCURRENTLY"`
	ClusterName string            `gorm:"column:clustername;type:varchar"`
	ClusterID   string            `gorm:"column:clusterid;type:uuid;index:serviceaccounts_sac_filter,type:btree,option:CONCURRENTLY"`
