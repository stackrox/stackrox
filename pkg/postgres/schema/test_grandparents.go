...
var (
	...
	TestGrandparentsSchema = func() *walker.Schema {
		...
		schema.SetOptionsMap(search.OptionsMapFromMap(v1.SearchCategory(109), map[search.FieldLabel]*search.Field{
			"Test Grandparent Embedded":   {FieldPath: "testgrandparent.embedded.val", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory(109)},
			"Test Grandparent Embedded2":  {FieldPath: "testgrandparent.embedded.embedded2.val", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory(109)},
			"Test Grandparent ID":         {FieldPath: "testgrandparent.id", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory(109)},
			"Test Grandparent Priority":   {FieldPath: "testgrandparent.priority", Type: v1.SearchDataType_SEARCH_NUMERIC, Category: v1.SearchCategory(109)},
			"Test Grandparent Risk Score": {FieldPath: "testgrandparent.risk_score", Type: v1.SearchDataType_SEARCH_NUMERIC, Category: v1.SearchCategory(109)},
			"Test Grandparent Val":        {FieldPath: "testgrandparent.val", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory(109)},
		}))
