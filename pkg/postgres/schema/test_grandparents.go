...
type TestGrandparentsEmbeddeds struct {
	...
	Idx                 int              `gorm:"column:idx;type:integer;primaryKey;index:testgrandparentsembeddeds_idx,type:btree,option:CONCURRENTLY"`
	Val                 string           `gorm:"column:val;type:varchar"`
...
type TestGrandparentsEmbeddedsEmbedded2 struct {
	...
	Idx                          int                       `gorm:"column:idx;type:integer;primaryKey;index:testgrandparentsembeddedsembedded2_idx,type:btree,option:CONCURRENTLY"`
	Val                          string                    `gorm:"column:val;type:varchar"`
