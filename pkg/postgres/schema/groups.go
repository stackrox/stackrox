...
var (
	...
	CreateTableGroupsStmt = &postgres.CreateStmts{
		...
		Indexes: []*postgres.IndexDefinition{
			{Name: "groups_unique_indicator", CreateSQL: "CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS groups_unique_indicator ON groups USING btree (props_authproviderid, props_key, props_value, rolename)"},
		},
	}
