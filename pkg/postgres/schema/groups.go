...
type Groups struct {
	...
	PropsAuthProviderID string `gorm:"column:props_authproviderid;type:varchar;uniqueIndex:groups_unique_indicator,option:CONCURRENTLY"`
	PropsKey            string `gorm:"column:props_key;type:varchar;uniqueIndex:groups_unique_indicator,option:CONCURRENTLY"`
	PropsValue          string `gorm:"column:props_value;type:varchar;uniqueIndex:groups_unique_indicator,option:CONCURRENTLY"`
	RoleName            string `gorm:"column:rolename;type:varchar;uniqueIndex:groups_unique_indicator,option:CONCURRENTLY"`
