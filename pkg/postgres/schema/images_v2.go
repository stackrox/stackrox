...
type ImagesV2 struct {
	...
	UnknownCves          int32             `gorm:"column:unknowncves;type:integer"`
	FixableUnknownCves   int32             `gorm:"column:fixableunknowncves;type:integer"`
	CriticalCves         int32             `gorm:"column:criticalcves;type:integer"`
	FixableCriticalCves  int32             `gorm:"column:fixablecriticalcves;type:integer"`
	ImportantCves        int32             `gorm:"column:importantcves;type:integer"`
	FixableImportantCves int32             `gorm:"column:fixableimportantcves;type:integer"`
	ModerateCves         int32             `gorm:"column:moderatecves;type:integer"`
	FixableModerateCves  int32             `gorm:"column:fixablemoderatecves;type:integer"`
	LowCves              int32             `gorm:"column:lowcves;type:integer"`
	FixableLowCves       int32             `gorm:"column:fixablelowcves;type:integer"`
