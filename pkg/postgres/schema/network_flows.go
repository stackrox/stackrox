...
type NetworkFlows struct {
	...
	PropsSrcEntityType storage.NetworkEntityInfo_Type `gorm:"column:props_srcentity_type;type:integer;primaryKey"`
	PropsSrcEntityID   string                         `gorm:"column:props_srcentity_id;type:varchar;index:network_flows_src,type:hash;primaryKey"`
	PropsDstEntityType storage.NetworkEntityInfo_Type `gorm:"column:props_dstentity_type;type:integer;primaryKey"`
	...
	ClusterID          string                         `gorm:"column:clusterid;type:uuid;index:network_flows_cluster,type:hash;primaryKey"`
}
