...
type NetworkFlows struct {
	...
	PropsSrcEntityType storage.NetworkEntityInfo_Type `gorm:"column:props_srcentity_type;type:integer;index:network_flows_src,type:hash"`
	PropsSrcEntityID   string                         `gorm:"column:props_srcentity_id;type:varchar;index:network_flows_src,type:hash"`
	PropsDstEntityType storage.NetworkEntityInfo_Type `gorm:"column:props_dstentity_type;type:integer;index:network_flows_dst,type:hash"`
	...
	ClusterID          string                         `gorm:"column:clusterid;type:uuid;index:network_flows_cluster,type:hash;index:network_flows_src,type:hash;index:network_flows_dst,type:hash"`
}
