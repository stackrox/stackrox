...
type NetworkFlows struct {
	...
	ClusterID          string                         `gorm:"column:clusterid;type:uuid;index:network_flows_cluster,type:hash;index:network_flows_src,type:btree;index:network_flows_dst,type:btree;primaryKey"`
}
