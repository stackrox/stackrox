...
var (
	...
	SimpleAccessScopesSchema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("simple_access_scopes", CreateTableSimpleAccessScopesStmt, SimpleAccessScopesSchema)
}
