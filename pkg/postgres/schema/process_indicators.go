...
// XXX: Contains manuall changes (extensions for ProcessIndicator schema
...
// XXX: unique_indicator index is specified manually, as it has to cover
// multiple columns, which is not supported by the store generator.
//
