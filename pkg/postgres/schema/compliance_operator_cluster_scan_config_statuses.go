...
var (
	...
	ComplianceOperatorClusterScanConfigStatusesSchema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("compliance_operator_cluster_scan_config_statuses", CreateTableComplianceOperatorClusterScanConfigStatusesStmt, ComplianceOperatorClusterScanConfigStatusesSchema, features.ComplianceEnhancements.Enabled)
}
