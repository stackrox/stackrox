...
var (
	...
	TestGrandChild1Schema = func() *walker.Schema {
		...
		schema.SetOptionsMap(search.OptionsMapFromMap(v1.SearchCategory(108), map[search.FieldLabel]*search.Field{
			"Test Grandchild1 ID":  {FieldPath: "testgrandchild1.id", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory(108)},
			"Test Grandchild1 Val": {FieldPath: "testgrandchild1.val", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory(108)},
		}))
