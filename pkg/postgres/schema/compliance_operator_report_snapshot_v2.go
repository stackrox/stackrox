...
func init() {
	...
	RegisterTableStmt("compliance_operator_report_snapshot_v2", CreateTableComplianceOperatorReportSnapshotV2Stmt, ComplianceOperatorReportSnapshotV2Schema, features.ComplianceEnhancements.Enabled)
}
