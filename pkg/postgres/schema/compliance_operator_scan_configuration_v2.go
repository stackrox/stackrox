...
func init() {
	...
	RegisterTableStmt("compliance_operator_scan_configuration_v2", CreateTableComplianceOperatorScanConfigurationV2Stmt, ComplianceOperatorScanConfigurationV2Schema, features.ComplianceEnhancements.Enabled)
}
