...
var (
	...
	ServiceIdentitiesSchema = func() *walker.Schema {
		...
		schema.Fields = []walker.Field{
			{Schema: schema, Name: "SerialStr", ProtoBufName: "serial_str", ColumnName: "SerialStr", Type: "string", DataType: postgres.String, SQLType: "varchar", ModelType: "string", ObjectGetter: walker.MakeObjectGetter("GetSerialStr()", false), Options: walker.PostgresOptions{PrimaryKey: true}},
