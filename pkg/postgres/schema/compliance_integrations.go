...
var (
	...
	ComplianceIntegrationsSchema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("compliance_integrations", CreateTableComplianceIntegrationsStmt, ComplianceIntegrationsSchema)
}
