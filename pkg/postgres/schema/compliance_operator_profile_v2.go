...
var (
	...
	ComplianceOperatorProfileV2Schema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("compliance_operator_profile_v2", CreateTableComplianceOperatorProfileV2Stmt, ComplianceOperatorProfileV2Schema, features.ComplianceEnhancements.Enabled)
}
