...
var (
	...
	ComplianceOperatorRulesSchema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("compliance_operator_rules", CreateTableComplianceOperatorRulesStmt, ComplianceOperatorRulesSchema)
}
