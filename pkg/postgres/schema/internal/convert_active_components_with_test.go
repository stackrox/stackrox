...
func convertActiveComponent_ActiveContextFromProto(obj *storage.ActiveComponent_ActiveContext, idx int, active_components_Id string) (*schema.ActiveComponentsActiveContextsSlices, error) {
