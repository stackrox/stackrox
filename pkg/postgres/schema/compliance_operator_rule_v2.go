...
func init() {
	...
	RegisterTableStmt("compliance_operator_rule_v2", CreateTableComplianceOperatorRuleV2Stmt, ComplianceOperatorRuleV2Schema, features.ComplianceEnhancements.Enabled)
}
