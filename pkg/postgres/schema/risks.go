...
type Risks struct {
	...
	SubjectNamespace string                  `gorm:"column:subject_namespace;type:varchar;index:sac_filter,type:btree"`
	SubjectClusterId string                  `gorm:"column:subject_clusterid;type:varchar;index:sac_filter,type:btree"`
