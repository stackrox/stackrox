...
type ListeningEndpoints struct {
	...
	ClusterID          string             `gorm:"column:clusterid;type:uuid;index:listeningendpoints_sac_filter,type:btree,option:CONCURRENTLY"`
	Namespace          string             `gorm:"column:namespace;type:varchar;index:listeningendpoints_sac_filter,type:btree,option:CONCURRENTLY"`
