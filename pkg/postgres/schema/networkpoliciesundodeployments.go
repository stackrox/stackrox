...
var (
	...
	NetworkpoliciesundodeploymentsSchema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("networkpoliciesundodeployments", CreateTableNetworkpoliciesundodeploymentsStmt, NetworkpoliciesundodeploymentsSchema)
}
