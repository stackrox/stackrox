...
var (
	...
	ComplianceRunResultsSchema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("compliance_run_results", CreateTableComplianceRunResultsStmt, ComplianceRunResultsSchema)
}
