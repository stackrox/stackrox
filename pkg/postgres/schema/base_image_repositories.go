...
var (
	...
	BaseImageRepositoriesSchema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("base_image_repositories", CreateTableBaseImageRepositoriesStmt, BaseImageRepositoriesSchema)
}
