...
var (
	...
	TestParent2Schema = func() *walker.Schema {
		...
		schema.Fields = []walker.Field{
			{Schema: schema, Name: "Id", ProtoBufName: "id", ColumnName: "Id", Type: "string", DataType: postgres.String, SQLType: "uuid", ModelType: "string", ObjectGetter: walker.MakeObjectGetter("GetId()", false), Options: walker.PostgresOptions{PrimaryKey: true, ColumnType: "uuid"}, Search: walker.SearchField{FieldName: "Test Parent2 ID", Enabled: true}},
			...
			{Schema: schema, Name: "Val", ProtoBufName: "val", ColumnName: "Val", Type: "string", DataType: postgres.String, SQLType: "varchar", ModelType: "string", ObjectGetter: walker.MakeObjectGetter("GetVal()", false), Search: walker.SearchField{FieldName: "Test Parent2 Val", Enabled: true}},
		...
		schema.SetOptionsMap(search.OptionsMapFromMap(v1.SearchCategory(111), map[search.FieldLabel]*search.Field{
			"Test Parent2 ID":  {FieldPath: "testparent2.id", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory(111)},
			"Test Parent2 Val": {FieldPath: "testparent2.val", Type: v1.SearchDataType_SEARCH_STRING, Category: v1.SearchCategory(111)},
		}))
