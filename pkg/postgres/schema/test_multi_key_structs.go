...
var (
	...
	TestOneKeyStructsSchema = func() *walker.Schema {
		...
		schema.SetOptionsMap(search.Walk(v1.SearchCategory(101), "TestOneKeyStruct", (*storage.TestOneKeyStruct)(nil)))
		RegisterTable(schema, CreateTableTestOneKeyStructsStmt)
...
type TestOneKeyStructsNesteds struct {
	...
	TestOneKeyStructsRef  TestOneKeyStructs `gorm:"foreignKey:test_multi_key_structs_key1;references:key1;belongsTo;constraint:OnDelete:CASCADE"`
}
