...
func init() {
	...
	RegisterTableStmt("compliance_operator_scan_setting_bindings", CreateTableComplianceOperatorScanSettingBindingsStmt, ComplianceOperatorScanSettingBindingsSchema)
}
