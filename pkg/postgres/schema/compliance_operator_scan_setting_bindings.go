...
var (
	...
	ComplianceOperatorScanSettingBindingsSchema = func() *walker.Schema {
		schema := registry.GetSchemaForTable("compliance_operator_scan_setting_bindings")
		if schema != nil {
			return schema
		}
		...
		registry.RegisterTable(schema, CreateTableComplianceOperatorScanSettingBindingsStmt)
		return schema
	}()
)
