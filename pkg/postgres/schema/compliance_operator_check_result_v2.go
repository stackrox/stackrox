...
func init() {
	...
	RegisterTableStmt("compliance_operator_check_result_v2", CreateTableComplianceOperatorCheckResultV2Stmt, ComplianceOperatorCheckResultV2Schema, features.ComplianceEnhancements.Enabled)
}
