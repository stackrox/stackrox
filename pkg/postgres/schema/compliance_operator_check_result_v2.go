...
var (
	...
	ComplianceOperatorCheckResultV2Schema = func() *walker.Schema {
		...
		schema.Fields = []walker.Field{
			...
			{Schema: schema, Name: "Status", ProtoBufName: "status", ColumnName: "Status", Type: "storage.ComplianceOperatorCheckResultV2_CheckStatus", DataType: postgres.Enum, SQLType: "integer", ModelType: "storage.ComplianceOperatorCheckResultV2_CheckStatus", ObjectGetter: walker.MakeObjectGetter("GetStatus()", false), Search: walker.SearchField{FieldName: "Compliance Check Status", Enabled: true}, DerivedSearchFields: []walker.DerivedSearchField{{DerivedFrom: "compliance error count", DerivationType: search.CustomFieldType, DerivedDataType: postgres.Integer}, {DerivedFrom: "compliance pass count", DerivationType: search.CustomFieldType, DerivedDataType: postgres.Integer}, {DerivedFrom: "compliance not applicable count", DerivationType: search.CustomFieldType, DerivedDataType: postgres.Integer}, {DerivedFrom: "compliance info count", DerivationType: search.CustomFieldType, DerivedDataType: postgres.Integer}, {DerivedFrom: "compliance fail count", DerivationType: search.CustomFieldType, DerivedDataType: postgres.Integer}, {DerivedFrom: "compliance manual count", DerivationType: search.CustomFieldType, DerivedDataType: postgres.Integer}, {DerivedFrom: "compliance inconsistent count", DerivationType: search.CustomFieldType, DerivedDataType: postgres.Integer}}},
