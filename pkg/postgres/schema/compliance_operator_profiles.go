...
var (
	...
	ComplianceOperatorProfilesSchema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("compliance_operator_profiles", CreateTableComplianceOperatorProfilesStmt, ComplianceOperatorProfilesSchema)
}
