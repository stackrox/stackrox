...
var (
	...
	NotificationSchedulesSchema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("notification_schedules", CreateTableNotificationSchedulesStmt, NotificationSchedulesSchema)
}
