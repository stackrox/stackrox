...
var (
	...
	ClusterInitBundlesSchema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("cluster_init_bundles", CreateTableClusterInitBundlesStmt, ClusterInitBundlesSchema)
}
