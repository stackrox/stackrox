...
var (
	...
	ComplianceOperatorScanSettingBindingV2Schema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("compliance_operator_scan_setting_binding_v2", CreateTableComplianceOperatorScanSettingBindingV2Stmt, ComplianceOperatorScanSettingBindingV2Schema, features.ComplianceEnhancements.Enabled)
}
