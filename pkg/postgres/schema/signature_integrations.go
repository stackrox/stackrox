...
var (
	...
	SignatureIntegrationsSchema = sync.OnceValue(func() *walker.Schema {
...
func init() {
	...
	RegisterTableStmt("signature_integrations", CreateTableSignatureIntegrationsStmt, SignatureIntegrationsSchema)
}
