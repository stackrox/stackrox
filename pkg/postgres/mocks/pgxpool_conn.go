...
func (mr *MockPgxPoolConnMockRecorder) Begin(ctx interface{}) *gomock.Call {
...
func (mr *MockPgxPoolConnMockRecorder) CopyFrom(ctx, tableName, columnNames, rowSrc interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPgxPoolConnMockRecorder) Exec(ctx, sql interface{}, arguments ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPgxPoolConnMockRecorder) SendBatch(ctx, b interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
