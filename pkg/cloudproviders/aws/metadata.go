...
func instanceTags(ctx context.Context, mdClient *ec2metadata.EC2Metadata) (string, error) {
	tags, err := mdClient.GetDynamicDataWithContext(ctx, "tags/instance")
	if err != nil {
...
func clusterName(ctx context.Context, mdClient *ec2metadata.EC2Metadata) (string, error) {
	clusterName, err := mdClient.GetDynamicDataWithContext(ctx, "tags/instance/kubernetes.io/cluster")
	if err != nil {
