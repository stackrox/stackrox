...
func (k StageSet) getSmallerLargerAndMaxIntLen(other StageSet) (smaller StageSet, larger StageSet, maxIntLen int) {
	maxIntLen = len(k)
...
func (k StageSet) Intersects(other StageSet) bool {
