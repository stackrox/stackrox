...
![](diagrams/random-forest.svg){fig-align="center" width="100%"}
...
# The Training {background-color="#2d2d2d"}

## End-to-End Training Flow

![](diagrams/training.svg){fig-align="center" width="100%"}

# The Predictions {background-color="#2d2d2d"}

## Prediction Flow

![](diagrams/prediction.svg){fig-align="bottom" width="100%"}
