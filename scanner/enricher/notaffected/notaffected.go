...
const (
	...
	// The following consts match Claircore's VEX https://github.com/quay/claircore/blob/v1.5.39/rhel/vex/updater.go.
...
// Enricher provides Red Hat VEX data as enrichments to a VulnerabilityReport.
//
