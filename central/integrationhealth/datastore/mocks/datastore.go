...
func (mr *MockDataStoreMockRecorder) GetBackupPlugins(ctx interface{}) *gomock.Call {
...
func (mr *MockDataStoreMockRecorder) GetNotifierPlugins(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) GetRegistriesAndScanners(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) RemoveIntegrationHealth(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
