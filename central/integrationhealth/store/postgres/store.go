...
const (
	...
	existsStmt = "SELECT EXISTS(SELECT 1 FROM IntegrationHealth WHERE )"

	getStmt    = "SELECT serialized FROM IntegrationHealth WHERE "
	deleteStmt = "DELETE FROM IntegrationHealth WHERE "
...
type Store interface {
	Count() (int, error)
	Exists() (bool, error)
	Get() (*storage.IntegrationHealth, bool, error)
...
func (s *storeImpl) Get() (*storage.IntegrationHealth, bool, error) {
...
func (s *storeImpl) Upsert(obj0 *storage.IntegrationHealth) error {
