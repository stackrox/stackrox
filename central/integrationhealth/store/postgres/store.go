...
//value of singlePK
//{0xc0006ce180 Id {false GetId()} Id  string string varchar {false  true false false} {  false false false false}}
...
func (s *storeImpl) copyIntoIntegrationhealth(ctx context.Context, tx pgx.Tx, objs ...*storage.IntegrationHealth) error {
	...
	lowerTable := strings.ToLower("integrationhealth")
...
func (s *storeImpl) copyFrom(ctx context.Context, objs ...*storage.IntegrationHealth) error {
	...
	if err := s.copyIntoIntegrationhealth(ctx, tx, objs...); err != nil {
