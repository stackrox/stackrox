...
func insertIntoIntegrationHealths(ctx context.Context, batch *pgx.Batch, obj *storage.IntegrationHealth) error {
	...
	finalStr := "INSERT INTO integration_healths (Id, serialized, tenant_id) VALUES($1, $2, $3) ON CONFLICT(Id) DO UPDATE SET Id = EXCLUDED.Id, serialized = EXCLUDED.serialized, tenant_id = EXCLUDED.tenant_id"
