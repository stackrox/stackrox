...
// NewIndexer returns new indexer for `storage.Blob`.
...
func (b *indexerImpl) Count(ctx context.Context, q *v1.Query, opts ...blevesearch.SearchOption) (int, error) {
	...
	return pgSearch.RunCountRequest(ctx, v1.SearchCategory_BLOB, q, b.db)
}
...
func (b *indexerImpl) Search(ctx context.Context, q *v1.Query, opts ...blevesearch.SearchOption) ([]search.Result, error) {
	...
	return pgSearch.RunSearchRequest(ctx, v1.SearchCategory_BLOB, q, b.db)
}

//// Stubs for satisfying interfaces

func (b *indexerImpl) AddBlob(deployment *storage.Blob) error {
	return nil
}

func (b *indexerImpl) AddBlobs(_ []*storage.Blob) error {
	return nil
}

func (b *indexerImpl) DeleteBlob(id string) error {
	return nil
}

func (b *indexerImpl) DeleteBlobs(_ []string) error {
	return nil
}
