...
func (s *channeledImpl) Start(eventsIn <-chan *v1.SensorEvent, pl pipeline.Pipeline, injector pipeline.EnforcementInjector) {
	go s.process(eventsIn, pl, injector)
}

func (s *channeledImpl) process(eventsIn <-chan *v1.SensorEvent, pl pipeline.Pipeline, injector pipeline.EnforcementInjector) {
