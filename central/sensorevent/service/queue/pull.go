...
func (p *persistedEventQueue) Pull() (*v1.DeploymentEvent, error) {
	p.mutex.Lock()
	...
	event, exists, err := p.eventStorage.GetDeploymentEvent(id)
	if err != nil {
	...
	if err := p.eventStorage.RemoveDeploymentEvent(id); err != nil {
