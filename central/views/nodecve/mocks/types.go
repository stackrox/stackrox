...
func (m *MockCveCore) GetNodeCount() int {
	m.ctrl.T.Helper()
...
func (mr *MockCveCoreMockRecorder) GetNodeCount() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNodeCount", reflect.TypeOf((*MockCveCore)(nil).GetNodeCount))
}
...
// GetNodeCountBySeverity indicates an expected call of GetNodeCountBySeverity.
func (mr *MockCveCoreMockRecorder) GetNodeCountBySeverity() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNodeCountBySeverity", reflect.TypeOf((*MockCveCore)(nil).GetNodeCountBySeverity))
}

// GetNodeIDs mocks base method.
func (m *MockCveCore) GetNodeIDs() []string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNodeIDs")
	ret0, _ := ret[0].([]string)
	return ret0
}

// GetNodeIDs indicates an expected call of GetNodeIDs.
func (mr *MockCveCoreMockRecorder) GetNodeIDs() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNodeIDs", reflect.TypeOf((*MockCveCore)(nil).GetNodeIDs))
}

// GetOperatingSystemCount mocks base method.
func (m *MockCveCore) GetOperatingSystemCount() int {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetOperatingSystemCount")
	ret0, _ := ret[0].(int)
	return ret0
}

// GetOperatingSystemCount indicates an expected call of GetOperatingSystemCount.
...
func (m *MockCveView) Get(ctx context.Context, q *v1.Query) ([]nodecve.CveCore, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, q)
	ret0, _ := ret[0].([]nodecve.CveCore)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetNodeIDs mocks base method.
func (m *MockCveView) GetNodeIDs(ctx context.Context, q *v1.Query) ([]string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNodeIDs", ctx, q)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
