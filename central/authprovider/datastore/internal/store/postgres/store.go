...
type storeImpl struct {
	*pgSearch.GenericSingleIDStore[storage.AuthProvider, *storage.AuthProvider]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		GenericSingleIDStore: pgSearch.NewGenericSingleIDStore[storage.AuthProvider, *storage.AuthProvider](
			db,
			"AuthProvider",
			targetResource,
			schema,
