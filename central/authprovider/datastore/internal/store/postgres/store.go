...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.AuthProvider, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.AuthProvider](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.AuthProvider, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.AuthProvider](ctx, schema, q, s.db)
	if err != nil {
