...
const (
	...
	existsStmt = "SELECT EXISTS(SELECT 1 FROM auth_providers WHERE Id = $1)"

	getStmt     = "SELECT serialized FROM auth_providers WHERE Id = $1"
	deleteStmt  = "DELETE FROM auth_providers WHERE Id = $1"
	walkStmt    = "SELECT serialized FROM auth_providers"
	getManyStmt = "SELECT serialized FROM auth_providers WHERE Id = ANY($1::text[])"

	deleteManyStmt = "DELETE FROM auth_providers WHERE Id = ANY($1::text[])"
...
func (s *storeImpl) Delete(ctx context.Context, id string) error {
	...
	conn, release, err := s.acquireConn(ctx, ops.Remove, "AuthProvider")
	if err != nil {
		return err
	}
	defer release()
...
func (s *storeImpl) DeleteMany(ctx context.Context, ids []string) error {
	...
	conn, release, err := s.acquireConn(ctx, ops.RemoveMany, "AuthProvider")
	if err != nil {
		return err
	}
	defer release()
