...
func (m *MockBackend) IssueCRS(ctx context.Context, name string, validUntil time.Time, validFor time.Duration) (*backend.CRSWithMeta, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IssueCRS", ctx, name, validUntil, validFor)
...
func (mr *MockBackendMockRecorder) IssueCRS(ctx, name, validUntil, validFor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IssueCRS", reflect.TypeOf((*MockBackend)(nil).IssueCRS), ctx, name, validUntil, validFor)
}
