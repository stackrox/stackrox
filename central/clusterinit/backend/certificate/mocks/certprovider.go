...
func (m *MockProvider) GetCRSCert(validUntil time.Time, validFor time.Duration) (*mtls.IssuedCert, uuid.UUID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCRSCert", validUntil, validFor)
...
func (mr *MockProviderMockRecorder) GetCRSCert(validUntil, validFor any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCRSCert", reflect.TypeOf((*MockProvider)(nil).GetCRSCert), validUntil, validFor)
}
