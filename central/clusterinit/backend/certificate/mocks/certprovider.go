...
func (m *MockProvider) GetCRSCert(validFor time.Time, validUntil time.Duration) (*mtls.IssuedCert, uuid.UUID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCRSCert", validFor, validUntil)
...
func (mr *MockProviderMockRecorder) GetCRSCert(validFor, validUntil any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCRSCert", reflect.TypeOf((*MockProvider)(nil).GetCRSCert), validFor, validUntil)
}
