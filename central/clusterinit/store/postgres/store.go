...
const (
	...
	existsStmt = "SELECT EXISTS(SELECT 1 FROM InitBundleMeta WHERE )"

	getStmt    = "SELECT serialized FROM InitBundleMeta WHERE "
	deleteStmt = "DELETE FROM InitBundleMeta WHERE "
...
type Store interface {
	Count() (int, error)
	Exists() (bool, error)
	Get() (*storage.InitBundleMeta, bool, error)
...
func (s *storeImpl) Get() (*storage.InitBundleMeta, bool, error) {
...
func (s *storeImpl) Upsert(obj0 *storage.InitBundleMeta) error {
