...
func (b *storeImpl) GetMany(_ context.Context, ids []string) ([]*storage.TokenMetadata, []int, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.TokenMetadata) error {
...
func (b *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TokenMetadata) error) error {
