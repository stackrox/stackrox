...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.TokenMetadata, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.TokenMetadata](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.TokenMetadata) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[storage.TokenMetadata](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
