...
const (
	...
	existsStmt = "SELECT EXISTS(SELECT 1 FROM TokenMetadata WHERE )"

	getStmt    = "SELECT serialized FROM TokenMetadata WHERE "
	deleteStmt = "DELETE FROM TokenMetadata WHERE "
...
type Store interface {
	Count() (int, error)
	Exists() (bool, error)
	Get() (*storage.TokenMetadata, bool, error)
...
func (s *storeImpl) Get() (*storage.TokenMetadata, bool, error) {
...
func (s *storeImpl) Upsert(obj0 *storage.TokenMetadata) error {
