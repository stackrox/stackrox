...
//value of singlePK
//{0xc0005aa380 Id {false GetId()} Id  string string varchar {false  true false false} {  false false false false}}
...
func (s *storeImpl) copyIntoApitokens(ctx context.Context, tx pgx.Tx, objs ...*storage.TokenMetadata) error {
	...
	lowerTable := strings.ToLower("apitokens")
...
func (s *storeImpl) copyFrom(ctx context.Context, objs ...*storage.TokenMetadata) error {
	...
	if err := s.copyIntoApitokens(ctx, tx, objs...); err != nil {
