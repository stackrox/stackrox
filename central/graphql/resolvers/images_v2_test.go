...
func TestImageV2Resolvers(t *testing.T) {
	suite.Run(t, new(ImageV2ResolversTestSuite))
}

type ImageV2ResolversTestSuite struct {
	suite.Suite
...
func (s *ImageV2ResolversTestSuite) SetupSuite() {
...
func (s *ImageV2ResolversTestSuite) TearDownSuite() {
	s.testDB.Teardown(s.T())
}

func (s *ImageV2ResolversTestSuite) TestDeployments() {
...
func compileExpectedForImageV2GraphQL(deployments []*storage.Deployment, images []*storage.Image,
