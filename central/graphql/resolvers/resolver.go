...
var (
	...
	readTokens                           = readAuth(resources.Integration)
	...
	readGroups                           = readAuth(resources.Access)
	readImages                           = readAuth(resources.Image)
	readIndicators                       = readAuth(resources.DeploymentExtension)
	...
	readNotifiers                        = readAuth(resources.Integration)
	...
	readRisks                            = readAuth(resources.DeploymentExtension)
	readRoles                            = readAuth(resources.Access)
	readSecrets                          = readAuth(resources.Secret)
	readServiceAccounts                  = readAuth(resources.ServiceAccount)
	readBaselines                        = readAuth(resources.DeploymentExtension)
