...
func (resolver *clusterCertExpiryStatusResolver) SensorCertAutoRefresh(ctx context.Context) bool {
	value := resolver.data.GetSensorCertAutoRefresh()
	return value
}
