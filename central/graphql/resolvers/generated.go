...
func (resolver *imageCVEV2Resolver) CvssMetrics(ctx context.Context) ([]*cVSSScoreResolver, error) {
	value := resolver.data.GetCvssMetrics()
	return resolver.root.wrapCVSSScores(value, nil)
}
...
func (resolver *imageComponentV2Resolver) Cves(ctx context.Context) ([]*imageCVEV2Resolver, error) {
	value := resolver.data.GetCves()
	return resolver.root.wrapImageCVEV2s(value, nil)
}
