...
func (resolver *microsoftSentinelResolver) DataCollectionRuleId(ctx context.Context) string {
...
func (resolver *microsoftSentinelResolver) StreamName(ctx context.Context) string {
