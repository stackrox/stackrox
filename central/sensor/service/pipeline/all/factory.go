...
import (
	...
	"github.com/stackrox/rox/central/sensor/service/pipeline/complianceoperatorscansettingbindingsv2"
	"github.com/stackrox/rox/central/sensor/service/pipeline/complianceoperatorscansv2"
	"github.com/stackrox/rox/central/sensor/service/pipeline/complianceoperatorsuites"
...
func (s *factoryImpl) PipelineForCluster(ctx context.Context, clusterID string) (pipeline.ClusterPipeline, error) {
	...
	pipelines := []pipeline.Fragment{
		...
		complianceoperatorsuites.GetPipeline(),
	}
