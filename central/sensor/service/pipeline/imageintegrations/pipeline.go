...
func NewPipeline(integrationManager enrichment.Manager,
	...
	enrichAndDetectLoop reprocessor.Loop, connManager connection.Manager) pipeline.Fragment {
	return &pipelineImpl{
...
func (s *pipelineImpl) Reconcile(ctx context.Context, clusterID string, storeMap *reconciliation.StoreMap) error {
	...
	conn := s.connManager.GetConnection(clusterID)
	if conn == nil {
		return nil
	}
...
func (s *pipelineImpl) Run(ctx context.Context, clusterID string, msg *central.MsgFromSensor, _ common.MessageInjector) error {
	...
	imageIntegration.Name = fmt.Sprintf("Autogenerated %s for cluster %s from %s/%s", description, clusterName, source.GetNamespace(), source.GetName())
