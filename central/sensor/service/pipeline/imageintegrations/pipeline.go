...
func (s *pipelineImpl) Run(ctx context.Context, clusterID string, msg *central.MsgFromSensor, _ common.MessageInjector) error {
	...
	isOCPGlobalPullSecret := source.GetImagePullSecretName() == "pull-secret" && source.GetNamespace() == "openshift-config"
	if (!features.SourcedAutogeneratedIntegrations.Enabled() || source == nil) && !isOCPGlobalPullSecret {
