...
func (ds *datastoreImpl) Upsert(ctx context.Context, edges ...*storage.NodeComponentEdge) error {
	if len(edges) == 0 {
		return nil
	}
	...
	return ds.indexer.AddNodeComponentEdges(edges)
}
...
func (ds *datastoreImpl) Delete(ctx context.Context, ids ...string) error {
	...
	return ds.indexer.DeleteNodeComponentEdges(ids)
}
