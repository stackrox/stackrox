...
func (m *MockDataStore) Get(ctx context.Context, id string) (*storage.NodeComponentEdge, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) GetBatch(ctx context.Context, id []string) ([]*storage.NodeComponentEdge, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) SearchRawEdges(ctx context.Context, q *v1.Query) ([]*storage.NodeComponentEdge, error) {
	m.ctrl.T.Helper()
