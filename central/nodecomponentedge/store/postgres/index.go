...
func (b *indexerImpl) Count(q *v1.Query, opts ...blevesearch.SearchOption) (int, error) {
	...
	return postgres.RunCountRequest(v1.SearchCategory_NODE_COMPONENT_EDGE, q, b.db)
}

func (b *indexerImpl) Search(q *v1.Query, opts ...blevesearch.SearchOption) ([]search.Result, error) {
	defer metrics.SetIndexOperationDurationTime(time.Now(), ops.Search, "NodeComponentEdge")

	return postgres.RunSearchRequest(v1.SearchCategory_NODE_COMPONENT_EDGE, q, b.db)
}
