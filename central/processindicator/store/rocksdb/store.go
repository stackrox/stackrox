...
func (b *storeImpl) GetMany(_ context.Context, ids []string) ([]*storage.ProcessIndicator, []int, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.ProcessIndicator) error {
...
func (b *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ProcessIndicator) error) error {
