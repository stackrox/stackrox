...
// TODO: Get this back to being generated. ROX-13790, ROX-13791, ROX-13789, ROX-13792
...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ProcessIndicator, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.ProcessIndicator](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.ProcessIndicator, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.ProcessIndicator](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ProcessIndicator) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchema[storage.ProcessIndicator](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
