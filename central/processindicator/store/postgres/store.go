...
const (
	...
	getWithRollupStmt = "select row_to_json((select record from (select table0.Id as Id, table0.DeploymentId as DeploymentId, table0.ContainerName as ContainerName, table0.PodId as PodId, table0.PodUid as PodUid, table0.Signal_Id as Signal_Id, table0.Signal_ContainerId as Signal_ContainerId, table0.Signal_Time as Signal_Time, table0.Signal_Name as Signal_Name, table0.Signal_Args as Signal_Args, table0.Signal_ExecFilePath as Signal_ExecFilePath, table0.Signal_Pid as Signal_Pid, table0.Signal_Uid as Signal_Uid, table0.Signal_Gid as Signal_Gid, table0.Signal_Lineage as Signal_Lineage, table0.Signal_Scraped as Signal_Scraped, table0.ClusterId as ClusterId, table0.Namespace as Namespace, table0.ContainerStartTime as ContainerStartTime, table0.ImageId as ImageId, to_json(join0)->'array' as join0 from process_indicators table0 left join lateral (select array(select json_build_object('idx', table1.idx, 'ParentUid', table1.ParentUid, 'ParentExecFilePath', table1.ParentExecFilePath) from process_indicators_LineageInfo table1 where (table0.Id = table1.process_indicators_Id))) join0 on true where (table0.Id = $1)) record ))"
