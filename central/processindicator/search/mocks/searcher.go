...
func (m *MockSearcher) SearchRawProcessIndicators(ctx context.Context, q *v1.Query) ([]*storage.ProcessIndicator, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSearcherMockRecorder) SearchRawProcessIndicators(ctx, q interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchRawProcessIndicators", reflect.TypeOf((*MockSearcher)(nil).SearchRawProcessIndicators), ctx, q)
}
