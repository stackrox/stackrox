...
var OptionsMap = map[search.FieldLabel]*v1.SearchField{
	...
	search.ProcessArguments: search.NewStoredStringField(v1.SearchCategory_PROCESS_INDICATORS, "process_indicator.signal.args"),
	...
	search.ProcessName:      search.NewStoredStringField(v1.SearchCategory_PROCESS_INDICATORS, "process_indicator.signal.name"),
}
