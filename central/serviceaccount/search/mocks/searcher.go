...
func (m *MockSearcher) SearchRawServiceAccounts(arg0 context.Context, arg1 *v1.Query) ([]*storage.ServiceAccount, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSearcherMockRecorder) SearchRawServiceAccounts(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockSearcherMockRecorder) SearchServiceAccounts(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
