...
//value of singlePK
//{0xc00016ae80 Id {false GetId()} Id  string string varchar {false  true false false} {  false false false false}}
...
func (s *storeImpl) copyIntoServiceaccounts(ctx context.Context, tx pgx.Tx, objs ...*storage.ServiceAccount) error {
	...
	copyCols := []string{}
	columns := "Id, Name, Namespace, ClusterName, ClusterId, Labels, Annotations, CreatedAt, AutomountToken, Secrets, ImagePullSecrets, serialized"
	...
	lowerTable := strings.ToLower("serviceaccounts")
