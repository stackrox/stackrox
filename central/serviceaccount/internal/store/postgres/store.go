...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ServiceAccount, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.ServiceAccount](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.ServiceAccount, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.ServiceAccount](ctx, schema, q, s.db)
	if err != nil {
