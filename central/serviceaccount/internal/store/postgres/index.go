...
func (b *indexerImpl) Count(q *v1.Query, opts ...blevesearch.SearchOption) (int, error) {
	...
	return postgres.RunCountRequest(v1.SearchCategory_SERVICE_ACCOUNTS, q, b.db, mappings.OptionsMap)
}

func (b *indexerImpl) Search(q *v1.Query, opts ...blevesearch.SearchOption) ([]search.Result, error) {
	defer metrics.SetIndexOperationDurationTime(time.Now(), ops.Search, "ServiceAccount")

	return postgres.RunSearchRequest(v1.SearchCategory_SERVICE_ACCOUNTS, q, b.db, mappings.OptionsMap)
}
