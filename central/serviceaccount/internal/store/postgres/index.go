...
func (b *indexerImpl) Count(ctx context.Context, q *v1.Query) (int, error) {
	...
	return pgSearch.RunCountRequest(ctx, v1.SearchCategory_SERVICE_ACCOUNTS, q, b.db)
}
...
func (b *indexerImpl) Search(ctx context.Context, q *v1.Query) ([]search.Result, error) {
	...
	return pgSearch.RunSearchRequest(ctx, v1.SearchCategory_SERVICE_ACCOUNTS, q, b.db)
}
