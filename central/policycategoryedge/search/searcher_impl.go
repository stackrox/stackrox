...
func (ds *searcherImplV2) SearchRawEdges(ctx context.Context, q *v1.Query) ([]*storage.PolicyCategoryEdge, error) {
	return ds.searchImageComponentEdges(ctx, q)
}

func (ds *searcherImplV2) resultsToEdges(ctx context.Context, results []search.Result) ([]*storage.PolicyCategoryEdge, []int, error) {
...
func (ds *searcherImplV2) searchImageComponentEdges(ctx context.Context, q *v1.Query) ([]*storage.PolicyCategoryEdge, error) {
	results, err := ds.Search(ctx, q)
	if err != nil {
		return nil, err
	}
