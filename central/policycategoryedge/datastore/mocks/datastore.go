...
func (m *MockDataStore) DeleteByQuery(ctx context.Context, q *v1.Query) error {
	m.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) DeleteByQuery(ctx, q interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteByQuery", reflect.TypeOf((*MockDataStore)(nil).DeleteByQuery), ctx, q)
}
...
func (mr *MockDataStoreMockRecorder) DeleteMany(ctx interface{}, ids ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx}, ids...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteMany", reflect.TypeOf((*MockDataStore)(nil).DeleteMany), varargs...)
}
...
func (m *MockDataStore) Get(ctx context.Context, id string) (*storage.PolicyCategoryEdge, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) GetAll(ctx context.Context) ([]*storage.PolicyCategoryEdge, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) GetBatch(ctx context.Context, id []string) ([]*storage.PolicyCategoryEdge, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) SearchRawEdges(ctx context.Context, q *v1.Query) ([]*storage.PolicyCategoryEdge, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) UpsertMany(ctx context.Context, edges []*storage.PolicyCategoryEdge) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpsertMany", ctx, edges)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpsertMany indicates an expected call of UpsertMany.
func (mr *MockDataStoreMockRecorder) UpsertMany(ctx, edges interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpsertMany", reflect.TypeOf((*MockDataStore)(nil).UpsertMany), ctx, edges)
}
