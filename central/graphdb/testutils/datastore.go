...
func (s *testGraphDataStoreImpl) PushImageToVulnerabilitiesGraph() (err error) {
	...
	if features.FlattenImageData.Enabled() {
		testImage1 := fixtures.GetImageV2SherlockHolmes1()
		testImage2 := fixtures.GetImageV2DoctorJekyll2()
		err = s.imageV2Store.UpsertImage(ctx, testImage1)
		if err != nil {
			return err
		}
		s.storedImages = append(s.storedImages, testImage1.GetId())
		err = s.imageV2Store.UpsertImage(ctx, testImage2)
		if err != nil {
			return err
		}
