...
func (ds *dataStoreImpl) Get(ctx context.Context, _ *types.Timestamp, _ *types.Timestamp) (<-chan *storage.Usage, error) {
...
func (ds *dataStoreImpl) AggregateAndFlush(ctx context.Context) (*storage.Usage, error) {
	if err := sac.VerifyAuthzOK(usageSAC.WriteAllowed(ctx)); err != nil {
