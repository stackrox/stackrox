...
type Store interface {
	...
	UpsertMany(ctx context.Context, objs []*storage.ContinuousIntegrationConfig) error
	...
	GetMany(ctx context.Context, identifiers []string) ([]*storage.ContinuousIntegrationConfig, []int, error)
...
func (s *storeImpl) Upsert(ctx context.Context, obj *storage.ContinuousIntegrationConfig) error {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Upsert, "ContinuousIntegrationConfig")
...
func (s *storeImpl) UpsertMany(ctx context.Context, objs []*storage.ContinuousIntegrationConfig) error {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.UpdateMany, "ContinuousIntegrationConfig")
...
func (s *storeImpl) Delete(ctx context.Context, id string) error {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Remove, "ContinuousIntegrationConfig")
...
func (s *storeImpl) DeleteMany(ctx context.Context, identifiers []string) error {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.RemoveMany, "ContinuousIntegrationConfig")
...
func (s *storeImpl) Count(ctx context.Context) (int, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Count, "ContinuousIntegrationConfig")
...
func (s *storeImpl) Exists(ctx context.Context, id string) (bool, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Exists, "ContinuousIntegrationConfig")
...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ContinuousIntegrationConfig, bool, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Get, "ContinuousIntegrationConfig")
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.ContinuousIntegrationConfig, []int, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.GetMany, "ContinuousIntegrationConfig")
	...
	rows, err := pgSearch.RunGetManyQueryForSchema[storage.ContinuousIntegrationConfig](ctx, schema, q, s.db)
	if err != nil {
	...
	resultsByID := make(map[string]*storage.ContinuousIntegrationConfig, len(rows))
	...
	elems := make([]*storage.ContinuousIntegrationConfig, 0, len(resultsByID))
...
func (s *storeImpl) GetIDs(ctx context.Context) ([]string, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.GetAll, "storage.ContinuousIntegrationConfigIDs")
	var sacQueryFilter *v1.Query
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ContinuousIntegrationConfig) error) error {
	var sacQueryFilter *v1.Query
	scopeChecker := sac.GlobalAccessScopeChecker(ctx).AccessMode(storage.Access_READ_ACCESS).Resource(targetResource)
	if !scopeChecker.IsAllowed() {
		return nil
	}
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.ContinuousIntegrationConfig](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
...
func Destroy(ctx context.Context, db postgres.DB) {
	dropTableContinuousIntegrationConfigs(ctx, db)
}

func dropTableContinuousIntegrationConfigs(ctx context.Context, db postgres.DB) {
	_, _ = db.Exec(ctx, "DROP TABLE IF EXISTS continuous_integration_configs CASCADE")
