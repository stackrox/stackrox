...
func (b *storeImpl) GetMany(_ context.Context, ids []string) ([]*storage.SignatureIntegration, []int, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.SignatureIntegration) error {
...
func (b *storeImpl) Walk(ctx context.Context, fn func(obj *storage.SignatureIntegration) error) error {
