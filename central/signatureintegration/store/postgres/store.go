...
const (
	...
	getStmt        = "SELECT t1.serialized FROM signatureintegrations t1 WHERE t1.Id = $1"
	deleteStmt     = "DELETE FROM signatureintegrations t1 WHERE t1.Id = $1"
	walkStmt       = "SELECT serialized FROM signatureintegrations"
	existsStmt     = "SELECT EXISTS(SELECT 1 FROM signatureintegrations t1 WHERE t1.Id = $1)"
	getIDsStmt     = "SELECT distinct Id FROM signatureintegrations"
