...
const (
	baseTable = "base_image_tags"
	storeName = "BaseImageTag"
)
...
type (
	storeType = storage.BaseImageTag
	callback  = func(obj *storeType) error
)

// Store is the interface to interact with the storage for storage.BaseImageTag
...
func New(db postgres.DB) Store {
	return pgSearch.NewGloballyScopedGenericStore[storeType, *storeType](
		...
		schema,
		pkGetter,
		insertIntoBaseImageTags,
		copyFromBaseImageTags,
...
func insertIntoBaseImageTags(batch *pgx.Batch, obj *storage.BaseImageTag) error {
	...
	finalStr := "INSERT INTO base_image_tags (Id, BaseImageRepositoryId, Tag, serialized) VALUES($1, $2, $3, $4) ON CONFLICT(Id) DO UPDATE SET Id = EXCLUDED.Id, BaseImageRepositoryId = EXCLUDED.BaseImageRepositoryId, Tag = EXCLUDED.Tag, serialized = EXCLUDED.serialized"
