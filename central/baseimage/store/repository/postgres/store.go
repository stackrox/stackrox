...
const (
	baseTable = "base_image_repositories"
	storeName = "BaseImageRepository"
)

var (
	log            = logging.LoggerForModule()
	schema         = pkgSchema.BaseImageRepositoriesSchema
	targetResource = resources.ImageAdministration
)

type (
	storeType = storage.BaseImageRepository
	callback  = func(obj *storeType) error
)

// Store is the interface to interact with the storage for storage.BaseImageRepository
...
func New(db postgres.DB) Store {
	return pgSearch.NewGloballyScopedGenericStore[storeType, *storeType](
		...
		schema,
		pkGetter,
		insertIntoBaseImageRepositories,
		copyFromBaseImageRepositories,
...
func insertIntoBaseImageRepositories(batch *pgx.Batch, obj *storage.BaseImageRepository) error {
