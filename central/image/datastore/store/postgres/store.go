...
func (s *storeImpl) insertIntoImages(
	...
	// set tenantID to -1 to have a valid ID for SQL query. -1 is like having no tenant
	if TenantID == "" {
		TenantID = "-1"
	}
	values := []interface{}{
