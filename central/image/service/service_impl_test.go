...
// TestReprocessClusterLocal ensures that an image formerly marked as cluster local
// that is now being sent to Central for full enrichment can eventually be enriched
// by Central.
