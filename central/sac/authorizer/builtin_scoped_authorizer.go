...
func newGlobalScopeCheckerCore(clusters []*storage.Cluster, namespaces []storage.ImmutableNamespaceMetadata, roles []permissions.ResolvedRole, trace *observe.AuthzTrace) sac.ScopeCheckerCore {
