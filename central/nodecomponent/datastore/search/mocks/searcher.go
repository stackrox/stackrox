...
func (m *MockSearcher) SearchNodeComponents(arg0 context.Context, arg1 *v1.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
...
// SearchNodeComponents indicates an expected call of SearchNodeComponents.
func (mr *MockSearcherMockRecorder) SearchNodeComponents(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchNodeComponents", reflect.TypeOf((*MockSearcher)(nil).SearchNodeComponents), arg0, arg1)
}

// SearchRawNodeComponents mocks base method.
func (m *MockSearcher) SearchRawNodeComponents(ctx context.Context, query *v1.Query) ([]*storage.NodeComponent, error) {
	m.ctrl.T.Helper()
...
// SearchRawNodeComponents indicates an expected call of SearchRawNodeComponents.
func (mr *MockSearcherMockRecorder) SearchRawNodeComponents(ctx, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchRawNodeComponents", reflect.TypeOf((*MockSearcher)(nil).SearchRawNodeComponents), ctx, query)
}
