...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.NodeComponent, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.NodeComponent](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.NodeComponent, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.NodeComponent](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.NodeComponent) error) error {
	var sacQueryFilter *v1.Query
	fetcher, closer, err := postgres.RunCursorQueryForSchema[storage.NodeComponent](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
