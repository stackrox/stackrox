...
func New(db postgres.DB) Store {
	return &storeImpl{
		db: db,
		GenericStore: pgSearch.NewGenericStore[storage.NodeComponent, *storage.NodeComponent](
			db,
			schema,
			pkGetter,
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.NodeComponent) error) error {
	...
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.NodeComponent](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
