...
const (
	...
	existsStmt = "SELECT EXISTS(SELECT 1 FROM node_components WHERE Id = $1)"

	getStmt     = "SELECT serialized FROM node_components WHERE Id = $1"
	deleteStmt  = "DELETE FROM node_components WHERE Id = $1"
