...
// Source: github.com/stackrox/rox/central/clustercveedge/datastore (interfaces: DataStore)
...
func (m *MockDataStore) Get(arg0 context.Context, arg1 string) (*storage.ClusterCVEEdge, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) GetBatch(arg0 context.Context, arg1 []string) ([]*storage.ClusterCVEEdge, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) SearchRawEdges(arg0 context.Context, arg1 *v1.Query) ([]*storage.ClusterCVEEdge, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) Upsert(arg0 context.Context, arg1 ...converter.ClusterCVEParts) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
