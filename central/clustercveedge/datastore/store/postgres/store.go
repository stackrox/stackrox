...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ClusterCVEEdge, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.ClusterCVEEdge](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.ClusterCVEEdge, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.ClusterCVEEdge](ctx, schema, q, s.db)
	if err != nil {
