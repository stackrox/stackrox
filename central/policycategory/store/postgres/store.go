...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.PolicyCategory, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.PolicyCategory](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.PolicyCategory, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.PolicyCategory](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.PolicyCategory) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[storage.PolicyCategory](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
