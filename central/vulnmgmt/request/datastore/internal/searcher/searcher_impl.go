...
import (
	...
	"github.com/stackrox/rox/central/vulnmgmt/request/datastore/internal/store"
...
// SearchRawRequests retrieves vulnerability requests from the storage
...
// Format the search functionality to be filtered (for sac) and paginated.
