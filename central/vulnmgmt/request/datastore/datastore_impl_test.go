...
import (
	...
	searcherMock "github.com/stackrox/rox/central/vulnmgmt/request/datastore/internal/searcher/mocks"
	storeMock "github.com/stackrox/rox/central/vulnmgmt/request/datastore/internal/store/mocks"
...
func (s *VulnRequestDataStoreTestSuite) TestUpdateRequestSucceedsIfDeferralRequestWasPending() {
	...
	s.Equal(update.DeferralUpdate.GetExpiry(), resp.GetDeferralReq().GetExpiry())
...
func (s *VulnRequestDataStoreTestSuite) TestUpdateRequestSucceedsIfDeferralUpdateWasPending() {
	...
	s.Equal(update.DeferralUpdate, resp.GetDeferralUpdate())
...
func (s *VulnRequestDataStoreTestSuite) TestUpdateRequestSucceedsIfOriginalDeferralReqApproved() {
	...
	s.Equal(req.GetFalsePositiveUpdate(), resp.GetFalsePositiveUpdate())
