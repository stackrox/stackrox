...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.PermissionSet, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.PermissionSet](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.PermissionSet) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[storage.PermissionSet](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
