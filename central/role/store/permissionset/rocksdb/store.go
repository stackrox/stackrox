...
func (b *storeImpl) Get(_ context.Context, id string) (*storage.PermissionSet, bool, error) {
...
func (b *storeImpl) GetMany(_ context.Context, ids []string) ([]*storage.PermissionSet, []int, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.PermissionSet) error {
...
func (b *storeImpl) Walk(ctx context.Context, fn func(obj *storage.PermissionSet) error) error {
