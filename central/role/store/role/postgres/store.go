...
const (
	createTableQuery = "create table if not exists roles (id varchar primary key, value jsonb)"
	createIDIndexQuery = "create index if not exists roles_id on roles using hash ((id))"
)
