...
func (b *storeImpl) Get(id string) (*storage.SimpleAccessScope, bool, error) {
...
func (b *storeImpl) GetMany(ids []string) ([]*storage.SimpleAccessScope, []int, error) {
...
func (b *storeImpl) Upsert(obj *storage.SimpleAccessScope) error {
...
func (b *storeImpl) UpsertMany(objs []*storage.SimpleAccessScope) error {
...
func (b *storeImpl) Walk(fn func(obj *storage.SimpleAccessScope) error) error {
