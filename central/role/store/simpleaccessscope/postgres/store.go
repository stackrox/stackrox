...
const (
	...
	getStmt        = "SELECT t1.serialized FROM simpleaccessscopes t1 WHERE t1.Id = $1"
	deleteStmt     = "DELETE FROM simpleaccessscopes t1 WHERE t1.Id = $1"
	walkStmt       = "SELECT serialized FROM simpleaccessscopes"
	existsStmt     = "SELECT EXISTS(SELECT 1 FROM simpleaccessscopes t1 WHERE t1.Id = $1)"
	getIDsStmt     = "SELECT distinct Id FROM simpleaccessscopes"
...
func (s *storeImpl) Delete(ctx context.Context, id string) error {
	...
	conn, release, err := s.acquireConn(ctx, ops.Remove, "SimpleAccessScope")
	if err != nil {
		return err
	}
	defer release()
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.SimpleAccessScope, []int, error) {
	...
	conn, release, err := s.acquireConn(ctx, ops.GetMany, "SimpleAccessScope")
	if err != nil {
		return nil, nil, err
	}
	defer release()
...
func (s *storeImpl) DeleteMany(ctx context.Context, ids []string) error {
	...
	conn, release, err := s.acquireConn(ctx, ops.RemoveMany, "SimpleAccessScope")
	if err != nil {
		return err
	}
	defer release()
