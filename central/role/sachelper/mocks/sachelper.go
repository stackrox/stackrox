...
func (mr *MockClusterSacHelperMockRecorder) GetClustersForPermissions(ctx, requestedPermissions, pagination interface{}) *gomock.Call {
...
func (mr *MockClusterSacHelperMockRecorder) IsClusterVisibleForPermissions(ctx, clusterID, resourcesWithAccess interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClusterNamespaceSacHelperMockRecorder) GetNamespacesForClusterAndPermissions(ctx, clusterID, requestedPermissions interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
