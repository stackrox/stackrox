...
func (m *MockDataStore) Get(ctx context.Context, id string) (*storage.NodeComponentCVEEdge, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) SearchRawEdges(ctx context.Context, q *v1.Query) ([]*storage.NodeComponentCVEEdge, error) {
	m.ctrl.T.Helper()
