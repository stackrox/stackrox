...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.NodeComponentCVEEdge, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.NodeComponentCVEEdge](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.NodeComponentCVEEdge, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.NodeComponentCVEEdge](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.NodeComponentCVEEdge) error) error {
	var sacQueryFilter *v1.Query
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[storage.NodeComponentCVEEdge](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
