...
func (m *MockStore) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.NamespaceMetadata, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Walk(arg0 context.Context, arg1 func(*storage.NamespaceMetadata) error) error {
	m.ctrl.T.Helper()
