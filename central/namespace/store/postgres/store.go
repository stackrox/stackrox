...
const (
	...
	getWithRollupStmt = "select row_to_json((select record from (select table0.Id as Id, table0.Name as Name, table0.ClusterId as ClusterId, table0.ClusterName as ClusterName, table0.Labels as Labels, table0.CreationTime as CreationTime, table0.Priority as Priority, table0.Annotations as Annotations from namespaces table0 where (table0.Id = $1)) record ))"
