...
func (s *NamespacesStoreSuite) TestSACGetMany() {
	...
	for name, expected := range map[string]struct {
		elems          []*storage.NamespaceMetadata
		missingIndices []int
	}{
		withAllAccess:           {elems: []*storage.NamespaceMetadata{objA, objB}, missingIndices: []int{}},
		withNoAccess:            {elems: []*storage.NamespaceMetadata{}, missingIndices: []int{0, 1}},
		withNoAccessToCluster:   {elems: []*storage.NamespaceMetadata{}, missingIndices: []int{0, 1}},
		withAccessToDifferentNs: {elems: []*storage.NamespaceMetadata{}, missingIndices: []int{0, 1}},
		withAccess:              {elems: []*storage.NamespaceMetadata{objA}, missingIndices: []int{1}},
		withAccessToCluster:     {elems: []*storage.NamespaceMetadata{objA}, missingIndices: []int{1}},
	} {
		s.T().Run(fmt.Sprintf("with %s", name), func(t *testing.T) {
