...
func (m *MockStore) Get(ctx context.Context, id string) (*storage.NamespaceMetadata, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Walk(arg0 context.Context, arg1 func(*storage.NamespaceMetadata) error, arg2 bool) error {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) Walk(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Walk", reflect.TypeOf((*MockStore)(nil).Walk), arg0, arg1, arg2)
}
