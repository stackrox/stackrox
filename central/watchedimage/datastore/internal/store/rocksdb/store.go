...
func (b *storeImpl) Get(id string) (*storage.WatchedImage, bool, error) {
...
func (b *storeImpl) GetMany(ids []string) ([]*storage.WatchedImage, []int, error) {
...
func (b *storeImpl) Upsert(obj *storage.WatchedImage) error {
...
func (b *storeImpl) UpsertMany(objs []*storage.WatchedImage) error {
