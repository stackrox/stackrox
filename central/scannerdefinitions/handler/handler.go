...
type httpHandler struct {
	...
	// rootDir is the root directory into which all data is downloaded.
	rootDir string
	// uploadPath is the file path to which "offline data" is stored.
	// This file will be under the rootDir directory.
	uploadPath string
...
func New(blobStore blob.Datastore, opts handlerOpts) http.Handler {
	root, err := os.MkdirTemp("", tmpDirPattern)
