...
func (mr *MockDataStoreMockRecorder) AddReportConfiguration(ctx, reportConfig interface{}) *gomock.Call {
...
func (mr *MockDataStoreMockRecorder) GetReportConfiguration(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) GetReportConfigurations(ctx, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) RemoveReportConfiguration(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) UpdateReportConfiguration(ctx, reportConfig interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
