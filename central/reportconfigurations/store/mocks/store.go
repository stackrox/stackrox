...
func (m *MockStore) Get(id string) (*storage.ReportConfiguration, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetMany(ids []string) ([]*storage.ReportConfiguration, []int, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Upsert(reportConfig *storage.ReportConfiguration) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Upsert", reportConfig)
	ret0, _ := ret[0].(error)
	return ret0
}

// Upsert indicates an expected call of Upsert.
func (mr *MockStoreMockRecorder) Upsert(reportConfig interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upsert", reflect.TypeOf((*MockStore)(nil).Upsert), reportConfig)
}

// Walk mocks base method.
func (m *MockStore) Walk(arg0 func(*storage.ReportConfiguration) error) error {
	m.ctrl.T.Helper()
