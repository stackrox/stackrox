...
//value of singlePK
//{0xc0004d0100 Id {false GetId()} Id  string string varchar {false  true false false} {  false false false false}}
...
func (s *storeImpl) copyIntoReportconfigs(ctx context.Context, tx pgx.Tx, objs ...*storage.ReportConfiguration) error {
	...
	lowerTable := strings.ToLower("reportconfigs")
...
func (s *storeImpl) copyFrom(ctx context.Context, objs ...*storage.ReportConfiguration) error {
	...
	if err := s.copyIntoReportconfigs(ctx, tx, objs...); err != nil {
