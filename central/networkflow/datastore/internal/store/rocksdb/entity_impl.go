...
func (s *entityStoreImpl) GetEntity(id string) (*storage.NetworkEntity, bool, error) {
...
func (s *entityStoreImpl) UpsertEntity(entity *storage.NetworkEntity) error {
...
func (s *entityStoreImpl) DeleteEntity(id string) error {
...
func (s *entityStoreImpl) DeleteEntities(ids []string) error {
