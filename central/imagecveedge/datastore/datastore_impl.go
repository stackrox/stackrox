...
func (ds *datastoreImpl) UpdateVulnerabilityStates(ctx context.Context, edgeStates map[string]map[string]storage.VulnerabilityState) error {
	...
	if err := ds.storage.UpdateVulnState(edgeStates); err != nil {
		return err
	}
	return nil
}
