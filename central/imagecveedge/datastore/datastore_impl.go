...
func (ds *datastoreImpl) SearchRawEdges(ctx context.Context, q *v1.Query) ([]*storage.ImageCVEEdge, error) {
	...
	err := ds.storage.GetByQueryFn(ctx, q, func(edge *storage.ImageCVEEdge) error {
...
func convertMany(cves []*storage.ImageCVEEdge, results []pkgSearch.Result) []*v1.SearchResult {
