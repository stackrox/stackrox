...
func (b *storeImpl) GetMany(_ context.Context, ids []string) ([]*storage.Risk, []int, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.Risk) error {
...
func (b *storeImpl) Walk(ctx context.Context, fn func(obj *storage.Risk) error) error {
