...
func (m *MockStore) Get(id string) (*storage.Risk, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetMany(ids []string) ([]*storage.Risk, []int, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Upsert(risk *storage.Risk) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Upsert", risk)
	ret0, _ := ret[0].(error)
	return ret0
}

// Upsert indicates an expected call of Upsert.
func (mr *MockStoreMockRecorder) Upsert(risk interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upsert", reflect.TypeOf((*MockStore)(nil).Upsert), risk)
}
