...
// A DNRIntegrationGetter provides the required access to DNR integrations for risk scoring.
...
type dnrAlertMultiplier struct {
	integrationGetter DNRIntegrationGetter
}

func newDNRAlertMultiplier(integrationGetter DNRIntegrationGetter) multiplier {
