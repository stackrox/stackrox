...
import (
	...
	mappings "github.com/stackrox/stackrox/central/imagecomponentedge/mappings"
...
func (b *indexerImpl) Count(q *v1.Query, opts ...blevesearch.SearchOption) (int, error) {
	...
	return postgres.RunCountRequest(v1.SearchCategory_IMAGE_COMPONENT_EDGE, q, b.db, mappings.OptionsMap)
}

func (b *indexerImpl) Search(q *v1.Query, opts ...blevesearch.SearchOption) ([]search.Result, error) {
	defer metrics.SetIndexOperationDurationTime(time.Now(), ops.Search, "ImageComponentEdge")

	return postgres.RunSearchRequest(v1.SearchCategory_IMAGE_COMPONENT_EDGE, q, b.db, mappings.OptionsMap)
}
