...
func (b *storeImpl) Exists(_ context.Context, id string, _ string, _ string, _ string, _ string, _ string) (bool, error) {
...
func (b *storeImpl) Get(_ context.Context, id string, _ string, _ string, _ string, _ string, _ string) (cve *storage.ImageComponentEdge, exists bool, err error) {
