...
func (ds *searcherImplV2) resultsToEdges(ctx context.Context, results []search.Result) ([]*storage.ImageComponentEdge, []int, error) {
...
func convertOne(obj *storage.ImageComponentEdge, result *search.Result) *v1.SearchResult {
