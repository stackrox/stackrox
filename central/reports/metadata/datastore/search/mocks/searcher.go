...
func (m *MockSearcher) SearchReportMetadatas(arg0 context.Context, arg1 *v1.Query) ([]*storage.ReportMetadata, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchReportMetadatas", arg0, arg1)
...
func (mr *MockSearcherMockRecorder) SearchReportMetadatas(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchReportMetadatas", reflect.TypeOf((*MockSearcher)(nil).SearchReportMetadatas), arg0, arg1)
}
