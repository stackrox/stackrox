...
func (m *MockStore) Get(ctx context.Context, id string) (*storage.ReportMetadata, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetMany(ctx context.Context, ids []string) ([]*storage.ReportMetadata, []int, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Upsert(arg0 context.Context, arg1 *storage.ReportMetadata) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) Walk(ctx context.Context, fn func(*storage.ReportMetadata) error) error {
	m.ctrl.T.Helper()
