...
func insertIntoReportConfigurationsNotifiers(ctx context.Context, batch *pgx.Batch, obj *storage.NotifierConfiguration, reportConfigurationID string, idx int) error {
