...
func (m *MockSearcher) SearchReportSnapshots(arg0 context.Context, arg1 *v1.Query) ([]*storage.ReportSnapshot, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchReportSnapshots", arg0, arg1)
...
func (mr *MockSearcherMockRecorder) SearchReportSnapshots(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchReportSnapshots", reflect.TypeOf((*MockSearcher)(nil).SearchReportSnapshots), arg0, arg1)
}
