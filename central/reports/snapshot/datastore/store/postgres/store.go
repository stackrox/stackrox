...
type storeImpl struct {
	*pgSearch.GenericSingleIDStore[storage.ReportSnapshot, *storage.ReportSnapshot]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		GenericSingleIDStore: pgSearch.NewGenericSingleIDStore[storage.ReportSnapshot, *storage.ReportSnapshot](
			db,
			"ReportSnapshot",
			targetResource,
			schema,
