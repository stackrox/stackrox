...
func (rg *reportGeneratorImpl) generateReportAndNotify(req *ReportRequest) error {
	...
	zippedCSVData, err := GenerateCSV(reportData.CVEResponses, req.ReportSnapshot.Name, req.ReportSnapshot.GetVulnReportFilters(), req.ReportSnapshot.GetOptionalColumns())
	if err != nil {
		return err
	}
