...
func (s *ConversionTestSuite) TestReportConfigurationRoundTrip() {
	...
	protoConfig := s.service.convertV2ReportConfigurationToProto(v2Config, creator, accessScopeRules)
...
func (s *ConversionTestSuite) TestResourceScopeConversions() {
	...
	protoScope := s.service.convertV2ResourceScopeToProto(v2Scope)
...
func (s *ConversionTestSuite) TestEmptyResourceScope() {
	result := s.service.convertV2ResourceScopeToProto(nil)
	assert.Nil(s.T(), result)
...
func (s *ConversionTestSuite) TestReportConfigurationWithoutNotifiers() {
	...
	protoConfig := s.service.convertV2ReportConfigurationToProto(v2Config, creator, nil)
	assert.NotNil(s.T(), protoConfig)
