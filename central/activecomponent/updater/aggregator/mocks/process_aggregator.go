...
import (
	...
	aggregator "github.com/stackrox/stackrox/central/activecomponent/updater/aggregator"
...
func (mr *MockProcessAggregatorMockRecorder) Add(indicators interface{}) *gomock.Call {
...
func (mr *MockProcessAggregatorMockRecorder) GetAndPrune(imageScanned, deploymentIDSet interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockProcessAggregatorMockRecorder) RefreshDeployment(deployment interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
