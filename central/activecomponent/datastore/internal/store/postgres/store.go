...
func (s *storeImpl) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.ActiveComponent, error) {
	...
	rows, err := pgSearch.RunGetManyQueryForSchema[storage.ActiveComponent](ctx, schema, query, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.ActiveComponent, []int, error) {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ActiveComponent) error) error {
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.ActiveComponent](ctx, schema, search.EmptyQuery(), s.db)
	if err != nil {
		return err
	}
	defer closer()
