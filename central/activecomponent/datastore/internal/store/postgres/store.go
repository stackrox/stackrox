...
func dropTableActiveComponents(ctx context.Context, db *postgres.Postgres) {
	_, _ = db.Exec(ctx, "DROP TABLE IF EXISTS active_components CASCADE")
	dropTableActiveComponentsActiveContextsSlices(ctx, db)

}

func dropTableActiveComponentsActiveContextsSlices(ctx context.Context, db *postgres.Postgres) {
