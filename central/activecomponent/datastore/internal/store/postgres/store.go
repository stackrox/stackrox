...
type storeImpl struct {
	*pgSearch.GenericSingleIDStore[storage.ActiveComponent, *storage.ActiveComponent]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		GenericSingleIDStore: pgSearch.NewGenericSingleIDStore[storage.ActiveComponent, *storage.ActiveComponent](
			db,
			"ActiveComponent",
			targetResource,
			schema,
