...
func TestShouldUpsert(t *testing.T) {
	...
	tcs := []struct {
		...
		{
			"always upsert manaul and integration with no source",
			set.NewSet("NoAutogen-GlobalPull", "NoAutogen-NoSource", "NoAutogen-Source", "Autogen-NoSource"),
			false, false,
		},
		{
			"upsert all integrations when sourced feature enabled",
			set.NewSet("NoAutogen-GlobalPull", "NoAutogen-NoSource", "NoAutogen-Source", "Autogen-GlobalPull", "Autogen-NoSource", "Autogen-Source"),
			true, false,
		},
		{
		...
		{
			"upsert manual and only global integrations when sourced feature disabled and global pull enabled",
			set.NewSet("NoAutogen-GlobalPull", "NoAutogen-NoSource", "NoAutogen-Source", "Autogen-NoSource", "Autogen-GlobalPull"),
			false, true,
		},
	}
	for _, tc := range tcs {
