...
func TestShouldUpsert(t *testing.T) {
	iis := []*storage.ImageIntegration{
		storage.ImageIntegration_builder{Id: "Manual-GlobalPull", Autogenerated: false, Source: storage.ImageIntegration_Source_builder{Namespace: openshift.GlobalPullSecretNamespace, ImagePullSecretName: openshift.GlobalPullSecretName}.Build()}.Build(),
		storage.ImageIntegration_builder{Id: "Manual-NoSource", Autogenerated: false, Source: nil}.Build(),
		storage.ImageIntegration_builder{Id: "Manual-Source", Autogenerated: false, Source: &storage.ImageIntegration_Source{}}.Build(),
