...
func (m *MockSearcher) SearchImageComponents(arg0 context.Context, arg1 *v1.Query) ([]*v1.SearchResult, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSearcherMockRecorder) SearchImageComponents(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockSearcher) SearchRawImageComponents(ctx context.Context, query *v1.Query) ([]*storage.ImageComponent, error) {
	m.ctrl.T.Helper()
...
func (mr *MockSearcherMockRecorder) SearchRawImageComponents(ctx, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
