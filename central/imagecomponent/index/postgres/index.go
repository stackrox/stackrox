...
const table = "ImageComponent"

func init() {
	mapping.RegisterCategoryToTable(v1.SearchCategory_IMAGE_COMPONENTS, table)
}
...
func (b *indexerImpl) Count(q *v1.Query, opts ...blevesearch.SearchOption) (int, error) {
	...
	return postgres.RunCountRequest(v1.SearchCategory_IMAGE_COMPONENTS, q, b.db, mappings.OptionsMap)
}

func (b *indexerImpl) Search(q *v1.Query, opts ...blevesearch.SearchOption) ([]search.Result, error) {
	defer metrics.SetIndexOperationDurationTime(time.Now(), ops.Search, "ImageComponent")
	return postgres.RunSearchRequest(v1.SearchCategory_IMAGE_COMPONENTS, q, b.db, mappings.OptionsMap)
}
