...
func (m *MockDataStore) Get(ctx context.Context, id string) (*storage.ImageComponentV2, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, id)
	ret0, _ := ret[0].(*storage.ImageComponentV2)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
...
func (m *MockDataStore) GetBatch(ctx context.Context, id []string) ([]*storage.ImageComponentV2, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) SearchImageComponents(ctx, q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockDataStore) SearchRawImageComponents(ctx context.Context, q *v1.Query) ([]*storage.ImageComponentV2, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) SearchRawImageComponents(ctx, q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
