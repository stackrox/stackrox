...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.Notifier, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.Notifier](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.Notifier) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[storage.Notifier](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
