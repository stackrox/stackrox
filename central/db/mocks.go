...
// MockDNRIntegrationStorage is an autogenerated mock type for the DNRIntegrationStorage type
type MockDNRIntegrationStorage struct {
	mock.Mock
}

// AddDNRIntegration provides a mock function with given fields: integration
func (_m *MockDNRIntegrationStorage) AddDNRIntegration(integration *v1.DNRIntegration) (string, error) {
...
func (_m *MockDNRIntegrationStorage) GetDNRIntegration(id string) (*v1.DNRIntegration, bool, error) {
	ret := _m.Called(id)
...
func (_m *MockDNRIntegrationStorage) GetDNRIntegrations(request *v1.GetDNRIntegrationsRequest) ([]*v1.DNRIntegration, error) {
...
func (_m *MockDNRIntegrationStorage) RemoveDNRIntegration(id string) error {
	ret := _m.Called(id)
...
func (_m *MockDNRIntegrationStorage) UpdateDNRIntegration(integration *v1.DNRIntegration) error {
	ret := _m.Called(integration)
