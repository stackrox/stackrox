...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.NetworkGraphConfig, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.NetworkGraphConfig](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.NetworkGraphConfig, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.NetworkGraphConfig](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.NetworkGraphConfig) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[storage.NetworkGraphConfig](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
