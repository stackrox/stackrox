...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.NetworkGraphConfig, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.NetworkGraphConfig](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.NetworkGraphConfig, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.NetworkGraphConfig](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.NetworkGraphConfig) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchema[storage.NetworkGraphConfig](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
