...
func (mr *MockManagerMockRecorder) CreateDefaultNetworkTree(ctx interface{}) *gomock.Call {
...
func (mr *MockManagerMockRecorder) CreateNetworkTree(ctx, clusterID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagerMockRecorder) DeleteNetworkTree(ctx, clusterID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagerMockRecorder) GetDefaultNetworkTree(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagerMockRecorder) GetNetworkTree(ctx, clusterID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagerMockRecorder) GetReadOnlyNetworkTree(ctx, clusterID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockManagerMockRecorder) Initialize(entitiesByCluster interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
