...
func (m *MockEntityStore) Walk(ctx context.Context, fn func(*storage.NetworkEntity) error, useClones bool) error {
	m.ctrl.T.Helper()
...
func (mr *MockEntityStoreMockRecorder) Walk(ctx, fn, useClones any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Walk", reflect.TypeOf((*MockEntityStore)(nil).Walk), ctx, fn, useClones)
}
