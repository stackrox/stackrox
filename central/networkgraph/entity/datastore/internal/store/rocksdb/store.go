...
func (b *storeImpl) GetMany(_ context.Context, ids []string) ([]*storage.NetworkEntity, []int, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.NetworkEntity) error {
