...
const createTableQuery = "create table if not exists networkentity (id varchar primary key, value jsonb)"
...
func (s *storeImpl) Get(id string) (*storage.NetworkEntity, bool, error) {
	...
	log.Infof("Took %d to query a NetworkEntity", time.Since(t).Milliseconds())
	...
	log.Infof("Took %d to scan a NetworkEntity", time.Since(t).Milliseconds())
	...
	log.Infof("Took %d to unmarshal a NetworkEntity", time.Since(t).Milliseconds())
