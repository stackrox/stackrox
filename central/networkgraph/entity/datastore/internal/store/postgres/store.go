...
//value of singlePK
//{0xc00074e480 Id {false GetInfo().GetId()} Info_Id  string string varchar {false  true false false} {  false false false false}}
...
func (s *storeImpl) copyIntoNetworkentity(ctx context.Context, tx pgx.Tx, objs ...*storage.NetworkEntity) error {
	...
	lowerTable := strings.ToLower("networkentity")
...
func (s *storeImpl) copyIntoNetworkentityListenPorts(ctx context.Context, tx pgx.Tx, networkentity_Id string, objs ...*storage.NetworkEntityInfo_Deployment_ListenPort) error {
	...
	lowerTable := strings.ToLower("networkentity_ListenPorts")
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.NetworkEntity, []int, error) {
	...
	for rows.Next() {
		...
		foundSet[msg.GetInfo().GetId()] = struct{}{}
