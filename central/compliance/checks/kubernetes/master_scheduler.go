...
func init() {
	framework.MustRegisterChecks(
		masterSchedulerCommandLine("CIS_Kubernetes_v1_4_1:1_2_1", "profiling", "false", "true", common.Matches),
		masterSchedulerCommandLine("CIS_Kubernetes_v1_4_1:1_2_2", "address", "127.0.0.1", "127.0.0.1", common.Matches),
	)
}
