...
func init() {
	framework.MustRegisterChecks(
		...
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_5", "insecure-bind-address", "", "", common.Unset),
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_6", "insecure-port", "0", "0", common.Matches),
		...
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_11", "enable-admission-plugins", "AlwaysPullImages", "", common.Contains),
		...
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_13", "enable-admission-plugins", "SecurityContextDeny", "", common.Contains),
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_14", "disable-admission-plugins", "NamespaceLifecycle", "NamespaceLifecycle", common.NotContains),
		...
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_23", "service-account-lookup", "true", "true", common.Matches),
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_24", "enable-admission-plugins", "PodSecurityPolicy", "", common.Contains),
		...
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_27", "disable-admission-plugins", "ServiceAccount", "ServiceAccount", common.NotContains),
		...
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_32", "authorization-mode", "Node", "Node", common.Contains),
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_33", "enable-admission-plugins", "NodeRestriction", "", common.Contains),
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_34", "encryption-provider-config", "", "", common.Set),
		encryptionProvider(),
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_36", "enable-admission-plugins", "EventRateLimit", "", common.Contains),
		...
		masterAPIServerCommandLine("CIS_Kubernetes_v1_4_1:1_1_39", "authorization-mode", "RBAC", "RBAC", common.Set),
	)
}
