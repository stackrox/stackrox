...
inbound and outbound traffic. Therefore, if every deployment has both outbound
(egress) Network Policies that apply to it, it can be considered compliant, so
