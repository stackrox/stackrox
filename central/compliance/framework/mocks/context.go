...
func (mr *MockComplianceContextMockRecorder) Finalize(err interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockComplianceContextMockRecorder) ForObject(target interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockComplianceContextMockRecorder) RecordEvidence(status, message interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
