...
func (mr *MockDeploymentObservationQueueMockRecorder) InObservation(deploymentID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDeploymentObservationQueueMockRecorder) RemoveFromObservation(deploymentID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
