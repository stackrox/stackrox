...
func insertIntoDeploymentsContainers(ctx context.Context, batch *pgx.Batch, obj *storage.Container, deployments_Id string, idx int) error {
	...
	for childIdx, child := range obj.GetConfig().GetEnv() {
		if err := insertIntoDeploymentsContainersEnvs(ctx, batch, child, deployments_Id, idx, childIdx); err != nil {
			return err
		}
	}
...
func insertIntoDeploymentsPorts(ctx context.Context, batch *pgx.Batch, obj *storage.PortConfig, deployments_Id string, idx int) error {
	...
	for childIdx, child := range obj.GetExposureInfos() {
		if err := insertIntoDeploymentsPortsExposureInfos(ctx, batch, child, deployments_Id, idx, childIdx); err != nil {
			return err
		}
	}
...
func dropTableDeployments(ctx context.Context, db *postgres.Postgres) {
...
func dropTableDeploymentsContainers(ctx context.Context, db *postgres.Postgres) {
...
func dropTableDeploymentsContainersEnvs(ctx context.Context, db *postgres.Postgres) {
	_, _ = db.Exec(ctx, "DROP TABLE IF EXISTS deployments_containers_envs CASCADE")

}

func dropTableDeploymentsContainersVolumes(ctx context.Context, db *postgres.Postgres) {
	_, _ = db.Exec(ctx, "DROP TABLE IF EXISTS deployments_containers_volumes CASCADE")

}

func dropTableDeploymentsContainersSecrets(ctx context.Context, db *postgres.Postgres) {
	_, _ = db.Exec(ctx, "DROP TABLE IF EXISTS deployments_containers_secrets CASCADE")

}

func dropTableDeploymentsPorts(ctx context.Context, db *postgres.Postgres) {
	_, _ = db.Exec(ctx, "DROP TABLE IF EXISTS deployments_ports CASCADE")
	dropTableDeploymentsPortsExposureInfos(ctx, db)

}

func dropTableDeploymentsPortsExposureInfos(ctx context.Context, db *postgres.Postgres) {
