...
func (s *storeImpl) Get(id string) (*storage.Deployment, bool, error) {
	...
	log.Infof("Took %d to query a Deployment", time.Since(t).Milliseconds())
	...
	log.Infof("Took %d to scan a Deployment", time.Since(t).Milliseconds())
	...
	log.Infof("Took %d to unmarshal a Deployment", time.Since(t).Milliseconds())
