...
func (suite *DeploymentDataStoreTestSuite) TestInitializeRanker() {
	...
	ds := newDatastoreImpl(suite.storage, nil, nil, nil, nil, nil, suite.riskStore, nil, suite.filter, clusterRanker, nsRanker, deploymentRanker, suite.matcher)
...
func (suite *DeploymentDataStoreTestSuite) TestMergeCronJobs() {
	ds := newDatastoreImpl(suite.storage, nil, nil, nil, nil, nil, suite.riskStore, nil, suite.filter, nil, nil, nil, suite.matcher)
...
func (suite *DeploymentDataStoreTestSuite) TestUpsert_PlatformComponentAssignment() {
	...
	ds := newDatastoreImpl(suite.storage, nil, nil, nil, nil, nil, suite.riskStore, nil, suite.filter, nil, nil, ranking.NewRanker(), suite.matcher)
	ctx := sac.WithAllAccess(context.Background())
