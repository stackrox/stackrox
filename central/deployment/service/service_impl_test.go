...
func setupPostgresDatastore(t *testing.T) (datastore.DataStore, func()) {
	...
	ds, err := datastore.New(pool, nil, nil, nil, nil, riskDataStore, nil, nil, ranking.NewRanker(), ranking.NewRanker(), ranking.NewRanker(), platformmatcher.GetTestPlatformMatcherWithDefaultPlatformComponentConfig(mockCtrl))
