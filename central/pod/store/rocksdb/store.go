...
func (b *storeImpl) GetMany(_ context.Context, ids []string) ([]*storage.Pod, []int, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.Pod) error {
...
func (b *storeImpl) Walk(ctx context.Context, fn func(obj *storage.Pod) error) error {
