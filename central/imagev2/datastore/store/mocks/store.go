...
func (m *MockStore) Get(ctx context.Context, id string) (*storage.ImageV2, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetByIDs(ctx context.Context, ids []string) ([]*storage.ImageV2, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetImageMetadata(ctx context.Context, id string) (*storage.ImageV2, bool, error) {
	m.ctrl.T.Helper()
...
// GetImagesIdAndDigestView mocks base method.
func (m *MockStore) GetImagesIdAndDigestView(ctx context.Context, q *v1.Query) ([]*views.ImageIDAndDigestView, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetImagesIdAndDigestView", ctx, q)
	ret0, _ := ret[0].([]*views.ImageIDAndDigestView)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetImagesIdAndDigestView indicates an expected call of GetImagesIdAndDigestView.
func (mr *MockStoreMockRecorder) GetImagesIdAndDigestView(ctx, q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetImagesIdAndDigestView", reflect.TypeOf((*MockStore)(nil).GetImagesIdAndDigestView), ctx, q)
}

// GetImagesRiskView mocks base method.
func (m *MockStore) GetImagesRiskView(ctx context.Context, q *v1.Query) ([]*views.ImageV2RiskView, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetImagesRiskView", ctx, q)
	ret0, _ := ret[0].([]*views.ImageV2RiskView)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) Upsert(ctx context.Context, image *storage.ImageV2) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) WalkByQuery(ctx context.Context, q *v1.Query, fn func(*storage.ImageV2) error) error {
	m.ctrl.T.Helper()
