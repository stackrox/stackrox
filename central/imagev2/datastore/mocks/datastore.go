...
func (m *MockDataStore) GetImage(ctx context.Context, id string) (*storage.ImageV2, bool, error) {
	m.ctrl.T.Helper()
...
// GetImageNamesWithDigest mocks base method.
func (m *MockDataStore) GetImageNamesWithDigest(ctx context.Context, digest string) ([]*storage.ImageName, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetImageNamesWithDigest", ctx, digest)
	ret0, _ := ret[0].([]*storage.ImageName)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetImageNamesWithDigest indicates an expected call of GetImageNamesWithDigest.
func (mr *MockDataStoreMockRecorder) GetImageNamesWithDigest(ctx, digest any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetImageNamesWithDigest", reflect.TypeOf((*MockDataStore)(nil).GetImageNamesWithDigest), ctx, digest)
}

// GetImagesBatch mocks base method.
func (m *MockDataStore) GetImagesBatch(ctx context.Context, ids []string) ([]*storage.ImageV2, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetImagesBatch", ctx, ids)
	ret0, _ := ret[0].([]*storage.ImageV2)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDataStoreMockRecorder) GetImagesBatch(ctx, ids any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetImagesBatch", reflect.TypeOf((*MockDataStore)(nil).GetImagesBatch), ctx, ids)
}

// GetManyImageMetadata mocks base method.
func (m *MockDataStore) GetManyImageMetadata(ctx context.Context, ids []string) ([]*storage.ImageV2, error) {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) UpsertImage(ctx context.Context, image *storage.ImageV2) error {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) WalkByQuery(ctx context.Context, q *v1.Query, fn func(*storage.ImageV2) error) error {
	m.ctrl.T.Helper()
