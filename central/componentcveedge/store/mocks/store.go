...
func (m *MockStore) Get(ctx context.Context, id string) (*storage.ComponentCVEEdge, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetByQueryFn(ctx context.Context, query *v1.Query, fn func(*storage.ComponentCVEEdge) error) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetMany(ctx context.Context, ids []string) ([]*storage.ComponentCVEEdge, []int, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) WalkByQuery(ctx context.Context, query *v1.Query, fn func(*storage.ComponentCVEEdge) error) error {
	m.ctrl.T.Helper()
