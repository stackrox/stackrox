...
func (mr *MockDataStoreMockRecorder) UpsertMany(ctx, cve any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpsertMany", reflect.TypeOf((*MockDataStore)(nil).UpsertMany), ctx, cve)
}
