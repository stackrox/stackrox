...
func (m *MockIndexer) AddCVE(cve *storage.CVE) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddCVE", cve)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddCVE indicates an expected call of AddCVE.
func (mr *MockIndexerMockRecorder) AddCVE(cve interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddCVE", reflect.TypeOf((*MockIndexer)(nil).AddCVE), cve)
}

// AddCVEs mocks base method.
func (m *MockIndexer) AddCVEs(cves []*storage.CVE) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddCVEs", cves)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddCVEs indicates an expected call of AddCVEs.
func (mr *MockIndexerMockRecorder) AddCVEs(cves interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddCVEs", reflect.TypeOf((*MockIndexer)(nil).AddCVEs), cves)
}
...
func (m *MockIndexer) DeleteCVE(id string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteCVE", id)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteCVE indicates an expected call of DeleteCVE.
func (mr *MockIndexerMockRecorder) DeleteCVE(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteCVE", reflect.TypeOf((*MockIndexer)(nil).DeleteCVE), id)
}

// DeleteCVEs mocks base method.
func (m *MockIndexer) DeleteCVEs(ids []string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteCVEs", ids)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteCVEs indicates an expected call of DeleteCVEs.
func (mr *MockIndexerMockRecorder) DeleteCVEs(ids interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteCVEs", reflect.TypeOf((*MockIndexer)(nil).DeleteCVEs), ids)
}
