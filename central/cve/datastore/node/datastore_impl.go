...
func (ds *datastoreImpl) Delete(_ context.Context, _ ...string) error {
	return errors.New("node vulnerabilities can be deleted only when all associated images are removed")
}
