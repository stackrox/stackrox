...
func (m *MockStore) Get(ctx context.Context, id string) (*storage.NodeCVE, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpsertMany(ctx context.Context, cves []*storage.NodeCVE) error {
	m.ctrl.T.Helper()
