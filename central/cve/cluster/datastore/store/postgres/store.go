...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ClusterCVE, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.ClusterCVE](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.ClusterCVE, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.ClusterCVE](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ClusterCVE) error) error {
	var sacQueryFilter *v1.Query
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[storage.ClusterCVE](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
