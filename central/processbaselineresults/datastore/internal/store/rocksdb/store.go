...
func (b *storeImpl) GetMany(_ context.Context, ids []string) ([]*storage.ProcessBaselineResults, []int, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.ProcessBaselineResults) error {
...
func (b *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ProcessBaselineResults) error) error {
