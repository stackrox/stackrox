...
const (
	...
	existsStmt = "SELECT EXISTS(SELECT 1 FROM ProcessBaselineResults WHERE )"

	getStmt    = "SELECT serialized FROM ProcessBaselineResults WHERE "
	deleteStmt = "DELETE FROM ProcessBaselineResults WHERE "
...
type Store interface {
	Count() (int, error)
	Exists() (bool, error)
	Get() (*storage.ProcessBaselineResults, bool, error)
...
func (s *storeImpl) Get() (*storage.ProcessBaselineResults, bool, error) {
...
func (s *storeImpl) Upsert(obj0 *storage.ProcessBaselineResults) error {
