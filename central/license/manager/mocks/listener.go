...
func (mr *MockLicenseEventListenerMockRecorder) OnInitialize(mgr, initialLicense interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnInitialize", reflect.TypeOf((*MockLicenseEventListener)(nil).OnInitialize), mgr, initialLicense)
}

// OnActiveLicenseChanged mocks base method
func (m *MockLicenseEventListener) OnActiveLicenseChanged(newLicense, oldLicense *v1.LicenseInfo) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "OnActiveLicenseChanged", newLicense, oldLicense)
}

// OnActiveLicenseChanged indicates an expected call of OnActiveLicenseChanged
func (mr *MockLicenseEventListenerMockRecorder) OnActiveLicenseChanged(newLicense, oldLicense interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnActiveLicenseChanged", reflect.TypeOf((*MockLicenseEventListener)(nil).OnActiveLicenseChanged), newLicense, oldLicense)
}
