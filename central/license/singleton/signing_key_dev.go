...
func init() {
	utils.Must(
		...
		// OLD VERSION - NO LONGER USED FOR LICENSES
		validatorInstance.RegisterSigningKey(
			validator.EC256,
			// projects/stackrox-dev/locations/us-west2/keyRings/licensing-dev/cryptoKeys/dev-license/cryptoKeyVersions/2
			[]byte{
				0x30, 0x59, 0x30, 0x13, 0x06, 0x07, 0x2a, 0x86, 0x48, 0xce, 0x3d, 0x02,
				0x01, 0x06, 0x08, 0x2a, 0x86, 0x48, 0xce, 0x3d, 0x03, 0x01, 0x07, 0x03,
			...
			validator.SigningKeyRestrictions{
				...
				LatestNotValidAfter:                     timeutil.MustParse(time.RFC3339, "2019-07-02T00:00:00Z"),
				MaxDuration:                             30 * 24 * time.Hour,
				AllowOffline:                            true,
				MaxNodeLimit:                            50,
				BuildFlavors:                            []string{"development"},
