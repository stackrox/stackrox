...
func (s *alertDataStoreTestSuite) SetupTest() {
	...
	s.storage.EXPECT().GetKeysToIndex(ctx.Any()).Return(nil, nil)
...
func (s *alertDataStoreTestSuite) TestAddAlert() {
	...
	s.storage.EXPECT().Upsert(ctx.Any(), fakeAlert).Return(nil)
...
func (s *alertDataStoreTestSuite) TestAddAlertWhenTheIndexerFails() {
	fakeAlert := alerttest.NewFakeAlert()
	s.storage.EXPECT().Upsert(ctx.Any(), fakeAlert).Return(errFake)
...
func (s *alertDataStoreTestSuite) TestMarkAlertStale() {
	...
	s.storage.EXPECT().Get(ctx.Any(), alerttest.FakeAlertID).Return(fakeAlert, true, nil)
	s.storage.EXPECT().Upsert(ctx.Any(), gomock.Any()).Return(nil)
	s.indexer.EXPECT().AddListAlert(gomock.Any()).Return(nil)
	s.storage.EXPECT().AckKeysIndexed(ctx.Any(), fakeAlert.GetId()).Times(1).Return(nil)
...
func (s *alertDataStoreTestSuite) TestMarkAlertStaleWhenStorageFails() {
	...
	s.storage.EXPECT().Get(ctx.Any(), alerttest.FakeAlertID).Return(fakeAlert, false, errFake)
...
func (s *alertDataStoreTestSuite) TestMarkAlertStaleWhenTheAlertWasNotFoundInStorage() {
	...
	s.storage.EXPECT().Get(ctx.Any(), alerttest.FakeAlertID).Return(fakeAlert, false, nil)
...
func (s *alertDataStoreWithSACTestSuite) TestAddAlertEnforced() {
	s.storage.EXPECT().Upsert(ctx.Any(), alerttest.NewFakeAlert()).Times(0)
...
func (s *alertDataStoreWithSACTestSuite) TestMarkAlertStaleEnforced() {
	...
	s.storage.EXPECT().Get(ctx.Any(), alerttest.FakeAlertID).Return(fakeAlert, true, nil)
	s.storage.EXPECT().Upsert(ctx.Any(), gomock.Any()).Times(0)
...
func (s *alertDataStoreTestSuite) TestAlertAccessControl() {
	fakeAlert := alerttest.NewFakeAlert()
	s.storage.EXPECT().Get(ctx.Any(), alerttest.FakeAlertID).Return(fakeAlert, true, nil).AnyTimes()
...
func (s *alertDataStoreWithSACTestSuite) TestAddAlertTagsAllowed() {
	...
	s.storage.EXPECT().Get(ctx.Any(), alerttest.FakeAlertID).Return(fakeAlertWithNoTags, true, nil)
	fakeAlertWithTwoTags := alerttest.NewFakeAlertWithTwoTags()
	s.storage.EXPECT().Upsert(ctx.Any(), fakeAlertWithTwoTags).Return(nil)
	s.indexer.EXPECT().AddListAlert(fillSortHelperFields(convert.AlertToListAlert(fakeAlertWithTwoTags))).Return(nil)
	s.storage.EXPECT().AckKeysIndexed(ctx.Any(), fakeAlertWithTwoTags.GetId()).Return(nil)
...
func (s *alertDataStoreWithSACTestSuite) TestAddAlertTagsAllowed2() {
	fakeAlertWithTwoTags := alerttest.NewFakeAlertWithTwoTags()
	s.storage.EXPECT().Get(ctx.Any(), alerttest.FakeAlertID).Return(fakeAlertWithTwoTags, true, nil)
	fakeAlertWithThreeTags := alerttest.NewFakeAlertWithThreeTags()
	s.storage.EXPECT().Upsert(ctx.Any(), fakeAlertWithThreeTags).Return(nil)
	s.indexer.EXPECT().AddListAlert(fillSortHelperFields(convert.AlertToListAlert(fakeAlertWithThreeTags))).Return(nil)
	s.storage.EXPECT().AckKeysIndexed(ctx.Any(), fakeAlertWithThreeTags.GetId()).Return(nil)
...
func (s *alertDataStoreWithSACTestSuite) TestRemoveAlertTagsAllowed() {
	...
	s.storage.EXPECT().Get(ctx.Any(), alerttest.FakeAlertID).Return(fakeAlertWithTwoTags, true, nil)
	fakeAlertWithNoTags := alerttest.NewFakeAlert()
	s.storage.EXPECT().Upsert(ctx.Any(), fakeAlertWithNoTags).Return(nil)
	s.indexer.EXPECT().AddListAlert(fillSortHelperFields(convert.AlertToListAlert(fakeAlertWithNoTags))).Return(nil)
	s.storage.EXPECT().AckKeysIndexed(ctx.Any(), fakeAlertWithNoTags.GetId()).Return(nil)
...
func (s *alertDataStoreWithSACTestSuite) TestRemoveAlertTagsAllowed2() {
	fakeAlertWithThreeTags := alerttest.NewFakeAlertWithThreeTags()
	s.storage.EXPECT().Get(ctx.Any(), alerttest.FakeAlertID).Return(fakeAlertWithThreeTags, true, nil)
	fakeAlertWithOneTag := alerttest.NewFakeAlertWithOneTag()
	s.storage.EXPECT().Upsert(ctx.Any(), fakeAlertWithOneTag).Return(nil)
	s.indexer.EXPECT().AddListAlert(fillSortHelperFields(convert.AlertToListAlert(fakeAlertWithOneTag))).Return(nil)
	s.storage.EXPECT().AckKeysIndexed(ctx.Any(), fakeAlertWithOneTag.GetId()).Return(nil)
...
func (suite *AlertReindexSuite) TestReconciliationFullReindex() {
	...
	suite.storage.EXPECT().GetIDs(ctx.Any()).Return([]string{"A", "B"}, nil)
	suite.storage.EXPECT().GetListAlerts(ctx.Any(), []string{"A", "B"}).Return(listAlerts, nil, nil)
	suite.indexer.EXPECT().AddListAlerts(listAlerts).Return(nil)

	suite.storage.EXPECT().GetKeysToIndex(ctx.Any()).Return([]string{"D", "E"}, nil)
	suite.storage.EXPECT().AckKeysIndexed(ctx.Any(), []string{"D", "E"}).Return(nil)
...
func (suite *AlertReindexSuite) TestReconciliationPartialReindex() {
	suite.storage.EXPECT().GetKeysToIndex(ctx.Any()).Return([]string{"A", "B", "C"}, nil)
	...
	suite.storage.EXPECT().GetListAlerts(ctx.Any(), []string{"A", "B", "C"}).Return(listAlerts, nil, nil)
	suite.indexer.EXPECT().AddListAlerts(listAlerts).Return(nil)
	...
	suite.storage.EXPECT().GetListAlerts(ctx.Any(), []string{"A", "B", "C"}).Return(listAlerts, []int{2}, nil)
	suite.indexer.EXPECT().AddListAlerts(listAlerts).Return(nil)
