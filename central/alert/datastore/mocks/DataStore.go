...
func (_m *DataStore) SearchAlerts(q *v1.Query) ([]*v1.SearchResult, error) {
	ret := _m.Called(q)
...
func (_m *DataStore) SearchListAlerts(q *v1.Query) ([]*v1.ListAlert, error) {
	ret := _m.Called(q)
...
func (_m *DataStore) SearchRawAlerts(q *v1.Query) ([]*v1.Alert, error) {
	ret := _m.Called(q)
