...
// Source: central/alert/datastore/datastore.go
//
// Generated by this command:
//
//	mockgen -package mocks -destination central/alert/datastore/mocks/datastore.go -source central/alert/datastore/datastore.go
//
