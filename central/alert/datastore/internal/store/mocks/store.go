...
func (mr *MockStoreMockRecorder) Upsert(ctx, alert any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) UpsertMany(ctx, alerts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpsertMany", reflect.TypeOf((*MockStore)(nil).UpsertMany), ctx, alerts)
}

// Walk mocks base method.
func (m *MockStore) Walk(ctx context.Context, fn func(*storage.Alert) error, useClones bool) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) WalkByQuery(ctx context.Context, q *v1.Query, fn func(*storage.Alert) error) error {
	m.ctrl.T.Helper()
