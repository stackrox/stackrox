...
func (b *indexerImpl) Count(ctx context.Context, q *v1.Query, opts ...blevesearch.SearchOption) (int, error) {
	...
	return postgres.RunCountRequest(ctx, v1.SearchCategory_ALERTS, q, b.db)
}
...
func (b *indexerImpl) Search(ctx context.Context, q *v1.Query, opts ...blevesearch.SearchOption) ([]search.Result, error) {
	...
	return postgres.RunSearchRequest(ctx, v1.SearchCategory_ALERTS, q, b.db)
}

//// Stubs for satisfying interfaces

func (b *indexerImpl) AddAlert(deployment *storage.Alert) error {
	return nil
}

func (b *indexerImpl) AddAlerts(_ []*storage.Alert) error {
	return nil
}
...
func (b *indexerImpl) DeleteAlerts(_ []string) error {
	return nil
}
