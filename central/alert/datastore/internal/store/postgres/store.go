...
const (
	...
	getWithRollupStmt = "select row_to_json((select record from (select table0.Id as Id, table0.Policy_Id as Policy_Id, table0.Policy_Name as Policy_Name, table0.Policy_Description as Policy_Description, table0.Policy_Rationale as Policy_Rationale, table0.Policy_Remediation as Policy_Remediation, table0.Policy_Disabled as Policy_Disabled, table0.Policy_Categories as Policy_Categories, table0.Policy_LifecycleStages as Policy_LifecycleStages, table0.Policy_EventSource as Policy_EventSource, table0.Policy_Severity as Policy_Severity, table0.Policy_EnforcementActions as Policy_EnforcementActions, table0.Policy_Notifiers as Policy_Notifiers, table0.Policy_LastUpdated as Policy_LastUpdated, table0.Policy_SORTName as Policy_SORTName, table0.Policy_SORTLifecycleStage as Policy_SORTLifecycleStage, table0.Policy_SORTEnforcement as Policy_SORTEnforcement, table0.Policy_PolicyVersion as Policy_PolicyVersion, table0.Policy_CriteriaLocked as Policy_CriteriaLocked, table0.Policy_MitreVectorsLocked as Policy_MitreVectorsLocked, table0.Policy_IsDefault as Policy_IsDefault, table0.LifecycleStage as LifecycleStage, table0.Deployment_Id as Deployment_Id, table0.Deployment_Name as Deployment_Name, table0.Deployment_Type as Deployment_Type, table0.Deployment_Namespace as Deployment_Namespace, table0.Deployment_NamespaceId as Deployment_NamespaceId, table0.Deployment_Labels as Deployment_Labels, table0.Deployment_ClusterId as Deployment_ClusterId, table0.Deployment_ClusterName as Deployment_ClusterName, table0.Deployment_Annotations as Deployment_Annotations, table0.Deployment_Inactive as Deployment_Inactive, table0.Image_Id as Image_Id, table0.Image_Name_Registry as Image_Name_Registry, table0.Image_Name_Remote as Image_Name_Remote, table0.Image_Name_Tag as Image_Name_Tag, table0.Image_Name_FullName as Image_Name_FullName, table0.Image_NotPullable as Image_NotPullable, table0.Image_IsClusterLocal as Image_IsClusterLocal, table0.Resource_ResourceType as Resource_ResourceType, table0.Resource_Name as Resource_Name, table0.Resource_ClusterId as Resource_ClusterId, table0.Resource_ClusterName as Resource_ClusterName, table0.Resource_Namespace as Resource_Namespace, table0.Resource_NamespaceId as Resource_NamespaceId, table0.ProcessViolation_Message as ProcessViolation_Message, table0.Enforcement_Action as Enforcement_Action, table0.Enforcement_Message as Enforcement_Message, table0.Time as Time, table0.FirstOccurred as FirstOccurred, table0.ResolvedAt as ResolvedAt, table0.State as State, table0.SnoozeTill as SnoozeTill, table0.Tags as Tags, to_json(join0)->'array' as join0, to_json(join1)->'array' as join1, to_json(join2)->'array' as join2, to_json(join3)->'array' as join3, to_json(join4)->'array' as join4, to_json(join5)->'array' as join5, to_json(join6)->'array' as join6, to_json(join7)->'array' as join7 from alerts table0 left join lateral (select array(select json_build_object('idx', table1.idx, 'Name', table1.Name, 'Deployment_Name', table1.Deployment_Name, 'Deployment_Scope_Cluster', table1.Deployment_Scope_Cluster, 'Deployment_Scope_Namespace', table1.Deployment_Scope_Namespace, 'Deployment_Scope_Label_Key', table1.Deployment_Scope_Label_Key, 'Deployment_Scope_Label_Value', table1.Deployment_Scope_Label_Value, 'Image_Name', table1.Image_Name, 'Expiration', table1.Expiration) from alerts_Whitelists table1 where (table0.Id = table1.alerts_Id))) join0 on true left join lateral (select array(select json_build_object('idx', table2.idx, 'Name', table2.Name, 'Deployment_Name', table2.Deployment_Name, 'Deployment_Scope_Cluster', table2.Deployment_Scope_Cluster, 'Deployment_Scope_Namespace', table2.Deployment_Scope_Namespace, 'Deployment_Scope_Label_Key', table2.Deployment_Scope_Label_Key, 'Deployment_Scope_Label_Value', table2.Deployment_Scope_Label_Value, 'Image_Name', table2.Image_Name, 'Expiration', table2.Expiration) from alerts_Exclusions table2 where (table0.Id = table2.alerts_Id))) join1 on true left join lateral (select array(select json_build_object('idx', table3.idx, 'Cluster', table3.Cluster, 'Namespace', table3.Namespace, 'Label_Key', table3.Label_Key, 'Label_Value', table3.Label_Value) from alerts_Scope table3 where (table0.Id = table3.alerts_Id))) join2 on true left join lateral (select array(select json_build_object('idx', table4.idx, 'SectionName', table4.SectionName, 'join0', to_json(join0)->'array') from alerts_PolicySections table4 left join lateral (select array(select json_build_object('idx', table5.idx, 'FieldName', table5.FieldName, 'BooleanOperator', table5.BooleanOperator, 'Negate', table5.Negate, 'join0', to_json(join0)->'array') from alerts_PolicySections_PolicyGroups table5 left join lateral (select array(select json_build_object('idx', table6.idx, 'Value', table6.Value) from alerts_PolicySections_PolicyGroups_Values table6 where (table0.Id = table6.alerts_Id and table4.idx = table6.alerts_PolicySections_idx and table5.idx = table6.alerts_PolicySections_PolicyGroups_idx))) join0 on true where (table0.Id = table5.alerts_Id and table4.idx = table5.alerts_PolicySections_idx))) join0 on true where (table0.Id = table4.alerts_Id))) join3 on true left join lateral (select array(select json_build_object('idx', table7.idx, 'Tactic', table7.Tactic, 'Techniques', table7.Techniques) from alerts_MitreAttackVectors table7 where (table0.Id = table7.alerts_Id))) join4 on true left join lateral (select array(select json_build_object('idx', table8.idx, 'Image_Id', table8.Image_Id, 'Image_Name_Registry', table8.Image_Name_Registry, 'Image_Name_Remote', table8.Image_Name_Remote, 'Image_Name_Tag', table8.Image_Name_Tag, 'Image_Name_FullName', table8.Image_Name_FullName, 'Image_NotPullable', table8.Image_NotPullable, 'Image_IsClusterLocal', table8.Image_IsClusterLocal, 'Name', table8.Name) from alerts_Containers table8 where (table0.Id = table8.alerts_Id))) join5 on true left join lateral (select array(select json_build_object('idx', table9.idx, 'Message', table9.Message, 'NetworkFlowInfo_Protocol', table9.NetworkFlowInfo_Protocol, 'NetworkFlowInfo_Source_Name', table9.NetworkFlowInfo_Source_Name, 'NetworkFlowInfo_Source_EntityType', table9.NetworkFlowInfo_Source_EntityType, 'NetworkFlowInfo_Source_DeploymentNamespace', table9.NetworkFlowInfo_Source_DeploymentNamespace, 'NetworkFlowInfo_Source_DeploymentType', table9.NetworkFlowInfo_Source_DeploymentType, 'NetworkFlowInfo_Source_Port', table9.NetworkFlowInfo_Source_Port, 'NetworkFlowInfo_Destination_Name', table9.NetworkFlowInfo_Destination_Name, 'NetworkFlowInfo_Destination_EntityType', table9.NetworkFlowInfo_Destination_EntityType, 'NetworkFlowInfo_Destination_DeploymentNamespace', table9.NetworkFlowInfo_Destination_DeploymentNamespace, 'NetworkFlowInfo_Destination_DeploymentType', table9.NetworkFlowInfo_Destination_DeploymentType, 'NetworkFlowInfo_Destination_Port', table9.NetworkFlowInfo_Destination_Port, 'Type', table9.Type, 'Time', table9.Time, 'join0', to_json(join0)->'array') from alerts_Violations table9 left join lateral (select array(select json_build_object('idx', table10.idx, 'Key', table10.Key, 'Value', table10.Value) from alerts_Violations_Attrs table10 where (table0.Id = table10.alerts_Id and table9.idx = table10.alerts_Violations_idx))) join0 on true where (table0.Id = table9.alerts_Id))) join6 on true left join lateral (select array(select json_build_object('idx', table11.idx, 'Id', table11.Id, 'DeploymentId', table11.DeploymentId, 'ContainerName', table11.ContainerName, 'PodId', table11.PodId, 'PodUid', table11.PodUid, 'Signal_Id', table11.Signal_Id, 'Signal_ContainerId', table11.Signal_ContainerId, 'Signal_Time', table11.Signal_Time, 'Signal_Name', table11.Signal_Name, 'Signal_Args', table11.Signal_Args, 'Signal_ExecFilePath', table11.Signal_ExecFilePath, 'Signal_Pid', table11.Signal_Pid, 'Signal_Uid', table11.Signal_Uid, 'Signal_Gid', table11.Signal_Gid, 'Signal_Lineage', table11.Signal_Lineage, 'Signal_Scraped', table11.Signal_Scraped, 'ClusterId', table11.ClusterId, 'Namespace', table11.Namespace, 'ContainerStartTime', table11.ContainerStartTime, 'ImageId', table11.ImageId, 'join0', to_json(join0)->'array') from alerts_Processes table11 left join lateral (select array(select json_build_object('idx', table12.idx, 'ParentUid', table12.ParentUid, 'ParentExecFilePath', table12.ParentExecFilePath) from alerts_Processes_LineageInfo table12 where (table0.Id = table12.alerts_Id and table11.idx = table12.alerts_Processes_idx))) join0 on true where (table0.Id = table11.alerts_Id))) join7 on true where (table0.Id = $1)) record ))"
