...
func insertIntoAlertsContainers(tx pgx.Tx, obj *storage.Alert_Deployment_Container, parent_Id string, idx int) error {
	...
	finalStr := "INSERT INTO alerts_Containers (parent_Id, idx, Image_Id, Image_Name_Registry, Image_Name_Remote, Image_Name_Tag, Image_Name_FullName, Image_NotPullable, Name) VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9) ON CONFLICT(parent_Id, idx) DO UPDATE SET parent_Id = EXCLUDED.parent_Id, idx = EXCLUDED.idx, Image_Id = EXCLUDED.Image_Id, Image_Name_Registry = EXCLUDED.Image_Name_Registry, Image_Name_Remote = EXCLUDED.Image_Name_Remote, Image_Name_Tag = EXCLUDED.Image_Name_Tag, Image_Name_FullName = EXCLUDED.Image_Name_FullName, Image_NotPullable = EXCLUDED.Image_NotPullable, Name = EXCLUDED.Name"
	_, err := tx.Exec(context.Background(), finalStr, values...)
	if err != nil {
		return err
	}
