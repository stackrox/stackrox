...
import dnrintegration "bitbucket.org/stack-rox/apollo/central/dnrintegration"
...
func (_m *MockDataStore) AddDNRIntegration(integration *v1.DNRIntegration) (string, error) {
...
func (_m *MockDataStore) ForCluster(clusterID string) (dnrintegration.DNRIntegration, bool, error) {
...
func (_m *MockDataStore) GetDNRIntegration(id string) (*v1.DNRIntegration, bool, error) {
	ret := _m.Called(id)
...
func (_m *MockDataStore) GetDNRIntegrations(request *v1.GetDNRIntegrationsRequest) ([]*v1.DNRIntegration, error) {
...
func (_m *MockDataStore) RemoveDNRIntegration(id string) error {
	ret := _m.Called(id)
...
func (_m *MockDataStore) UpdateDNRIntegration(integration *v1.DNRIntegration) error {
	ret := _m.Called(integration)
