...
func TestEvaluateClustersWithExtSrcsFeatureDisabled(t *testing.T) {
...
func TestEvaluateClustersWithPortsWithExtSrcsDisabled(t *testing.T) {
	g := newMockGraphEvaluator()
...
func TestEvaluateClustersWithPortsWithExtSrcsFeatureEnabled(t *testing.T) {
	g := newMockGraphEvaluator()
