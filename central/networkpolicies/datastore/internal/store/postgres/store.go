...
func (s *storeImpl) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.NetworkPolicy, error) {
	...
	rows, err := pgSearch.RunGetManyQueryForSchema[storage.NetworkPolicy](ctx, schema, query, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.NetworkPolicy) error) error {
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.NetworkPolicy](ctx, schema, search.EmptyQuery(), s.db)
	if err != nil {
		return err
	}
	defer closer()
