...
func (b *storeImpl) Get(id string) (*storage.NetworkPolicyApplicationUndoDeploymentRecord, bool, error) {
...
func (b *storeImpl) GetMany(ids []string) ([]*storage.NetworkPolicyApplicationUndoDeploymentRecord, []int, error) {
...
func (b *storeImpl) Upsert(obj *storage.NetworkPolicyApplicationUndoDeploymentRecord) error {
...
func (b *storeImpl) UpsertMany(objs []*storage.NetworkPolicyApplicationUndoDeploymentRecord) error {
...
func (b *storeImpl) Walk(fn func(obj *storage.NetworkPolicyApplicationUndoDeploymentRecord) error) error {
