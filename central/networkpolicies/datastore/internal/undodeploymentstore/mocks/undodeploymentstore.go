...
func (mr *MockUndoDeploymentStoreMockRecorder) Get(ctx, deploymentID interface{}) *gomock.Call {
...
func (mr *MockUndoDeploymentStoreMockRecorder) Upsert(ctx, undoRecord interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
