...
type Store interface {
	...
	GetMany(ctx context.Context, identifiers []string) ([]*storage.NetworkPolicyApplicationUndoDeploymentRecord, []int, error)
...
type storeImpl struct {
	*pgSearch.GenericStore[storage.NetworkPolicyApplicationUndoDeploymentRecord, *storage.NetworkPolicyApplicationUndoDeploymentRecord]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		db: db,
		GenericStore: pgSearch.NewGenericStore[storage.NetworkPolicyApplicationUndoDeploymentRecord, *storage.NetworkPolicyApplicationUndoDeploymentRecord](
			db,
			targetResource,
			schema,
...
func pkGetter(obj *storage.NetworkPolicyApplicationUndoDeploymentRecord) string {
	return obj.GetDeploymentId()
}

func metricsSetPostgresOperationDurationTime(start time.Time, op ops.Op) {
	metrics.SetPostgresOperationDurationTime(start, op, "NetworkPolicyApplicationUndoDeploymentRecord")
}

func metricsSetAcquireDBConnDuration(start time.Time, op ops.Op) {
	metrics.SetAcquireDBConnDuration(start, op, "NetworkPolicyApplicationUndoDeploymentRecord")
}
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.NetworkPolicyApplicationUndoDeploymentRecord, []int, error) {
