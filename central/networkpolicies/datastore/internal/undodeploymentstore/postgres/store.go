...
func insertIntoNetworkpoliciesundodeployments(ctx context.Context, batch *pgx.Batch, obj *storage.NetworkPolicyApplicationUndoDeploymentRecord) error {
...
func (s *storeImpl) Get(ctx context.Context, deploymentId string) (*storage.NetworkPolicyApplicationUndoDeploymentRecord, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.NetworkPolicyApplicationUndoDeploymentRecord](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.NetworkPolicyApplicationUndoDeploymentRecord, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.NetworkPolicyApplicationUndoDeploymentRecord](ctx, schema, q, s.db)
	if err != nil {
