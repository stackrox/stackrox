...
var (
	...
	ComplianceOperatorScanSettingBindingsSchema = func() *walker.Schema {
		schema := schemaPkg.GetSchemaForTable("compliance_operator_scan_setting_bindings")
		if schema != nil {
			return schema
		}
		...
		schemaPkg.RegisterTable(schema, CreateTableComplianceOperatorScanSettingBindingsStmt)
		return schema
	}()
)
