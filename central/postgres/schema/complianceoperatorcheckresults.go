...
const (
	ComplianceoperatorcheckresultsTableName = "complianceoperatorcheckresults"
)

// Complianceoperatorcheckresults holds the Gorm model for Postgres table `complianceoperatorcheckresults`.
