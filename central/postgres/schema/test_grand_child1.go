...
var (
	...
	TestGrandChild1Schema = func() *walker.Schema {
		schema := globaldb.GetSchemaForTable("test_grand_child1")
		if schema != nil {
			return schema
		}
		...
		schema.SetOptionsMap(search.Walk(v1.SearchCategory(64), "test_grand_child1", (*storage.TestGrandChild1)(nil)))
