...
var (
	...
	TestSingleKeyStructsSchema = func() *walker.Schema {
		...
		schema.SetOptionsMap(search.Walk(v1.SearchCategory_SEARCH_UNSET, "test_single_key_structs", (*storage.TestSingleKeyStruct)(nil)))
...
// TestSingleKeyStruct holds the Gorm model for Postgres table `test_single_key_structs`.
