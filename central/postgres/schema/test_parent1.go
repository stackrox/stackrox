...
var (
	...
	TestParent1Schema = func() *walker.Schema {
		...
		schema.SetOptionsMap(search.Walk(v1.SearchCategory(62), "test_parent1", (*storage.TestParent1)(nil)))
...
// TestParent1_Child1Ref holds the Gorm model for Postgres table `test_parent1_childrens`.
