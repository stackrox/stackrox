...
var (
	...
	TestG2GrandChild1Schema = func() *walker.Schema {
		schema := globaldb.GetSchemaForTable("test_g2_grand_child1")
		if schema != nil {
			return schema
		}
		...
		schema.SetOptionsMap(search.Walk(v1.SearchCategory(66), "test_g2_grand_child1", (*storage.TestG2GrandChild1)(nil)))
