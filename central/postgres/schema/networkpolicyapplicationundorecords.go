...
var (
	...
	NetworkpolicyapplicationundorecordsSchema = func() *walker.Schema {
		schema := schemaPkg.GetSchemaForTable("networkpolicyapplicationundorecords")
		if schema != nil {
			return schema
		}
		schema = walker.Walk(reflect.TypeOf((*storage.NetworkPolicyApplicationUndoRecord)(nil)), "networkpolicyapplicationundorecords")
		schemaPkg.RegisterTable(schema, CreateTableNetworkpolicyapplicationundorecordsStmt)
		return schema
	}()
)
