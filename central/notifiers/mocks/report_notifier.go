...
// Source: github.com/stackrox/stackrox/central/notifiers (interfaces: ReportNotifier)
...
func (m *MockReportNotifier) ReportNotify(arg0 context.Context, arg1 *bytes.Buffer, arg2 []string, arg3 string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReportNotify", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(error)
	return ret0
}

// ReportNotify indicates an expected call of ReportNotify.
func (mr *MockReportNotifierMockRecorder) ReportNotify(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReportNotify", reflect.TypeOf((*MockReportNotifier)(nil).ReportNotify), arg0, arg1, arg2, arg3)
}
...
func (mr *MockReportNotifierMockRecorder) Test(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
