...
func (b *storeImpl) Get(id string) (*storage.NetworkBaseline, bool, error) {
...
func (b *storeImpl) GetMany(ids []string) ([]*storage.NetworkBaseline, []int, error) {
...
func (b *storeImpl) Upsert(obj *storage.NetworkBaseline) error {
...
func (b *storeImpl) UpsertMany(objs []*storage.NetworkBaseline) error {
...
func (b *storeImpl) Walk(fn func(obj *storage.NetworkBaseline) error) error {
