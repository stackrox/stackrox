...
func dropTableCollections(ctx context.Context, db *postgres.Postgres) {
	_, _ = db.Exec(ctx, "DROP TABLE IF EXISTS collections CASCADE")
	dropTableCollectionsEmbeddedCollections(ctx, db)

}

func dropTableCollectionsEmbeddedCollections(ctx context.Context, db *postgres.Postgres) {
