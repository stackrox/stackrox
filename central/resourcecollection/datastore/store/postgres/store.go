...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ResourceCollection, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.ResourceCollection](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.ResourceCollection, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.ResourceCollection](ctx, schema, q, s.db)
	if err != nil {
