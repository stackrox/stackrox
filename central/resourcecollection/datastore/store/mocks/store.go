...
func (m *MockStore) Get(ctx context.Context, id string) (*storage.ResourceCollection, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetByQueryFn(ctx context.Context, query *v1.Query, fn func(*storage.ResourceCollection) error) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetMany(ctx context.Context, ids []string) ([]*storage.ResourceCollection, []int, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Upsert(arg0 context.Context, arg1 *storage.ResourceCollection) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) Walk(ctx context.Context, fn func(*storage.ResourceCollection) error) error {
	m.ctrl.T.Helper()
