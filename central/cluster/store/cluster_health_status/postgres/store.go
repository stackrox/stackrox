...
const (
	...
	getWithRollupStmt = "select row_to_json((select record from (select table0.Id as Id, table0.CollectorHealthInfo_Version as CollectorHealthInfo_Version, table0.CollectorHealthInfo_TotalDesiredPods as CollectorHealthInfo_TotalDesiredPods, table0.CollectorHealthInfo_TotalReadyPods as CollectorHealthInfo_TotalReadyPods, table0.CollectorHealthInfo_TotalRegisteredNodes as CollectorHealthInfo_TotalRegisteredNodes, table0.CollectorHealthInfo_StatusErrors as CollectorHealthInfo_StatusErrors, table0.AdmissionControlHealthInfo_TotalDesiredPods as AdmissionControlHealthInfo_TotalDesiredPods, table0.AdmissionControlHealthInfo_TotalReadyPods as AdmissionControlHealthInfo_TotalReadyPods, table0.AdmissionControlHealthInfo_StatusErrors as AdmissionControlHealthInfo_StatusErrors, table0.SensorHealthStatus as SensorHealthStatus, table0.CollectorHealthStatus as CollectorHealthStatus, table0.OverallHealthStatus as OverallHealthStatus, table0.AdmissionControlHealthStatus as AdmissionControlHealthStatus, table0.LastContact as LastContact, table0.HealthInfoComplete as HealthInfoComplete from cluster_health_status table0 where (table0.Id = $1)) record ))"
