...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.Cluster, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.Cluster](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.Cluster, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.Cluster](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.Cluster) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[storage.Cluster](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
