...
func (m *MockStore) Get(ctx context.Context, id string) (*storage.Cluster, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetByQueryFn(ctx context.Context, query *v1.Query, fn func(*storage.Cluster) error) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) Upsert(ctx context.Context, obj *storage.Cluster) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) Walk(ctx context.Context, fn func(*storage.Cluster) error) error {
	m.ctrl.T.Helper()
