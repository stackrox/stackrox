...
func (b *storeImpl) GetMany(_ context.Context, ids []string) ([]*storage.Cluster, []int, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.Cluster) error {
...
func (b *storeImpl) Walk(ctx context.Context, fn func(obj *storage.Cluster) error) error {
