...
func (m *MockDataStore) GetClusterDefaults(ctx context.Context, kernelSupport bool, clusterType storage.ClusterType) (*storage.Cluster, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetClusterDefaults", ctx, kernelSupport, clusterType)
	ret0, _ := ret[0].(*storage.Cluster)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockDataStoreMockRecorder) GetClusterDefaults(ctx, kernelSupport, clusterType interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetClusterDefaults", reflect.TypeOf((*MockDataStore)(nil).GetClusterDefaults), ctx, kernelSupport, clusterType)
}
...
func (mr *MockDataStoreMockRecorder) GetClusterName(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) LookupOrCreateClusterFromConfig(ctx, clusterID, bundleID, hello interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) UpdateAuditLogFileStates(ctx, id, states interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) UpdateClusterCertExpiryStatus(ctx, id, clusterCertExpiryStatus interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) UpdateClusterHealth(ctx, id, clusterHealthStatus interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) UpdateSensorDeploymentIdentification(ctx, id, identification interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
