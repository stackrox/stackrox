...
func (m *MockDataStore) AddCluster(arg0 *v1.Cluster) (string, error) {
...
func (m *MockDataStore) GetCluster(arg0 string) (*v1.Cluster, bool, error) {
...
func (m *MockDataStore) GetClusters() ([]*v1.Cluster, error) {
...
func (m *MockDataStore) UpdateCluster(arg0 *v1.Cluster) error {
