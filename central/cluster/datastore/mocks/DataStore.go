...
func (_m *DataStore) AddCluster(cluster *v1.Cluster) (string, error) {
...
func (_m *DataStore) CountClusters() (int, error) {
	ret := _m.Called()
...
func (_m *DataStore) GetCluster(id string) (*v1.Cluster, bool, error) {
	ret := _m.Called(id)
...
func (_m *DataStore) GetClusters() ([]*v1.Cluster, error) {
	ret := _m.Called()
...
func (_m *DataStore) RemoveCluster(id string) error {
	ret := _m.Called(id)
...
func (_m *DataStore) UpdateCluster(cluster *v1.Cluster) error {
	ret := _m.Called(cluster)
...
func (_m *DataStore) UpdateClusterContactTime(id string, t time.Time) error {
	ret := _m.Called(id, t)
