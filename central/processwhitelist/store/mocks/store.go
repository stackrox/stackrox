...
func (m *MockStore) Get(id string) (*storage.ProcessWhitelist, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetMany(ids []string) ([]*storage.ProcessWhitelist, []int, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Walk(fn func(*storage.ProcessWhitelist) error) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) Upsert(whitelist *storage.ProcessWhitelist) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Upsert", whitelist)
	ret0, _ := ret[0].(error)
	return ret0
}

// Upsert indicates an expected call of Upsert
func (mr *MockStoreMockRecorder) Upsert(whitelist interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upsert", reflect.TypeOf((*MockStore)(nil).Upsert), whitelist)
}
