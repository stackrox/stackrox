...
func (m *MockEvaluator) EvaluateWhitelistsAndPersistResult(deployment *storage.Deployment) ([]*storage.ProcessIndicator, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EvaluateWhitelistsAndPersistResult", deployment)
...
func (mr *MockEvaluatorMockRecorder) EvaluateWhitelistsAndPersistResult(deployment interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EvaluateWhitelistsAndPersistResult", reflect.TypeOf((*MockEvaluator)(nil).EvaluateWhitelistsAndPersistResult), deployment)
}
