...
type storeImpl struct {
	*pgSearch.GenericSingleIDStore[storage.ProcessListeningOnPortStorage, *storage.ProcessListeningOnPortStorage]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		GenericSingleIDStore: pgSearch.NewGenericSingleIDStore[storage.ProcessListeningOnPortStorage, *storage.ProcessListeningOnPortStorage](
			db,
