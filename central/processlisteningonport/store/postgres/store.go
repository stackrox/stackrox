...
var (
	...
	schema         = centralSchema.ListeningEndpointsSchema
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ProcessListeningOnPortStorage) error) error {
	var sacQueryFilter *v1.Query
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.ProcessListeningOnPortStorage](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
