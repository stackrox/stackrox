...
func (u *accessScopeUpdater) DeleteResources(ctx context.Context, resourceIDsToSkip ...string) error {
	...
	if err != nil {
		return errors.Wrap(err, "retrieving declarative access scopes")
	}
