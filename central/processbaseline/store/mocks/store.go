...
func (m *MockStore) GetByQueryFn(ctx context.Context, query *v1.Query, fn func(*storage.ProcessBaseline) error) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) Walk(ctx context.Context, fn func(*storage.ProcessBaseline) error, useClones bool) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) WalkByQuery(ctx context.Context, query *v1.Query, fn func(*storage.ProcessBaseline) error) error {
	m.ctrl.T.Helper()
