...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ProcessBaseline, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.ProcessBaseline](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.ProcessBaseline, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.ProcessBaseline](ctx, schema, q, s.db)
	if err != nil {
