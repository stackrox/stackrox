...
func metricsSetPostgresOperationDurationTime(start time.Time, op ops.Op) {
	metrics.SetPostgresOperationDurationTime(start, op, "ProcessBaseline")
}

func metricsSetAcquireDBConnDuration(start time.Time, op ops.Op) {
	metrics.SetAcquireDBConnDuration(start, op, "ProcessBaseline")
}
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.ProcessBaseline, []int, error) {
