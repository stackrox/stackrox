...
// Source: central/administration/usage/datastore/securedunits/get_cluster_ids.go
...
func (mr *MockclusterDataStoreMockRecorder) GetClusters(ctx interface{}) *gomock.Call {
