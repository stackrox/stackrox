...
type DataStore interface {
	...
	RemoveEvents(ctx context.Context, ids ...string) error
}

func newDataStore(searcher eventsSearch.Searcher, storage store.Store, writer writer.Writer) DataStore {
...
func GetTestPostgresDataStore(_ testing.TB, pool postgres.DB) DataStore {
	searcher := eventsSearch.New(pgStore.NewIndexer(pool))
