...
func NewPipeline(ctx context.Context, clusters datastore.ClusterDataStore, deployments datastore.DeploymentDataStore, images datastore.ImageDataStore, detector *detection.Detector) Pipeline {
	return &pipelineImpl{
