...
type PipelineTestSuite struct {
	...
	ctx         context.Context
	clusters    *datastore.MockClusterDataStore
	deployments *datastore.MockDeploymentDataStore
	images      *datastore.MockImageDataStore
	detector    *mockDetector
}

func (suite *PipelineTestSuite) SetupTest() {
	suite.clusters = &datastore.MockClusterDataStore{}
	suite.deployments = &datastore.MockDeploymentDataStore{}
	suite.images = &datastore.MockImageDataStore{}
