...
func (m *MockSearcher) SearchRawRoleBindings(ctx context.Context, query *v1.Query) ([]*storage.K8SRoleBinding, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchRawRoleBindings", ctx, query)
...
func (mr *MockSearcherMockRecorder) SearchRawRoleBindings(ctx, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchRawRoleBindings", reflect.TypeOf((*MockSearcher)(nil).SearchRawRoleBindings), ctx, query)
}
...
func (mr *MockSearcherMockRecorder) SearchRoleBindings(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
