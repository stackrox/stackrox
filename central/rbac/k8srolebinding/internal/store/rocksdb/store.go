...
func (b *storeImpl) GetMany(_ context.Context, ids []string) ([]*storage.K8SRoleBinding, []int, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.K8SRoleBinding) error {
...
func (b *storeImpl) Walk(ctx context.Context, fn func(obj *storage.K8SRoleBinding) error) error {
