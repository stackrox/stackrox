...
type storeImpl struct {
	*pgSearch.GenericSingleIDStore[storage.K8SRoleBinding, *storage.K8SRoleBinding]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		GenericSingleIDStore: pgSearch.NewGenericSingleIDStore[storage.K8SRoleBinding, *storage.K8SRoleBinding](
			db,
			"K8SRoleBinding",
			targetResource,
			schema,
