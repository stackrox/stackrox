...
const (
	...
	getWithRollupStmt = "select row_to_json((select table0_record from (select table0.Id as Id, table0.Name as Name, table0.Namespace as Namespace, table0.ClusterId as ClusterId, table0.ClusterName as ClusterName, table0.ClusterRole as ClusterRole, table0.Labels as Labels, table0.Annotations as Annotations, table0.CreatedAt as CreatedAt, table0.RoleId as RoleId, to_json(join0)->'array' as join0 from rolebindings table0 left join lateral (select array(select row_to_json((select table1_record from (select table1.idx as idx, table1.Id as Id, table1.Kind as Kind, table1.Name as Name, table1.Namespace as Namespace, table1.ClusterId as ClusterId, table1.ClusterName as ClusterName from rolebindings_Subjects table1 where (table1) ) table0.Id = table1.rolebindings_Id_record )))) join0 on true where (table0) ) table0.Id = $1_record ))"
