...
const (
	...
	getStmt     = "SELECT serialized FROM role_bindings WHERE Id = $1"
	deleteStmt  = "DELETE FROM role_bindings WHERE Id = $1"
	walkStmt    = "SELECT serialized FROM role_bindings"
	getManyStmt = "SELECT serialized FROM role_bindings WHERE Id = ANY($1::text[])"

	deleteManyStmt = "DELETE FROM role_bindings WHERE Id = ANY($1::text[])"
