...
func (s *storeImpl) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.K8SRoleBinding, error) {
	...
	rows, err := pgSearch.RunGetManyQueryForSchema[storage.K8SRoleBinding](ctx, schema, query, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.K8SRoleBinding) error) error {
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.K8SRoleBinding](ctx, schema, search.EmptyQuery(), s.db)
	if err != nil {
		return err
	}
	defer closer()
