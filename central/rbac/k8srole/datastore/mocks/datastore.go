...
func (mr *MockDataStoreMockRecorder) GetRole(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) RemoveRole(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) SearchRawRoles(ctx, q interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) SearchRoles(ctx, q interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) UpsertRole(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockDataStore) WalkAll(ctx context.Context, fn func(*storage.K8SRole) error) error {
	m.ctrl.T.Helper()
