...
func (m *MockSearcher) SearchRawRoles(ctx context.Context, query *v1.Query) ([]*storage.K8SRole, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchRawRoles", ctx, query)
...
func (mr *MockSearcherMockRecorder) SearchRawRoles(ctx, query any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchRawRoles", reflect.TypeOf((*MockSearcher)(nil).SearchRawRoles), ctx, query)
}
...
func (mr *MockSearcherMockRecorder) SearchRoles(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
