...
func (b *storeImpl) Get(_ context.Context, id string) (*storage.K8SRole, bool, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.K8SRole) error {
...
func (b *storeImpl) Walk(ctx context.Context, fn func(obj *storage.K8SRole) error) error {
