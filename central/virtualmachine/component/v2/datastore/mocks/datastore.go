...
func (m *MockDataStore) Get(ctx context.Context, id string) (*storage.VirtualMachineComponentV2, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, id)
	ret0, _ := ret[0].(*storage.VirtualMachineComponentV2)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
...
func (m *MockDataStore) GetBatch(ctx context.Context, ids []string) ([]*storage.VirtualMachineComponentV2, error) {
	m.ctrl.T.Helper()
...
// SearchRawVMComponents mocks base method.
func (m *MockDataStore) SearchRawVMComponents(ctx context.Context, q *v1.Query) ([]*storage.VirtualMachineComponentV2, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchRawVMComponents", ctx, q)
	ret0, _ := ret[0].([]*storage.VirtualMachineComponentV2)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SearchRawVMComponents indicates an expected call of SearchRawVMComponents.
func (mr *MockDataStoreMockRecorder) SearchRawVMComponents(ctx, q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchRawVMComponents", reflect.TypeOf((*MockDataStore)(nil).SearchRawVMComponents), ctx, q)
}
