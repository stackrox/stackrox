...
// EnsureVMExists mocks base method.
func (m *MockStore) EnsureVMExists(ctx context.Context, vmID, clusterID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnsureVMExists", ctx, vmID, clusterID)
	ret0, _ := ret[0].(error)
	return ret0
}

// EnsureVMExists indicates an expected call of EnsureVMExists.
func (mr *MockStoreMockRecorder) EnsureVMExists(ctx, vmID, clusterID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnsureVMExists", reflect.TypeOf((*MockStore)(nil).EnsureVMExists), ctx, vmID, clusterID)
}
...
func (m *MockStore) GetMany(ctx context.Context, ids []string) ([]*storage.VirtualMachineV2, []int, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpsertScan(ctx context.Context, vmID string, parts common.VMScanParts) error {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) UpsertScan(ctx, vmID, parts any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpsertScan", reflect.TypeOf((*MockStore)(nil).UpsertScan), ctx, vmID, parts)
}

// UpsertVM mocks base method.
func (m *MockStore) UpsertVM(ctx context.Context, vm *storage.VirtualMachineV2) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpsertVM", ctx, vm)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpsertVM indicates an expected call of UpsertVM.
func (mr *MockStoreMockRecorder) UpsertVM(ctx, vm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpsertVM", reflect.TypeOf((*MockStore)(nil).UpsertVM), ctx, vm)
}

// Walk mocks base method.
func (m *MockStore) Walk(ctx context.Context, fn func(*storage.VirtualMachineV2) error) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) WalkByQuery(ctx context.Context, q *v1.Query, fn func(*storage.VirtualMachineV2) error) error {
	m.ctrl.T.Helper()
