...
func (m *MockDataStore) Get(ctx context.Context, id string) (*storage.VirtualMachineScanV2, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, id)
	ret0, _ := ret[0].(*storage.VirtualMachineScanV2)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
...
func (m *MockDataStore) GetBatch(ctx context.Context, ids []string) ([]*storage.VirtualMachineScanV2, error) {
	m.ctrl.T.Helper()
...
// SearchRawVMScans mocks base method.
func (m *MockDataStore) SearchRawVMScans(ctx context.Context, q *v1.Query) ([]*storage.VirtualMachineScanV2, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchRawVMScans", ctx, q)
	ret0, _ := ret[0].([]*storage.VirtualMachineScanV2)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SearchRawVMScans indicates an expected call of SearchRawVMScans.
func (mr *MockDataStoreMockRecorder) SearchRawVMScans(ctx, q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchRawVMScans", reflect.TypeOf((*MockDataStore)(nil).SearchRawVMScans), ctx, q)
}
