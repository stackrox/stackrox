...
func (m *MockStore) GetByQueryFn(ctx context.Context, query *v1.Query, fn func(*storage.Policy) error) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) Walk(ctx context.Context, fn func(*storage.Policy) error, useClones bool) error {
	m.ctrl.T.Helper()
