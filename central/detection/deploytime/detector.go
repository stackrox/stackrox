...
type Detector interface {
	...
	Detect(ctx deploytime.DetectionContext, deployment *storage.Deployment, images []*storage.Image, association *augmentedobjs.NetworkPolicyAssociation, policyFilters ...detection.FilterOption) ([]*storage.Alert, error)
}
