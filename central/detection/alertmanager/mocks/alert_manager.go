...
//
//	mockgen -package mocks -destination mocks/alert_manager.go -source alert_manager.go
//
...
func (mr *MockAlertManagerMockRecorder) AlertAndNotify(ctx, alerts any, oldAlertFilters ...any) *gomock.Call {
