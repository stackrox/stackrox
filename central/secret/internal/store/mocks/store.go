...
func (m *MockStore) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.Secret, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) Upsert(ctx, secret interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
