...
func (b *storeImpl) GetMany(_ context.Context, ids []string) ([]*storage.Secret, []int, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.Secret) error {
...
func (b *storeImpl) Walk(ctx context.Context, fn func(obj *storage.Secret) error) error {
