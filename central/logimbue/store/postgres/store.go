...
func New(ctx context.Context, db *pgxpool.Pool) Store {
	pgutils.CreateTable(ctx, db, pkgSchema.CreateTableLogImbuesStmt)
...
func insertIntoLogImbues(ctx context.Context, tx pgx.Tx, obj *storage.LogImbue) error {
...
func (s *storeImpl) upsert(ctx context.Context, objs ...*storage.LogImbue) error {
	...
	for _, obj := range objs {
		...
		if err := insertIntoLogImbues(ctx, tx, obj); err != nil {
			if err := tx.Rollback(ctx); err != nil {
				return err
			}
			return err
