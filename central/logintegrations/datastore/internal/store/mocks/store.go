...
func (m *MockStore) Walk(fn func(*storage.LogIntegration) error) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) Get(id string) (*storage.LogIntegration, bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetMany(ids []string) ([]*storage.LogIntegration, []int, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) Upsert(cluster *storage.LogIntegration) error {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) Upsert(cluster interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upsert", reflect.TypeOf((*MockStore)(nil).Upsert), cluster)
}
