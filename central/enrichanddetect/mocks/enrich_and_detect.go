...
func (m *MockEnricherAndDetector) EnrichAndDetect(deployment *storage.Deployment) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnrichAndDetect", deployment)
	ret0, _ := ret[0].(error)
	return ret0
}

// EnrichAndDetect indicates an expected call of EnrichAndDetect
func (mr *MockEnricherAndDetectorMockRecorder) EnrichAndDetect(deployment interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnrichAndDetect", reflect.TypeOf((*MockEnricherAndDetector)(nil).EnrichAndDetect), deployment)
}
