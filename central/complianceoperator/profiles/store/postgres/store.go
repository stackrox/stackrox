...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ComplianceOperatorProfile, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.ComplianceOperatorProfile](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.ComplianceOperatorProfile, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.ComplianceOperatorProfile](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ComplianceOperatorProfile) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchema[storage.ComplianceOperatorProfile](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
