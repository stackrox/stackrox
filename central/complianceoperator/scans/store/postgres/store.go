...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ComplianceOperatorScan, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.ComplianceOperatorScan](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.ComplianceOperatorScan, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.ComplianceOperatorScan](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ComplianceOperatorScan) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchema[storage.ComplianceOperatorScan](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
