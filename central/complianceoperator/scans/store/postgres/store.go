...
func insertIntoComplianceOperatorScans(ctx context.Context, batch *pgx.Batch, obj *storage.ComplianceOperatorScan) error {
	...
	finalStr := "INSERT INTO compliance_operator_scans (Id, ClusterId, serialized) VALUES($1, $2, $3) ON CONFLICT(Id) DO UPDATE SET Id = EXCLUDED.Id, ClusterId = EXCLUDED.ClusterId, serialized = EXCLUDED.serialized"
