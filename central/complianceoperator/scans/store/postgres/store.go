...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ComplianceOperatorScan, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.ComplianceOperatorScan](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.ComplianceOperatorScan, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.ComplianceOperatorScan](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ComplianceOperatorScan) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[storage.ComplianceOperatorScan](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
