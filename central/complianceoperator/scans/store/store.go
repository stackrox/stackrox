...
type Store interface {
	...
	GetIDs() ([]string, error)
	Get(id string) (*storage.ComplianceOperatorScan, bool, error)
	GetMany(ids []string) ([]*storage.ComplianceOperatorScan, []int, error)
	Upsert(obj *storage.ComplianceOperatorScan) error
	UpsertMany(objs []*storage.ComplianceOperatorScan) error
	Delete(id string) error
	DeleteMany(ids []string) error
	Walk(fn func(obj *storage.ComplianceOperatorScan) error) error
...
func (b *storeImpl) Get(id string) (*storage.ComplianceOperatorScan, bool, error) {
...
func (b *storeImpl) GetMany(ids []string) ([]*storage.ComplianceOperatorScan, []int, error) {
...
func (b *storeImpl) Upsert(obj *storage.ComplianceOperatorScan) error {
...
func (b *storeImpl) UpsertMany(objs []*storage.ComplianceOperatorScan) error {
...
func (b *storeImpl) Walk(fn func(obj *storage.ComplianceOperatorScan) error) error {
