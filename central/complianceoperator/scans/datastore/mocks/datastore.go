...
func (m *MockDataStore) Upsert(ctx context.Context, rule *storage.ComplianceOperatorScan) error {
	m.ctrl.T.Helper()
...
func (m *MockDataStore) Walk(ctx context.Context, fn func(*storage.ComplianceOperatorScan) error) error {
	m.ctrl.T.Helper()
