...
type Store interface {
	...
	GetMany(ctx context.Context, identifiers []string) ([]*storage.ComplianceOperatorCheckResult, []int, error)
...
type storeImpl struct {
	*pgSearch.GenericStore[storage.ComplianceOperatorCheckResult, *storage.ComplianceOperatorCheckResult]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		db: db,
		GenericStore: pgSearch.NewGenericStore[storage.ComplianceOperatorCheckResult, *storage.ComplianceOperatorCheckResult](
			db,
			schema,
			pkGetter,
...
func pkGetter(obj *storage.ComplianceOperatorCheckResult) string {
	return obj.GetId()
}

func metricsSetPostgresOperationDurationTime(start time.Time, op ops.Op) {
	metrics.SetPostgresOperationDurationTime(start, op, "ComplianceOperatorCheckResult")
}

func metricsSetAcquireDBConnDuration(start time.Time, op ops.Op) {
	metrics.SetAcquireDBConnDuration(start, op, "ComplianceOperatorCheckResult")
}
...
func (s *storeImpl) Upsert(ctx context.Context, obj *storage.ComplianceOperatorCheckResult) error {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Upsert, "ComplianceOperatorCheckResult")
...
func (s *storeImpl) UpsertMany(ctx context.Context, objs []*storage.ComplianceOperatorCheckResult) error {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.UpdateMany, "ComplianceOperatorCheckResult")
...
func (s *storeImpl) Count(ctx context.Context) (int, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Count, "ComplianceOperatorCheckResult")
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.ComplianceOperatorCheckResult, []int, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.GetMany, "ComplianceOperatorCheckResult")
