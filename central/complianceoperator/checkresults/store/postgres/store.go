...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ComplianceOperatorCheckResult, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.ComplianceOperatorCheckResult](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.ComplianceOperatorCheckResult, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.ComplianceOperatorCheckResult](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ComplianceOperatorCheckResult) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchema[storage.ComplianceOperatorCheckResult](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
...
func dropTableComplianceOperatorCheckResults(ctx context.Context, db *pgxpool.Pool) {
