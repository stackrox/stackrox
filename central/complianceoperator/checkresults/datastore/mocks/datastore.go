...
func (mr *MockDataStoreMockRecorder) Delete(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockDataStore)(nil).Delete), ctx, id)
}

// Upsert mocks base method.
func (m *MockDataStore) Upsert(ctx context.Context, result *storage.ComplianceOperatorCheckResult) error {
	m.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) Upsert(ctx, result interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upsert", reflect.TypeOf((*MockDataStore)(nil).Upsert), ctx, result)
}

// Walk mocks base method.
func (m *MockDataStore) Walk(ctx context.Context, fn func(*storage.ComplianceOperatorCheckResult) error) error {
	m.ctrl.T.Helper()
