...
func (mr *MockDataStoreMockRecorder) DeleteScanConfiguration(ctx, id interface{}) *gomock.Call {
...
func (mr *MockDataStoreMockRecorder) GetScanConfigClusterStatus(ctx, scanID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockDataStore) GetScanConfiguration(ctx context.Context, id string) (*storage.ComplianceOperatorScanSettingV2, bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetScanConfiguration", ctx, id)
	ret0, _ := ret[0].(*storage.ComplianceOperatorScanSettingV2)
	ret1, _ := ret[1].(bool)
	ret2, _ := ret[2].(error)
...
func (mr *MockDataStoreMockRecorder) GetScanConfiguration(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// GetScanConfigurationExists mocks base method.
func (m *MockDataStore) GetScanConfigurationExists(ctx context.Context, scanName string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetScanConfigurationExists", ctx, scanName)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetScanConfigurationExists indicates an expected call of GetScanConfigurationExists.
func (mr *MockDataStoreMockRecorder) GetScanConfigurationExists(ctx, scanName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetScanConfigurationExists", reflect.TypeOf((*MockDataStore)(nil).GetScanConfigurationExists), ctx, scanName)
}

// GetScanConfigurations mocks base method.
func (m *MockDataStore) GetScanConfigurations(ctx context.Context, query *v1.Query) ([]*storage.ComplianceOperatorScanSettingV2, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) GetScanConfigurations(ctx, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) UpdateClusterStatus(ctx, scanID, clusterID, clusterStatus interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockDataStore) UpsertScanConfiguration(ctx context.Context, scanConfig *storage.ComplianceOperatorScanSettingV2) error {
	m.ctrl.T.Helper()
...
func (mr *MockDataStoreMockRecorder) UpsertScanConfiguration(ctx, scanConfig interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
