...
// Source: central/complianceoperator/v2/scanconfigurations/datastore/datastore.go
...
func (mr *MockDataStoreMockRecorder) CountScanConfigurations(ctx, q interface{}) *gomock.Call {
...
func (mr *MockDataStoreMockRecorder) ScanConfigurationExists(ctx, scanName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
