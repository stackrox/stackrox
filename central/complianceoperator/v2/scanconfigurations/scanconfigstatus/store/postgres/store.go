...
func insertIntoComplianceOperatorClusterScanConfigStatuses(batch *pgx.Batch, pool pgSearch.BufferPool, obj *storage.ComplianceOperatorClusterScanConfigStatus) (*[]byte, error) {
...
func copyFromComplianceOperatorClusterScanConfigStatuses(ctx context.Context, s pgSearch.Deleter, tx *postgres.Tx, pool pgSearch.BufferPool, objs ...*storage.ComplianceOperatorClusterScanConfigStatus) error {
	if len(objs) == 0 {
		return nil
	}
