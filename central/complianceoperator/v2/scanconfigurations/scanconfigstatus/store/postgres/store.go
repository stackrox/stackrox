...
func insertIntoComplianceOperatorClusterScanConfigStatuses(ctx context.Context, batch *pgx.Batch, obj *storage.ComplianceOperatorClusterScanConfigStatus) error {
