...
func Singleton() Service {
	...
	serviceInstanceInit.Do(func() {
		serviceInstance = New(resultsDS.Singleton(), configDS.Singleton(), complianceIntegrationDS.Singleton(), profileDatastore.Singleton(), scanDS.Singleton(), ruleDS.Singleton(), clusterDatastore.Singleton())
	})
