...
type DataStore interface {
	Walk(ctx context.Context, fn func(result *storage.ComplianceOperatorCheckResultV2) error) error
	Upsert(ctx context.Context, result *storage.ComplianceOperatorCheckResultV2) error
...
func (d *datastoreImpl) Walk(ctx context.Context, fn func(result *storage.ComplianceOperatorCheckResultV2) error) error {
...
func (d *datastoreImpl) Upsert(ctx context.Context, result *storage.ComplianceOperatorCheckResultV2) error {
