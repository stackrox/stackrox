...
func initialize() {
	instance = New(checkResults.Singleton(), notifierProcessor.Singleton(), profileDS.Singleton(), remediationDS.Singleton(), scanDS.Singleton(), benchmarksDS.Singleton(), complianceRuleDS.Singleton(), snapshotDS.Singleton())
}
