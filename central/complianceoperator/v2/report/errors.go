...
const (
	...
	SCAN_TIMEOUT                     = "Timeout waiting for scan %s to finish"
	SCAN_TIMEOUT_SENSOR_DISCONNECTED = "Timeout waiting for scan %s to finish (Sensor disconnect during the scan)"
)
