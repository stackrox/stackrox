...
func (m *managerImpl) ProcessScanRequest(ctx context.Context, scanRequest *storage.ComplianceOperatorScanSettingV2, clusters []string) (*storage.ComplianceOperatorScanSettingV2, error) {
	if !features.ComplianceEnhancements.Enabled() {
		return nil, nil
	}
