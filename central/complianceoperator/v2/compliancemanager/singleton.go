...
func Singleton() Manager {
	once.Do(func() {
		manager = New(connection.ManagerSingleton(), compIntegration.Singleton(), compScanSetting.Singleton(), ssbDatastore.Singleton(), clusterDatastore.Singleton(), profileDatastore.Singleton(), scansDatastore.Singleton(), resultsDatastore.Singleton())
	})
	return manager
}
