...
type Manager interface {
	...
	ProcessScanRequest(ctx context.Context, scanRequest *storage.ComplianceOperatorScanSettingV2, clusters []string) (*storage.ComplianceOperatorScanSettingV2, error)
