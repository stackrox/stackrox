...
func buildScanConfigSensorMsg(msgID string, cron string, profiles []string, profileRefs []*central.ApplyComplianceScanConfigRequest_ProfileReference, configName string, createConfig bool) *central.MsgToSensor {
	if createConfig {
