...
type Store interface {
	...
	GetMany(ctx context.Context, identifiers []string) ([]*storage.ComplianceOperatorScanSettingBinding, []int, error)
...
type storeImpl struct {
	*pgSearch.GenericStore[storage.ComplianceOperatorScanSettingBinding, *storage.ComplianceOperatorScanSettingBinding]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		db: db,
		GenericStore: pgSearch.NewGenericStore[storage.ComplianceOperatorScanSettingBinding, *storage.ComplianceOperatorScanSettingBinding](
			db,
			schema,
			pkGetter,
...
func pkGetter(obj *storage.ComplianceOperatorScanSettingBinding) string {
	return obj.GetId()
}

func metricsSetPostgresOperationDurationTime(start time.Time, op ops.Op) {
	metrics.SetPostgresOperationDurationTime(start, op, "ComplianceOperatorScanSettingBinding")
}

func metricsSetAcquireDBConnDuration(start time.Time, op ops.Op) {
	metrics.SetAcquireDBConnDuration(start, op, "ComplianceOperatorScanSettingBinding")
}
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.ComplianceOperatorScanSettingBinding, []int, error) {
