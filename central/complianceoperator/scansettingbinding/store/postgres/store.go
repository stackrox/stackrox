...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ComplianceOperatorScanSettingBinding, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.ComplianceOperatorScanSettingBinding](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, identifiers []string) ([]*storage.ComplianceOperatorScanSettingBinding, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchema[storage.ComplianceOperatorScanSettingBinding](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ComplianceOperatorScanSettingBinding) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchema[storage.ComplianceOperatorScanSettingBinding](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
