...
func copyFromComplianceOperatorScanSettingBindings(ctx context.Context, s pgSearch.Deleter, tx *postgres.Tx, objs ...*storage.ComplianceOperatorScanSettingBinding) error {
	...
	for objBatch := range slices.Chunk(objs, batchSize) {
		...
		if _, err := tx.CopyFrom(ctx, pgx.Identifier{"compliance_operator_scan_setting_bindings"}, copyColsComplianceOperatorScanSettingBindings, pgx.CopyFromRows(inputRows)); err != nil {
			return err
		}
