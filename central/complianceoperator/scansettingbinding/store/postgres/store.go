...
type storeImpl struct {
	*pgSearch.GenericSingleIDStore[storage.ComplianceOperatorScanSettingBinding, *storage.ComplianceOperatorScanSettingBinding]
	db    postgres.DB
	mutex sync.RWMutex
}
...
func New(db postgres.DB) Store {
	return &storeImpl{
		GenericSingleIDStore: pgSearch.NewGenericSingleIDStore[storage.ComplianceOperatorScanSettingBinding, *storage.ComplianceOperatorScanSettingBinding](
			db,
