...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ComplianceOperatorScanSettingBinding, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.ComplianceOperatorScanSettingBinding](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.ComplianceOperatorScanSettingBinding, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.ComplianceOperatorScanSettingBinding](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ComplianceOperatorScanSettingBinding) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchemaType[storage.ComplianceOperatorScanSettingBinding](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
