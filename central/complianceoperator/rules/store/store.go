...
func (b *storeImpl) Get(_ context.Context, id string) (*storage.ComplianceOperatorRule, bool, error) {
...
func (b *storeImpl) GetMany(_ context.Context, ids []string) ([]*storage.ComplianceOperatorRule, []int, error) {
...
func (b *storeImpl) Upsert(_ context.Context, obj *storage.ComplianceOperatorRule) error {
