...
func (mr *MockStoreMockRecorder) Upsert(ctx, backup any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Upsert", reflect.TypeOf((*MockStore)(nil).Upsert), ctx, backup)
}

// Walk mocks base method.
func (m *MockStore) Walk(ctx context.Context, fn func(*storage.ExternalBackup) error, useClones bool) error {
	m.ctrl.T.Helper()
