...
func (s *storeImpl) Exists(ctx context.Context, id string) (bool, error) {
	defer metrics.SetPostgresOperationDurationTime(time.Now(), ops.Exists, "ImageIntegration")
...
func (s *storeImpl) GetByQuery(ctx context.Context, query *v1.Query) ([]*storage.ImageIntegration, error) {
	...
	rows, err := pgSearch.RunGetManyQueryForSchema[storage.ImageIntegration](ctx, schema, query, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ImageIntegration) error) error {
	fetcher, closer, err := pgSearch.RunCursorQueryForSchema[storage.ImageIntegration](ctx, schema, search.EmptyQuery(), s.db)
	if err != nil {
		return err
	}
	defer closer()
