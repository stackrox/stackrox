...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ImageIntegration, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchemaType[storage.ImageIntegration](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) GetMany(ctx context.Context, ids []string) ([]*storage.ImageIntegration, []int, error) {
	...
	rows, err := postgres.RunGetManyQueryForSchemaType[storage.ImageIntegration](ctx, schema, q, s.db)
	if err != nil {
