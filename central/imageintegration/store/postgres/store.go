...
func (s *storeImpl) Get(ctx context.Context, id string) (*storage.ImageIntegration, bool, error) {
	...
	data, err := postgres.RunGetQueryForSchema[storage.ImageIntegration](ctx, schema, q, s.db)
	if err != nil {
...
func (s *storeImpl) Walk(ctx context.Context, fn func(obj *storage.ImageIntegration) error) error {
	...
	fetcher, closer, err := postgres.RunCursorQueryForSchema[storage.ImageIntegration](ctx, schema, sacQueryFilter, s.db)
	if err != nil {
		return err
	}
	defer closer()
