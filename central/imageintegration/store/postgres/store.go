...
func New(ctx context.Context, db *pgxpool.Pool) Store {
	pgutils.CreateTable(ctx, db, pkgSchema.CreateTableImageIntegrationsStmt)
...
func insertIntoImageIntegrations(ctx context.Context, tx pgx.Tx, obj *storage.ImageIntegration) error {
...
func (s *storeImpl) upsert(ctx context.Context, objs ...*storage.ImageIntegration) error {
	...
	for _, obj := range objs {
		...
		if err := insertIntoImageIntegrations(ctx, tx, obj); err != nil {
			if err := tx.Rollback(ctx); err != nil {
				return err
			}
			return err
