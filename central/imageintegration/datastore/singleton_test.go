...
func mustUpdateSourcedAutogenFeature(t *testing.T, desired bool) {
	t.Setenv(features.SourcedAutogeneratedIntegrations.EnvVar(), fmt.Sprintf("%t", desired))
...
func TestDeleteAutogeneratedRegistries(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			t.Setenv(env.AutogeneratedRegistriesDisabled.EnvVar(), fmt.Sprintf("%t", !tc.autogenEnabled))
