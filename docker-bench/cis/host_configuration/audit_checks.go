...
import "bitbucket.org/stack-rox/apollo/docker-bench/utils"

// NewDockerDaemonAudit implements CIS-1.5
func NewDockerDaemonAudit() utils.Benchmark {
...
func NewVarLibDockerAudit() utils.Benchmark {
...
func NewEtcDockerAudit() utils.Benchmark {
...
func NewDockerServiceAudit() utils.Benchmark {
...
func NewDockerSocketAudit() utils.Benchmark {
...
func NewEtcDefaultDockerAudit() utils.Benchmark {
...
func NewEtcDockerDaemonJSONAudit() utils.Benchmark {
...
func NewUsrBinContainerdAudit() utils.Benchmark {
...
func NewUsrBinRundAudit() utils.Benchmark {
