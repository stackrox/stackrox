...
- ROX-26374: Upgrading from a version prior to 4.6 will not be supported. If upgrading from a version prior to 4.6 an upgrade to 4.6, 4.7, 4.8 or 4.9 must be performed before upgrading to 4.10. Similarly, once on 4.10, rollback to a version prior to 4.6 is no longer supported.  For example:
