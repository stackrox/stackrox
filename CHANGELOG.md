...
- Vulnerability exception management for host(/node) and platform(/cluster) vulnerabilities has been deprecated and 
will be removed in the future. Once removed, exceptions/deferral cannot be created for host and platform vulnerabilities 
