...
- The manifest install method is now deprecated and will be removed in the future. Manifest install is currently done using the roxctl command line utility, or by choosing the "Legacy installation method" in the UI. Users should switch to Operator or Helm installation.
