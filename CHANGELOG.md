...
- ROX-36383: RHEL virtual machines created using OpenShift Virtualization can now be scanned for package vulnerabilities after installing the roxagent in the VM Guest OS.
