...
- Helm and Operator now support installing a Scanner with Secured Cluster installations on OpenShift to scan images in cluster local registries. If not disabled the operator automatically installs the scanner on a Secured Cluster.
