...
### Technical Changes
- ROX-36885: Unmatched virtual machine packages (no usable repository CPE) now show as not scanned on the V2 VM API, including ListVMs component counts. Previously they appeared as scanned with no CVEs.
