...
- **Groovy/Spock Tests** (`qa-tests-backend/`) - Job pattern: `*-qa-e2e-tests`
- **Go Integration Tests** (`tests/`) - Job patterns: `*-compliance-e2e-tests`, `*-compatibility-tests`, `*-nongroovy-*`

**MCP Integration:**
- **JIRA Investigation** via `mcp-atlassian` for automatic ticket analysis
