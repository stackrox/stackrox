...
func TestReadConfig(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedInstanceName: "profile-1",
		...
		},
		{
			...
			expectedInstanceName: "dev-environment",
		...
		},
		{
			...
			expectedInstanceName: "staging-profile",
		...
		},
		{
			...
			expectedInstanceName: "production-profile",
		...
		},
		{
			...
			expectedInstanceName: "test-profile",
