...
func generateCommand(cliEnvironment environment.Environment) *cobra.Command {
	...
	c.PersistentFlags().Uint32Var(&maxRegistrations, "max-registrations", 1, "Specify after how many cluster registrations the CRS will be revoked automatically, use 0 for no limit (default: 1)")
