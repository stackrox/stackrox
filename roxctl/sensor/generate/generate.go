...
func Command(cliEnvironment environment.Environment) *cobra.Command {
	...
	c.PersistentFlags().Var(&collectionTypeWrapper{CollectionMethod: &generateCmd.cluster.CollectionMethod}, "collection-method", "which collection method to use for runtime support (none, default, kernel-module, ebpf, core_bpf). Note that core_bpf is on Tech Preview stage")
