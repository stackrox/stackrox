...
func newDeploymentEventFromResource(obj interface{}, action *central.ResourceAction, deploymentType, clusterID string,
	lister v1listers.PodLister, namespaceStore *namespaces.NamespaceStore, hierarchy references.ParentHierarchy, registryOverride string,
...
func (w *deploymentWrap) populateNonStaticFields(obj interface{}, action *central.ResourceAction, lister v1listers.PodLister,
	namespaceStore *namespaces.NamespaceStore, hierarchy references.ParentHierarchy,
...
func (w *deploymentWrap) populateNamespaceID(namespaceStore *namespaces.NamespaceStore,
