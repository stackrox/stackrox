...
func New(client client.Interface, configHandler config.Handler, nodeName string, resyncPeriod time.Duration, traceWriter io.Writer, queue component.OutputQueue) common.SensorComponent {
	k := &listenerImpl{
		client:             client,
