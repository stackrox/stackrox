...
type ResourceEvent struct {
	...
	ForwardMessages []*EventCallbackPair
...
func newEventCallbackPair(event *central.SensorEvent, callback func()) *EventCallbackPair {
...
func NewEvent(msg ...*central.SensorEvent) *ResourceEvent {
	var msgs []*EventCallbackPair
	for _, m := range msg {
		msgs = append(msgs, newEventCallbackPair(m, nil))
	}
	return &ResourceEvent{ForwardMessages: msgs, Context: context.Background()}
}

func (e *ResourceEvent) AddSensorEventWithCallback(event *central.SensorEvent, callback func()) *ResourceEvent {
	e.ForwardMessages = append(e.ForwardMessages, newEventCallbackPair(event, callback))
	return e
}
...
func (e *ResourceEvent) AddSensorEvent(event ...*central.SensorEvent) *ResourceEvent {
	...
	e.ForwardMessages = append(e.ForwardMessages, msgs...)
	return e
}
