...
func (m *MockPipelineComponent) ResponsesC() <-chan *central.MsgFromSensor {
	m.ctrl.T.Helper()
...
func (mr *MockPipelineComponentMockRecorder) ResponsesC() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResponsesC", reflect.TypeOf((*MockPipelineComponent)(nil).ResponsesC))
}
...
func (m *MockOutputQueue) Send(detectionObject *component.ResourceEvent) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Send", detectionObject)
}

// Send indicates an expected call of Send.
func (mr *MockOutputQueueMockRecorder) Send(detectionObject interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Send", reflect.TypeOf((*MockOutputQueue)(nil).Send), detectionObject)
}
