...
func CreateSensor(cfg *CreateOptions) (*sensor.Sensor, error) {
	...
	networkFlowManager :=
		manager.NewManager(storeProvider.Entities(), externalsrcs.StoreInstance(), policyDetector, pubSub, updatecomputer.NewCategorized(), manager.WithEnrichTicker(cfg.networkFlowTicker))
