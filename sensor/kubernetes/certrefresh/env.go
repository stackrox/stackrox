...
// SENSOR_CA_ROTATION_ENABLED enables Sensor to advertise CA rotation support to Central.
...
var sensorCARotationEnabled = env.RegisterBooleanSetting("SENSOR_CA_ROTATION_ENABLED", false)
