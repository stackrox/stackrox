...
// Source: github.com/stackrox/rox/sensor/common/admissioncontroller (interfaces: SettingsManager)
...
func (m *MockSettingsManager) UpdateConfig(arg0 *storage.DynamicClusterConfig) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "UpdateConfig", arg0)
}

// UpdateConfig indicates an expected call of UpdateConfig
func (mr *MockSettingsManagerMockRecorder) UpdateConfig(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateConfig", reflect.TypeOf((*MockSettingsManager)(nil).UpdateConfig), arg0)
}

// UpdatePolicies mocks base method
func (m *MockSettingsManager) UpdatePolicies(arg0 []*storage.Policy) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "UpdatePolicies", arg0)
}

// UpdatePolicies indicates an expected call of UpdatePolicies
func (mr *MockSettingsManagerMockRecorder) UpdatePolicies(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatePolicies", reflect.TypeOf((*MockSettingsManager)(nil).UpdatePolicies), arg0)
}

// UpdateResources mocks base method
func (m *MockSettingsManager) UpdateResources(arg0 ...*central.SensorEvent) {
	m.ctrl.T.Helper()
	varargs := []interface{}{}
	for _, a := range arg0 {
...
func (mr *MockSettingsManagerMockRecorder) UpdateResources(arg0 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateResources", reflect.TypeOf((*MockSettingsManager)(nil).UpdateResources), arg0...)
}
