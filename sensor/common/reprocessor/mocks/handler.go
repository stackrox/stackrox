...
func (mr *MockHandlerMockRecorder) ProcessInvalidateImageCache(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockHandlerMockRecorder) ProcessReprocessDeployments(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
