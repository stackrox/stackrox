...
// Source: sensor/common/compliance/service.go
...
func (mr *MockServiceMockRecorder) AuthFuncOverride(ctx, fullMethodName interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) RegisterServiceServer(server interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) RunScrape(msg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
