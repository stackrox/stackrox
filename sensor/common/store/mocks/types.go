...
>>>>>>> 31b2bd8a0d (service and netpol now use DeploymentReferences)
	ret0, _ := ret[0].([]string)
	return ret0
}
...
// OnDeploymentRemoveByID mocks base method.
func (m *MockEndpointManager) OnDeploymentRemoveByID(id string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "OnDeploymentRemoveByID", id)
}

// OnDeploymentRemoveByID indicates an expected call of OnDeploymentRemoveByID.
func (mr *MockEndpointManagerMockRecorder) OnDeploymentRemoveByID(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnDeploymentRemoveByID", reflect.TypeOf((*MockEndpointManager)(nil).OnDeploymentRemoveByID), id)
}
