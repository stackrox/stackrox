...
func New(clusterIDGetter clusterIDGetter, enforcer enforcer.Enforcer, admCtrlSettingsMgr admissioncontroller.SettingsManager,
	...
	return &detectorImpl{
		...
		enricher:            newEnricher(clusterIDGetter, cache, serviceAccountStore, registryStore, localScan),
