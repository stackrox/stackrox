...
// optimizedBaselineEvaluatorXXHash implements memory-optimized baseline evaluation using process set deduplication
type optimizedBaselineEvaluatorXXHash struct {
...
func newOptimizedBaselineEvaluatorXXHash() Evaluator {
	return &optimizedBaselineEvaluatorXXHash{
...
func (oe *optimizedBaselineEvaluatorXXHash) RemoveDeployment(id string) {
	oe.lock.Lock()
...
func (oe *optimizedBaselineEvaluatorXXHash) AddBaseline(baseline *storage.ProcessBaseline) {
	oe.lock.Lock()
	defer oe.lock.Unlock()
...
func (oe *optimizedBaselineEvaluatorXXHash) removeBaseline(baseline *storage.ProcessBaseline) {
...
func (oe *optimizedBaselineEvaluatorXXHash) findOrCreateProcessSet(processes set.StringSet) XXHashKey {
...
func (oe *optimizedBaselineEvaluatorXXHash) IsOutsideLockedBaseline(pi *storage.ProcessIndicator) bool {
	if pi == nil {
