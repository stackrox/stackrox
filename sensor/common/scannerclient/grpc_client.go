...
func convertIndexReportToAnalysis(ctx context.Context, ir *v4.IndexReport, indexerVersion string) *ImageAnalysis {
...
func (c *v4Client) GetImageAnalysis(ctx context.Context, image *storage.Image, cfg *types.Config) (*ImageAnalysis, error) {
	...
	imageAnalysis := convertIndexReportToAnalysis(ctx, ir, scannerVersion.Indexer)
