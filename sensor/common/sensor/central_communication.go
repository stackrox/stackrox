...
type CentralCommunication interface {
	Start(client central.SensorServiceClient, centralReachable *concurrency.Flag, syncDone *concurrency.Signal, onSyncDoneCallback func(), handler config.Handler, detector detector.Detector)
	Stop(error)
