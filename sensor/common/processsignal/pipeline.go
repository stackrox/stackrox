...
// fields on a ProcessIndicator from the cluster entities store.
func PopulateIndicatorFromContainer(indicator *storage.ProcessIndicator, cachedContainer clusterentities.ContainerMetadata) {
