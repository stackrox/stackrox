...
func (mr *MockEntityStoreMockRecorder) RegisterPublicIPsListener(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEntityStoreMockRecorder) UnregisterPublicIPsListener(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
