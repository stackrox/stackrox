...
func (m *MockStore) CollectorConfigValueStream() concurrency.ReadOnlyValueStream[*sensor.CollectorConfig] {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) CollectorConfigValueStream() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CollectorConfigValueStream", reflect.TypeOf((*MockStore)(nil).CollectorConfigValueStream))
}
