...
class ImageIntegrationService extends BaseService {
    ...
    static ImageIntegrationServiceGrpc.ImageIntegrationServiceBlockingStub getImageIntegrationClient() {
    ...
    static List<ImageIntegrationOuterClass.ImageIntegration> getImageIntegrations() {
    ...
    static ImageIntegrationOuterClass.ImageIntegration getImageIntegrationByName(String name) {
