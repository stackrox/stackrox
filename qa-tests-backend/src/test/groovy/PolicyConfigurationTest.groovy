...
class PolicyConfigurationTest extends BaseSpecification {
    ...
    static final private Deployment NGINX_WITH_DIGEST = new Deployment()
            ...
            .setImage("quay.io/rhacs-eng/qa-multi-arch:nginx-1.21.1@sha256:a05b0cdd4fc1be3b224ba9662ebdf98fe44c09c0c9215b45f84344c12867002e")
    ...
    static final private Deployment NGINX_LATEST = new Deployment()
            ...
            .setImage("quay.io/rhacs-eng/qa-multi-arch:latest@sha256:a05b0cdd4fc1be3b224ba9662ebdf98fe44c09c0c9215b45f84344c12867002e")
            .setCommand(["sleep", "60000"])
            .setSkipReplicaWait(false)
