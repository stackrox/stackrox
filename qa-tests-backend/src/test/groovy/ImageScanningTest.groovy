...
class ImageScanningTest extends BaseSpecification {
    ...
    def "Verify Image Scanner Integrations: #testName"() {
        ...
        testName            | integration |
                ...
                components | totalCves | fixable | cves | deleteAutoGenerated

        /* The full quay test should look like the below, ROX-4001 will causes this test to fail
        "quay"      | { ImageIntegrationService.addDefaultQuayRegistry() } |
                165        | 184       | 28      |
        ...
        */
        ...
        "quay-keep-autogenerated"              | "quay"      |
                ...
                165 | null | null | ["CVE-2017-8804", "CVE-2017-9614"] | false

        "quay"              | "quay"      |
                [{ ImageIntegrationService.addDefaultQuayRegistry() },] |
                165 | null | null | ["CVE-2017-8804", "CVE-2017-9614"] | true
