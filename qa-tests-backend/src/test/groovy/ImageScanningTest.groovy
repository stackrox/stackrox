...
class ImageScanningTest extends BaseSpecification {
    ...
    static final private String OCI_IMAGE   = "quay.io/cgorman1/qa:oci-manifest"
    ...
    static final private String CENTOS_ECHO_IMAGE = "quay.io/cgorman1/qa:centos7-base-echo"
