...
class ImageSignatureVerificationTest extends BaseSpecification {
    ...
    static final private String REFERRER_KEYLESS_SIGSTORE_MATCHING = "Referrer-Keyless-Sigstore-Matching"
    static final private String REFERRER_KEYLESS_SIGSTORE_UNVERIFIABLE = "Referrer-Keyless-Sigstore-Unverifiable"
    ...
    static final private List<String> INTEGRATION_NAMES = [
            ...
            REFERRER_KEYLESS_SIGSTORE_MATCHING,
            REFERRER_KEYLESS_SIGSTORE_UNVERIFIABLE,
    ]
...
-----END PUBLIC KEY-----"""
    ...
    def setupSpec() {
        ...
        // Signature integration for referrer signed keyless via public Sigstore.
        String referrerKeylessSigstoreMatchingID = createSignatureIntegration(
            REFERRER_KEYLESS_SIGSTORE_MATCHING, NO_PUBLIC_KEYS,
            new CertificateVerificationArgs(
                chain: "",
                identity: KEYLESS_SIGSTORE_IDENTITY,
                issuer: KEYLESS_SIGSTORE_ISSUER,
        ...
        assert referrerKeylessSigstoreMatchingID
        CREATED_SIGNATURE_INTEGRATIONS.put(REFERRER_KEYLESS_SIGSTORE_MATCHING, referrerKeylessSigstoreMatchingID)

        // Referrer keyless with disabled transparency log.
        String referrerKeylessSigstoreUnverifiableID = createSignatureIntegration(
            REFERRER_KEYLESS_SIGSTORE_UNVERIFIABLE, NO_PUBLIC_KEYS,
            new CertificateVerificationArgs(
                chain: "",
                identity: KEYLESS_SIGSTORE_IDENTITY,
                issuer: KEYLESS_SIGSTORE_ISSUER,
        ...
        assert referrerKeylessSigstoreUnverifiableID
        CREATED_SIGNATURE_INTEGRATIONS.put(REFERRER_KEYLESS_SIGSTORE_UNVERIFIABLE,
            referrerKeylessSigstoreUnverifiableID)
    ...
    def "Check violations of policy '#policyName' for deployment '#deployment.name'"() {
        ...
        KEYLESS_SIGSTORE_MATCHING                  | REFERRER_KEYLESS_SIGSTORE_MATCHING_DEPLOYMENT      | true
        ...
        // Referrer keyless matching: only the matching deployment passes.
        REFERRER_KEYLESS_SIGSTORE_MATCHING          | REFERRER_BYOPKI_DEPLOYMENT                     | true
        REFERRER_KEYLESS_SIGSTORE_MATCHING          | REFERRER_PUBKEY_MATCHING_DEPLOYMENT             | true
        REFERRER_KEYLESS_SIGSTORE_MATCHING          | REFERRER_KEYLESS_SIGSTORE_MATCHING_DEPLOYMENT   | false
        REFERRER_KEYLESS_SIGSTORE_MATCHING          | DISTROLESS_DEPLOYMENT                           | true
        REFERRER_KEYLESS_SIGSTORE_MATCHING          | TEKTON_DEPLOYMENT                               | true
        REFERRER_KEYLESS_SIGSTORE_MATCHING          | WITHOUT_SIGNATURE_DEPLOYMENT                    | true
        // Referrer keyless with disabled tlog: all deployments alert.
        REFERRER_KEYLESS_SIGSTORE_UNVERIFIABLE      | REFERRER_BYOPKI_DEPLOYMENT                     | true
        REFERRER_KEYLESS_SIGSTORE_UNVERIFIABLE      | REFERRER_PUBKEY_MATCHING_DEPLOYMENT             | true
        REFERRER_KEYLESS_SIGSTORE_UNVERIFIABLE      | REFERRER_KEYLESS_SIGSTORE_MATCHING_DEPLOYMENT   | true
        REFERRER_KEYLESS_SIGSTORE_UNVERIFIABLE      | DISTROLESS_DEPLOYMENT                           | true
        REFERRER_KEYLESS_SIGSTORE_UNVERIFIABLE      | TEKTON_DEPLOYMENT                               | true
        REFERRER_KEYLESS_SIGSTORE_UNVERIFIABLE      | WITHOUT_SIGNATURE_DEPLOYMENT                    | true
    }
