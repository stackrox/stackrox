...
-----END CERTIFICATE-----"""
    ...
    static final private String KEYLESS_WILDCARD_ISSUER = "https://github.com/login/oauth"
    static final private String KEYLESS_WILDCARD_IDENTITY = ".*@redhat.com"
    ...
    static final private String KEYLESS_IMAGE_DIGEST =
            "sha256:7b3ccabffc97de872a30dfd234fd972a66d247c8cfc69b0550f276481852627c"
    ...
    static final private Deployment KEYLESS_SIGSTORE_DEPLOYMENT = new Deployment()
            ...
            .setImage("quay.io/stehessel/qa-signatures:keyless@" + KEYLESS_IMAGE_DIGEST)
    ...
    def setupSpec() {
        ...
        String keylessSigstoreMatchingSignatureIntegrationID = createSignatureIntegration(
                KEYLESS_SIGSTORE_MATCHING, [:], "", KEYLESS_WILDCARD_IDENTITY, KEYLESS_WILDCARD_ISSUER, true
        )
        ...
        String keylessSigstoreUnverifiableSignatureIntegrationID = createSignatureIntegration(
                KEYLESS_SIGSTORE_UNVERIFIABLE, [:], "", KEYLESS_WILDCARD_IDENTITY, KEYLESS_WILDCARD_ISSUER, false
        )
    ...
    def "Check violations of policy '#policyName' for deployment '#deployment.name'"() {
        ...
        // one running the keyless signed image.
    ...
    private static String createSignatureIntegration(
            ...
            String identity = "", String issuer = "", enableTlog = false) {
        ...
        if (identity != "" && issuer != "") {
            CosignCertificateVerification verification = CosignCertificateVerification.newBuilder()
                ...
                .setCertificateTransparencyLog(CertificateTransparencyLogVerification.newBuilder()
                    .setEnabled(enableTlog)
                    .build()
                )

            builder.addCosignCertificates(verification.build())
        }
