...
-----END PUBLIC KEY-----"""
    ...
    static final private String KEYLESS_RHTAS_IMAGE_DIGEST =
            "sha256:ec15a5bd53cf9507beb851574654669e778a9735f8e605e0ee3d71fd07debbe1"
    ...
    static final private Deployment KEYLESS_RHTAS_DEPLOYMENT = new Deployment()
            ...
            .setImage("quay.io/stehessel/qa-signatures:keyless@" + KEYLESS_RHTAS_IMAGE_DIGEST)
    ...
    def setupSpec() {
        ...
        String keylessSigstoreMatchingSignatureIntegrationID = createSignatureIntegration(
            ...
            ctlogEnabled: true],
            [enabled: true, url: KEYLESS_SIGSTORE_REKOR_URL]
        )
        ...
        String keylessRHTASMatchingSignatureIntegrationID = createSignatureIntegration(
            KEYLESS_RHTAS_MATCHING, [:],
            [chain: KEYLESS_RHTAS_FULCIO_CHAIN, identity: KEYLESS_RHTAS_IDENTITY, issuer: KEYLESS_RHTAS_ISSUER,
            ctlogEnabled: true, ctlogPublicKey: ""],
            [enabled: true, url: KEYLESS_RHTAS_REKOR_URL, publicKey: KEYLESS_RHTAS_REKOR_PUBLIC_KEY]
        )
        ...
        String keylessRHTASUnverifiableSignatureIntegrationID = createSignatureIntegration(
            KEYLESS_RHTAS_UNVERIFIABLE, [:],
            [chain: KEYLESS_RHTAS_FULCIO_CHAIN, identity: KEYLESS_RHTAS_IDENTITY, issuer: KEYLESS_RHTAS_ISSUER,
            ctlogEnabled: true, ctlogPublicKey: KEYLESS_RHTAS_CTLOG_PUBLIC_KEY],
            [enabled: true, url: KEYLESS_RHTAS_REKOR_URL, publicKey: KEYLESS_RHTAS_REKOR_PUBLIC_KEY]
        )
