...
class BuiltinPoliciesTest extends BaseSpecification {
    ...
    @Shared
    private String manuallyCreatedGCRId = ""
    ...
    def setupSpec() {
        ...
        if ({ Env.IN_CI && Env.get("CIRCLE_JOB").contains("openshift-rhel") }) {
            ...
            manuallyCreatedGCRId = handleUnreliableGCRAutoGenerate()
        }
    ...
    def cleanupSpec() {
        ...
        if (manuallyCreatedGCRId) {
            ImageIntegrationService.deleteImageIntegration(manuallyCreatedGCRId)
        }
    ...
    def handleUnreliableGCRAutoGenerate() {
        Boolean autogenerated = false
        Timer t = new Timer(10, 6)
        while (!autogenerated && t.IsValid()) {
            autogenerated = ImageIntegrationService.getImageIntegrations().any
        ...
        return ImageIntegrationService.createImageIntegration(integration)
    }
}
