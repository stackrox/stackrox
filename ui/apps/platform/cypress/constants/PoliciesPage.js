...
export const selectors = {
    ...
    step3: {
        ...
        policySection: {
            ...
            deleteBtn: '[aria-label="Delete policy section"]',
            cards: '.policy-section-card-body',
            name: '[data-testid="policy-section-name"]',
            nameEditBtn: '.policy-section-card-header [aria-label="Edit name of policy section"]',
            nameSaveBtn: '.policy-section-card-header [aria-label="Save name of policy section"]',
        ...
        policyCriteria: {
            ...
            value: {
                ...
                addBtn: '[aria-label="Add value of policy field"]',
                deleteBtn: '[aria-label="Delete value of policy field"]',
            },
            deleteBtn: '[aria-label="Delete policy field"]',
