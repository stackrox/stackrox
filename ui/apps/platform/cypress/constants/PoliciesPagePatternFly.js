...
export const selectors = {
    ...
    step3: {
        ...
        policyCriteria: {
            ...
            // valueTextInput: '[data-testid="policy-criteria-value-text-input"]',
            // valueNumberInput: '[data-testid="policy-criteria-value-number-input"]',
            // valueRadioGroup: '[data-testid="policy-criteria-value-radio-group"]',
            // valueRadioGroupItem: '[data-testid="policy-criteria-value-radio-group-item"]',
            // valueRadioGroupString: '[data-testid="policy-criteria-value-radio-group-string"]',
            // valueRadioGroupStringItem:
            //     '[data-testid="policy-criteria-value-radio-group-string-item"]',
            // valueNegateCheckbox: '[data-testid="policy-criteria-value-negate-checkbox"]',
            // valueSelect: '[data-testid="policy-criteria-value-select"]',
            // valueSelectOption: '[data-testid="policy-criteria-value-select-option"]',
            // valueMultiselect: '[data-testid="policy-criteria-value-multiselect"]',
            // valueMultiselectOption: '[data-testid="policy-criteria-value-multiselect-option"]',
            deleteBtn: '[data-testid="delete-policy-criteria-btn"]',
            // addValueBtn: '[data-testid="add-policy-criteria-value-btn"]',
            // deleteValueBtn: '[data-testid="delete-policy-criteria-value-btn"]',
