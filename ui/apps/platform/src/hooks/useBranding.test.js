...
describe('useBranding', () => {
    ...
    it('should return Open Source Branding when productBranding is an invalid value', () => {
    ...
    it('should return Open Source Branding when productBranding is not defined', () => {
