...
export function overrideManagedColumns<
    Config extends Record<string, ColumnConfig>,
    Overrides extends Record<string, Partial<ColumnConfig>>,
>(managedColumns: Config, overrides: Overrides): Config {
