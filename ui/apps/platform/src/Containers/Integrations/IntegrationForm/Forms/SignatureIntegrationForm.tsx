        ...
        <>
            <PageSection variant="light" isFilled hasOverflowScroll>
                <Flex direction={{ default: 'column' }}>
                    <FlexItem>
                        <Text>
                            Image signatures are verified by ensuring that their signature has been
                            signed by a trusted image signer. Configure at least one trusted image
                            signer by specifying a Cosign public encryption key or a Cosign
                            certificate chain. Multiple image signers may be combined in a single
                    ...
                    <FlexItem>
                        <Text>
                            ...
                            expired. Communication with the transparency log Rekor is not supported.
                        </Text>
                    </FlexItem>
                    <FlexItem>
                        <Text>
