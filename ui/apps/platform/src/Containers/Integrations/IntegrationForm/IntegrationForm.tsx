...
} as Record<IntegrationSource, Record<IntegrationType, FunctionComponent<React.PropsWithChildren<FormProps>>>>;
...
function IntegrationForm({
    ...
    const Form: FunctionComponent<React.PropsWithChildren<FormProps>> = ComponentFormMap?.[source]?.[type];
    if (!Form) {
        throw new Error(
