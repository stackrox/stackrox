                        ...
                        >
                            <Tab eventKey={0} title={<TabTitleText>Core system</TabTitleText>}>
                                <div className="pf-v5-u-p-md">
                                    ...
                                    <Text>
                                        Components found in core Openshift and Kubernetes namespaces
                                    ...
                                    >
                                        <TextArea
                                            ...
                                            value={
                                                values?.platformComponentsConfigRules
                                                    ?.coreSystemRule.namespaceRule.regex
                                            }
                            ...
                            >
                                <div className="pf-v5-u-p-md">
                                    ...
                                    <Text>
                                        ...
                                        namespaces are included in the platform definition by
                                        default. Enter one or more namespaces using regex, separated
                                        by | (pipe symbol). For more information on the syntax
                                        structure, see{' '}
                                    ...
                                    >
                                        For guidance on adding new component namespaces introduced
                                        with the RHACS upgrade, please refer to the documentation.
                                        Use the reset button to revert all changes back to the
                                        default definition.
                                    </Alert>
                                    <Divider component="div" className="pf-v5-u-py-md" />
                                    <Flex alignItems={{ default: 'alignItemsCenter' }}>
                                        ...
                                        <FlexItem>
                                            <Tooltip
                                                content={<div>Reset to default definition</div>}
                                            >
                                                <Button
                                                    variant="plain"
                            ...
                            <Tab
                                eventKey={2}
                                title={<TabTitleText>Custom components</TabTitleText>}
                            >
                                <div className="pf-v5-u-p-md">
                                    ...
                                    <Text>
                                        ...
                                        namespaces using regex, separated by | (pipe symbol). For
                                        more information on the syntax structure, see{' '}
                                        <Button variant="link" isInline>
                                            RE2 syntax reference
                                        </Button>
                                        .
