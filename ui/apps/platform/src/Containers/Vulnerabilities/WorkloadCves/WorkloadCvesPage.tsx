...
function getWorkloadCveContextFromView(viewId: string, isFeatureFlagEnabled: IsFeatureFlagEnabled) {
    ...
    switch (viewId) {
        case userWorkloadViewId:
            if (isFeatureFlagEnabled('ROX_PLATFORM_CVE_SPLIT')) {
                ...
                pageTitleDescription =
                    'Vulnerabilities affecting images and workloads that are part of user applications';
        ...
        case platformViewId:
            ...
            pageTitleDescription =
                'Vulnerabilities affecting images and workloads used by the underlying kubernetes infrastructure';
        ...
        case allImagesViewId:
            pageTitle = 'All vulnerable workloads';
            pageTitleDescription =
        ...
        case inactiveImagesViewId:
            ...
            pageTitleDescription = 'View findings for images not currently deployed as workloads';
