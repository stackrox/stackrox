...
export type VirtualMachinePageVulnerabilitiesLegacyProps = {
...
function VirtualMachinePageVulnerabilitiesLegacy({
    ...
    urlSorting,
    urlPagination,
}: VirtualMachinePageVulnerabilitiesLegacyProps) {
...
export default VirtualMachinePageVulnerabilitiesLegacy;
