...
const riskIndicatorsTab = 'risk-tab-risk-indicators';
const deploymentDetailsTab = 'risk-tab-deployment-details';
const processDiscoveryTab = 'risk-tab-process-discovery';
