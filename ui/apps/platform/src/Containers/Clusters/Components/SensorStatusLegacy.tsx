...
type SensorStatusLegacyProps = {
    healthStatus: ClusterHealthStatus;
    isList?: boolean;
};

function SensorStatusLegacy({
    healthStatus,
    isList = false,
}: SensorStatusLegacyProps): ReactElement {
    ...
    const { Icon, fgColor } = healthStatusStylesLegacy[sensorHealthStatus];
...
export default SensorStatusLegacy;
