...
type AdmissionControlStatusLegacyProps = {
    healthStatus: ClusterHealthStatus;
    isList?: boolean;
};

function AdmissionControlStatusLegacy({
    healthStatus,
    isList = false,
}: AdmissionControlStatusLegacyProps): ReactElement {
    ...
    const { Icon, fgColor } = isDelayed
        ? delayedAdmissionControlStatusStyle
        : healthStatusStylesLegacy[admissionControlHealthStatus];
...
export default AdmissionControlStatusLegacy;
