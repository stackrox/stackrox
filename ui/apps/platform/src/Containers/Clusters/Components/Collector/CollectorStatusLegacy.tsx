...
type CollectorStatusLegacyProps = {
    healthStatus: ClusterHealthStatus;
    isList?: boolean;
};

function CollectorStatusLegacy({
    healthStatus,
    isList = false,
}: CollectorStatusLegacyProps): ReactElement {
    ...
    const { Icon, fgColor } = isDelayed
        ? delayedCollectorStatusStyle
        : healthStatusStylesLegacy[collectorHealthStatus];
...
export default CollectorStatusLegacy;
