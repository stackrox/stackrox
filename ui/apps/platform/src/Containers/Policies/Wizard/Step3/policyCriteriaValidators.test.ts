...
describe('policyCriteriaValidators', () => {
    ...
    describe('File operation requires mounted file path (Deploy) validator', () => {
        ...
        it('should fail when File Operation is present but Effective File Path is missing', () => {
            const section: ClientPolicySection = {
                sectionName: 'Test Section',
        ...
        it('should pass when File Operation and Effective File Path both present with values', () => {
            const section: ClientPolicySection = {
                sectionName: 'Test Section',
                policyGroups: [
                    mockCriterionWithName('File Operation', [{ value: 'CREATE' }]),
                    mockCriterionWithName('Effective File Path', [{ value: '/etc/passwd' }]),
                ],
            };
            expect(validator.validate(section, context)).toBeUndefined();
        });
    ...
    describe('File operation requires node file path (Node) validator', () => {
        ...
        it('should fail when File Operation is present but Actual File Path is missing', () => {
            const section: ClientPolicySection = {
                sectionName: 'Test Section',
                policyGroups: [mockCriterionWithName('File Operation', [{ value: 'CREATE' }])],
            };
        ...
        it('should pass when File Operation and Actual File Path both present with values', () => {
            const section: ClientPolicySection = {
                sectionName: 'Test Section',
                policyGroups: [
                    mockCriterionWithName('File Operation', [{ value: 'CREATE' }]),
                    mockCriterionWithName('Actual File Path', [{ value: '/etc/passwd' }]),
                ],
            };
            expect(validator.validate(section, context)).toBeUndefined();
        });
