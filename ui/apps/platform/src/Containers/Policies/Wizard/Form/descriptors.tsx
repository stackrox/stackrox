...
export const policyConfigurationDescriptor: Descriptor[] = [
    ...
    {
        label: 'Liveness probe defined',
        name: 'Liveness Probe Defined',
        shortName: 'Liveness probe defined',
        longName: 'Liveness probe defined',
        category: policyCriteriaCategories.CONTAINER_CONFIGURATION,
        type: 'radioGroup',
        radioButtons: [
            {
    ...
    {
        label: 'Readiness probe defined',
        name: 'Readiness Probe Defined',
        shortName: 'Readiness probe defined',
        longName: 'Readiness probe defined',
        category: policyCriteriaCategories.CONTAINER_CONFIGURATION,
        type: 'radioGroup',
        radioButtons: [
            {
