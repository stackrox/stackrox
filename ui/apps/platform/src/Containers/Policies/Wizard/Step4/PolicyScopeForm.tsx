    ...
    return (
        <Flex direction={{ default: 'column' }} spaceItems={{ default: 'spaceItemsNone' }}>
            <FlexItem flex={{ default: 'flex_1' }} className="pf-v6-u-p-lg">
                <Title headingLevel="h2">{isNewScopingEnabled ? 'Resources' : 'Scope'}</Title>
                    ...
                    <Flex direction={{ default: 'column' }} className="pf-v6-u-p-lg">
                        <Flex>
                            <FlexItem flex={{ default: 'flex_1' }}>
                                ...
                                <div className="pf-v6-u-mt-sm">
                                    {isNewScopingEnabled
                                        ? 'Apply this policy to one or more clusters, namespaces or deployments (if applicable). If no inclusions are configured, the policy will apply to all resources in your environment, except those excluded.'
                            ...
                            >
                                ...
                                >
                                    {isNewScopingEnabled ? 'Add Inclusion' : 'Add inclusion scope'}
                                </Button>
                            </FlexItem>
                        </Flex>
                        <FlexItem>
                        ...
                        <FlexItem>
                            ...
                            >
                                ...
                                <FormHelperText>
                                    <HelperText>
                                        <HelperTextItem>
                                            Select all images from the list for which you don&apos;t
                                            want to trigger a violation for the policy.
                                        </HelperTextItem>
                                    </HelperText>
                                </FormHelperText>
                            </FormGroup>
