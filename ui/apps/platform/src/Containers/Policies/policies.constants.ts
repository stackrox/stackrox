// ids for policy wizard steps
export const POLICY_DEFINITION_DETAILS_ID = 'policy-definition-details';
...
export const POLICY_BEHAVIOR_ENFORCEMENT_ID = 'policy-behavior-enforcement';
export const POLICY_BEHAVIOR_NOTIFIERS_ID = 'policy-behavior-notifiers';
