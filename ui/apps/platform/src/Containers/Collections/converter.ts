import type { Collection, CollectionRequest, SelectorRule } from 'services/CollectionsService';
...
import type { ClientCollection, SelectorEntityType, SelectorField } from './types';
