...
import { useParameterSidePanelTab, useParameterSidePanelToggle } from '../URLStateContext';
...
function DeploymentSideBar({
    ...
    const { selectedTabSidePanel, setSelectedTabSidePanel } = useParameterSidePanelTab();
    const { setSelectedToggleSidePanel } = useParameterSidePanelToggle();
