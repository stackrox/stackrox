    ...
    return (
        <Flex direction={{ default: 'column' }} spaceItems={{ default: 'spaceItemsMd' }}>
            ...
            <FlexItem>
                ...
                <p>A report is partially complete and ready for download.</p>
            </FlexItem>
            <FlexItem>
                <p>
                    <strong>Report successfully sent:</strong>
                </p>
                <p>The report was successfully emailed.</p>
            </FlexItem>
            <FlexItem>
                <p>
                    <strong>Partial report successfully sent:</strong>
                </p>
                <p>A report is partially complete and was successfully emailed.</p>
            </FlexItem>
            <FlexItem>
                <p>
