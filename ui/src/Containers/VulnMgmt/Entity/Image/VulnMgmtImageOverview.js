...
const VulnMgmtImageOverview = ({ data }) => {
    const { metadata, scan, topVuln } = data;
        ...
        <div className="w-full" id="capture-dashboard-stretch">
            <CollapsibleSection title="Image Summary">
                <div className="flex mb-4 flex-wrap pdf-page">
                    <Widget
                        ...
                        className="mx-4 bg-base-100 h-48 mb-4 bg-counts-widget"
                    >
                        <div className="flex flex-col w-full">
                            ...
                            <div className="flex flex-col border-base-400 p-4">
                                <div className="flex p-3 border-b border-base-400">
                                    <span className="text-base-700 font-600 mr-2">Created:</span>
                                    {(metadata &&
                                        metadata.v1 &&
                                ...
                                <div className="flex p-3 border-b border-base-400">
                                    <span className="text-base-700 font-600 mr-2">Scan time:</span>
                                    {(scan && format(scan.scanTime, dateTimeFormat)) || 'N/A'}
                                </div>
                            </div>
                        </div>
                    </Widget>
            ...
            <CollapsibleSection title="Image Findings">
                <div className="flex pdf-page pdf-stretch shadow rounded relative rounded bg-base-100 mb-4 ml-4 mr-4">
                    <Tabs hasTabSpacing headers={[{ text: 'Dockerfile' }, { text: 'CVEs' }]}>
                        <TabContent>
                            {layers.length === 0 && (
                                <NoResultsMessage
