...
export const defaultHeaderClassName =
    'px-2 py-4 pb-3 font-700 text-base-600 hover:bg-primary-200 hover:z-1 hover:text-primary-700 truncate select-none relative text-left border-r-0 leading-normal';
