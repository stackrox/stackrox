...
config-controller-gen:
	...
	echo -e '# DO NOT EDIT: Generated by make config-controller-gen\n{{- include "srox.init" . -}}' > image/templates/helm/stackrox-central/templates/00-securitypolicies-crd.yaml
