    ...
    {{ else }}
      {{ if not $._rox._ca }}
        {{ $msg := list
            ...
            ""
            "If the CA was generated by the Helm chart during initial installation, you need to retrieve these auto-generated values from the cluster and provide them to the 'helm upgrade' command. A command for retrieving the auto-generated values was included in the post-installation notes of the central-services Helm chart."
            ""
            "If the CA was generated outside of the Helm chart and provided during the installation of the central-services chart, then the same must be done when executing 'helm upgrade'. This can be achieved conveniently by specifying the '--reuse-values' flag to 'helm upgrade'."
            | join "\n"
        }}
