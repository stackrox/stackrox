...
func (m *CosignSignature) GetCertChainPem() []byte {
	if m != nil {
...
func (m *CosignSignature) Clone() *CosignSignature {
	...
	*cloned = *m
	...
	if m.CertChainPem != nil {
		cloned.CertChainPem = make([]byte, len(m.CertChainPem))
		copy(cloned.CertChainPem, m.CertChainPem)
	}
	return cloned
}
...
var fileDescriptor_c926ac8b7cb24b2e = []byte{
	...
	,
}
...
func (m *CosignSignature) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CertChainPem) > 0 {
		...
		i = encodeVarintImage(dAtA, i, uint64(len(m.CertChainPem)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.CertPem) > 0 {
