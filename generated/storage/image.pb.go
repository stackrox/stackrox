...
type DataSource struct {
	...
	MirrorClusterId      string   `protobuf:"bytes,4,opt,name=mirror_cluster_id,json=mirrorClusterId,proto3" json:"mirror_cluster_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *DataSource) GetMirrorClusterId() string {
	if m != nil {
		return m.MirrorClusterId
	}
	return ""
}
...
var fileDescriptor_c926ac8b7cb24b2e = []byte{
	...
	,
}
...
func (m *DataSource) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.MirrorClusterId) > 0 {
		i -= len(m.MirrorClusterId)
		copy(dAtA[i:], m.MirrorClusterId)
		i = encodeVarintImage(dAtA, i, uint64(len(m.MirrorClusterId)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Mirror) > 0 {
...
func (m *DataSource) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MirrorClusterId", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MirrorClusterId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipImage(dAtA[iNdEx:])
