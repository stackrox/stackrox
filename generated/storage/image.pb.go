...
type Image struct {
	...
	// different locations.
	// TODO(dhaus): For now, the ImageName message has been duplicated without search tags.
	Names                     *AlternativeImageNames          `protobuf:"bytes,18,opt,name=names,proto3" json:"names,omitempty"`
...
func (m *Image) GetNames() *AlternativeImageNames {
	if m != nil {
		return m.Names
	}
	return nil
...
type ImageSignatureVerificationResult struct {
	...
	// The full image name that the signature references. Since images can come from different locations, this will
	// ensure we can verify the matching location as well.
...
type AlternativeImageNames struct {
	Names                []*AlternativeImageNames_Name `protobuf:"bytes,1,rep,name=names,proto3" json:"names,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}

func (m *AlternativeImageNames) Reset()         { *m = AlternativeImageNames{} }
func (m *AlternativeImageNames) String() string { return proto.CompactTextString(m) }
func (*AlternativeImageNames) ProtoMessage()    {}
func (*AlternativeImageNames) Descriptor() ([]byte, []int) {
	return fileDescriptor_c926ac8b7cb24b2e, []int{15}
}
func (m *AlternativeImageNames) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AlternativeImageNames) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AlternativeImageNames.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AlternativeImageNames) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AlternativeImageNames.Merge(m, src)
}
func (m *AlternativeImageNames) XXX_Size() int {
	return m.Size()
}
func (m *AlternativeImageNames) XXX_DiscardUnknown() {
	xxx_messageInfo_AlternativeImageNames.DiscardUnknown(m)
}

var xxx_messageInfo_AlternativeImageNames proto.InternalMessageInfo

func (m *AlternativeImageNames) GetNames() []*AlternativeImageNames_Name {
	if m != nil {
		return m.Names
	}
	return nil
...
func (m *AlternativeImageNames) MessageClone() proto.Message {
	return m.Clone()
}
func (m *AlternativeImageNames) Clone() *AlternativeImageNames {
	if m == nil {
		return nil
	}
	cloned := new(AlternativeImageNames)
	*cloned = *m

	if m.Names != nil {
		cloned.Names = make([]*AlternativeImageNames_Name, len(m.Names))
...
type AlternativeImageNames_Name struct {
	// TODO(dhaus): For now without search tags, since duplicated tags are not allowed and setting `policy:",prefer-parent"` does not fix it.
...
func (m *AlternativeImageNames_Name) Reset()         { *m = AlternativeImageNames_Name{} }
func (m *AlternativeImageNames_Name) String() string { return proto.CompactTextString(m) }
func (*AlternativeImageNames_Name) ProtoMessage()    {}
func (*AlternativeImageNames_Name) Descriptor() ([]byte, []int) {
	return fileDescriptor_c926ac8b7cb24b2e, []int{15, 0}
}
func (m *AlternativeImageNames_Name) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AlternativeImageNames_Name) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AlternativeImageNames_Name.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AlternativeImageNames_Name) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AlternativeImageNames_Name.Merge(m, src)
}
func (m *AlternativeImageNames_Name) XXX_Size() int {
	return m.Size()
}
func (m *AlternativeImageNames_Name) XXX_DiscardUnknown() {
	xxx_messageInfo_AlternativeImageNames_Name.DiscardUnknown(m)
}

var xxx_messageInfo_AlternativeImageNames_Name proto.InternalMessageInfo

func (m *AlternativeImageNames_Name) GetRegistry() string {
	if m != nil {
		return m.Registry
	}
	return ""
...
func (m *AlternativeImageNames_Name) GetRemote() string {
	if m != nil {
		return m.Remote
	}
	return ""
...
func (m *AlternativeImageNames_Name) GetTag() string {
	if m != nil {
		return m.Tag
	}
	return ""
...
func (m *AlternativeImageNames_Name) GetFullName() string {
	if m != nil {
		return m.FullName
	}
	return ""
...
func (m *AlternativeImageNames_Name) MessageClone() proto.Message {
	return m.Clone()
}
func (m *AlternativeImageNames_Name) Clone() *AlternativeImageNames_Name {
	if m == nil {
		return nil
	}
	cloned := new(AlternativeImageNames_Name)
	*cloned = *m
...
func init() {
	...
	proto.RegisterType((*AlternativeImageNames)(nil), "storage.AlternativeImageNames")
	proto.RegisterType((*AlternativeImageNames_Name)(nil), "storage.AlternativeImageNames.Name")
...
var fileDescriptor_c926ac8b7cb24b2e = []byte{
	...
	,
}
...
func (m *AlternativeImageNames) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AlternativeImageNames) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AlternativeImageNames) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AlternativeImageNames_Name) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AlternativeImageNames_Name) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AlternativeImageNames_Name) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AlternativeImageNames) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AlternativeImageNames_Name) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AlternativeImageNames) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AlternativeImageNames: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AlternativeImageNames: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Names = append(m.Names, &AlternativeImageNames_Name{})
...
func (m *AlternativeImageNames_Name) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
