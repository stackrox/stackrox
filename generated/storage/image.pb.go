...
type Image_Cves struct {
	Cves int32 `protobuf:"varint,8,opt,name=cves,proto3,oneof"` // @gotags: search:"Image CVE Count,store"
}
...
type EmbeddedImageScanComponent struct {
	...
	RiskScore  float32                                 `protobuf:"fixed32,10,opt,name=risk_score,json=riskScore,proto3" json:"risk_score,omitempty"` // @gotags: search:"Component Risk Score,hidden" hash:"ignore"
...
type V1Metadata struct {
	...
	Labels        map[string]string      `protobuf:"bytes,9,rep,name=labels,proto3" json:"labels,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // @gotags: search:"Image Label,store"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_storage_image_proto_rawDesc = "" +
	"\n" +
	"\x13storage/image.proto\x12\astorage\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bstorage/vulnerability.proto\"\x8d\a\n" +
	"\x05Image\x12\x0e\n" +
