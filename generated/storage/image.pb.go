...
type Image struct {
	...
	OpenVexReport             []*OpenVex                      `protobuf:"bytes,19,rep,name=open_vex_report,json=openVexReport,proto3" json:"open_vex_report,omitempty"`
...
func (m *Image) Clone() *Image {
	...
	*cloned = *m
	...
	if m.OpenVexReport != nil {
		cloned.OpenVexReport = make([]*OpenVex, len(m.OpenVexReport))
		for idx, v := range m.OpenVexReport {
			cloned.OpenVexReport[idx] = v.Clone()
		}
	}
...
type OpenVex struct {
	OpenVexReport        []byte   `protobuf:"bytes,1,opt,name=open_vex_report,json=openVexReport,proto3" json:"open_vex_report,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *OpenVex) Clone() *OpenVex {
	...
	*cloned = *m
	...
	if m.OpenVexReport != nil {
		...
		copy(cloned.OpenVexReport, m.OpenVexReport)
	}
	return cloned
}
...
var fileDescriptor_c926ac8b7cb24b2e = []byte{
	...
	0x15, 0x37, 0xff, 0x93, 0x8f, 0xb4, 0x4c, 0xaf, 0x5d, 0x1b, 0x96, 0x63, 0x01, 0x86, 0x92, 0x58,
	...
	,
}
...
func (m *Image) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OpenVexReport) > 0 {
		for iNdEx := len(m.OpenVexReport) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OpenVexReport[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *OpenVex) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OpenVexReport) > 0 {
		i -= len(m.OpenVexReport)
		copy(dAtA[i:], m.OpenVexReport)
		i = encodeVarintImage(dAtA, i, uint64(len(m.OpenVexReport)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Image) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 19:
			...
			m.OpenVexReport = append(m.OpenVexReport, &OpenVex{})
			if err := m.OpenVexReport[len(m.OpenVexReport)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *OpenVex) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.OpenVexReport = append(m.OpenVexReport[:0], dAtA[iNdEx:postIndex]...)
			if m.OpenVexReport == nil {
				m.OpenVexReport = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
