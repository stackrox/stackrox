...
func (x *Image) GetBaseImageInfo() []*BaseImageInfo {
	if x != nil {
		return x.BaseImageInfo
	}
	return nil
}
...
type BaseImageInfo struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	BaseImageId       string                 `protobuf:"bytes,1,opt,name=base_image_id,json=baseImageId,proto3" json:"base_image_id,omitempty" search:"Matched Base Image Id"`                     // @gotags: search:"Matched Base Image Id"
	BaseImageFullName string                 `protobuf:"bytes,2,opt,name=base_image_full_name,json=baseImageFullName,proto3" json:"base_image_full_name,omitempty" search:"Matched Base Image Full Name"` // @gotags: search:"Matched Base Image Full Name"
	BaseImageDigest   string                 `protobuf:"bytes,3,opt,name=base_image_digest,json=baseImageDigest,proto3" json:"base_image_digest,omitempty" search:"Matched Base Image Id Digest"`         // @gotags: search:"Matched Base Image Id Digest"
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *BaseImageInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use BaseImageInfo.ProtoReflect.Descriptor instead.
func (*BaseImageInfo) Descriptor() ([]byte, []int) {
	return file_storage_image_proto_rawDescGZIP(), []int{17}
}

func (x *BaseImageInfo) GetBaseImageId() string {
	if x != nil {
...
func (x *BaseImageInfo) GetBaseImageFullName() string {
	if x != nil {
		return x.BaseImageFullName
	}
	return ""
}

func (x *BaseImageInfo) GetBaseImageDigest() string {
	if x != nil {
...
const file_storage_image_proto_rawDesc = "" +
	"\n" +
	"\x13storage/image.proto\x12\astorage\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bstorage/vulnerability.proto\"\xcd\a\n" +
	"\x05Image\x12\x0e\n" +
	...
	"\x05notes\x18\x0e \x03(\x0e2\x13.storage.Image.NoteR\x05notes\x12>\n" +
	"\x0fbase_image_info\x18\x13 \x03(\v2\x16.storage.BaseImageInfoR\rbaseImageInfo\"s\n" +
	"\x04Note\x12\x14\n" +
