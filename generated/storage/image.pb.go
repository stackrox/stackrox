...
type ImageComponentEdgeEntry struct {
	ImageId              string        `protobuf:"bytes,1,opt,name=image_id,json=imageId,proto3" json:"image_id,omitempty" search:"Image Sha" sql:"pk"`
	ComponentId          string        `protobuf:"bytes,2,opt,name=component_id,json=componentId,proto3" json:"component_id,omitempty" search:"Component Id" sql:"pk"`
	Edge                 *ImageCVEEdge `protobuf:"bytes,3,opt,name=edge,proto3" json:"edge,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}

func (m *ImageComponentEdgeEntry) Reset()         { *m = ImageComponentEdgeEntry{} }
func (m *ImageComponentEdgeEntry) String() string { return proto.CompactTextString(m) }
func (*ImageComponentEdgeEntry) ProtoMessage()    {}
func (*ImageComponentEdgeEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_c926ac8b7cb24b2e, []int{17}
}
func (m *ImageComponentEdgeEntry) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ImageComponentEdgeEntry) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ImageComponentEdgeEntry.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ImageComponentEdgeEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ImageComponentEdgeEntry.Merge(m, src)
}
func (m *ImageComponentEdgeEntry) XXX_Size() int {
	return m.Size()
}
func (m *ImageComponentEdgeEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_ImageComponentEdgeEntry.DiscardUnknown(m)
}

var xxx_messageInfo_ImageComponentEdgeEntry proto.InternalMessageInfo

func (m *ImageComponentEdgeEntry) GetImageId() string {
	if m != nil {
		return m.ImageId
	}
	return ""
...
func (m *ImageComponentEdgeEntry) GetComponentId() string {
	if m != nil {
...
func (m *ImageComponentEdgeEntry) GetEdge() *ImageCVEEdge {
	if m != nil {
		return m.Edge
	}
	return nil
...
func (m *ImageComponentEdgeEntry) MessageClone() proto.Message {
	return m.Clone()
}
func (m *ImageComponentEdgeEntry) Clone() *ImageComponentEdgeEntry {
	if m == nil {
		return nil
	}
	cloned := new(ImageComponentEdgeEntry)
	*cloned = *m
...
func (m *ImageCVEEdgeEntry) Reset()         { *m = ImageCVEEdgeEntry{} }
func (m *ImageCVEEdgeEntry) String() string { return proto.CompactTextString(m) }
func (*ImageCVEEdgeEntry) ProtoMessage()    {}
func (*ImageCVEEdgeEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_c926ac8b7cb24b2e, []int{19}
}
func (m *ImageCVEEdgeEntry) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ImageCVEEdgeEntry) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ImageCVEEdgeEntry.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ImageCVEEdgeEntry) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ImageCVEEdgeEntry.Merge(m, src)
}
func (m *ImageCVEEdgeEntry) XXX_Size() int {
	return m.Size()
}
func (m *ImageCVEEdgeEntry) XXX_DiscardUnknown() {
	xxx_messageInfo_ImageCVEEdgeEntry.DiscardUnknown(m)
}

var xxx_messageInfo_ImageCVEEdgeEntry proto.InternalMessageInfo

func (m *ImageCVEEdgeEntry) GetImageId() string {
	if m != nil {
		return m.ImageId
	}
	return ""
...
func (m *ImageCVEEdgeEntry) GetCveId() string {
	if m != nil {
		return m.CveId
	}
	return ""
...
func (m *ImageCVEEdgeEntry) GetEdge() *ImageCVEEdge {
	if m != nil {
		return m.Edge
	}
	return nil
...
func (m *ImageCVEEdgeEntry) MessageClone() proto.Message {
	return m.Clone()
}
func (m *ImageCVEEdgeEntry) Clone() *ImageCVEEdgeEntry {
	if m == nil {
		return nil
	}
	cloned := new(ImageCVEEdgeEntry)
	*cloned = *m
...
func init() {
	...
	proto.RegisterType((*ImageComponentEdgeEntry)(nil), "storage.ImageComponentEdgeEntry")
	proto.RegisterType((*ImageCVEEdge)(nil), "storage.ImageCVEEdge")
	proto.RegisterType((*ImageCVEEdgeEntry)(nil), "storage.ImageCVEEdgeEntry")
...
var fileDescriptor_c926ac8b7cb24b2e = []byte{
	...
	,
}
...
func (m *ImageComponentEdgeEntry) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ImageComponentEdgeEntry) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ImageComponentEdgeEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ComponentId) > 0 {
		...
		i = encodeVarintImage(dAtA, i, uint64(len(m.ComponentId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ImageId) > 0 {
		...
		i = encodeVarintImage(dAtA, i, uint64(len(m.ImageId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ImageCVEEdgeEntry) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ImageCVEEdgeEntry) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ImageCVEEdgeEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.CveId) > 0 {
		i -= len(m.CveId)
		copy(dAtA[i:], m.CveId)
		i = encodeVarintImage(dAtA, i, uint64(len(m.CveId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ImageId) > 0 {
...
func (m *ImageComponentEdgeEntry) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ImageCVEEdgeEntry) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ImageComponentEdgeEntry) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ImageComponentEdgeEntry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ImageComponentEdgeEntry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ImageCVEEdgeEntry) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ImageCVEEdgeEntry: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ImageCVEEdgeEntry: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
