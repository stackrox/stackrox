...
type BaseImageInfo struct {
	...
	BaseImageTotalLayers int32                  `protobuf:"varint,5,opt,name=base_image_total_layers,json=baseImageTotalLayers,proto3" json:"base_image_total_layers,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *BaseImageInfo) GetBaseImageTotalLayers() int32 {
	if x != nil {
		return x.BaseImageTotalLayers
	}
	return 0
}
...
const file_storage_image_proto_rawDesc = "" +
	...
	"\acreated\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\acreated\x125\n" +
	"\x17base_image_total_layers\x18\x05 \x01(\x05R\x14baseImageTotalLayers*s\n" +
	"\n" +
	"SourceType\x12\x06\n" +
	"\x02OS\x10\x00\x12\n" +
	"\n" +
