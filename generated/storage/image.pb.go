...
type ImageMetadata struct {
	...
	//	*ImageMetadata_Cosign
	Signature            isImageMetadata_Signature `protobuf_oneof:"Signature"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
type isImageMetadata_Signature interface {
	isImageMetadata_Signature()
	MarshalTo([]byte) (int, error)
	Size() int
	Clone() isImageMetadata_Signature
}

type ImageMetadata_Cosign struct {
	Cosign *CosignSignature `protobuf:"bytes,6,opt,name=cosign,proto3,oneof" json:"cosign,omitempty"`
}

func (*ImageMetadata_Cosign) isImageMetadata_Signature() {}
func (m *ImageMetadata_Cosign) Clone() isImageMetadata_Signature {
	if m == nil {
		return nil
	}
	cloned := new(ImageMetadata_Cosign)
	*cloned = *m
...
func (m *ImageMetadata) GetSignature() isImageMetadata_Signature {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *ImageMetadata) GetCosign() *CosignSignature {
	if x, ok := m.GetSignature().(*ImageMetadata_Cosign); ok {
		return x.Cosign
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*ImageMetadata) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*ImageMetadata_Cosign)(nil),
	}
}
...
func (m *ImageMetadata_Cosign) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ImageMetadata_Cosign) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Cosign != nil {
		{
...
func (m *ImageMetadata_Cosign) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ImageMetadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.Signature = &ImageMetadata_Cosign{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipImage(dAtA[iNdEx:])
