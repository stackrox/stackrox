...
type BaseImage struct {
	...
	BaseImageRepositoryId string                 `protobuf:"bytes,2,opt,name=base_image_repository_id,json=baseImageRepositoryId,proto3" json:"base_image_repository_id,omitempty" sql:"fk(BaseImageRepository:id),no-fk-constraint"` // @gotags: sql:"fk(BaseImageRepository:id),no-fk-constraint"
