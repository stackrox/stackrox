...
type ProcessIndicator struct {
	...
	PodUid string `protobuf:"bytes,11,opt,name=pod_uid,json=podUid,proto3" json:"pod_uid,omitempty" search:"Pod UID,hidden" sql:"type(uuid)"` // @gotags: search:"Pod UID,hidden" sql:"type(uuid)"
