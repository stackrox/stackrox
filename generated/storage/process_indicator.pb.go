...
type ProcessIndicator struct {
	...
	DeploymentId  string `protobuf:"bytes,2,opt,name=deployment_id,json=deploymentId,proto3" json:"deployment_id,omitempty" search:"Deployment ID,hidden" policy:",prefer-parent" sql:"index=btree,fk(Deployment:id),no-fk-constraint,type(uuid)"`    // @gotags: search:"Deployment ID,hidden" policy:",prefer-parent" sql:"index=btree,fk(Deployment:id),no-fk-constraint,type(uuid)"
	...
	PodUid string `protobuf:"bytes,11,opt,name=pod_uid,json=podUid,proto3" json:"pod_uid,omitempty" search:"Pod UID,hidden" sql:"index=btree,type(uuid)"` // @gotags: search:"Pod UID,hidden" sql:"index=btree,type(uuid)"
