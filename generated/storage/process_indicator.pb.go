...
type ProcessIndicator struct {
	...
	Id            string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" search:"Process ID" sql:"pk,type(uuid)"`                                            // @gotags: search:"Process ID"  sql:"pk,type(uuid)"
	DeploymentId  string `protobuf:"bytes,2,opt,name=deployment_id,json=deploymentId,proto3" json:"deployment_id,omitempty" search:"Deployment ID" policy:",prefer-parent" sql:"index=hash,fk(Deployment:id),no-fk-constraint,type(uuid)"`    // @gotags: search:"Deployment ID" policy:",prefer-parent" sql:"index=hash,fk(Deployment:id),no-fk-constraint,type(uuid)"
	ContainerName string `protobuf:"bytes,3,opt,name=container_name,json=containerName,proto3" json:"container_name,omitempty" search:"Container Name" policy:",prefer-parent"` // @gotags: search:"Container Name" policy:",prefer-parent"
	// Pod name
	PodId  string `protobuf:"bytes,4,opt,name=pod_id,json=podId,proto3" json:"pod_id,omitempty" search:"Pod ID"`     // @gotags: search:"Pod ID"
	PodUid string `protobuf:"bytes,11,opt,name=pod_uid,json=podUid,proto3" json:"pod_uid,omitempty" search:"Pod UID" sql:"index=hash,type(uuid)"` // @gotags: search:"Pod UID" sql:"index=hash,type(uuid)"
	...
	ClusterId          string                 `protobuf:"bytes,7,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty" search:"Cluster ID" policy:",prefer-parent" sql:"type(uuid)"`                              // @gotags: search:"Cluster ID" policy:",prefer-parent" sql:"type(uuid)"
	Namespace          string                 `protobuf:"bytes,8,opt,name=namespace,proto3" json:"namespace,omitempty" search:"Namespace" policy:",prefer-parent"`                                               // @gotags: search:"Namespace" policy:",prefer-parent"
...
type ProcessSignal struct {
	...
	ContainerId string `protobuf:"bytes,2,opt,name=container_id,json=containerId,proto3" json:"container_id,omitempty" search:"Container ID"` // @gotags: search:"Container ID"
	// Process creation time
	Time *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=time,proto3" json:"time,omitempty" search:"Process Creation Time" sql:"index=btree"` // @gotags: search:"Process Creation Time" sql:"index=btree"
	// Process name
