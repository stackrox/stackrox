...
type ComponentCVEEdge_FixedBy struct {
	FixedBy string `protobuf:"bytes,3,opt,name=fixed_by,json=fixedBy,proto3,oneof" json:"fixed_by,omitempty" search:"Fixed By,store,hidden"` // @gotags: search:"Fixed By,store,hidden"
}
...
type ClusterCVEEdge_FixedBy struct {
	FixedBy string `protobuf:"bytes,3,opt,name=fixed_by,json=fixedBy,proto3,oneof" json:"fixed_by,omitempty" search:"Cluster CVE Fixed By,store,hidden"` // @gotags: search:"Cluster CVE Fixed By,store,hidden"
}
...
func (*ComplianceOperatorControlRuleV2Edge) Descriptor() ([]byte, []int) {
	return fileDescriptor_62f882e266fcf764, []int{7}
}
...
var fileDescriptor_62f882e266fcf764 = []byte{
	...
	,
}
...
func (m *ComplianceOperatorControlRuleV2Edge) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RuleId) > 0 {
		...
		i = encodeVarintRelations(dAtA, i, uint64(len(m.RuleId)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.ControlId) > 0 {
		...
		i = encodeVarintRelations(dAtA, i, uint64(len(m.ControlId)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Id) > 0 {
