...
type NodeComponentEdge struct {
	...
	Id              string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" sql:"pk,id"`                                                    // @gotags: sql:"pk,id"
	NodeId          string `protobuf:"bytes,2,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty" sql:"fk(Node:id),index=hash"`                              // @gotags: sql:"fk(Node:id),index=hash"
...
type ClusterCVEEdge struct {
	...
	ClusterId  string                      `protobuf:"bytes,4,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty" sql:"fk(Cluster:id)"` // @gotags: sql:"fk(Cluster:id)"
...
var file_storage_relations_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x73, 0x5f, 0x66, 0x69, 0x78, 0x65, 0x64, 0x5f, 0x62, 0x79, 0x42, 0x24, 0x0a, 0x19,
