...
type ImageComponentEdge struct {
	...
	Location         string                             `protobuf:"bytes,3,opt,name=location,proto3" json:"location,omitempty" search:"Component Location"`                                           // @gotags: search:"Component Location"
...
type ComponentCVEEdge_FixedBy struct {
	FixedBy string `protobuf:"bytes,3,opt,name=fixed_by,json=fixedBy,proto3,oneof" search:"Fixed By"` // @gotags: search:"Fixed By"
}
...
type ImageCVEEdge struct {
	...
	Id                   string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" sql:"pk,id"`                                                                   // @gotags: sql:"pk,id"
	FirstImageOccurrence *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=first_image_occurrence,json=firstImageOccurrence,proto3" json:"first_image_occurrence,omitempty" search:"First Image Occurrence Timestamp"` // @gotags: search:"First Image Occurrence Timestamp"
...
type ClusterCVEEdge struct {
	...
	Id        string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" sql:"pk,id"`                                 // @gotags: sql:"pk,id"
	IsFixable bool   `protobuf:"varint,2,opt,name=is_fixable,json=isFixable,proto3" json:"is_fixable,omitempty" search:"Cluster CVE Fixable"` // @gotags: search:"Cluster CVE Fixable"
...
type ClusterCVEEdge_FixedBy struct {
	FixedBy string `protobuf:"bytes,3,opt,name=fixed_by,json=fixedBy,proto3,oneof" search:"Cluster CVE Fixed By"` // @gotags: search:"Cluster CVE Fixed By"
}
...
type PolicyCategoryEdge struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Id            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" sql:"pk,id"`                                   // @gotags: sql:"pk,id"
	PolicyId      string                 `protobuf:"bytes,2,opt,name=policy_id,json=policyId,proto3" json:"policy_id,omitempty" sql:"fk(Policy:id)" search:"Policy ID"`       // @gotags: sql:"fk(Policy:id)" search:"Policy ID"
