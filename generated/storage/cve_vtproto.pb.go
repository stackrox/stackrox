...
func (m *ImageCVEV3) CloneVT() *ImageCVEV3 {
	if m == nil {
		return (*ImageCVEV3)(nil)
	}
	r := new(ImageCVEV3)
	r.Id = m.Id
	r.ImageId = m.ImageId
	...
	if m.HasFixedBy != nil {
		r.HasFixedBy = m.HasFixedBy.(interface {
			CloneVT() isImageCVEV3_HasFixedBy
		}).CloneVT()
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *ImageCVEV3) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *ImageCVEV3_FixedBy) CloneVT() isImageCVEV3_HasFixedBy {
	if m == nil {
		return (*ImageCVEV3_FixedBy)(nil)
	}
	r := new(ImageCVEV3_FixedBy)
	r.FixedBy = m.FixedBy
	return r
}
...
func (this *ImageCVEV3) EqualVT(that *ImageCVEV3) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
	...
	if this.HasFixedBy == nil && that.HasFixedBy != nil {
		...
		if !this.HasFixedBy.(interface {
			EqualVT(isImageCVEV3_HasFixedBy) bool
...
func (this *ImageCVEV3) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*ImageCVEV3)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *ImageCVEV3_FixedBy) EqualVT(thatIface isImageCVEV3_HasFixedBy) bool {
	that, ok := thatIface.(*ImageCVEV3_FixedBy)
	if !ok {
		return false
	}
	if this == that {
...
func (m *ImageCVEV3) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ImageCVEV3) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ImageCVEV3) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *ImageCVEV3_FixedBy) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ImageCVEV3_FixedBy) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.FixedBy)
...
func (m *ImageCVEV3) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ImageCVEV3_FixedBy) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ImageCVEV3) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ImageCVEV3: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ImageCVEV3: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 14:
			...
			m.HasFixedBy = &ImageCVEV3_FixedBy{FixedBy: stringValue}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
