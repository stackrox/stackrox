...
func (this *CustomResource) EqualVT(that *CustomResource) bool {
	if this == that {
		return true
...
func (this *CustomResource) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*CustomResource)
	if !ok {
		return false
	}
...
func (m *CustomResource) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
