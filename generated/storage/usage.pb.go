...
func (m *Usage) GetNumNodes() int64 {
	if m != nil {
		return m.NumNodes
	}
	return 0
...
func (m *Usage) GetNumCpuUnits() int64 {
	if m != nil {
...
var fileDescriptor_5b4522b7737f3601 = []byte{
	...
	0x99, 0x9b, 0x5a, 0x5c, 0x92, 0x98, 0x5b, 0x00, 0x51, 0xa0, 0xb4, 0x98, 0x91, 0x8b, 0x35, 0x14,
	...
	0xfc, 0x94, 0xd4, 0x62, 0x09, 0x26, 0x05, 0x46, 0x0d, 0xe6, 0x20, 0x8e, 0xbc, 0xd2, 0x5c, 0x3f,
	0x10, 0x5f, 0x48, 0x89, 0x8b, 0x17, 0x24, 0x99, 0x5c, 0x50, 0x1a, 0x5f, 0x9a, 0x97, 0x59, 0x52,
	0x2c, 0xc1, 0x0c, 0x56, 0xc0, 0x9d, 0x57, 0x9a, 0xeb, 0x5c, 0x50, 0x1a, 0x0a, 0x12, 0x72, 0x92,
	0x3c, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6, 0x07, 0x8f, 0xe4, 0x18, 0x67, 0x3c, 0x96,
	0x63, 0x88, 0x82, 0xf9, 0x3b, 0x89, 0x0d, 0xec, 0x36, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff,
	0x5f, 0x9c, 0x67, 0x79, 0x1e, 0x01, 0x00, 0x00,
}
...
func (m *Usage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.NumCpuUnits != 0 {
		i = encodeVarintUsage(dAtA, i, uint64(m.NumCpuUnits))
		i--
		dAtA[i] = 0x18
	}
	if m.NumNodes != 0 {
