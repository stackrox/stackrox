...
func (b0 SensorUpgradeConfig_builder) Build() *SensorUpgradeConfig {
...
const file_storage_sensor_upgrade_proto_rawDesc = "" +
	"\n" +
...
func file_storage_sensor_upgrade_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_storage_sensor_upgrade_proto_rawDesc), len(file_storage_sensor_upgrade_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
