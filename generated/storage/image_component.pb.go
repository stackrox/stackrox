...
type ImageComponentV2 struct {
	...
	LayerIdx      int64                            `protobuf:"varint,15,opt,name=layer_idx,json=layerIdx,proto3" json:"layer_idx,omitempty" search:"Component Layer Index,store,hidden"`     // @gotags: search:"Component Layer Index,store,hidden"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ImageComponentV2) GetLayerIdx() int64 {
	if x != nil {
		return x.LayerIdx
	}
	return 0
...
const file_storage_image_component_proto_rawDesc = "" +
	...
	"\vimage_id_v2\x18\x0e \x01(\tR\timageIdV2\x12\x1b\n" +
	"\tlayer_idx\x18\x0f \x01(\x03R\blayerIdxB\x0e\n" +
	"\fset_top_cvssB\x11\n" +
	"\x0fhas_layer_indexB.\n" +
