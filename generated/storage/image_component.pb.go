...
type ImageComponent struct {
	...
	Id        string     `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" search:"Component ID,store,hidden" sql:"pk,id"`           // @gotags: search:"Component ID,store,hidden" sql:"pk,id" // This field is composite id over name, version, and operating system.
