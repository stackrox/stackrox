...
func (x *SensorUpgradeConfig) ProtoReflect() protoreflect.Message {
	file_storage_sensor_upgrade_proto_init_ensure()
	mi := &file_storage_sensor_upgrade_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
const file_storage_sensor_upgrade_proto_rawDesc = "" +
	"\n" +
	"\x1cstorage/sensor_upgrade.proto\x12\astorage\"E\n" +
	"\x13SensorUpgradeConfig\x12.\n" +
	"\x13enable_auto_upgrade\x18\x01 \x01(\bR\x11enableAutoUpgradeB.\n" +
	"\x19io.stackrox.proto.storageZ\x11./storage;storageb\x06proto3"

var (
	file_storage_sensor_upgrade_proto_rawDescOnce sync.Once
	file_storage_sensor_upgrade_proto_rawDescData []byte
)

func file_storage_sensor_upgrade_proto_rawDescGZIP() []byte {
	file_storage_sensor_upgrade_proto_rawDescOnce.Do(func() {
		file_storage_sensor_upgrade_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_storage_sensor_upgrade_proto_rawDesc), len(file_storage_sensor_upgrade_proto_rawDesc)))
	})
...
var file_storage_sensor_upgrade_proto_init_once sync.Once
func file_storage_sensor_upgrade_proto_init_ensure() { file_storage_sensor_upgrade_proto_init_once.Do(file_storage_sensor_upgrade_proto_init) }
