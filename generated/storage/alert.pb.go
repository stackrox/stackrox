...
type Alert_Deployment struct {
	state         protoimpl.MessageState        `protogen:"open.v1"`
	Id            string                        `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" search:"Deployment ID" sql:"index=hash,type(uuid)"`     // @gotags: search:"Deployment ID" sql:"index=hash,type(uuid)"
