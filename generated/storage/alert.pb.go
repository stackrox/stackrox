...
func (x *Alert_Violation) GetFileAccess() *FileAccess {
	if x != nil {
		if x, ok := x.MessageAttributes.(*Alert_Violation_FileAccess); ok {
			return x.FileAccess
		}
	}
	return nil
...
func (*Alert_Violation_FileAccess) isAlert_Violation_MessageAttributes() {}
...
const file_storage_alert_proto_rawDesc = "" +
	...
	"\x11network_flow_info\x18\a \x01(\v2(.storage.Alert.Violation.NetworkFlowInfoH\x00R\x0fnetworkFlowInfo\x126\n" +
	"\vfile_access\x18\b \x01(\v2\x13.storage.FileAccessH\x00R\n" +
	"fileAccess\x121\n" +
...
var file_storage_alert_proto_goTypes = []any{
	...
	(*ListAlert_NodeEntity)(nil),                       // 24: storage.ListAlert.NodeEntity
...
var file_storage_alert_proto_depIdxs = []int32{
	...
	24, // 22: storage.ListAlert.node:type_name -> storage.ListAlert.NodeEntity
	...
	15, // 25: storage.Alert.Deployment.labels:type_name -> storage.Alert.Deployment.LabelsEntry
	16, // 26: storage.Alert.Deployment.containers:type_name -> storage.Alert.Deployment.Container
	17, // 27: storage.Alert.Deployment.annotations:type_name -> storage.Alert.Deployment.AnnotationsEntry
	2,  // 28: storage.Alert.Resource.resource_type:type_name -> storage.Alert.Resource.ResourceType
	18, // 29: storage.Alert.Violation.key_value_attrs:type_name -> storage.Alert.Violation.KeyValueAttrs
	19, // 30: storage.Alert.Violation.network_flow_info:type_name -> storage.Alert.Violation.NetworkFlowInfo
	32, // 31: storage.Alert.Violation.file_access:type_name -> storage.FileAccess
	3,  // 32: storage.Alert.Violation.type:type_name -> storage.Alert.Violation.Type
	29, // 33: storage.Alert.Violation.time:type_name -> google.protobuf.Timestamp
...
func file_storage_alert_proto_init() {
	...
	file_storage_alert_proto_msgTypes[7].OneofWrappers = []any{
		...
		(*Alert_Violation_FileAccess)(nil),
	}
	type x struct{}
