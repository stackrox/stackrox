...
func (m *NetworkBaselineConnectionProperties) CloneVT() *NetworkBaselineConnectionProperties {
	...
	r := new(NetworkBaselineConnectionProperties)
	r.Ingress = m.Ingress
	r.Port = m.Port
...
func (m *NetworkBaselineConnectionProperties) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *NetworkBaselinePeer) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *NetworkBaseline) CloneVT() *NetworkBaseline {
	...
	r := new(NetworkBaseline)
	r.DeploymentId = m.DeploymentId
	r.ClusterId = m.ClusterId
	r.Namespace = m.Namespace
	r.ObservationPeriodEnd = (*timestamppb.Timestamp)((*timestamppb1.Timestamp)(m.ObservationPeriodEnd).CloneVT())
	r.Locked = m.Locked
...
func (m *NetworkBaseline) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *NetworkBaselineConnectionProperties) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*NetworkBaselineConnectionProperties)
	if !ok {
		return false
	}
...
func (this *NetworkBaselinePeer) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*NetworkBaselinePeer)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *NetworkBaseline) EqualVT(that *NetworkBaseline) bool {
	...
	if !(*timestamppb1.Timestamp)(this.ObservationPeriodEnd).EqualVT((*timestamppb1.Timestamp)(that.ObservationPeriodEnd)) {
		return false
	}
...
func (this *NetworkBaseline) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*NetworkBaseline)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *NetworkBaseline) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ObservationPeriodEnd != nil {
		size, err := (*timestamppb1.Timestamp)(m.ObservationPeriodEnd).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *NetworkBaseline) SizeVT() (n int) {
	...
	if m.ObservationPeriodEnd != nil {
		l = (*timestamppb1.Timestamp)(m.ObservationPeriodEnd).SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.Locked {
		n += 2
...
func (m *NetworkBaseline) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if err := (*timestamppb1.Timestamp)(m.ObservationPeriodEnd).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
...
func (m *NetworkBaselinePeer) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *NetworkBaseline) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 5:
			...
			m.ForbiddenPeers = append(m.ForbiddenPeers, &NetworkBaselinePeer{})
			if err := m.ForbiddenPeers[len(m.ForbiddenPeers)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 6:
			...
			if err := (*timestamppb1.Timestamp)(m.ObservationPeriodEnd).UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
