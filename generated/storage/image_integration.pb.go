...
type ScannerV4Config struct {
	// The presense of a ScannerV4 integration is not enough to accurately
	// determine if ScannerV4 should be used.
	// TODO: fix comments here
	Disabled             bool     `protobuf:"varint,1,opt,name=disabled,proto3" json:"disabled,omitempty"`
	NumConcurrentScans   int32    `protobuf:"varint,2,opt,name=num_concurrent_scans,json=numConcurrentScans,proto3" json:"num_concurrent_scans,omitempty"`
	IndexerEndpoint      string   `protobuf:"bytes,3,opt,name=indexer_endpoint,json=indexerEndpoint,proto3" json:"indexer_endpoint,omitempty"`
	MatcherEndpoint      string   `protobuf:"bytes,4,opt,name=matcher_endpoint,json=matcherEndpoint,proto3" json:"matcher_endpoint,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ScannerV4Config) GetDisabled() bool {
	if m != nil {
		return m.Disabled
	}
	return false
...
var fileDescriptor_9e3766be4a43c581 = []byte{
	...
	,
}
