...
type QuayConfig struct {
	Endpoint string `protobuf:"bytes,1,opt,name=endpoint,proto3" json:"endpoint,omitempty" scrub:"dependent" validate:"nolocalendpoint"`
	// The OAuth token for the integration. Required if this is a scanner integration. Can choose Robot Accounts instead for registry. The server will mask the value of this credential in responses and logs.
...
var fileDescriptor_9e3766be4a43c581 = []byte{
	...
	,
}
