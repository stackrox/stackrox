...
var (
	ImageIntegrationCategory_name = map[int32]string{
		...
		1: "SCANNER",
		2: "NODE_SCANNER",
		4: "VIRTUAL_MACHINE_SCANNER",
	}
	ImageIntegrationCategory_value = map[string]int32{
		"REGISTRY":                0,
		"SCANNER":                 1,
		"NODE_SCANNER":            2,
		"VIRTUAL_MACHINE_SCANNER": 4,
	}
)
...
type ImageIntegration struct {
	...
	ClusterId           string                               `protobuf:"bytes,16,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty" search:"Cluster ID,hidden" sql:"type(uuid)"` // @gotags: search:"Cluster ID,hidden" sql:"type(uuid)"
...
const file_storage_image_integration_proto_rawDesc = "" +
	...
	"\x17VIRTUAL_MACHINE_SCANNER\x10\x04B.\n" +
