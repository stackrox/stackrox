...
type ImageIntegration struct {
	...
	ClusterId           string                               `protobuf:"bytes,16,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"` // @gotags: search:"Cluster ID,hidden,store" sql:"type(uuid)"
...
type IBMRegistryConfig struct {
	...
	ApiKey string `protobuf:"bytes,2,opt,name=api_key,json=apiKey,proto3" json:"api_key,omitempty"` // @gotags: scrub:"always"
}
...
type QuayConfig struct {
	...
	OauthToken string `protobuf:"bytes,2,opt,name=oauthToken,proto3" json:"oauthToken,omitempty"` // @gotags: scrub:"always"
...
type ClairifyConfig struct {
	...
	Endpoint           string `protobuf:"bytes,1,opt,name=endpoint,proto3" json:"endpoint,omitempty"`                             // @gotags: validate:"nolocalendpoint"
	GrpcEndpoint       string `protobuf:"bytes,3,opt,name=grpc_endpoint,json=grpcEndpoint,proto3" json:"grpc_endpoint,omitempty"` // @gotags: validate:"nolocalendpoint"
...
type ECRConfig struct {
	...
	UseIam               bool                         `protobuf:"varint,5,opt,name=use_iam,json=useIam,proto3" json:"use_iam,omitempty"` // @gotags: scrub:"dependent"
...
type QuayConfig_RobotAccount struct {
	...
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // @gotags: scrub:"always"
}
...
var file_storage_image_integration_proto_rawDesc = []byte{
	...
	0x45, 0x52, 0x10, 0x02, 0x42, 0x27, 0x0a, 0x19, 0x69, 0x6f, 0x2e, 0x73, 0x74, 0x61, 0x63, 0x6b,
	0x72, 0x6f, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67,
	0x65, 0x5a, 0x0a, 0x2e, 0x2f, 0x3b, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x62, 0x06, 0x70,
...
func file_storage_image_integration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_storage_image_integration_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_storage_image_integration_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_storage_image_integration_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
