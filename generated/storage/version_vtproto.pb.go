...
func (this *Version) EqualVT(that *Version) bool {
	...
	if !(*timestamppb1.Timestamp)(this.LastPersisted).EqualVT((*timestamppb1.Timestamp)(that.LastPersisted)) {
		return false
	}
...
func (m *Version) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.LastPersisted != nil {
		size, err := (*timestamppb1.Timestamp)(m.LastPersisted).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *Version) SizeVT() (n int) {
	...
	if m.LastPersisted != nil {
		l = (*timestamppb1.Timestamp)(m.LastPersisted).SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	if m.MinSeqNum != 0 {
...
func (m *Version) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := (*timestamppb1.Timestamp)(m.LastPersisted).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *Version) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if err := (*timestamppb1.Timestamp)(m.LastPersisted).UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
