...
type Risk struct {
	...
	Score                float32        `protobuf:"fixed32,3,opt,name=score,proto3" json:"score,omitempty" search:"Risk Score,store,hidden"`
...
type Risk_Result struct {
	Name                 string                `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" search:"Risk Indicator,store,hidden"`
...
type RiskSubject struct {
	...
	Type                 RiskSubjectType `protobuf:"varint,4,opt,name=type,proto3,enum=storage.RiskSubjectType" json:"type,omitempty" search:"Risk Subject Type,store,hidden"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
var fileDescriptor_76ed3b6b4b68c2b1 = []byte{
	...
	,
}
