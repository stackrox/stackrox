...
type Group struct {
	...
	RoleName      string `protobuf:"bytes,3,opt,name=role_name,json=roleName,proto3" json:"role_name,omitempty" search:"Role" sql:"index=name:groups_unique_indicator;category:unique"` // @gotags: search:"Role" sql:"index=name:groups_unique_indicator;category:unique"
...
type GroupProperties struct {
	...
	AuthProviderId string  `protobuf:"bytes,1,opt,name=auth_provider_id,json=authProviderId,proto3" json:"auth_provider_id,omitempty" search:"Group Auth Provider" sql:"index=category:unique;name:groups_unique_indicator"` // @gotags: search:"Group Auth Provider" sql:"index=category:unique;name:groups_unique_indicator"
	Key            string  `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty" search:"Group Key" sql:"index=category:unique;name:groups_unique_indicator"`                                               // @gotags: search:"Group Key" sql:"index=category:unique;name:groups_unique_indicator"
	Value          string  `protobuf:"bytes,3,opt,name=value,proto3" json:"value,omitempty" search:"Group Value" sql:"index=category:unique;name:groups_unique_indicator"`                                           // @gotags: search:"Group Value" sql:"index=category:unique;name:groups_unique_indicator"
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_storage_group_proto_rawDesc = "" +
	"\n" +
	"\x13storage/group.proto\x12\astorage\x1a\x14storage/traits.proto\"T\n" +
	"\x05Group\x12.\n" +
