...
type ProcessListeningOnPort struct {
	Endpoints            []*ProcessListeningOnPort_Endpoint `protobuf:"bytes,1,rep,name=endpoints,proto3" json:"endpoints,omitempty"`
...
func (m *ProcessListeningOnPort) GetEndpoints() []*ProcessListeningOnPort_Endpoint {
	if m != nil {
		return m.Endpoints
	}
	return nil
...
func (m *ProcessListeningOnPort) Clone() *ProcessListeningOnPort {
	...
	*cloned = *m
	...
	if m.Endpoints != nil {
		cloned.Endpoints = make([]*ProcessListeningOnPort_Endpoint, len(m.Endpoints))
		for idx, v := range m.Endpoints {
			cloned.Endpoints[idx] = v.Clone()
		}
	}
...
var fileDescriptor_44bd1925a567394f = []byte{
	...
	,
}
...
func (m *ProcessListeningOnPort) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Endpoints = append(m.Endpoints, &ProcessListeningOnPort_Endpoint{})
