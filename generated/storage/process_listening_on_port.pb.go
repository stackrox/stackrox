...
type ProcessListeningOnPortStorage struct {
	...
	TimeFirstSeen        *types.Timestamp           `protobuf:"bytes,8,opt,name=time_first_seen,json=timeFirstSeen,proto3" json:"time_first_seen,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func (m *ProcessListeningOnPortStorage) GetTimeFirstSeen() *types.Timestamp {
	if m != nil {
...
func (m *ProcessListeningOnPortStorage) Clone() *ProcessListeningOnPortStorage {
	...
	*cloned = *m
	...
	cloned.CloseTimestamp = m.CloseTimestamp.Clone()
	cloned.Process = m.Process.Clone()
	cloned.TimeFirstSeen = m.TimeFirstSeen.Clone()
	return cloned
}
...
var fileDescriptor_44bd1925a567394f = []byte{
	...
	,
}
...
func (m *ProcessListeningOnPortStorage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TimeFirstSeen != nil {
		{
			size, err := m.TimeFirstSeen.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ProcessListeningOnPortStorage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TimeFirstSeen", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TimeFirstSeen == nil {
				m.TimeFirstSeen = &types.Timestamp{}
			}
			if err := m.TimeFirstSeen.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
