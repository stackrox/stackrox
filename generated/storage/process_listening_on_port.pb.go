...
type ProcessListeningOnPortStorage struct {
	...
	Port               uint32                 `protobuf:"varint,2,opt,name=port,proto3" json:"port,omitempty"`                                                        // @gotags: search:"Port,store"
	Protocol           L4Protocol             `protobuf:"varint,3,opt,name=protocol,proto3,enum=storage.L4Protocol" json:"protocol,omitempty"`                        // @gotags: search:"Port Protocol,store"
	CloseTimestamp     *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=close_timestamp,json=closeTimestamp,proto3" json:"close_timestamp,omitempty"`               // @gotags: search:"Closed Time,hidden"
	ProcessIndicatorId string                 `protobuf:"bytes,5,opt,name=process_indicator_id,json=processIndicatorId,proto3" json:"process_indicator_id,omitempty"` // @gotags: search:"Process ID,store" sql:"fk(ProcessIndicator:id),no-fk-constraint,index=btree,type(uuid)"
	// XXX: Make it a partial index on only active, not closed, PLOP
	Closed bool `protobuf:"varint,6,opt,name=closed,proto3" json:"closed,omitempty"` // @gotags: search:"Closed,store" sql:"index=btree"
	...
	DeploymentId string                     `protobuf:"bytes,8,opt,name=deployment_id,json=deploymentId,proto3" json:"deployment_id,omitempty"` // @gotags: search:"Deployment ID,store" sql:"fk(Deployment:id),no-fk-constraint,index=btree,type(uuid)"
	PodUid       string                     `protobuf:"bytes,9,opt,name=pod_uid,json=podUid,proto3" json:"pod_uid,omitempty"`                   // @gotags: search:"Pod UID,hidden" sql:"fk(Pod:id),no-fk-constraint,index=hash,type(uuid)"
	ClusterId    string                     `protobuf:"bytes,10,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`         // @gotags: search:"Cluster ID" sql:"type(uuid)"
	Namespace    string                     `protobuf:"bytes,11,opt,name=namespace,proto3" json:"namespace,omitempty"`                          // @gotags: search:"Namespace"
}
