...
type K8SRoleBinding struct {
	...
	CreatedAt     *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	Subjects      []*Subject             `protobuf:"bytes,10,rep,name=subjects,proto3" json:"subjects,omitempty" sensorhash:"set"`           // @gotags: sensorhash:"set"
...
var file_storage_rbac_proto_init_once sync.Once
func file_storage_rbac_proto_init_ensure() { file_storage_rbac_proto_init_once.Do(file_storage_rbac_proto_init) }
