...
type CosignPublicKeyVerification_PublicKey struct {
	...
	PublicKeysPemEnc     string   `protobuf:"bytes,2,opt,name=public_keys_pem_enc,json=publicKeysPemEnc,proto3" json:"public_keys_pem_enc,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *CosignPublicKeyVerification_PublicKey) GetPublicKeysPemEnc() string {
	if m != nil {
		return m.PublicKeysPemEnc
	}
	return ""
}
...
var fileDescriptor_b3165e7a4c19e14a = []byte{
	...
	,
}
...
func (m *CosignPublicKeyVerification_PublicKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PublicKeysPemEnc) > 0 {
		i -= len(m.PublicKeysPemEnc)
		copy(dAtA[i:], m.PublicKeysPemEnc)
		i = encodeVarintSignatureIntegration(dAtA, i, uint64(len(m.PublicKeysPemEnc)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Name) > 0 {
...
func (m *CosignPublicKeyVerification_PublicKey) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PublicKeysPemEnc", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PublicKeysPemEnc = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSignatureIntegration(dAtA[iNdEx:])
