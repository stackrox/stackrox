...
func (m *VirtualMachineV2) CloneVT() *VirtualMachineV2 {
	if m == nil {
		return (*VirtualMachineV2)(nil)
	}
	r := new(VirtualMachineV2)
	r.Id = m.Id
	r.Name = m.Name
	...
	if rhs := m.Notes; rhs != nil {
		tmpContainer := make([]VirtualMachineV2_Note, len(rhs))
...
func (m *VirtualMachineV2) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (this *VirtualMachineV2) EqualVT(that *VirtualMachineV2) bool {
	if this == that {
		return true
...
func (this *VirtualMachineV2) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*VirtualMachineV2)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (m *VirtualMachineV2) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *VirtualMachineV2) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *VirtualMachineV2) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *VirtualMachineV2) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VirtualMachineV2) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: VirtualMachineV2: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VirtualMachineV2: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 8:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.State |= VirtualMachineV2_State(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 10:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= VirtualMachineV2_Note(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.Notes) == 0 {
					m.Notes = make([]VirtualMachineV2_Note, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v VirtualMachineV2_Note
					for shift := uint(0); ; shift += 7 {
...
func (m *VirtualMachineV2) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
