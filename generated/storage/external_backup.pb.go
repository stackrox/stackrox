...
func (x *ExternalBackup) GetS3Compatible() *S3Compatible {
	if x, ok := x.GetConfig().(*ExternalBackup_S3Compatible); ok {
...
func file_storage_external_backup_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_storage_external_backup_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_storage_external_backup_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_storage_external_backup_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*S3Compatible); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_storage_external_backup_proto_msgTypes[3].Exporter = func(v any, i int) any {
