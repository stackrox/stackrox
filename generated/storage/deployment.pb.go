...
type Deployment struct {
	...
	AutomountServiceAccountToken  bool                   `protobuf:"varint,25,opt,name=automount_service_account_token,json=automountServiceAccountToken,proto3" json:"automount_service_account_token,omitempty" search:"Automount Service Account Token" policy:"Automount Service Account Token"`                                 // @gotags: search:"Automount Service Account Token" policy:"Automount Service Account Token"
	HostNetwork                   bool                   `protobuf:"varint,21,opt,name=host_network,json=hostNetwork,proto3" json:"host_network,omitempty" search:"Host Network" policy:"Host Network"`                                                                                        // @gotags: search:"Host Network" policy:"Host Network"
	HostPid                       bool                   `protobuf:"varint,31,opt,name=host_pid,json=hostPid,proto3" json:"host_pid,omitempty" search:"Host PID" policy:"Host PID"`                                                                                                    // @gotags: search:"Host PID" policy:"Host PID"
	HostIpc                       bool                   `protobuf:"varint,32,opt,name=host_ipc,json=hostIpc,proto3" json:"host_ipc,omitempty" search:"Host IPC" policy:"Host IPC"`                                                                                                    // @gotags: search:"Host IPC" policy:"Host IPC"
...
type SecurityContext struct {
	...
	AllowPrivilegeEscalation bool                            `protobuf:"varint,7,opt,name=allow_privilege_escalation,json=allowPrivilegeEscalation,proto3" json:"allow_privilege_escalation,omitempty" search:"Allow Privilege Escalation" policy:"Allow Privilege Escalation"` // @gotags: search:"Allow Privilege Escalation" policy:"Allow Privilege Escalation"
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
