...
type Deployment struct {
	...
	Namespace                     string                 `protobuf:"bytes,5,opt,name=namespace,proto3" json:"namespace,omitempty" search:"Namespace,store" sql:"index=name:deployment_dashboard_sac;priority:3;type:btree"`                                                                                             // @gotags: search:"Namespace,store" sql:"index=name:deployment_dashboard_sac;priority:3;type:btree"
	...
	ClusterId                     string                 `protobuf:"bytes,9,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty" search:"Cluster ID,store,hidden" sql:"type(uuid),index=name:deployment_dashboard_sac;priority:2;type:btree"`        // @gotags: search:"Cluster ID,store,hidden" sql:"type(uuid),index=name:deployment_dashboard_sac;priority:2;type:btree"
	...
	RiskScore                     float32                `protobuf:"fixed32,29,opt,name=risk_score,json=riskScore,proto3" json:"risk_score,omitempty" search:"Deployment Risk Score,hidden" policy:",ignore" sql:"index=name:deployment_dashboard_sac;priority:1;type:btree"`                                                                                             // @gotags: search:"Deployment Risk Score,hidden" policy:",ignore" sql:"index=name:deployment_dashboard_sac;priority:1;type:btree"
