...
// DeploymentLifecycleStage represents the lifecycle state of a deployment resource.
type DeploymentLifecycleStage int32

const (
	DeploymentLifecycleStage_DEPLOYMENT_ACTIVE  DeploymentLifecycleStage = 0
	DeploymentLifecycleStage_DEPLOYMENT_DELETED DeploymentLifecycleStage = 1 // Future: DEPLOYMENT_SCALED_DOWN, DEPLOYMENT_SUSPENDED, etc.
)

// Enum value maps for DeploymentLifecycleStage.
var (
	DeploymentLifecycleStage_name = map[int32]string{
		0: "DEPLOYMENT_ACTIVE",
		1: "DEPLOYMENT_DELETED",
	}
	DeploymentLifecycleStage_value = map[string]int32{
		"DEPLOYMENT_ACTIVE":  0,
		"DEPLOYMENT_DELETED": 1,
	}
)

func (x DeploymentLifecycleStage) Enum() *DeploymentLifecycleStage {
	p := new(DeploymentLifecycleStage)
	*p = x
	return p
}

func (x DeploymentLifecycleStage) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DeploymentLifecycleStage) Descriptor() protoreflect.EnumDescriptor {
	return file_storage_deployment_proto_enumTypes[0].Descriptor()
}

func (DeploymentLifecycleStage) Type() protoreflect.EnumType {
	return &file_storage_deployment_proto_enumTypes[0]
}

func (x DeploymentLifecycleStage) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DeploymentLifecycleStage.Descriptor instead.
func (DeploymentLifecycleStage) EnumDescriptor() ([]byte, []int) {
...
// Tombstone tracks when a resource was soft-deleted and when it should be permanently purged.
...
type Deployment struct {
	...
	Inactive                      bool            `protobuf:"varint,16,opt,name=inactive,proto3" json:"inactive,omitempty"`                                                                                                                 // Deprecated: Use lifecycle_stage instead.
	...
	// tombstone indicates if this deployment has been soft-deleted and when it will be purged.
	Tombstone *Tombstone `protobuf:"bytes,36,opt,name=tombstone,proto3" json:"tombstone,omitempty"`
	// lifecycle_stage indicates the current lifecycle state of this deployment.
	LifecycleStage DeploymentLifecycleStage `protobuf:"varint,37,opt,name=lifecycle_stage,json=lifecycleStage,proto3,enum=storage.DeploymentLifecycleStage" json:"lifecycle_stage,omitempty" search:"Lifecycle Stage"` // @gotags: search:"Lifecycle Stage"
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Deployment) GetLifecycleStage() DeploymentLifecycleStage {
	if x != nil {
		return x.LifecycleStage
	}
	return DeploymentLifecycleStage_DEPLOYMENT_ACTIVE
}
...
type Resources struct {
	...
	CpuCoresLimit   float32                `protobuf:"fixed32,2,opt,name=cpu_cores_limit,json=cpuCoresLimit,proto3" json:"cpu_cores_limit,omitempty" search:"CPU Cores Limit"`       // @gotags: search:"CPU Cores Limit"
	MemoryMbRequest float32                `protobuf:"fixed32,3,opt,name=memory_mb_request,json=memoryMbRequest,proto3" json:"memory_mb_request,omitempty" search:"Memory Request (MB)"` // @gotags: search:"Memory Request (MB)"
	MemoryMbLimit   float32                `protobuf:"fixed32,4,opt,name=memory_mb_limit,json=memoryMbLimit,proto3" json:"memory_mb_limit,omitempty" search:"Memory Limit (MB)"`       // @gotags: search:"Memory Limit (MB)"
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type Volume struct {
	state            protoimpl.MessageState  `protogen:"open.v1"`
	Name             string                  `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" search:"Volume Name"`                                                                                       // @gotags: search:"Volume Name"
	Source           string                  `protobuf:"bytes,2,opt,name=source,proto3" json:"source,omitempty" search:"Volume Source"`                                                                                   // @gotags: search:"Volume Source"
	Destination      string                  `protobuf:"bytes,3,opt,name=destination,proto3" json:"destination,omitempty" search:"Volume Destination"`                                                                         // @gotags: search:"Volume Destination"
	ReadOnly         bool                    `protobuf:"varint,4,opt,name=read_only,json=readOnly,proto3" json:"read_only,omitempty" search:"Volume ReadOnly"`                                                              // @gotags: search:"Volume ReadOnly"
	Type             string                  `protobuf:"bytes,5,opt,name=type,proto3" json:"type,omitempty" search:"Volume Type"`                                                                                       // @gotags: search:"Volume Type"
...
type PortConfig struct {
	...
	ContainerPort int32                    `protobuf:"varint,2,opt,name=container_port,json=containerPort,proto3" json:"container_port,omitempty" search:"Port"`        // @gotags: search:"Port"
	Protocol      string                   `protobuf:"bytes,3,opt,name=protocol,proto3" json:"protocol,omitempty" search:"Port Protocol"`                                        // @gotags: search:"Port Protocol"
	Exposure      PortConfig_ExposureLevel `protobuf:"varint,4,opt,name=exposure,proto3,enum=storage.PortConfig_ExposureLevel" json:"exposure,omitempty" search:"Max Exposure Level"` // @gotags: search:"Max Exposure Level"
	// Deprecated: Marked as deprecated in storage/deployment.proto.
...
type SecurityContext struct {
	state                    protoimpl.MessageState          `protogen:"open.v1"`
	Privileged               bool                            `protobuf:"varint,1,opt,name=privileged,proto3" json:"privileged,omitempty" search:"Privileged"` // @gotags: search:"Privileged"
	Selinux                  *SecurityContext_SELinux        `protobuf:"bytes,2,opt,name=selinux,proto3" json:"selinux,omitempty"`
	DropCapabilities         []string                        `protobuf:"bytes,3,rep,name=drop_capabilities,json=dropCapabilities,proto3" json:"drop_capabilities,omitempty" search:"Drop Capabilities"`                        // @gotags: search:"Drop Capabilities"
	AddCapabilities          []string                        `protobuf:"bytes,4,rep,name=add_capabilities,json=addCapabilities,proto3" json:"add_capabilities,omitempty" search:"Add Capabilities"`                           // @gotags: search:"Add Capabilities"
	ReadOnlyRootFilesystem   bool                            `protobuf:"varint,5,opt,name=read_only_root_filesystem,json=readOnlyRootFilesystem,proto3" json:"read_only_root_filesystem,omitempty" search:"Read Only Root Filesystem"` // @gotags: search:"Read Only Root Filesystem"
...
type PortConfig_ExposureInfo struct {
	state protoimpl.MessageState   `protogen:"open.v1"`
	Level PortConfig_ExposureLevel `protobuf:"varint,1,opt,name=level,proto3,enum=storage.PortConfig_ExposureLevel" json:"level,omitempty" search:"Exposure Level"` // @gotags: search:"Exposure Level"
	// only set if level is not HOST
	ServiceName      string `protobuf:"bytes,2,opt,name=service_name,json=serviceName,proto3" json:"service_name,omitempty" search:"Exposing Service"` // @gotags: search:"Exposing Service"
	...
	ServicePort      int32  `protobuf:"varint,5,opt,name=service_port,json=servicePort,proto3" json:"service_port,omitempty" search:"Exposing Service Port"` // @gotags: search:"Exposing Service Port"
	// only set if level is HOST, NODE, EXTERNAL or ROUTE
	NodePort int32 `protobuf:"varint,6,opt,name=node_port,json=nodePort,proto3" json:"node_port,omitempty" search:"Exposed Node Port"` // @gotags: search:"Exposed Node Port"
	// only set if level is EXTERNAL
	ExternalIps []string `protobuf:"bytes,7,rep,name=external_ips,json=externalIps,proto3" json:"external_ips,omitempty" search:"External IP"` // @gotags: search:"External IP"
	// only set if level is EXTERNAL or ROUTE
	ExternalHostnames []string `protobuf:"bytes,8,rep,name=external_hostnames,json=externalHostnames,proto3" json:"external_hostnames,omitempty" search:"External Hostname"` // @gotags: search:"External Hostname"
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type ContainerConfig_EnvironmentConfig struct {
	state         protoimpl.MessageState                         `protogen:"open.v1"`
	Key           string                                         `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty" search:"Environment Key"`                                                                                                      // @gotags: search:"Environment Key"
	Value         string                                         `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty" search:"Environment Value"`                                                                                                  // @gotags: search:"Environment Value"
	EnvVarSource  ContainerConfig_EnvironmentConfig_EnvVarSource `protobuf:"varint,3,opt,name=env_var_source,json=envVarSource,proto3,enum=storage.ContainerConfig_EnvironmentConfig_EnvVarSource" json:"env_var_source,omitempty" search:"Environment Variable Source"` // @gotags: search:"Environment Variable Source"
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_storage_deployment_proto_rawDesc = "" +
	"\n" +
	"\x18storage/deployment.proto\x12\astorage\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1fstorage/container_runtime.proto\x1a\x13storage/image.proto\x1a\x14storage/labels.proto\x1a\x12storage/rbac.proto\x1a\x14storage/taints.proto\"\x81\x01\n" +
	"\tTombstone\x129\n" +
	"\n" +
	"deleted_at\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\tdeletedAt\x129\n" +
	"\n" +
	"expires_at\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\texpiresAt\"\xf8\f\n" +
	"\n" +
	"Deployment\x12\x0e\n" +
	...
	"\ttombstone\x18$ \x01(\v2\x12.storage.TombstoneR\ttombstone\x12J\n" +
	"\x0flifecycle_stage\x18% \x01(\x0e2!.storage.DeploymentLifecycleStageR\x0elifecycleStage\x1a9\n" +
	...
	"\bpriority\x18\a \x01(\x03R\bpriority*I\n" +
	"\x18DeploymentLifecycleStage\x12\x15\n" +
	"\x11DEPLOYMENT_ACTIVE\x10\x00\x12\x16\n" +
	"\x12DEPLOYMENT_DELETED\x10\x01B.\n" +
...
var file_storage_deployment_proto_goTypes = []any{
	(DeploymentLifecycleStage)(0),                       // 0: storage.DeploymentLifecycleStage
	...
	(*Tombstone)(nil),                                   // 5: storage.Tombstone
	...
	(*LabelSelector)(nil),                               // 30: storage.LabelSelector
...
var file_storage_deployment_proto_depIdxs = []int32{
	29, // 0: storage.Tombstone.deleted_at:type_name -> google.protobuf.Timestamp
	29, // 1: storage.Tombstone.expires_at:type_name -> google.protobuf.Timestamp
	21, // 2: storage.Deployment.labels:type_name -> storage.Deployment.LabelsEntry
	22, // 3: storage.Deployment.pod_labels:type_name -> storage.Deployment.PodLabelsEntry
	30, // 4: storage.Deployment.label_selector:type_name -> storage.LabelSelector
	29, // 5: storage.Deployment.created:type_name -> google.protobuf.Timestamp
	8,  // 6: storage.Deployment.containers:type_name -> storage.Container
	23, // 7: storage.Deployment.annotations:type_name -> storage.Deployment.AnnotationsEntry
	31, // 8: storage.Deployment.service_account_permission_level:type_name -> storage.PermissionLevel
	32, // 9: storage.Deployment.tolerations:type_name -> storage.Toleration
	17, // 10: storage.Deployment.ports:type_name -> storage.PortConfig
	5,  // 11: storage.Deployment.tombstone:type_name -> storage.Tombstone
	0,  // 12: storage.Deployment.lifecycle_stage:type_name -> storage.DeploymentLifecycleStage
	33, // 13: storage.ContainerImage.name:type_name -> storage.ImageName
	18, // 14: storage.Container.config:type_name -> storage.ContainerConfig
	7,  // 15: storage.Container.image:type_name -> storage.ContainerImage
	19, // 16: storage.Container.security_context:type_name -> storage.SecurityContext
	10, // 17: storage.Container.volumes:type_name -> storage.Volume
	17, // 18: storage.Container.ports:type_name -> storage.PortConfig
	16, // 19: storage.Container.secrets:type_name -> storage.EmbeddedSecret
	9,  // 20: storage.Container.resources:type_name -> storage.Resources
	11, // 21: storage.Container.liveness_probe:type_name -> storage.LivenessProbe
	12, // 22: storage.Container.readiness_probe:type_name -> storage.ReadinessProbe
	1,  // 23: storage.Volume.mount_propagation:type_name -> storage.Volume.MountPropagation
	14, // 24: storage.Pod.live_instances:type_name -> storage.ContainerInstance
	24, // 25: storage.Pod.terminated_instances:type_name -> storage.Pod.ContainerInstanceList
	29, // 26: storage.Pod.started:type_name -> google.protobuf.Timestamp
	15, // 27: storage.ContainerInstance.instance_id:type_name -> storage.ContainerInstanceID
	29, // 28: storage.ContainerInstance.started:type_name -> google.protobuf.Timestamp
	29, // 29: storage.ContainerInstance.finished:type_name -> google.protobuf.Timestamp
	34, // 30: storage.ContainerInstanceID.container_runtime:type_name -> storage.ContainerRuntime
	2,  // 31: storage.PortConfig.exposure:type_name -> storage.PortConfig.ExposureLevel
	25, // 32: storage.PortConfig.exposure_infos:type_name -> storage.PortConfig.ExposureInfo
	26, // 33: storage.ContainerConfig.env:type_name -> storage.ContainerConfig.EnvironmentConfig
	27, // 34: storage.SecurityContext.selinux:type_name -> storage.SecurityContext.SELinux
	28, // 35: storage.SecurityContext.seccomp_profile:type_name -> storage.SecurityContext.SeccompProfile
	29, // 36: storage.ListDeployment.created:type_name -> google.protobuf.Timestamp
	14, // 37: storage.Pod.ContainerInstanceList.instances:type_name -> storage.ContainerInstance
	2,  // 38: storage.PortConfig.ExposureInfo.level:type_name -> storage.PortConfig.ExposureLevel
	3,  // 39: storage.ContainerConfig.EnvironmentConfig.env_var_source:type_name -> storage.ContainerConfig.EnvironmentConfig.EnvVarSource
	4,  // 40: storage.SecurityContext.SeccompProfile.type:type_name -> storage.SecurityContext.SeccompProfile.ProfileType
