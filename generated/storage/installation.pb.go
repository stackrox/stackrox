...
func (x *InstallationInfo) ProtoReflect() protoreflect.Message {
	file_storage_installation_proto_init_ensure()
	mi := &file_storage_installation_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
const file_storage_installation_proto_rawDesc = "" +
	"\n" +
	"\x1astorage/installation.proto\x12\astorage\x1a\x1fgoogle/protobuf/timestamp.proto\"X\n" +
	"\x10InstallationInfo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x124\n" +
	"\acreated\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\acreatedB.\n" +
	"\x19io.stackrox.proto.storageZ\x11./storage;storageb\x06proto3"

var (
	file_storage_installation_proto_rawDescOnce sync.Once
	file_storage_installation_proto_rawDescData []byte
)

func file_storage_installation_proto_rawDescGZIP() []byte {
	file_storage_installation_proto_rawDescOnce.Do(func() {
		file_storage_installation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_storage_installation_proto_rawDesc), len(file_storage_installation_proto_rawDesc)))
	})
...
var file_storage_installation_proto_init_once sync.Once
func file_storage_installation_proto_init_ensure() { file_storage_installation_proto_init_once.Do(file_storage_installation_proto_init) }
