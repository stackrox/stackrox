...
var file_storage_installation_proto_goTypes = []interface{}{
...
func file_storage_installation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_storage_installation_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InstallationInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
