...
type Exploit struct {
	...
	KnownRansomwareCampaignUse bool `protobuf:"varint,2,opt,name=known_ransomware_campaign_use,json=knownRansomwareCampaignUse,proto3" json:"known_ransomware_campaign_use,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *Exploit) GetKnownRansomwareCampaignUse() bool {
	if x != nil {
...
const file_storage_cve_proto_rawDesc = "" +
	...
	"\x0fepss_percentile\x18\x02 \x01(\x02R\x0eepssPercentile\"b\n" +
	"\aExploit\x12\x14\n" +
	"\x05known\x18\x01 \x01(\bR\x05known\x12A\n" +
	"\x1dknown_ransomware_campaign_use\x18\x02 \x01(\bR\x1aknownRansomwareCampaignUse\"\xbf\v\n" +
	"\x03CVE\x12\x0e\n" +
...
var file_storage_cve_proto_depIdxs = []int32{
	...
	35, // 25: storage.ImageCVE.snooze_start:type_name -> google.protobuf.Timestamp
	35, // 26: storage.ImageCVE.snooze_expiry:type_name -> google.protobuf.Timestamp
	...
	35, // 32: storage.ImageCVEV2.first_image_occurrence:type_name -> google.protobuf.Timestamp
	...
	22, // 35: storage.NodeCVE.cve_base_info:type_name -> storage.CVEInfo
	...
	22, // 40: storage.ClusterCVE.cve_base_info:type_name -> storage.CVEInfo
	...
	29, // 46: storage.CVSSScore.cvssv2:type_name -> storage.CVSSV2
	30, // 47: storage.CVSSScore.cvssv3:type_name -> storage.CVSSV3
	...
	1,  // 64: storage.CVE.DistroSpecific.severity:type_name -> storage.VulnerabilitySeverity
	5,  // 65: storage.CVE.DistroSpecific.score_version:type_name -> storage.CVE.ScoreVersion
	29, // 66: storage.CVE.DistroSpecific.cvss_v2:type_name -> storage.CVSSV2
	30, // 67: storage.CVE.DistroSpecific.cvss_v3:type_name -> storage.CVSSV3
	31, // 68: storage.CVE.DistroSpecificsEntry.value:type_name -> storage.CVE.DistroSpecific
