...
type PolicyCategory struct {
	...
	Teams                []string `protobuf:"bytes,4,rep,name=teams,proto3" json:"teams,omitempty" search:"Team"`
...
func (m *PolicyCategory) GetTeams() []string {
	if m != nil {
		return m.Teams
	}
	return nil
...
var fileDescriptor_0b38511e664e6e6a = []byte{
	...
	,
}
...
func (m *PolicyCategory) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Teams) > 0 {
		for iNdEx := len(m.Teams) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintPolicyCategory(dAtA, i, uint64(len(m.Teams[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
