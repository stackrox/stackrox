...
type Node struct {
	...
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" search:"Node ID" sql:"pk,type(uuid)"` // @gotags: search:"Node ID" sql:"pk,type(uuid)"
	...
	JoinedAt *timestamppb.Timestamp `protobuf:"bytes,13,opt,name=joined_at,json=joinedAt,proto3" json:"joined_at,omitempty" search:"Node Join Time"` // @gotags: search:"Node Join Time"
...
type Node_TopCvss struct {
	TopCvss float32 `protobuf:"fixed32,24,opt,name=top_cvss,json=topCvss,proto3,oneof" search:"Node Top CVSS"` // @gotags: search:"Node Top CVSS"
}
...
type NodeScan struct {
	state           protoimpl.MessageState       `protogen:"open.v1"`
	ScanTime        *timestamppb.Timestamp       `protobuf:"bytes,1,opt,name=scan_time,json=scanTime,proto3" json:"scan_time,omitempty" search:"Node Scan Time"` // @gotags: search:"Node Scan Time"
