...
type Node_Components struct {
	Components int32 `protobuf:"varint,19,opt,name=components,proto3,oneof" json:"components,omitempty" search:"Component Count,store,hidden"` // @gotags: search:"Component Count,store,hidden"
}
type Node_Cves struct {
	Cves int32 `protobuf:"varint,20,opt,name=cves,proto3,oneof" json:"cves,omitempty" search:"CVE Count,store,hidden"` // @gotags: search:"CVE Count,store,hidden"
}
type Node_FixableCves struct {
	FixableCves int32 `protobuf:"varint,21,opt,name=fixable_cves,json=fixableCves,proto3,oneof" json:"fixable_cves,omitempty" search:"Fixable CVE Count,store,hidden"` // @gotags: search:"Fixable CVE Count,store,hidden"
}
type Node_TopCvss struct {
	TopCvss float32 `protobuf:"fixed32,24,opt,name=top_cvss,json=topCvss,proto3,oneof" json:"top_cvss,omitempty" search:"Node Top CVSS,store"` // @gotags: search:"Node Top CVSS,store"
}
...
var fileDescriptor_107f6eed651900c7 = []byte{
	...
	,
}
