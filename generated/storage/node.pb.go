...
// This is a copy of scannerV1.Note
...
type NodeInventory struct {
	NodeId               string                    `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty" search:"Node Inventory ID"`
	NodeName             string                    `protobuf:"bytes,2,opt,name=node_name,json=nodeName,proto3" json:"node_name,omitempty" search:"Node Inventory Name"`
	ScanTime             *types.Timestamp          `protobuf:"bytes,3,opt,name=scan_time,json=scanTime,proto3" json:"scan_time,omitempty"`
	Components           *NodeInventory_Components `protobuf:"bytes,4,opt,name=components,proto3" json:"components,omitempty" sql:"-"`
...
// This is a copy of scannerV1.Components.
// We have it copied to avoid conflicts when generating the code in central/graphql/resolvers/generated.go
type NodeInventory_Components struct {
	Namespace            string              `protobuf:"bytes,1,opt,name=namespace,proto3" json:"namespace,omitempty"`
	RhelComponents       []*v1.RHELComponent `protobuf:"bytes,2,rep,name=rhel_components,json=rhelComponents,proto3" json:"rhel_components,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *NodeInventory_Components) GetRhelComponents() []*v1.RHELComponent {
	if m != nil {
...
func (m *NodeInventory_Components) Clone() *NodeInventory_Components {
	...
	*cloned = *m
	...
	if m.RhelComponents != nil {
		cloned.RhelComponents = make([]*v1.RHELComponent, len(m.RhelComponents))
...
var fileDescriptor_107f6eed651900c7 = []byte{
	...
	,
}
...
func (m *NodeInventory_Components) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.RhelComponents = append(m.RhelComponents, &v1.RHELComponent{})
