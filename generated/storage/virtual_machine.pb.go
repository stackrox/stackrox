...
// VirtualMachineScan duplicates most of the ImageScan or NodeScan
// data structure tree, trimming down fields considered not needed for now.
// An important consideration is that no field in this data structure tree has
// any search tag. The goal was to ensure the whole Virtual Machine scan
// could be stored in the `serialized` column from
// the `virtual_machines` table.
