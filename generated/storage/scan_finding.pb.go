...
type ScanFinding struct {
	...
	ImageId               string                 `protobuf:"bytes,6,opt,name=image_id,json=imageId,proto3" json:"image_id,omitempty" search:"Image ID,hidden" sql:"index=btree"`                                                        // @gotags: search:"Image ID,hidden" sql:"index=btree"
