...
const file_storage_container_runtime_proto_rawDesc = "" +
	"\n" +
	"\x1fstorage/container_runtime.proto\x12\astorage\x1a!google/protobuf/go_features.proto\"_\n" +
	"\x14ContainerRuntimeInfo\x12-\n" +
	"\x04type\x18\x01 \x01(\x0e2\x19.storage.ContainerRuntimeR\x04type\x12\x18\n" +
...
var file_storage_container_runtime_proto_goTypes = []any{
...
func file_storage_container_runtime_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_storage_container_runtime_proto_rawDesc), len(file_storage_container_runtime_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
