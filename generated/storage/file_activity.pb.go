...
type FileActivity struct {
	...
	Moved         *FileActivity_File `protobuf:"bytes,5,opt,name=moved,proto3,oneof" json:"moved,omitempty"`
...
const file_storage_file_activity_proto_rawDesc = "" +
	"\n" +
	"\x1bstorage/file_activity.proto\x12\astorage\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1fstorage/process_indicator.proto\"\xf9\x04\n" +
	"\fFileActivity\x128\n" +
	...
	"\x04meta\x18\x03 \x01(\v2\".storage.FileActivity.FileMetadataR\x04meta\"n\n" +
	"\x04Type\x12\f\n" +
