...
func file_storage_compliance_operator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_storage_compliance_operator_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_storage_compliance_operator_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_storage_compliance_operator_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_storage_compliance_operator_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_storage_compliance_operator_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_storage_compliance_operator_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_storage_compliance_operator_proto_msgTypes[14].Exporter = func(v any, i int) any {
