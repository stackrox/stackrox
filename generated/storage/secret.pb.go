...
type Secret struct {
	...
	Files         []*SecretDataFile   `protobuf:"bytes,10,rep,name=files,proto3" json:"files,omitempty" sensorhash:"set"` // @gotags: sensorhash:"set"
...
type ImagePullSecret_Registry struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty" search:"Image Pull Secret Registry"` // @gotags: search:"Image Pull Secret Registry"
