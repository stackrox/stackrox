...
type OrchestratorMetadata struct {
	state   protoimpl.MessageState `protogen:"open.v1"`
	Version string                 `protobuf:"bytes,1,opt,name=version,proto3" json:"version,omitempty"` // @gotags: search:"Cluster Kubernetes Version"
...
type Cluster struct {
	...
	Type               ClusterType            `protobuf:"varint,3,opt,name=type,proto3,enum=storage.ClusterType" json:"type,omitempty"`                                                      // @gotags: search:"Cluster Platform Type"
	Labels             map[string]string      `protobuf:"bytes,27,rep,name=labels,proto3" json:"labels,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // @gotags: search:"Cluster Label"
