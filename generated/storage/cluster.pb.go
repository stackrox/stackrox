...
type Cluster struct {
	...
	HealthStatus               *ClusterHealthStatus  `protobuf:"bytes,22,opt,name=health_status,json=healthStatus,proto3" json:"health_status,omitempty" sql:"ignore_pk"`
...
type ClusterHealthStatus struct {
	Id                         string                      `protobuf:"bytes,9,opt,name=id,proto3" json:"id,omitempty" sql:"pk"`
	...
	LocalScannerHealthInfo     *LocalScannerHealthInfo     `protobuf:"bytes,10,opt,name=local_scanner_health_info,json=localScannerHealthInfo,proto3" json:"local_scanner_health_info,omitempty"`
	...
	LocalScannerHealthStatus     ClusterHealthStatus_HealthStatusLabel `protobuf:"varint,11,opt,name=local_scanner_health_status,json=localScannerHealthStatus,proto3,enum=storage.ClusterHealthStatus_HealthStatusLabel" json:"local_scanner_health_status,omitempty" search:"Local Scanner Status,store"`
	...
	LastContact *types.Timestamp `protobuf:"bytes,5,opt,name=last_contact,json=lastContact,proto3" json:"last_contact,omitempty"`
...
func (m *ClusterHealthStatus) GetLocalScannerHealthInfo() *LocalScannerHealthInfo {
	if m != nil {
		return m.LocalScannerHealthInfo
	}
	return nil
}
...
func (m *ClusterHealthStatus) GetLocalScannerHealthStatus() ClusterHealthStatus_HealthStatusLabel {
	if m != nil {
		return m.LocalScannerHealthStatus
	}
	return ClusterHealthStatus_UNINITIALIZED
}
...
func (m *ClusterHealthStatus) Clone() *ClusterHealthStatus {
	...
	*cloned = *m
	...
	cloned.LocalScannerHealthInfo = m.LocalScannerHealthInfo.Clone()
...
// LocalScannerHealthInfo carries data about local scanner deployment but does not include local scanner health status
// derived from this data.
// Aggregated local scanner health status is not included because it is derived in central and not in the component that
// first reports LocalScannerHealthInfo (sensor).
type LocalScannerHealthInfo struct {
	// Types that are valid to be assigned to TotalDesiredAnalyzerPodsOpt:
	//	*LocalScannerHealthInfo_TotalDesiredAnalyzerPods
	TotalDesiredAnalyzerPodsOpt isLocalScannerHealthInfo_TotalDesiredAnalyzerPodsOpt `protobuf_oneof:"total_desired_analyzer_pods_opt"`
	// Types that are valid to be assigned to TotalReadyAnalyzerPodsOpt:
	//	*LocalScannerHealthInfo_TotalReadyAnalyzerPods
	TotalReadyAnalyzerPodsOpt isLocalScannerHealthInfo_TotalReadyAnalyzerPodsOpt `protobuf_oneof:"total_ready_analyzer_pods_opt"`
	// Types that are valid to be assigned to TotalDesiredDbPodsOpt:
	//	*LocalScannerHealthInfo_TotalDesiredDbPods
	TotalDesiredDbPodsOpt isLocalScannerHealthInfo_TotalDesiredDbPodsOpt `protobuf_oneof:"total_desired_db_pods_opt"`
	// Types that are valid to be assigned to TotalReadyDbPodsOpt:
	//	*LocalScannerHealthInfo_TotalReadyDbPods
	TotalReadyDbPodsOpt isLocalScannerHealthInfo_TotalReadyDbPodsOpt `protobuf_oneof:"total_ready_db_pods_opt"`
...
func (m *LocalScannerHealthInfo) Reset()         { *m = LocalScannerHealthInfo{} }
func (m *LocalScannerHealthInfo) String() string { return proto.CompactTextString(m) }
func (*LocalScannerHealthInfo) ProtoMessage()    {}
func (*LocalScannerHealthInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_bd4108636841f8d0, []int{21}
}
func (m *LocalScannerHealthInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *LocalScannerHealthInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LocalScannerHealthInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *LocalScannerHealthInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LocalScannerHealthInfo.Merge(m, src)
}
func (m *LocalScannerHealthInfo) XXX_Size() int {
	return m.Size()
}
func (m *LocalScannerHealthInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_LocalScannerHealthInfo.DiscardUnknown(m)
}

var xxx_messageInfo_LocalScannerHealthInfo proto.InternalMessageInfo

type isLocalScannerHealthInfo_TotalDesiredAnalyzerPodsOpt interface {
	isLocalScannerHealthInfo_TotalDesiredAnalyzerPodsOpt()
	MarshalTo([]byte) (int, error)
	Size() int
	Clone() isLocalScannerHealthInfo_TotalDesiredAnalyzerPodsOpt
}
type isLocalScannerHealthInfo_TotalReadyAnalyzerPodsOpt interface {
	isLocalScannerHealthInfo_TotalReadyAnalyzerPodsOpt()
	MarshalTo([]byte) (int, error)
	Size() int
	Clone() isLocalScannerHealthInfo_TotalReadyAnalyzerPodsOpt
}
type isLocalScannerHealthInfo_TotalDesiredDbPodsOpt interface {
	isLocalScannerHealthInfo_TotalDesiredDbPodsOpt()
	MarshalTo([]byte) (int, error)
	Size() int
	Clone() isLocalScannerHealthInfo_TotalDesiredDbPodsOpt
}
type isLocalScannerHealthInfo_TotalReadyDbPodsOpt interface {
	isLocalScannerHealthInfo_TotalReadyDbPodsOpt()
	MarshalTo([]byte) (int, error)
	Size() int
	Clone() isLocalScannerHealthInfo_TotalReadyDbPodsOpt
}

type LocalScannerHealthInfo_TotalDesiredAnalyzerPods struct {
...
type LocalScannerHealthInfo_TotalReadyAnalyzerPods struct {
...
type LocalScannerHealthInfo_TotalDesiredDbPods struct {
...
type LocalScannerHealthInfo_TotalReadyDbPods struct {
...
func (*LocalScannerHealthInfo_TotalDesiredAnalyzerPods) isLocalScannerHealthInfo_TotalDesiredAnalyzerPodsOpt() {
}
func (m *LocalScannerHealthInfo_TotalDesiredAnalyzerPods) Clone() isLocalScannerHealthInfo_TotalDesiredAnalyzerPodsOpt {
	if m == nil {
		return nil
	}
	cloned := new(LocalScannerHealthInfo_TotalDesiredAnalyzerPods)
	*cloned = *m

	return cloned
}
func (*LocalScannerHealthInfo_TotalReadyAnalyzerPods) isLocalScannerHealthInfo_TotalReadyAnalyzerPodsOpt() {
}
func (m *LocalScannerHealthInfo_TotalReadyAnalyzerPods) Clone() isLocalScannerHealthInfo_TotalReadyAnalyzerPodsOpt {
	if m == nil {
		return nil
	}
	cloned := new(LocalScannerHealthInfo_TotalReadyAnalyzerPods)
	*cloned = *m

	return cloned
}
func (*LocalScannerHealthInfo_TotalDesiredDbPods) isLocalScannerHealthInfo_TotalDesiredDbPodsOpt() {}
func (m *LocalScannerHealthInfo_TotalDesiredDbPods) Clone() isLocalScannerHealthInfo_TotalDesiredDbPodsOpt {
	if m == nil {
		return nil
	}
	cloned := new(LocalScannerHealthInfo_TotalDesiredDbPods)
	*cloned = *m

	return cloned
}
func (*LocalScannerHealthInfo_TotalReadyDbPods) isLocalScannerHealthInfo_TotalReadyDbPodsOpt() {}
func (m *LocalScannerHealthInfo_TotalReadyDbPods) Clone() isLocalScannerHealthInfo_TotalReadyDbPodsOpt {
	if m == nil {
		return nil
	}
	cloned := new(LocalScannerHealthInfo_TotalReadyDbPods)
	*cloned = *m

	return cloned
}

func (m *LocalScannerHealthInfo) GetTotalDesiredAnalyzerPodsOpt() isLocalScannerHealthInfo_TotalDesiredAnalyzerPodsOpt {
	if m != nil {
		return m.TotalDesiredAnalyzerPodsOpt
	}
	return nil
}
func (m *LocalScannerHealthInfo) GetTotalReadyAnalyzerPodsOpt() isLocalScannerHealthInfo_TotalReadyAnalyzerPodsOpt {
	if m != nil {
		return m.TotalReadyAnalyzerPodsOpt
	}
	return nil
}
func (m *LocalScannerHealthInfo) GetTotalDesiredDbPodsOpt() isLocalScannerHealthInfo_TotalDesiredDbPodsOpt {
	if m != nil {
		return m.TotalDesiredDbPodsOpt
	}
	return nil
}
func (m *LocalScannerHealthInfo) GetTotalReadyDbPodsOpt() isLocalScannerHealthInfo_TotalReadyDbPodsOpt {
	if m != nil {
...
func (m *LocalScannerHealthInfo) GetTotalDesiredAnalyzerPods() int32 {
	if x, ok := m.GetTotalDesiredAnalyzerPodsOpt().(*LocalScannerHealthInfo_TotalDesiredAnalyzerPods); ok {
		return x.TotalDesiredAnalyzerPods
	}
	return 0
}

func (m *LocalScannerHealthInfo) GetTotalReadyAnalyzerPods() int32 {
	if x, ok := m.GetTotalReadyAnalyzerPodsOpt().(*LocalScannerHealthInfo_TotalReadyAnalyzerPods); ok {
		return x.TotalReadyAnalyzerPods
	}
	return 0
}

func (m *LocalScannerHealthInfo) GetTotalDesiredDbPods() int32 {
	if x, ok := m.GetTotalDesiredDbPodsOpt().(*LocalScannerHealthInfo_TotalDesiredDbPods); ok {
		return x.TotalDesiredDbPods
	}
	return 0
}

func (m *LocalScannerHealthInfo) GetTotalReadyDbPods() int32 {
	if x, ok := m.GetTotalReadyDbPodsOpt().(*LocalScannerHealthInfo_TotalReadyDbPods); ok {
		return x.TotalReadyDbPods
	}
	return 0
}

func (m *LocalScannerHealthInfo) GetStatusErrors() []string {
	if m != nil {
		return m.StatusErrors
	}
	return nil
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*LocalScannerHealthInfo) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*LocalScannerHealthInfo_TotalDesiredAnalyzerPods)(nil),
		(*LocalScannerHealthInfo_TotalReadyAnalyzerPods)(nil),
		(*LocalScannerHealthInfo_TotalDesiredDbPods)(nil),
		(*LocalScannerHealthInfo_TotalReadyDbPods)(nil),
	}
}

func (m *LocalScannerHealthInfo) MessageClone() proto.Message {
	return m.Clone()
}
func (m *LocalScannerHealthInfo) Clone() *LocalScannerHealthInfo {
	if m == nil {
		return nil
	}
	cloned := new(LocalScannerHealthInfo)
	*cloned = *m
...
func init() {
	...
	proto.RegisterType((*LocalScannerHealthInfo)(nil), "storage.LocalScannerHealthInfo")
}
...
var fileDescriptor_bd4108636841f8d0 = []byte{
	...
	,
}
...
func (m *ClusterHealthStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.LocalScannerHealthStatus != 0 {
		i = encodeVarintCluster(dAtA, i, uint64(m.LocalScannerHealthStatus))
		i--
		dAtA[i] = 0x58
	}
	if m.LocalScannerHealthInfo != nil {
		{
			size, err := m.LocalScannerHealthInfo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *LocalScannerHealthInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *LocalScannerHealthInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LocalScannerHealthInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LocalScannerHealthInfo_TotalDesiredAnalyzerPods) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LocalScannerHealthInfo_TotalDesiredAnalyzerPods) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *LocalScannerHealthInfo_TotalReadyAnalyzerPods) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LocalScannerHealthInfo_TotalReadyAnalyzerPods) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *LocalScannerHealthInfo_TotalDesiredDbPods) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LocalScannerHealthInfo_TotalDesiredDbPods) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *LocalScannerHealthInfo_TotalReadyDbPods) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *LocalScannerHealthInfo_TotalReadyDbPods) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *ClusterHealthStatus) Size() (n int) {
	...
	if m.LocalScannerHealthInfo != nil {
		l = m.LocalScannerHealthInfo.Size()
		n += 1 + l + sovCluster(uint64(l))
	}
	if m.LocalScannerHealthStatus != 0 {
		n += 1 + sovCluster(uint64(m.LocalScannerHealthStatus))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *LocalScannerHealthInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LocalScannerHealthInfo_TotalDesiredAnalyzerPods) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LocalScannerHealthInfo_TotalReadyAnalyzerPods) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LocalScannerHealthInfo_TotalDesiredDbPods) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *LocalScannerHealthInfo_TotalReadyDbPods) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ClusterHealthStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field LocalScannerHealthInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.LocalScannerHealthInfo == nil {
				m.LocalScannerHealthInfo = &LocalScannerHealthInfo{}
			}
			if err := m.LocalScannerHealthInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LocalScannerHealthStatus", wireType)
			}
			m.LocalScannerHealthStatus = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowCluster
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LocalScannerHealthStatus |= ClusterHealthStatus_HealthStatusLabel(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *LocalScannerHealthInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: LocalScannerHealthInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: LocalScannerHealthInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			m.TotalDesiredAnalyzerPodsOpt = &LocalScannerHealthInfo_TotalDesiredAnalyzerPods{v}
		case 2:
			if wireType != 0 {
			...
			m.TotalReadyAnalyzerPodsOpt = &LocalScannerHealthInfo_TotalReadyAnalyzerPods{v}
		case 3:
			if wireType != 0 {
			...
			m.TotalDesiredDbPodsOpt = &LocalScannerHealthInfo_TotalDesiredDbPods{v}
		case 4:
			if wireType != 0 {
			...
			m.TotalReadyDbPodsOpt = &LocalScannerHealthInfo_TotalReadyDbPods{v}
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StatusErrors", wireType)
			}
