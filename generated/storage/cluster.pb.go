...
type ScannerHealthInfo struct {
	...
	// Types that are valid to be assigned to TotalDesiredV4IndexerPodsOpt:
	//
	//	*ScannerHealthInfo_TotalDesiredV4IndexerPods
	TotalDesiredV4IndexerPodsOpt isScannerHealthInfo_TotalDesiredV4IndexerPodsOpt `protobuf_oneof:"total_desired_v4_indexer_pods_opt"`
	// Types that are valid to be assigned to TotalReadyV4IndexerPodsOpt:
	//
	//	*ScannerHealthInfo_TotalReadyV4IndexerPods
	TotalReadyV4IndexerPodsOpt isScannerHealthInfo_TotalReadyV4IndexerPodsOpt `protobuf_oneof:"total_ready_v4_indexer_pods_opt"`
	// Types that are valid to be assigned to TotalDesiredV4DbPodsOpt:
	//
	//	*ScannerHealthInfo_TotalDesiredV4DbPods
	TotalDesiredV4DbPodsOpt isScannerHealthInfo_TotalDesiredV4DbPodsOpt `protobuf_oneof:"total_desired_v4_db_pods_opt"`
	// Types that are valid to be assigned to TotalReadyV4DbPodsOpt:
	//
	//	*ScannerHealthInfo_TotalReadyV4DbPods
	TotalReadyV4DbPodsOpt isScannerHealthInfo_TotalReadyV4DbPodsOpt `protobuf_oneof:"total_ready_v4_db_pods_opt"`
...
type isScannerHealthInfo_TotalDesiredV4IndexerPodsOpt interface {
	isScannerHealthInfo_TotalDesiredV4IndexerPodsOpt()
	MarshalTo([]byte) (int, error)
	Size() int
	Clone() isScannerHealthInfo_TotalDesiredV4IndexerPodsOpt
}
type isScannerHealthInfo_TotalReadyV4IndexerPodsOpt interface {
	isScannerHealthInfo_TotalReadyV4IndexerPodsOpt()
	MarshalTo([]byte) (int, error)
	Size() int
	Clone() isScannerHealthInfo_TotalReadyV4IndexerPodsOpt
}
type isScannerHealthInfo_TotalDesiredV4DbPodsOpt interface {
	isScannerHealthInfo_TotalDesiredV4DbPodsOpt()
	MarshalTo([]byte) (int, error)
	Size() int
	Clone() isScannerHealthInfo_TotalDesiredV4DbPodsOpt
}
type isScannerHealthInfo_TotalReadyV4DbPodsOpt interface {
	isScannerHealthInfo_TotalReadyV4DbPodsOpt()
	MarshalTo([]byte) (int, error)
	Size() int
	Clone() isScannerHealthInfo_TotalReadyV4DbPodsOpt
}
...
type ScannerHealthInfo_TotalDesiredV4IndexerPods struct {
	TotalDesiredV4IndexerPods int32 `protobuf:"varint,6,opt,name=total_desired_v4_indexer_pods,json=totalDesiredV4IndexerPods,proto3,oneof" json:"total_desired_v4_indexer_pods,omitempty"`
}
type ScannerHealthInfo_TotalReadyV4IndexerPods struct {
	TotalReadyV4IndexerPods int32 `protobuf:"varint,7,opt,name=total_ready_v4_indexer_pods,json=totalReadyV4IndexerPods,proto3,oneof" json:"total_ready_v4_indexer_pods,omitempty"`
}
type ScannerHealthInfo_TotalDesiredV4DbPods struct {
	TotalDesiredV4DbPods int32 `protobuf:"varint,8,opt,name=total_desired_v4_db_pods,json=totalDesiredV4DbPods,proto3,oneof" json:"total_desired_v4_db_pods,omitempty"`
}
type ScannerHealthInfo_TotalReadyV4DbPods struct {
	TotalReadyV4DbPods int32 `protobuf:"varint,9,opt,name=total_ready_v4_db_pods,json=totalReadyV4DbPods,proto3,oneof" json:"total_ready_v4_db_pods,omitempty"`
}
...
func (*ScannerHealthInfo_TotalDesiredV4IndexerPods) isScannerHealthInfo_TotalDesiredV4IndexerPodsOpt() {
}
func (m *ScannerHealthInfo_TotalDesiredV4IndexerPods) Clone() isScannerHealthInfo_TotalDesiredV4IndexerPodsOpt {
	if m == nil {
		return nil
	}
	cloned := new(ScannerHealthInfo_TotalDesiredV4IndexerPods)
	*cloned = *m

	return cloned
}
func (*ScannerHealthInfo_TotalReadyV4IndexerPods) isScannerHealthInfo_TotalReadyV4IndexerPodsOpt() {}
func (m *ScannerHealthInfo_TotalReadyV4IndexerPods) Clone() isScannerHealthInfo_TotalReadyV4IndexerPodsOpt {
	if m == nil {
		return nil
	}
	cloned := new(ScannerHealthInfo_TotalReadyV4IndexerPods)
	*cloned = *m

	return cloned
}
func (*ScannerHealthInfo_TotalDesiredV4DbPods) isScannerHealthInfo_TotalDesiredV4DbPodsOpt() {}
func (m *ScannerHealthInfo_TotalDesiredV4DbPods) Clone() isScannerHealthInfo_TotalDesiredV4DbPodsOpt {
	if m == nil {
		return nil
	}
	cloned := new(ScannerHealthInfo_TotalDesiredV4DbPods)
	*cloned = *m

	return cloned
}
func (*ScannerHealthInfo_TotalReadyV4DbPods) isScannerHealthInfo_TotalReadyV4DbPodsOpt() {}
func (m *ScannerHealthInfo_TotalReadyV4DbPods) Clone() isScannerHealthInfo_TotalReadyV4DbPodsOpt {
	if m == nil {
		return nil
	}
	cloned := new(ScannerHealthInfo_TotalReadyV4DbPods)
	*cloned = *m
...
func (m *ScannerHealthInfo) GetTotalDesiredV4IndexerPodsOpt() isScannerHealthInfo_TotalDesiredV4IndexerPodsOpt {
	if m != nil {
		return m.TotalDesiredV4IndexerPodsOpt
	}
	return nil
}
func (m *ScannerHealthInfo) GetTotalReadyV4IndexerPodsOpt() isScannerHealthInfo_TotalReadyV4IndexerPodsOpt {
	if m != nil {
		return m.TotalReadyV4IndexerPodsOpt
	}
	return nil
}
func (m *ScannerHealthInfo) GetTotalDesiredV4DbPodsOpt() isScannerHealthInfo_TotalDesiredV4DbPodsOpt {
	if m != nil {
		return m.TotalDesiredV4DbPodsOpt
	}
	return nil
}
func (m *ScannerHealthInfo) GetTotalReadyV4DbPodsOpt() isScannerHealthInfo_TotalReadyV4DbPodsOpt {
	if m != nil {
		return m.TotalReadyV4DbPodsOpt
	}
	return nil
}
...
func (m *ScannerHealthInfo) GetTotalDesiredV4IndexerPods() int32 {
	if x, ok := m.GetTotalDesiredV4IndexerPodsOpt().(*ScannerHealthInfo_TotalDesiredV4IndexerPods); ok {
		return x.TotalDesiredV4IndexerPods
	}
	return 0
}

func (m *ScannerHealthInfo) GetTotalReadyV4IndexerPods() int32 {
	if x, ok := m.GetTotalReadyV4IndexerPodsOpt().(*ScannerHealthInfo_TotalReadyV4IndexerPods); ok {
		return x.TotalReadyV4IndexerPods
	}
	return 0
}

func (m *ScannerHealthInfo) GetTotalDesiredV4DbPods() int32 {
	if x, ok := m.GetTotalDesiredV4DbPodsOpt().(*ScannerHealthInfo_TotalDesiredV4DbPods); ok {
		return x.TotalDesiredV4DbPods
	}
	return 0
}

func (m *ScannerHealthInfo) GetTotalReadyV4DbPods() int32 {
	if x, ok := m.GetTotalReadyV4DbPodsOpt().(*ScannerHealthInfo_TotalReadyV4DbPods); ok {
		return x.TotalReadyV4DbPods
	}
	return 0
}
...
func (*ScannerHealthInfo) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*ScannerHealthInfo_TotalDesiredV4IndexerPods)(nil),
		(*ScannerHealthInfo_TotalReadyV4IndexerPods)(nil),
		(*ScannerHealthInfo_TotalDesiredV4DbPods)(nil),
		(*ScannerHealthInfo_TotalReadyV4DbPods)(nil),
	}
}
...
func (m *ScannerHealthInfo) Clone() *ScannerHealthInfo {
	...
	*cloned = *m
	...
	if m.TotalDesiredV4IndexerPodsOpt != nil {
		cloned.TotalDesiredV4IndexerPodsOpt = m.TotalDesiredV4IndexerPodsOpt.Clone()
	}
	if m.TotalReadyV4IndexerPodsOpt != nil {
		cloned.TotalReadyV4IndexerPodsOpt = m.TotalReadyV4IndexerPodsOpt.Clone()
	}
	if m.TotalDesiredV4DbPodsOpt != nil {
		cloned.TotalDesiredV4DbPodsOpt = m.TotalDesiredV4DbPodsOpt.Clone()
	}
	if m.TotalReadyV4DbPodsOpt != nil {
		cloned.TotalReadyV4DbPodsOpt = m.TotalReadyV4DbPodsOpt.Clone()
	}
	if m.StatusErrors != nil {
		cloned.StatusErrors = make([]string, len(m.StatusErrors))
		copy(cloned.StatusErrors, m.StatusErrors)
...
var fileDescriptor_bd4108636841f8d0 = []byte{
	...
	,
}
...
func (m *ScannerHealthInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.TotalReadyV4DbPodsOpt != nil {
		{
			size := m.TotalReadyV4DbPodsOpt.Size()
			i -= size
			if _, err := m.TotalReadyV4DbPodsOpt.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
	if m.TotalDesiredV4DbPodsOpt != nil {
		{
			size := m.TotalDesiredV4DbPodsOpt.Size()
			i -= size
			if _, err := m.TotalDesiredV4DbPodsOpt.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
	if m.TotalReadyV4IndexerPodsOpt != nil {
		{
			size := m.TotalReadyV4IndexerPodsOpt.Size()
			i -= size
			if _, err := m.TotalReadyV4IndexerPodsOpt.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
	if m.TotalDesiredV4IndexerPodsOpt != nil {
		{
			size := m.TotalDesiredV4IndexerPodsOpt.Size()
			i -= size
			if _, err := m.TotalDesiredV4IndexerPodsOpt.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *ScannerHealthInfo_TotalDesiredV4IndexerPods) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ScannerHealthInfo_TotalDesiredV4IndexerPods) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarintCluster(dAtA, i, uint64(m.TotalDesiredV4IndexerPods))
	i--
	dAtA[i] = 0x30
	return len(dAtA) - i, nil
}
func (m *ScannerHealthInfo_TotalReadyV4IndexerPods) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ScannerHealthInfo_TotalReadyV4IndexerPods) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarintCluster(dAtA, i, uint64(m.TotalReadyV4IndexerPods))
	i--
	dAtA[i] = 0x38
	return len(dAtA) - i, nil
}
func (m *ScannerHealthInfo_TotalDesiredV4DbPods) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ScannerHealthInfo_TotalDesiredV4DbPods) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarintCluster(dAtA, i, uint64(m.TotalDesiredV4DbPods))
	i--
	dAtA[i] = 0x40
	return len(dAtA) - i, nil
}
func (m *ScannerHealthInfo_TotalReadyV4DbPods) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ScannerHealthInfo_TotalReadyV4DbPods) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarintCluster(dAtA, i, uint64(m.TotalReadyV4DbPods))
	i--
	dAtA[i] = 0x48
	return len(dAtA) - i, nil
}
...
func (m *ScannerHealthInfo) Size() (n int) {
	...
	if m.TotalDesiredV4IndexerPodsOpt != nil {
		n += m.TotalDesiredV4IndexerPodsOpt.Size()
	}
	if m.TotalReadyV4IndexerPodsOpt != nil {
		n += m.TotalReadyV4IndexerPodsOpt.Size()
	}
	if m.TotalDesiredV4DbPodsOpt != nil {
		n += m.TotalDesiredV4DbPodsOpt.Size()
	}
	if m.TotalReadyV4DbPodsOpt != nil {
		n += m.TotalReadyV4DbPodsOpt.Size()
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ScannerHealthInfo_TotalDesiredV4IndexerPods) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovCluster(uint64(m.TotalDesiredV4IndexerPods))
	return n
}
func (m *ScannerHealthInfo_TotalReadyV4IndexerPods) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovCluster(uint64(m.TotalReadyV4IndexerPods))
	return n
}
func (m *ScannerHealthInfo_TotalDesiredV4DbPods) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovCluster(uint64(m.TotalDesiredV4DbPods))
	return n
}
func (m *ScannerHealthInfo_TotalReadyV4DbPods) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovCluster(uint64(m.TotalReadyV4DbPods))
	return n
}
...
func (m *ScannerHealthInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalDesiredV4IndexerPods", wireType)
			}
			var v int32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalDesiredV4IndexerPodsOpt = &ScannerHealthInfo_TotalDesiredV4IndexerPods{v}
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalReadyV4IndexerPods", wireType)
			}
			var v int32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalReadyV4IndexerPodsOpt = &ScannerHealthInfo_TotalReadyV4IndexerPods{v}
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalDesiredV4DbPods", wireType)
			}
			var v int32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalDesiredV4DbPodsOpt = &ScannerHealthInfo_TotalDesiredV4DbPods{v}
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalReadyV4DbPods", wireType)
			}
			var v int32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TotalReadyV4DbPodsOpt = &ScannerHealthInfo_TotalReadyV4DbPods{v}
		default:
			iNdEx = preIndex
			skippy, err := skipCluster(dAtA[iNdEx:])
			if err != nil {
