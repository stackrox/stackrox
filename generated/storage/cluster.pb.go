...
// Deprecated: Use AutoLockProcessBaselinesConfig.ProtoReflect.Descriptor instead.
func (*AutoLockProcessBaselinesConfig) Descriptor() ([]byte, []int) {
...
type DynamicClusterConfig struct {
	...
	RuntimeDataControl             *DynamicClusterConfig_RuntimeDataControl `protobuf:"bytes,5,opt,name=runtime_data_control,json=runtimeDataControl,proto3" json:"runtime_data_control,omitempty"`
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
func (x *DynamicClusterConfig) GetRuntimeDataControl() *DynamicClusterConfig_RuntimeDataControl {
	if x != nil {
		return x.RuntimeDataControl
	}
	return nil
}
...
type ClusterHealthStatus struct {
	...
	SensorHealthStatus           ClusterHealthStatus_HealthStatusLabel `protobuf:"varint,2,opt,name=sensor_health_status,json=sensorHealthStatus,proto3,enum=storage.ClusterHealthStatus_HealthStatusLabel" json:"sensor_health_status,omitempty" search:"Sensor Status"`                                 // @gotags: search:"Sensor Status"
	CollectorHealthStatus        ClusterHealthStatus_HealthStatusLabel `protobuf:"varint,3,opt,name=collector_health_status,json=collectorHealthStatus,proto3,enum=storage.ClusterHealthStatus_HealthStatusLabel" json:"collector_health_status,omitempty" search:"Collector Status"`                        // @gotags: search:"Collector Status"
	OverallHealthStatus          ClusterHealthStatus_HealthStatusLabel `protobuf:"varint,4,opt,name=overall_health_status,json=overallHealthStatus,proto3,enum=storage.ClusterHealthStatus_HealthStatusLabel" json:"overall_health_status,omitempty" search:"Cluster Status"`                              // @gotags: search:"Cluster Status"
	AdmissionControlHealthStatus ClusterHealthStatus_HealthStatusLabel `protobuf:"varint,7,opt,name=admission_control_health_status,json=admissionControlHealthStatus,proto3,enum=storage.ClusterHealthStatus_HealthStatusLabel" json:"admission_control_health_status,omitempty" search:"Admission Control Status"` // @gotags: search:"Admission Control Status"
	ScannerHealthStatus          ClusterHealthStatus_HealthStatusLabel `protobuf:"varint,11,opt,name=scanner_health_status,json=scannerHealthStatus,proto3,enum=storage.ClusterHealthStatus_HealthStatusLabel" json:"scanner_health_status,omitempty" search:"Scanner Status"`                             // @gotags: search:"Scanner Status"
	...
	LastContact *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=last_contact,json=lastContact,proto3" json:"last_contact,omitempty" search:"Last Contact"` // @gotags: search:"Last Contact"
...
type DynamicClusterConfig_RuntimeDataControl struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	NamespaceFilter  string                 `protobuf:"bytes,1,opt,name=namespace_filter,json=namespaceFilter,proto3" json:"namespace_filter,omitempty"`
	ExcludeOpenshift bool                   `protobuf:"varint,2,opt,name=exclude_openshift,json=excludeOpenshift,proto3" json:"exclude_openshift,omitempty"`
	Persistence      bool                   `protobuf:"varint,3,opt,name=persistence,proto3" json:"persistence,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *DynamicClusterConfig_RuntimeDataControl) Reset() {
	*x = DynamicClusterConfig_RuntimeDataControl{}
	mi := &file_storage_cluster_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DynamicClusterConfig_RuntimeDataControl) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DynamicClusterConfig_RuntimeDataControl) ProtoMessage() {}

func (x *DynamicClusterConfig_RuntimeDataControl) ProtoReflect() protoreflect.Message {
	mi := &file_storage_cluster_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DynamicClusterConfig_RuntimeDataControl.ProtoReflect.Descriptor instead.
func (*DynamicClusterConfig_RuntimeDataControl) Descriptor() ([]byte, []int) {
	return file_storage_cluster_proto_rawDescGZIP(), []int{10, 0}
}

func (x *DynamicClusterConfig_RuntimeDataControl) GetNamespaceFilter() string {
	if x != nil {
...
func (x *DynamicClusterConfig_RuntimeDataControl) GetExcludeOpenshift() bool {
	if x != nil {
		return x.ExcludeOpenshift
	}
	return false
}

func (x *DynamicClusterConfig_RuntimeDataControl) GetPersistence() bool {
	if x != nil {
...
const file_storage_cluster_proto_rawDesc = "" +
	"\n" +
	"\x15storage/cluster.proto\x12\astorage\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc1\x01\n" +
	...
	"\aenabled\x18\x01 \x01(\bR\aenabled\"\xbf\x04\n" +
	...
	"\"auto_lock_process_baselines_config\x18\x04 \x01(\v2'.storage.AutoLockProcessBaselinesConfigR\x1eautoLockProcessBaselinesConfig\x12b\n" +
	"\x14runtime_data_control\x18\x05 \x01(\v20.storage.DynamicClusterConfig.RuntimeDataControlR\x12runtimeDataControl\x1a\x8e\x01\n" +
	"\x12RuntimeDataControl\x12)\n" +
	"\x10namespace_filter\x18\x01 \x01(\tR\x0fnamespaceFilter\x12+\n" +
	"\x11exclude_openshift\x18\x02 \x01(\bR\x10excludeOpenshift\x12 \n" +
	"\vpersistence\x18\x03 \x01(\bR\vpersistence\"\xeb\x02\n" +
...
var file_storage_cluster_proto_goTypes = []any{
	...
	(*DynamicClusterConfig_RuntimeDataControl)(nil),                   // 31: storage.DynamicClusterConfig.RuntimeDataControl
...
var file_storage_cluster_proto_depIdxs = []int32{
	...
	31, // 11: storage.DynamicClusterConfig.runtime_data_control:type_name -> storage.DynamicClusterConfig.RuntimeDataControl
