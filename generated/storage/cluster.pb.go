...
type CollectorFeature struct {
	...
	//
	//	*CollectorFeature_Processes
	//	*CollectorFeature_NetworkConnections
	//	*CollectorFeature_NetworkEndpoints
	Feature isCollectorFeature_Feature `protobuf_oneof:"feature"`
}

func (x *CollectorFeature) Reset() {
	*x = CollectorFeature{}
	if protoimpl.UnsafeEnabled {
...
func (x *CollectorFeature) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CollectorFeature) ProtoMessage() {}

func (x *CollectorFeature) ProtoReflect() protoreflect.Message {
	mi := &file_storage_cluster_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CollectorFeature.ProtoReflect.Descriptor instead.
func (*CollectorFeature) Descriptor() ([]byte, []int) {
	return file_storage_cluster_proto_rawDescGZIP(), []int{10}
}

func (m *CollectorFeature) GetFeature() isCollectorFeature_Feature {
	if m != nil {
		return m.Feature
	}
	return nil
...
func (x *CollectorFeature) GetProcesses() *ProcessConfig {
	if x, ok := x.GetFeature().(*CollectorFeature_Processes); ok {
		return x.Processes
	}
	return nil
}

func (x *CollectorFeature) GetNetworkConnections() *NetworkConnectionConfig {
	if x, ok := x.GetFeature().(*CollectorFeature_NetworkConnections); ok {
		return x.NetworkConnections
	}
	return nil
}

func (x *CollectorFeature) GetNetworkEndpoints() *NetworkEndpointConfig {
	if x, ok := x.GetFeature().(*CollectorFeature_NetworkEndpoints); ok {
		return x.NetworkEndpoints
	}
	return nil
}

type isCollectorFeature_Feature interface {
	isCollectorFeature_Feature()
}

type CollectorFeature_Processes struct {
	Processes *ProcessConfig `protobuf:"bytes,1,opt,name=processes,proto3,oneof"`
}

type CollectorFeature_NetworkConnections struct {
	NetworkConnections *NetworkConnectionConfig `protobuf:"bytes,2,opt,name=network_connections,json=networkConnections,proto3,oneof"`
}

type CollectorFeature_NetworkEndpoints struct {
	NetworkEndpoints *NetworkEndpointConfig `protobuf:"bytes,3,opt,name=network_endpoints,json=networkEndpoints,proto3,oneof"`
}

func (*CollectorFeature_Processes) isCollectorFeature_Feature() {}

func (*CollectorFeature_NetworkConnections) isCollectorFeature_Feature() {}

func (*CollectorFeature_NetworkEndpoints) isCollectorFeature_Feature() {}

type CollectorNamespaceConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Feature            *CollectorFeature                         `protobuf:"bytes,1,opt,name=feature,proto3" json:"feature,omitempty"`
	NamespaceSelection []*CollectorNamespaceConfig_NamespaceRule `protobuf:"bytes,2,rep,name=namespace_selection,json=namespaceSelection,proto3" json:"namespace_selection,omitempty"`
}

func (x *CollectorNamespaceConfig) Reset() {
	*x = CollectorNamespaceConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *CollectorNamespaceConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CollectorNamespaceConfig) ProtoMessage() {}

func (x *CollectorNamespaceConfig) ProtoReflect() protoreflect.Message {
	mi := &file_storage_cluster_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CollectorNamespaceConfig.ProtoReflect.Descriptor instead.
func (*CollectorNamespaceConfig) Descriptor() ([]byte, []int) {
	return file_storage_cluster_proto_rawDescGZIP(), []int{11}
}

func (x *CollectorNamespaceConfig) GetFeature() *CollectorFeature {
	if x != nil {
		return x.Feature
	}
	return nil
...
func (x *CollectorNamespaceConfig) GetNamespaceSelection() []*CollectorNamespaceConfig_NamespaceRule {
	if x != nil {
...
type CollectorConfig struct {
	...
	ClusterScopeConfig   []*CollectorFeature         `protobuf:"bytes,1,rep,name=cluster_scope_config,json=clusterScopeConfig,proto3" json:"cluster_scope_config,omitempty"`
	NamespaceScopeConfig []*CollectorNamespaceConfig `protobuf:"bytes,2,rep,name=namespace_scope_config,json=namespaceScopeConfig,proto3" json:"namespace_scope_config,omitempty"`
}
...
func (x *CollectorConfig) GetClusterScopeConfig() []*CollectorFeature {
	if x != nil {
		return x.ClusterScopeConfig
	}
	return nil
}

func (x *CollectorConfig) GetNamespaceScopeConfig() []*CollectorNamespaceConfig {
	if x != nil {
		return x.NamespaceScopeConfig
	}
	return nil
}
...
type CollectorNamespaceConfig_NamespaceRule struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CollectorNamespaceConfig_NamespaceRule) Reset() {
	*x = CollectorNamespaceConfig_NamespaceRule{}
	if protoimpl.UnsafeEnabled {
...
func (x *CollectorNamespaceConfig_NamespaceRule) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CollectorNamespaceConfig_NamespaceRule) ProtoMessage() {}

func (x *CollectorNamespaceConfig_NamespaceRule) ProtoReflect() protoreflect.Message {
	mi := &file_storage_cluster_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CollectorNamespaceConfig_NamespaceRule.ProtoReflect.Descriptor instead.
func (*CollectorNamespaceConfig_NamespaceRule) Descriptor() ([]byte, []int) {
	return file_storage_cluster_proto_rawDescGZIP(), []int{11, 0}
}

func (x *CollectorNamespaceConfig_NamespaceRule) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *CollectorNamespaceConfig_NamespaceRule) GetMatchType() MatchType {
	if x != nil {
		return x.MatchType
	}
...
var file_storage_cluster_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x52, 0x75, 0x6c, 0x65, 0x52, 0x12, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x53,
	0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x60, 0x0a, 0x0d, 0x4e, 0x61, 0x6d, 0x65,
	...
	,
	...
	0x64, 0x79, 0x6e, 0x61, 0x6d, 0x69, 0x63, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x41, 0x0a,
	0x0d, 0x73, 0x74, 0x61, 0x74, 0x69, 0x63, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x53,
	...
	0x12, 0x2d, 0x0a, 0x12, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x66, 0x69, 0x6e, 0x67, 0x65,
	0x72, 0x70, 0x72, 0x69, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x46, 0x69, 0x6e, 0x67, 0x65, 0x72, 0x70, 0x72, 0x69, 0x6e, 0x74, 0x12,
	0x58, 0x0a, 0x0e, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x5f, 0x6c, 0x61, 0x62, 0x65, 0x6c,
	0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67,
	0x65, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65,
	0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x4c,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x52, 0x12, 0x73, 0x65, 0x6e,
	0x73, 0x6f, 0x72, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	0x66, 0x0a, 0x17, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x5f, 0x68, 0x65, 0x61,
	0x6c, 0x74, 0x68, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e,
	...
	0x52, 0x15, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x48, 0x65, 0x61, 0x6c, 0x74,
	0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x62, 0x0a, 0x15, 0x6f, 0x76, 0x65, 0x72, 0x61,
	0x6c, 0x6c, 0x5f, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2e, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65,
	...
	0x73, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x52, 0x13, 0x6f, 0x76, 0x65, 0x72, 0x61, 0x6c, 0x6c, 0x48,
	0x65, 0x61, 0x6c, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x75, 0x0a, 0x1f, 0x61,
	0x64, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c,
	0x5f, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x07,
	...
	0x61, 0x62, 0x65, 0x6c, 0x52, 0x1c, 0x61, 0x64, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x43,
	0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x12, 0x62, 0x0a, 0x15, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65, 0x72, 0x5f, 0x68, 0x65,
	0x61, 0x6c, 0x74, 0x68, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0b, 0x20, 0x01, 0x28,
	...
	,
	...
	0x0c, 0x0a, 0x08, 0x44, 0x45, 0x47, 0x52, 0x41, 0x44, 0x45, 0x44, 0x10, 0x03, 0x12, 0x0b, 0x0a,
	0x07, 0x48, 0x45, 0x41, 0x4c, 0x54, 0x48, 0x59, 0x10, 0x04, 0x22, 0xb8, 0x02, 0x0a, 0x13, 0x43,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x2e, 0x0a, 0x12,
	0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x64, 0x65, 0x73, 0x69, 0x72, 0x65, 0x64, 0x5f, 0x70, 0x6f,
	0x64, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x48, 0x00, 0x52, 0x10, 0x74, 0x6f, 0x74, 0x61,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x48, 0x01, 0x52, 0x0e, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x52,
	0x65, 0x61, 0x64, 0x79, 0x50, 0x6f, 0x64, 0x73, 0x12, 0x36, 0x0a, 0x16, 0x74, 0x6f, 0x74, 0x61,
	0x6c, 0x5f, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x65, 0x64, 0x5f, 0x6e, 0x6f, 0x64,
	0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x48, 0x02, 0x52, 0x14, 0x74, 0x6f, 0x74, 0x61,
	0x6c, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x65, 0x64, 0x4e, 0x6f, 0x64, 0x65, 0x73,
	...
	,
	...
	,
	...
	,
...
var file_storage_cluster_proto_goTypes = []any{
	...
	(*CollectorFeature)(nil),                                          // 18: storage.CollectorFeature
	(*CollectorNamespaceConfig)(nil),                                  // 19: storage.CollectorNamespaceConfig
	...
	(*CollectorNamespaceConfig_NamespaceRule)(nil),                    // 36: storage.CollectorNamespaceConfig.NamespaceRule
...
var file_storage_cluster_proto_depIdxs = []int32{
	...
	15, // 6: storage.CollectorFeature.processes:type_name -> storage.ProcessConfig
	16, // 7: storage.CollectorFeature.network_connections:type_name -> storage.NetworkConnectionConfig
	17, // 8: storage.CollectorFeature.network_endpoints:type_name -> storage.NetworkEndpointConfig
	18, // 9: storage.CollectorNamespaceConfig.feature:type_name -> storage.CollectorFeature
	36, // 10: storage.CollectorNamespaceConfig.namespace_selection:type_name -> storage.CollectorNamespaceConfig.NamespaceRule
	18, // 11: storage.CollectorConfig.cluster_scope_config:type_name -> storage.CollectorFeature
	19, // 12: storage.CollectorConfig.namespace_scope_config:type_name -> storage.CollectorNamespaceConfig
	0,  // 13: storage.StaticClusterConfig.type:type_name -> storage.ClusterType
	1,  // 14: storage.StaticClusterConfig.collection_method:type_name -> storage.CollectionMethod
	21, // 15: storage.StaticClusterConfig.tolerations_config:type_name -> storage.TolerationsConfig
	14, // 16: storage.DynamicClusterConfig.admission_controller_config:type_name -> storage.AdmissionControllerConfig
	20, // 17: storage.DynamicClusterConfig.collector_config:type_name -> storage.CollectorConfig
	23, // 18: storage.CompleteClusterConfig.dynamic_config:type_name -> storage.DynamicClusterConfig
	22, // 19: storage.CompleteClusterConfig.static_config:type_name -> storage.StaticClusterConfig
	37, // 20: storage.CompleteClusterConfig.cluster_labels:type_name -> storage.CompleteClusterConfig.ClusterLabelsEntry
	0,  // 21: storage.Cluster.type:type_name -> storage.ClusterType
	38, // 22: storage.Cluster.labels:type_name -> storage.Cluster.LabelsEntry
	1,  // 23: storage.Cluster.collection_method:type_name -> storage.CollectionMethod
	28, // 24: storage.Cluster.status:type_name -> storage.ClusterStatus
	23, // 25: storage.Cluster.dynamic_config:type_name -> storage.DynamicClusterConfig
	21, // 26: storage.Cluster.tolerations_config:type_name -> storage.TolerationsConfig
	32, // 27: storage.Cluster.health_status:type_name -> storage.ClusterHealthStatus
	24, // 28: storage.Cluster.helm_config:type_name -> storage.CompleteClusterConfig
	25, // 29: storage.Cluster.most_recent_sensor_id:type_name -> storage.SensorDeploymentIdentification
	39, // 30: storage.Cluster.audit_log_state:type_name -> storage.Cluster.AuditLogStateEntry
	2,  // 31: storage.Cluster.managed_by:type_name -> storage.ManagerType
	41, // 32: storage.ClusterCertExpiryStatus.sensor_cert_expiry:type_name -> google.protobuf.Timestamp
	41, // 33: storage.ClusterCertExpiryStatus.sensor_cert_not_before:type_name -> google.protobuf.Timestamp
	41, // 34: storage.ClusterStatus.DEPRECATED_last_contact:type_name -> google.protobuf.Timestamp
	12, // 35: storage.ClusterStatus.provider_metadata:type_name -> storage.ProviderMetadata
	13, // 36: storage.ClusterStatus.orchestrator_metadata:type_name -> storage.OrchestratorMetadata
	29, // 37: storage.ClusterStatus.upgrade_status:type_name -> storage.ClusterUpgradeStatus
	27, // 38: storage.ClusterStatus.cert_expiry_status:type_name -> storage.ClusterCertExpiryStatus
	4,  // 39: storage.ClusterUpgradeStatus.upgradability:type_name -> storage.ClusterUpgradeStatus.Upgradability
	40, // 40: storage.ClusterUpgradeStatus.most_recent_process:type_name -> storage.ClusterUpgradeStatus.UpgradeProcessStatus
	6,  // 41: storage.UpgradeProgress.upgrade_state:type_name -> storage.UpgradeProgress.UpgradeState
	41, // 42: storage.UpgradeProgress.since:type_name -> google.protobuf.Timestamp
	41, // 43: storage.AuditLogFileState.collect_logs_since:type_name -> google.protobuf.Timestamp
	33, // 44: storage.ClusterHealthStatus.collector_health_info:type_name -> storage.CollectorHealthInfo
	34, // 45: storage.ClusterHealthStatus.admission_control_health_info:type_name -> storage.AdmissionControlHealthInfo
	35, // 46: storage.ClusterHealthStatus.scanner_health_info:type_name -> storage.ScannerHealthInfo
	7,  // 47: storage.ClusterHealthStatus.sensor_health_status:type_name -> storage.ClusterHealthStatus.HealthStatusLabel
	7,  // 48: storage.ClusterHealthStatus.collector_health_status:type_name -> storage.ClusterHealthStatus.HealthStatusLabel
	7,  // 49: storage.ClusterHealthStatus.overall_health_status:type_name -> storage.ClusterHealthStatus.HealthStatusLabel
	7,  // 50: storage.ClusterHealthStatus.admission_control_health_status:type_name -> storage.ClusterHealthStatus.HealthStatusLabel
	7,  // 51: storage.ClusterHealthStatus.scanner_health_status:type_name -> storage.ClusterHealthStatus.HealthStatusLabel
	41, // 52: storage.ClusterHealthStatus.last_contact:type_name -> google.protobuf.Timestamp
	42, // 53: storage.CollectorNamespaceConfig.NamespaceRule.match_type:type_name -> storage.MatchType
...
func file_storage_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_storage_cluster_proto_msgTypes[11].Exporter = func(v any, i int) any {
			switch v := v.(*CollectorNamespaceConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_storage_cluster_proto_msgTypes[28].Exporter = func(v any, i int) any {
			switch v := v.(*CollectorNamespaceConfig_NamespaceRule); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_storage_cluster_proto_msgTypes[10].OneofWrappers = []any{
		(*CollectorFeature_Processes)(nil),
		(*CollectorFeature_NetworkConnections)(nil),
		(*CollectorFeature_NetworkEndpoints)(nil),
	}
