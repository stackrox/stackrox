...
func (ClusterUpgradeStatus_UpgradeProcessStatus_UpgradeProcessType) EnumDescriptor() ([]byte, []int) {
	return file_storage_cluster_proto_rawDescGZIP(), []int{22, 0, 0}
}
...
func (UpgradeProgress_UpgradeState) EnumDescriptor() ([]byte, []int) {
	return file_storage_cluster_proto_rawDescGZIP(), []int{23, 0}
}
...
func (x *NetworkConnectionConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *NetworkConnectionConfig) GetAggregateExternal() bool {
	if x != nil {
...
type NetworkEndpointConfig struct {
	...
	Enabled                           bool `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	IncludeListeningEndpointProcesses bool `protobuf:"varint,2,opt,name=include_listening_endpoint_processes,json=includeListeningEndpointProcesses,proto3" json:"include_listening_endpoint_processes,omitempty"`
}
...
func (x *NetworkEndpointConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *NetworkEndpointConfig) GetIncludeListeningEndpointProcesses() bool {
	if x != nil {
		return x.IncludeListeningEndpointProcesses
	}
	return false
}

type CollectorFeatureConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*CollectorFeatureConfig_ProcessConfig
	//	*CollectorFeatureConfig_NetworkConnectionConfig
	//	*CollectorFeatureConfig_NetworkEndpointConfig
	Config isCollectorFeatureConfig_Config `protobuf_oneof:"config"`
}

func (x *CollectorFeatureConfig) Reset() {
	*x = CollectorFeatureConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *CollectorFeatureConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CollectorFeatureConfig) ProtoMessage() {}

func (x *CollectorFeatureConfig) ProtoReflect() protoreflect.Message {
	mi := &file_storage_cluster_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CollectorFeatureConfig.ProtoReflect.Descriptor instead.
func (*CollectorFeatureConfig) Descriptor() ([]byte, []int) {
	return file_storage_cluster_proto_rawDescGZIP(), []int{10}
}

func (m *CollectorFeatureConfig) GetConfig() isCollectorFeatureConfig_Config {
	if m != nil {
		return m.Config
	}
	return nil
...
func (x *CollectorFeatureConfig) GetProcessConfig() *ProcessConfig {
	if x, ok := x.GetConfig().(*CollectorFeatureConfig_ProcessConfig); ok {
		return x.ProcessConfig
	}
	return nil
}

func (x *CollectorFeatureConfig) GetNetworkConnectionConfig() *NetworkConnectionConfig {
	if x, ok := x.GetConfig().(*CollectorFeatureConfig_NetworkConnectionConfig); ok {
		return x.NetworkConnectionConfig
	}
	return nil
}

func (x *CollectorFeatureConfig) GetNetworkEndpointConfig() *NetworkEndpointConfig {
	if x, ok := x.GetConfig().(*CollectorFeatureConfig_NetworkEndpointConfig); ok {
		return x.NetworkEndpointConfig
	}
	return nil
}

type isCollectorFeatureConfig_Config interface {
	isCollectorFeatureConfig_Config()
}

type CollectorFeatureConfig_ProcessConfig struct {
	ProcessConfig *ProcessConfig `protobuf:"bytes,1,opt,name=process_config,json=processConfig,proto3,oneof"`
}

type CollectorFeatureConfig_NetworkConnectionConfig struct {
	NetworkConnectionConfig *NetworkConnectionConfig `protobuf:"bytes,2,opt,name=network_connection_config,json=networkConnectionConfig,proto3,oneof"`
}

type CollectorFeatureConfig_NetworkEndpointConfig struct {
	NetworkEndpointConfig *NetworkEndpointConfig `protobuf:"bytes,3,opt,name=network_endpoint_config,json=networkEndpointConfig,proto3,oneof"`
}

func (*CollectorFeatureConfig_ProcessConfig) isCollectorFeatureConfig_Config() {}

func (*CollectorFeatureConfig_NetworkConnectionConfig) isCollectorFeatureConfig_Config() {}

func (*CollectorFeatureConfig_NetworkEndpointConfig) isCollectorFeatureConfig_Config() {}
...
type RuntimeRule struct {
	...
	CollectorFeatureConfig *CollectorFeatureConfig `protobuf:"bytes,1,opt,name=collector_feature_config,json=collectorFeatureConfig,proto3" json:"collector_feature_config,omitempty"`
	NamespaceRule          *NamespaceRule          `protobuf:"bytes,2,opt,name=namespace_rule,json=namespaceRule,proto3" json:"namespace_rule,omitempty"`
}
...
func (x *RuntimeRule) GetCollectorFeatureConfig() *CollectorFeatureConfig {
	if x != nil {
		return x.CollectorFeatureConfig
	}
	return nil
}

func (x *RuntimeRule) GetNamespaceRule() *NamespaceRule {
	if x != nil {
...
type CollectorConfig struct {
	...
	ClusterLevelConfigs []*CollectorFeatureConfig `protobuf:"bytes,1,rep,name=cluster_level_configs,json=clusterLevelConfigs,proto3" json:"cluster_level_configs,omitempty"`
...
func (x *CollectorConfig) GetClusterLevelConfigs() []*CollectorFeatureConfig {
	if x != nil {
		return x.ClusterLevelConfigs
	}
	return nil
}

func (x *CollectorConfig) GetRules() []*RuntimeRule {
	if x != nil {
		return x.Rules
	}
	return nil
...
type CollectorConfig_CollectorNamespaceConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Config             *CollectorFeatureConfig `protobuf:"bytes,2,opt,name=config,proto3" json:"config,omitempty"`
}

func (x *CollectorConfig_CollectorNamespaceConfig) Reset() {
	*x = CollectorConfig_CollectorNamespaceConfig{}
	if protoimpl.UnsafeEnabled {
...
func (x *CollectorConfig_CollectorNamespaceConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CollectorConfig_CollectorNamespaceConfig) ProtoMessage() {}

func (x *CollectorConfig_CollectorNamespaceConfig) ProtoReflect() protoreflect.Message {
	mi := &file_storage_cluster_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CollectorConfig_CollectorNamespaceConfig.ProtoReflect.Descriptor instead.
func (*CollectorConfig_CollectorNamespaceConfig) Descriptor() ([]byte, []int) {
	return file_storage_cluster_proto_rawDescGZIP(), []int{13, 0}
}

func (x *CollectorConfig_CollectorNamespaceConfig) GetNamespaceSelection() []*NamespaceRule {
	if x != nil {
...
func (x *CollectorConfig_CollectorNamespaceConfig) GetConfig() *CollectorFeatureConfig {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *ClusterUpgradeStatus_UpgradeProcessStatus) Reset() {
	*x = ClusterUpgradeStatus_UpgradeProcessStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_storage_cluster_proto_msgTypes[33]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_storage_cluster_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x65, 0x73, 0x22, 0x29, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x43,
	...
	,
	...
	,
	...
	0x74, 0x6f, 0x72, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x2f, 0x0a, 0x11, 0x54, 0x6f, 0x6c, 0x65,
	...
	0x08, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x22, 0xa8, 0x04, 0x0a, 0x13, 0x53, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x18, 0x15, 0x20,
	...
	0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x18, 0x19,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x19, 0x61, 0x64, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x43,
	0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x6c, 0x65, 0x72, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x12,
	0x2e, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x16, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65,
	...
	0x67, 0x18, 0x12, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x12, 0x73, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x66, 0x0a, 0x17, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72,
	...
	0x61, 0x62, 0x65, 0x6c, 0x52, 0x15, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x48,
	0x65, 0x61, 0x6c, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x62, 0x0a, 0x15, 0x6f,
	0x76, 0x65, 0x72, 0x61, 0x6c, 0x6c, 0x5f, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x5f, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2e, 0x2e, 0x73, 0x74, 0x6f,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x52, 0x13, 0x6f, 0x76, 0x65, 0x72,
	0x61, 0x6c, 0x6c, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12,
	0x75, 0x0a, 0x1f, 0x61, 0x64, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x6e,
	0x74, 0x72, 0x6f, 0x6c, 0x5f, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x5f, 0x73, 0x74, 0x61, 0x74,
	0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2e, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61,
	...
	0x74, 0x75, 0x73, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x52, 0x1c, 0x61, 0x64, 0x6d, 0x69, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x62, 0x0a, 0x15, 0x73, 0x63, 0x61, 0x6e, 0x6e, 0x65,
	0x72, 0x5f, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x0b, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2e, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_storage_cluster_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_storage_cluster_proto_goTypes = []any{
	...
	(*ProcessConfig)(nil),                                             // 15: storage.ProcessConfig
	(*NetworkConnectionConfig)(nil),                                   // 16: storage.NetworkConnectionConfig
	(*NetworkEndpointConfig)(nil),                                     // 17: storage.NetworkEndpointConfig
	(*CollectorFeatureConfig)(nil),                                    // 18: storage.CollectorFeatureConfig
	(*NamespaceRule)(nil),                                             // 19: storage.NamespaceRule
	(*RuntimeRule)(nil),                                               // 20: storage.RuntimeRule
	(*CollectorConfig)(nil),                                           // 21: storage.CollectorConfig
	(*TolerationsConfig)(nil),                                         // 22: storage.TolerationsConfig
	(*StaticClusterConfig)(nil),                                       // 23: storage.StaticClusterConfig
	(*DynamicClusterConfig)(nil),                                      // 24: storage.DynamicClusterConfig
	(*CompleteClusterConfig)(nil),                                     // 25: storage.CompleteClusterConfig
	(*SensorDeploymentIdentification)(nil),                            // 26: storage.SensorDeploymentIdentification
	(*Cluster)(nil),                                                   // 27: storage.Cluster
	(*ClusterCertExpiryStatus)(nil),                                   // 28: storage.ClusterCertExpiryStatus
	(*ClusterStatus)(nil),                                             // 29: storage.ClusterStatus
	(*ClusterUpgradeStatus)(nil),                                      // 30: storage.ClusterUpgradeStatus
	(*UpgradeProgress)(nil),                                           // 31: storage.UpgradeProgress
	(*AuditLogFileState)(nil),                                         // 32: storage.AuditLogFileState
	(*ClusterHealthStatus)(nil),                                       // 33: storage.ClusterHealthStatus
	(*CollectorHealthInfo)(nil),                                       // 34: storage.CollectorHealthInfo
	(*AdmissionControlHealthInfo)(nil),                                // 35: storage.AdmissionControlHealthInfo
	(*ScannerHealthInfo)(nil),                                         // 36: storage.ScannerHealthInfo
	(*CollectorConfig_CollectorNamespaceConfig)(nil),                  // 37: storage.CollectorConfig.CollectorNamespaceConfig
	nil, // 38: storage.CompleteClusterConfig.ClusterLabelsEntry
	nil, // 39: storage.Cluster.LabelsEntry
	nil, // 40: storage.Cluster.AuditLogStateEntry
	(*ClusterUpgradeStatus_UpgradeProcessStatus)(nil), // 41: storage.ClusterUpgradeStatus.UpgradeProcessStatus
	(*timestamppb.Timestamp)(nil),                     // 42: google.protobuf.Timestamp
	(MatchType)(0),                                    // 43: storage.MatchType
}
var file_storage_cluster_proto_depIdxs = []int32{
	...
	42, // 5: storage.OrchestratorMetadata.build_date:type_name -> google.protobuf.Timestamp
	15, // 6: storage.CollectorFeatureConfig.process_config:type_name -> storage.ProcessConfig
	16, // 7: storage.CollectorFeatureConfig.network_connection_config:type_name -> storage.NetworkConnectionConfig
	17, // 8: storage.CollectorFeatureConfig.network_endpoint_config:type_name -> storage.NetworkEndpointConfig
	43, // 9: storage.NamespaceRule.match_type:type_name -> storage.MatchType
	18, // 10: storage.RuntimeRule.collector_feature_config:type_name -> storage.CollectorFeatureConfig
	19, // 11: storage.RuntimeRule.namespace_rule:type_name -> storage.NamespaceRule
	18, // 12: storage.CollectorConfig.cluster_level_configs:type_name -> storage.CollectorFeatureConfig
	20, // 13: storage.CollectorConfig.rules:type_name -> storage.RuntimeRule
	0,  // 14: storage.StaticClusterConfig.type:type_name -> storage.ClusterType
	1,  // 15: storage.StaticClusterConfig.collection_method:type_name -> storage.CollectionMethod
	22, // 16: storage.StaticClusterConfig.tolerations_config:type_name -> storage.TolerationsConfig
	14, // 17: storage.DynamicClusterConfig.admission_controller_config:type_name -> storage.AdmissionControllerConfig
	21, // 18: storage.DynamicClusterConfig.collector_config:type_name -> storage.CollectorConfig
	24, // 19: storage.CompleteClusterConfig.dynamic_config:type_name -> storage.DynamicClusterConfig
	23, // 20: storage.CompleteClusterConfig.static_config:type_name -> storage.StaticClusterConfig
	38, // 21: storage.CompleteClusterConfig.cluster_labels:type_name -> storage.CompleteClusterConfig.ClusterLabelsEntry
	0,  // 22: storage.Cluster.type:type_name -> storage.ClusterType
	39, // 23: storage.Cluster.labels:type_name -> storage.Cluster.LabelsEntry
	1,  // 24: storage.Cluster.collection_method:type_name -> storage.CollectionMethod
	29, // 25: storage.Cluster.status:type_name -> storage.ClusterStatus
	24, // 26: storage.Cluster.dynamic_config:type_name -> storage.DynamicClusterConfig
	22, // 27: storage.Cluster.tolerations_config:type_name -> storage.TolerationsConfig
	33, // 28: storage.Cluster.health_status:type_name -> storage.ClusterHealthStatus
	25, // 29: storage.Cluster.helm_config:type_name -> storage.CompleteClusterConfig
	26, // 30: storage.Cluster.most_recent_sensor_id:type_name -> storage.SensorDeploymentIdentification
	40, // 31: storage.Cluster.audit_log_state:type_name -> storage.Cluster.AuditLogStateEntry
	2,  // 32: storage.Cluster.managed_by:type_name -> storage.ManagerType
	42, // 33: storage.ClusterCertExpiryStatus.sensor_cert_expiry:type_name -> google.protobuf.Timestamp
	42, // 34: storage.ClusterCertExpiryStatus.sensor_cert_not_before:type_name -> google.protobuf.Timestamp
	42, // 35: storage.ClusterStatus.DEPRECATED_last_contact:type_name -> google.protobuf.Timestamp
	12, // 36: storage.ClusterStatus.provider_metadata:type_name -> storage.ProviderMetadata
	13, // 37: storage.ClusterStatus.orchestrator_metadata:type_name -> storage.OrchestratorMetadata
	30, // 38: storage.ClusterStatus.upgrade_status:type_name -> storage.ClusterUpgradeStatus
	28, // 39: storage.ClusterStatus.cert_expiry_status:type_name -> storage.ClusterCertExpiryStatus
	4,  // 40: storage.ClusterUpgradeStatus.upgradability:type_name -> storage.ClusterUpgradeStatus.Upgradability
	41, // 41: storage.ClusterUpgradeStatus.most_recent_process:type_name -> storage.ClusterUpgradeStatus.UpgradeProcessStatus
	6,  // 42: storage.UpgradeProgress.upgrade_state:type_name -> storage.UpgradeProgress.UpgradeState
	42, // 43: storage.UpgradeProgress.since:type_name -> google.protobuf.Timestamp
	42, // 44: storage.AuditLogFileState.collect_logs_since:type_name -> google.protobuf.Timestamp
	34, // 45: storage.ClusterHealthStatus.collector_health_info:type_name -> storage.CollectorHealthInfo
	35, // 46: storage.ClusterHealthStatus.admission_control_health_info:type_name -> storage.AdmissionControlHealthInfo
	36, // 47: storage.ClusterHealthStatus.scanner_health_info:type_name -> storage.ScannerHealthInfo
	7,  // 48: storage.ClusterHealthStatus.sensor_health_status:type_name -> storage.ClusterHealthStatus.HealthStatusLabel
	7,  // 49: storage.ClusterHealthStatus.collector_health_status:type_name -> storage.ClusterHealthStatus.HealthStatusLabel
	7,  // 50: storage.ClusterHealthStatus.overall_health_status:type_name -> storage.ClusterHealthStatus.HealthStatusLabel
	7,  // 51: storage.ClusterHealthStatus.admission_control_health_status:type_name -> storage.ClusterHealthStatus.HealthStatusLabel
	7,  // 52: storage.ClusterHealthStatus.scanner_health_status:type_name -> storage.ClusterHealthStatus.HealthStatusLabel
	42, // 53: storage.ClusterHealthStatus.last_contact:type_name -> google.protobuf.Timestamp
	19, // 54: storage.CollectorConfig.CollectorNamespaceConfig.namespace_selection:type_name -> storage.NamespaceRule
	18, // 55: storage.CollectorConfig.CollectorNamespaceConfig.config:type_name -> storage.CollectorFeatureConfig
	32, // 56: storage.Cluster.AuditLogStateEntry.value:type_name -> storage.AuditLogFileState
	42, // 57: storage.ClusterUpgradeStatus.UpgradeProcessStatus.initiated_at:type_name -> google.protobuf.Timestamp
	31, // 58: storage.ClusterUpgradeStatus.UpgradeProcessStatus.progress:type_name -> storage.UpgradeProgress
	5,  // 59: storage.ClusterUpgradeStatus.UpgradeProcessStatus.type:type_name -> storage.ClusterUpgradeStatus.UpgradeProcessStatus.UpgradeProcessType
...
func file_storage_cluster_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_storage_cluster_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*NetworkEndpointConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_storage_cluster_proto_msgTypes[10].Exporter = func(v any, i int) any {
			switch v := v.(*CollectorFeatureConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_storage_cluster_proto_msgTypes[29].Exporter = func(v any, i int) any {
			switch v := v.(*CollectorConfig_CollectorNamespaceConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_storage_cluster_proto_msgTypes[33].Exporter = func(v any, i int) any {
	...
	file_storage_cluster_proto_msgTypes[10].OneofWrappers = []any{
		(*CollectorFeatureConfig_ProcessConfig)(nil),
		(*CollectorFeatureConfig_NetworkConnectionConfig)(nil),
		(*CollectorFeatureConfig_NetworkEndpointConfig)(nil),
	}
