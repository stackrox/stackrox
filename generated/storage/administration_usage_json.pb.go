...
func (m *SecuredUnits) MarshalJSON() ([]byte, error) {
	if m == nil {
...
func (m *SecuredUnits) marshalJSON(buf *strings.Builder) (err error) {
	if m == nil {
	...
	if x := m.GetNumCpuUnits(); x != 0 {
		if trailingComma {
			buf.WriteByte(',')
		}
		trailingComma = true
		buf.WriteString("\"")
		buf.WriteString("numCpuUnits")
		buf.WriteString("\"")
		buf.WriteString(":")
		fmt.Fprintf(buf, "\"%d\"", x)
	}
