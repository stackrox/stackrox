...
func (m *FileActivity_FileMetadata) CloneVT() *FileActivity_FileMetadata {
	if m == nil {
		return (*FileActivity_FileMetadata)(nil)
	}
	r := new(FileActivity_FileMetadata)
	r.Uid = m.Uid
	r.Gid = m.Gid
	r.Mode = m.Mode
...
func (m *FileActivity_FileMetadata) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *FileActivity_FileMetadata) EqualVT(that *FileActivity_FileMetadata) bool {
	if this == that {
		return true
...
func (this *FileActivity_FileMetadata) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*FileActivity_FileMetadata)
	if !ok {
		return false
	}
...
func (m *FileActivity_FileMetadata) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FileActivity_FileMetadata) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FileActivity_FileMetadata) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *FileActivity_FileMetadata) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *FileActivity_FileMetadata) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: FileActivity_FileMetadata: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FileActivity_FileMetadata: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *FileActivity_File) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Meta == nil {
				m.Meta = &FileActivity_FileMetadata{}
			}
...
func (m *FileActivity_FileMetadata) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
