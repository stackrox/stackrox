...
func (m *IntegrationHealth) CloneVT() *IntegrationHealth {
	if m == nil {
	...
	if rhs := m.LastTimestamp; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *timestamppb.Timestamp }); ok {
			r.LastTimestamp = vtpb.CloneVT()
		} else {
			r.LastTimestamp = proto.Clone(rhs).(*timestamppb.Timestamp)
		}
	}
...
func (m *IntegrationHealth) CloneGenericVT() proto.Message {
	return m.CloneVT()
}

func (this *IntegrationHealth) EqualVT(that *IntegrationHealth) bool {
	if this == nil {
		return that == nil
	} else if that == nil {
		return false
	...
	if equal, ok := interface{}(this.LastTimestamp).(interface {
		EqualVT(*timestamppb.Timestamp) bool
	}); ok {
		if !equal.EqualVT(that.LastTimestamp) {
			return false
		}
	} else if !proto.Equal(this.LastTimestamp, that.LastTimestamp) {
		return false
	}
...
func (m *IntegrationHealth) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *IntegrationHealth) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *IntegrationHealth) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
