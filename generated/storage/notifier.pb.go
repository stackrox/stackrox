...
type MicrosoftSentinel struct {
	...
	DirectoryTenantId    string `protobuf:"bytes,4,opt,name=directory_tenant_id,json=directoryTenantId,proto3" json:"directory_tenant_id,omitempty"`
	ApplicationClientId  string `protobuf:"bytes,5,opt,name=application_client_id,json=applicationClientId,proto3" json:"application_client_id,omitempty"`
	Secret               string `protobuf:"bytes,6,opt,name=secret,proto3" json:"secret,omitempty" scrub:"always"` // @gotags: scrub:"always"
}
...
func (x *MicrosoftSentinel) GetDataCollectionRuleId() string {
	if x != nil {
...
func (x *MicrosoftSentinel) GetStreamName() string {
	if x != nil {
		return x.StreamName
	}
	return ""
...
var file_storage_notifier_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x75, 0x6c, 0x65, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x2e, 0x0a, 0x13, 0x64, 0x69,
	0x72, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x79, 0x5f, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x5f, 0x69,
	0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x6f,
	...
	0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x61, 0x70, 0x70, 0x6c, 0x69,
	...
	0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x42, 0x2e, 0x0a, 0x19, 0x69, 0x6f, 0x2e, 0x73, 0x74, 0x61,
...
var file_storage_notifier_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_storage_notifier_proto_goTypes = []any{
	...
	(*MicrosoftSentinel)(nil),          // 13: storage.MicrosoftSentinel
	...
	(*Syslog_TCPConfig)(nil),           // 17: storage.Syslog.TCPConfig
	(*Traits)(nil),                     // 18: storage.Traits
	(*KeyValuePair)(nil),               // 19: storage.KeyValuePair
	(Severity)(0),                      // 20: storage.Severity
}
var file_storage_notifier_proto_depIdxs = []int32{
	...
	13, // 9: storage.Notifier.microsoft_sentinel:type_name -> storage.MicrosoftSentinel
	18, // 10: storage.Notifier.traits:type_name -> storage.Traits
	...
	19, // 15: storage.Generic.headers:type_name -> storage.KeyValuePair
	19, // 16: storage.Generic.extra_fields:type_name -> storage.KeyValuePair
	1,  // 17: storage.Syslog.local_facility:type_name -> storage.Syslog.LocalFacility
	17, // 18: storage.Syslog.tcp_config:type_name -> storage.Syslog.TCPConfig
	19, // 19: storage.Syslog.extra_fields:type_name -> storage.KeyValuePair
	2,  // 20: storage.Syslog.message_format:type_name -> storage.Syslog.MessageFormat
	20, // 21: storage.Jira.PriorityMapping.severity:type_name -> storage.Severity
