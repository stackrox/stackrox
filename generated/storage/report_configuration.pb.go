...
type ReportConfiguration struct {
	...
	AccessScopes          []*SimpleAccessScope                 `protobuf:"bytes,14,rep,name=access_scopes,json=accessScopes,proto3" json:"access_scopes,omitempty" sql:"ignore_pk,ignore_unique"`
...
func (m *ReportConfiguration) GetAccessScopes() []*SimpleAccessScope {
	if m != nil {
...
func (m *ReportConfiguration) Clone() *ReportConfiguration {
	...
	*cloned = *m
	...
	if m.AccessScopes != nil {
		cloned.AccessScopes = make([]*SimpleAccessScope, len(m.AccessScopes))
...
var fileDescriptor_541201f82fe9caab = []byte{
	...
	,
}
...
func (m *ReportConfiguration) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			...
			m.AccessScopes = append(m.AccessScopes, &SimpleAccessScope{})
