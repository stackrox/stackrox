...
type VulnerabilityReportFilters struct {
	...
	IncludeKnownExploit    bool                                   `protobuf:"varint,12,opt,name=include_known_exploit,json=includeKnownExploit,proto3" json:"include_known_exploit,omitempty"`
...
const file_storage_report_configuration_proto_rawDesc = "" +
	...
	" \x01(\bR\x16includeEpssProbability\x122\n" +
	"\x15include_known_exploit\x18\f \x01(\bR\x13includeKnownExploit\x12)\n" +
