...
type NetworkPolicy struct {
	...
	ClusterId            string             `protobuf:"bytes,3,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty" search:"Cluster ID,hidden,store" sql:"fk(Cluster:id)"`
...
type NetworkPolicyApplicationUndoRecord struct {
	ClusterId            string                     `protobuf:"bytes,5,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty" sql:"pk"`
...
var fileDescriptor_d39ddeaa4e89803b = []byte{
	...
	,
}
