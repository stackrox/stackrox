...
var fileDescriptor_338da3bb08fef41d = []byte{
	...
	,
...
func (m *Maximus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Value != 0 {
		i = encodeVarintBillingMetrics(dAtA, i, uint64(m.Value))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Metric) > 0 {
		...
		i = encodeVarintBillingMetrics(dAtA, i, uint64(len(m.Metric)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *Maximus) Size() (n int) {
	...
	if m.Value != 0 {
		n += 1 + sovBillingMetrics(uint64(m.Value))
	}
	if m.Ts != nil {
		l = m.Ts.Size()
		n += 1 + l + sovBillingMetrics(uint64(l))
