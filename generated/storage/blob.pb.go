...
var file_storage_blob_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x27, 0x0a, 0x19, 0x69, 0x6f, 0x2e, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x72, 0x6f, 0x78,
...
var file_storage_blob_proto_goTypes = []interface{}{
...
func file_storage_blob_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_storage_blob_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Blob); i {
			case 0:
				return &v.state
			case 1:
