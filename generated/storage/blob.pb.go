...
func (x *Blob) ProtoReflect() protoreflect.Message {
	file_storage_blob_proto_init_ensure()
	mi := &file_storage_blob_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
const file_storage_blob_proto_rawDesc = "" +
	"\n" +
	"\x12storage/blob.proto\x12\astorage\x1a\x1fgoogle/protobuf/timestamp.proto\"\xe0\x01\n" +
	"\x04Blob\x12\x12\n" +
...
var file_storage_blob_proto_init_once sync.Once
func file_storage_blob_proto_init_ensure() { file_storage_blob_proto_init_once.Do(file_storage_blob_proto_init) }
func init() {} // proto registration is lazy — triggered by first ProtoReflect() call
func file_storage_blob_proto_init() {
	if File_storage_blob_proto != nil || skipProtoInit {
		return
	}
	type x struct{}
