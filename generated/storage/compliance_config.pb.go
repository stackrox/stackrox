...
var fileDescriptor_49cb46a3a17bbb25 = []byte{
	...
	,
}
...
func (m *ComplianceConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Id) > 0 {
		i -= len(m.Id)
		copy(dAtA[i:], m.Id)
		i = encodeVarintComplianceConfig(dAtA, i, uint64(len(m.Id)))
		i--
		dAtA[i] = 0xa
	}
