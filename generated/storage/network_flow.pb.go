...
type NetworkFlow struct {
	...
	ClusterId            string   `protobuf:"bytes,3,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty" sql:"pk"`
...
type NetworkEntity_Scope struct {
	ClusterId            string   `protobuf:"bytes,1,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty" search:"Cluster ID,store,hidden"`
...
func (m *NetworkEntity_Scope) GetNamespace() string {
	if m != nil {
		return m.Namespace
	}
	return ""
...
var fileDescriptor_a6317ef286eb605d = []byte{
	...
	,
}
