...
func (m *ComplianceOperatorCheckResultV2) GetPriority() int64 {
	if m != nil {
		return m.Priority
	}
	return 0
...
func (m *ComplianceOperatorCheckResultV2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Priority != 0 {
		i = encodeVarintComplianceOperatorV2(dAtA, i, uint64(m.Priority))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa0
...
func (m *ComplianceOperatorCheckResultV2) Size() (n int) {
	...
	if m.Priority != 0 {
		n += 2 + sovComplianceOperatorV2(uint64(m.Priority))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
