...
type ComplianceOperatorScanSettingV2 struct {
	...
	Annotations            map[string]string                          `protobuf:"bytes,6,rep,name=annotations,proto3" json:"annotations,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Profiles               []*ComplianceOperatorScanSettingV2_Profile `protobuf:"bytes,7,rep,name=profiles,proto3" json:"profiles,omitempty"`
	Clusters               []*ComplianceOperatorScanSettingV2_Cluster `protobuf:"bytes,8,rep,name=clusters,proto3" json:"clusters,omitempty"`
	NodeRoles              []ComplianceOperatorScanSettingV2_NodeRole `protobuf:"varint,9,rep,packed,name=node_roles,json=nodeRoles,proto3,enum=storage.ComplianceOperatorScanSettingV2_NodeRole" json:"node_roles,omitempty"`
	// Starting point for schedule will probably have to build upon it
	...
	LastUpdatedTime *types.Timestamp `protobuf:"bytes,12,opt,name=last_updated_time,json=lastUpdatedTime,proto3" json:"last_updated_time,omitempty"`
	// Most recent user to update the scan settings
...
func (m *ComplianceOperatorScanSettingV2_Cluster) String() string { return proto.CompactTextString(m) }
func (*ComplianceOperatorScanSettingV2_Cluster) ProtoMessage()    {}
func (*ComplianceOperatorScanSettingV2_Cluster) Descriptor() ([]byte, []int) {
	return fileDescriptor_26c2ec1f62102154, []int{2, 3}
}
func (m *ComplianceOperatorScanSettingV2_Cluster) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ComplianceOperatorScanSettingV2_Cluster) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
...
func (m *ComplianceOperatorScanSettingV2_Cluster) XXX_Size() int {
	return m.Size()
}
func (m *ComplianceOperatorScanSettingV2_Cluster) XXX_DiscardUnknown() {
	xxx_messageInfo_ComplianceOperatorScanSettingV2_Cluster.DiscardUnknown(m)
}

var xxx_messageInfo_ComplianceOperatorScanSettingV2_Cluster proto.InternalMessageInfo
...
func (m *ComplianceOperatorScanSettingV2_Cluster) Clone() *ComplianceOperatorScanSettingV2_Cluster {
	if m == nil {
		return nil
	}
	cloned := new(ComplianceOperatorScanSettingV2_Cluster)
	*cloned = *m
