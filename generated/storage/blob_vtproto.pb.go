...
func (m *Blob) CloneVT() *Blob {
	...
	r.ModifiedTime = (*timestamppb.Timestamp)((*timestamppb1.Timestamp)(m.ModifiedTime).CloneVT())
...
func (this *Blob) EqualVT(that *Blob) bool {
	...
	if !(*timestamppb1.Timestamp)(this.ModifiedTime).EqualVT((*timestamppb1.Timestamp)(that.ModifiedTime)) {
		return false
	}
...
func (m *Blob) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.ModifiedTime != nil {
		size, err := (*timestamppb1.Timestamp)(m.ModifiedTime).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.Oid != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.Oid))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Name) > 0 {
...
func (m *Blob) SizeVT() (n int) {
	...
	if m.Oid != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.Oid))
	}
	l = len(m.Checksum)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	...
	if m.ModifiedTime != nil {
		l = (*timestamppb1.Timestamp)(m.ModifiedTime).SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
...
func (m *Blob) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if err := (*timestamppb1.Timestamp)(m.ModifiedTime).UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Blob) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 6:
			...
			if err := (*timestamppb1.Timestamp)(m.ModifiedTime).UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
