...
func (m *GroupProperties) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *GroupProperties) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*GroupProperties)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *GroupProperties) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
