...
func (m *Policy) CloneVT() *Policy {
	...
	r.Source = m.Source
	r.EvaluationFilter = m.EvaluationFilter.CloneVT()
...
func (m *EvaluationFilter) CloneVT() *EvaluationFilter {
	if m == nil {
...
func (m *EvaluationFilter) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Exclusion_ExcludeByType) CloneVT() *Exclusion_ExcludeByType {
	if m == nil {
		return (*Exclusion_ExcludeByType)(nil)
	}
	r := new(Exclusion_ExcludeByType)
	if rhs := m.Types; rhs != nil {
		tmpContainer := make([]Exclusion_WorkloadType, len(rhs))
		copy(tmpContainer, rhs)
...
func (m *Exclusion_ExcludeByType) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Exclusion_ExcludeByType_) CloneVT() isExclusion_Matcher {
	if m == nil {
		return (*Exclusion_ExcludeByType_)(nil)
	}
	r := new(Exclusion_ExcludeByType_)
	r.ExcludeByType = m.ExcludeByType.CloneVT()
	return r
}
...
func (this *Policy) EqualVT(that *Policy) bool {
	...
	if !this.EvaluationFilter.EqualVT(that.EvaluationFilter) {
		return false
	}
	return string(this.unknownFields) == string(that.unknownFields)
}
...
func (this *EvaluationFilter) EqualVT(that *EvaluationFilter) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *EvaluationFilter) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*EvaluationFilter)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *Exclusion_ExcludeByType) EqualVT(that *Exclusion_ExcludeByType) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *Exclusion_ExcludeByType) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*Exclusion_ExcludeByType)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *Exclusion_ExcludeByType_) EqualVT(thatIface isExclusion_Matcher) bool {
	that, ok := thatIface.(*Exclusion_ExcludeByType_)
	if !ok {
		return false
	}
	if this == that {
	...
	if p, q := this.ExcludeByType, that.ExcludeByType; p != q {
		if p == nil {
			p = &Exclusion_ExcludeByType{}
		}
		if q == nil {
			q = &Exclusion_ExcludeByType{}
		}
		if !p.EqualVT(q) {
			return false
		}
...
func (m *Policy) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.EvaluationFilter != nil {
		size, err := m.EvaluationFilter.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *EvaluationFilter) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *EvaluationFilter) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *EvaluationFilter) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *Exclusion_ExcludeByType) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Exclusion_ExcludeByType) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Exclusion_ExcludeByType) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *Exclusion_ExcludeByType_) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Exclusion_ExcludeByType_) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ExcludeByType != nil {
		size, err := m.ExcludeByType.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *EvaluationFilter) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Exclusion_ExcludeByType) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Exclusion_ExcludeByType_) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Policy) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 28:
			...
			if m.EvaluationFilter == nil {
				m.EvaluationFilter = &EvaluationFilter{}
			}
			if err := m.EvaluationFilter.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *EvaluationFilter) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EvaluationFilter: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
...
func (m *Exclusion_ExcludeByType) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Exclusion_ExcludeByType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Exclusion_ExcludeByType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType == 0 {
				var v Exclusion_WorkloadType
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protohelpers.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= Exclusion_WorkloadType(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.Types) == 0 {
					m.Types = make([]Exclusion_WorkloadType, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v Exclusion_WorkloadType
					for shift := uint(0); ; shift += 7 {
...
func (m *Exclusion) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExcludeByType", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if oneof, ok := m.Matcher.(*Exclusion_ExcludeByType_); ok {
				if err := oneof.ExcludeByType.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &Exclusion_ExcludeByType{}
				if err := v.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.Matcher = &Exclusion_ExcludeByType_{ExcludeByType: v}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *Policy) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 28:
			...
			if err := m.EvaluationFilter.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *EvaluationFilter) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *Exclusion_ExcludeByType) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *Exclusion) UnmarshalVTUnsafe(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if oneof, ok := m.Matcher.(*Exclusion_ExcludeByType_); ok {
				if err := oneof.ExcludeByType.UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &Exclusion_ExcludeByType{}
