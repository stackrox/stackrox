...
func (m *K8SRole) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *PolicyRule) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *K8SRoleBinding) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *K8SRole) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*K8SRole)
	if !ok {
		return false
	}
...
func (this *K8SRoleBinding) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*K8SRoleBinding)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *PolicyRule) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.NonResourceUrls) > 0 {
		for iNdEx := len(m.NonResourceUrls) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.NonResourceUrls[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	...
	if len(m.ApiGroups) > 0 {
		for iNdEx := len(m.ApiGroups) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ApiGroups[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *K8SRole) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *PolicyRule) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			m.Verbs = append(m.Verbs, stringValue)
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ApiGroups", wireType)
			...
			m.ApiGroups = append(m.ApiGroups, stringValue)
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Resources", wireType)
		...
		case 4:
			...
			m.NonResourceUrls = append(m.NonResourceUrls, stringValue)
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ResourceNames", wireType)
			...
			m.ResourceNames = append(m.ResourceNames, stringValue)
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := protohelpers.Skip(dAtA[iNdEx:])
...
func (m *K8SRoleBinding) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 10:
			...
			m.Subjects = append(m.Subjects, &Subject{})
			if err := m.Subjects[len(m.Subjects)-1].UnmarshalVTUnsafe(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 11:
