...
const file_storage_declarative_config_health_proto_rawDesc = "" +
	"\n" +
	"'storage/declarative_config_health.proto\x12\astorage\x1a\x1fgoogle/protobuf/timestamp.proto\"\xa6\x04\n" +
	...
	"\x1eAUTH_MACHINE_TO_MACHINE_CONFIG\x10\aB.\n" +
...
var file_storage_declarative_config_health_proto_init_once sync.Once
func file_storage_declarative_config_health_proto_init_ensure() { file_storage_declarative_config_health_proto_init_once.Do(file_storage_declarative_config_health_proto_init) }
