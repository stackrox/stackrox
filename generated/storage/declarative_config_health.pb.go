...
var file_storage_declarative_config_health_proto_rawDesc = []byte{
	...
	0x49, 0x46, 0x49, 0x45, 0x52, 0x10, 0x06, 0x42, 0x27, 0x0a, 0x19, 0x69, 0x6f, 0x2e, 0x73, 0x74,
...
var file_storage_declarative_config_health_proto_goTypes = []interface{}{
...
func file_storage_declarative_config_health_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_storage_declarative_config_health_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeclarativeConfigHealth); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
