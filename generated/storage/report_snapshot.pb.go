...
const (
	...
	ReportSnapshot_COMPLIANCE    ReportSnapshot_ReportType = 1
)
...
func (ReportStatus_RunState) EnumDescriptor() ([]byte, []int) {
	return file_storage_report_snapshot_proto_rawDescGZIP(), []int{5, 0}
}
...
func (ReportStatus_NotificationMethod) EnumDescriptor() ([]byte, []int) {
	return file_storage_report_snapshot_proto_rawDescGZIP(), []int{5, 1}
}
...
func (ReportStatus_RunMethod) EnumDescriptor() ([]byte, []int) {
	return file_storage_report_snapshot_proto_rawDescGZIP(), []int{5, 2}
}
...
type ReportSnapshot struct {
	...
	Collection   *CollectionSnapshot     `protobuf:"bytes,7,opt,name=collection,proto3" json:"collection,omitempty"` // deprecate this
	...
	SnapshotData *ReportSnapshotData     `protobuf:"bytes,12,opt,name=snapshot_data,json=snapshotData,proto3" json:"snapshot_data,omitempty"`
}
...
func (x *ReportSnapshot) GetSnapshotData() *ReportSnapshotData {
	if x != nil {
...
type ReportSnapshotData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	//
	//	*ReportSnapshotData_CollectionSnapshot
	//	*ReportSnapshotData_ComplianceScanConfigSnapshot
	Data isReportSnapshotData_Data `protobuf_oneof:"data"`
}

func (x *ReportSnapshotData) Reset() {
	*x = ReportSnapshotData{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReportSnapshotData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReportSnapshotData) ProtoMessage() {}

func (x *ReportSnapshotData) ProtoReflect() protoreflect.Message {
	mi := &file_storage_report_snapshot_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReportSnapshotData.ProtoReflect.Descriptor instead.
func (*ReportSnapshotData) Descriptor() ([]byte, []int) {
	return file_storage_report_snapshot_proto_rawDescGZIP(), []int{1}
}

func (m *ReportSnapshotData) GetData() isReportSnapshotData_Data {
	if m != nil {
		return m.Data
	}
	return nil
...
func (x *ReportSnapshotData) GetCollectionSnapshot() *CollectionSnapshot {
	if x, ok := x.GetData().(*ReportSnapshotData_CollectionSnapshot); ok {
		return x.CollectionSnapshot
	}
	return nil
}

func (x *ReportSnapshotData) GetComplianceScanConfigSnapshot() *ComplianceScanConfigSnapshot {
	if x, ok := x.GetData().(*ReportSnapshotData_ComplianceScanConfigSnapshot); ok {
		return x.ComplianceScanConfigSnapshot
	}
	return nil
}

type isReportSnapshotData_Data interface {
	isReportSnapshotData_Data()
}

type ReportSnapshotData_CollectionSnapshot struct {
	CollectionSnapshot *CollectionSnapshot `protobuf:"bytes,1,opt,name=collection_snapshot,json=collectionSnapshot,proto3,oneof"`
}

type ReportSnapshotData_ComplianceScanConfigSnapshot struct {
	ComplianceScanConfigSnapshot *ComplianceScanConfigSnapshot `protobuf:"bytes,2,opt,name=compliance_scan_config_snapshot,json=complianceScanConfigSnapshot,proto3,oneof"`
}

func (*ReportSnapshotData_CollectionSnapshot) isReportSnapshotData_Data() {}

func (*ReportSnapshotData_ComplianceScanConfigSnapshot) isReportSnapshotData_Data() {}

type ComplianceScanConfigSnapshot struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ComplianceScanConfigSnapshot) Reset() {
	*x = ComplianceScanConfigSnapshot{}
	if protoimpl.UnsafeEnabled {
...
func (x *ComplianceScanConfigSnapshot) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ComplianceScanConfigSnapshot) ProtoMessage() {}

func (x *ComplianceScanConfigSnapshot) ProtoReflect() protoreflect.Message {
	mi := &file_storage_report_snapshot_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ComplianceScanConfigSnapshot.ProtoReflect.Descriptor instead.
func (*ComplianceScanConfigSnapshot) Descriptor() ([]byte, []int) {
	return file_storage_report_snapshot_proto_rawDescGZIP(), []int{2}
}

func (x *ComplianceScanConfigSnapshot) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ComplianceScanConfigSnapshot) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *NotifierSnapshot) Reset() {
	*x = NotifierSnapshot{}
	if protoimpl.UnsafeEnabled {
		mi := &file_storage_report_snapshot_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*NotifierSnapshot) Descriptor() ([]byte, []int) {
	return file_storage_report_snapshot_proto_rawDescGZIP(), []int{4}
}
...
func (x *ReportStatus) Reset() {
	*x = ReportStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_storage_report_snapshot_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReportStatus) Descriptor() ([]byte, []int) {
	return file_storage_report_snapshot_proto_rawDescGZIP(), []int{5}
}
...
var file_storage_report_snapshot_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb9, 0x05, 0x0a, 0x0e, 0x52, 0x65, 0x70, 0x6f, 0x72,
	...
	,
	...
	,
...
var file_storage_report_snapshot_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_storage_report_snapshot_proto_goTypes = []any{
	...
	(*ReportSnapshotData)(nil),           // 5: storage.ReportSnapshotData
	(*ComplianceScanConfigSnapshot)(nil), // 6: storage.ComplianceScanConfigSnapshot
	(*CollectionSnapshot)(nil),           // 7: storage.CollectionSnapshot
	(*NotifierSnapshot)(nil),             // 8: storage.NotifierSnapshot
	(*ReportStatus)(nil),                 // 9: storage.ReportStatus
	(*VulnerabilityReportFilters)(nil),   // 10: storage.VulnerabilityReportFilters
...
var file_storage_report_snapshot_proto_depIdxs = []int32{
	...
	10, // 1: storage.ReportSnapshot.vuln_report_filters:type_name -> storage.VulnerabilityReportFilters
	7,  // 2: storage.ReportSnapshot.collection:type_name -> storage.CollectionSnapshot
	11, // 3: storage.ReportSnapshot.schedule:type_name -> storage.Schedule
	9,  // 4: storage.ReportSnapshot.report_status:type_name -> storage.ReportStatus
	8,  // 5: storage.ReportSnapshot.notifiers:type_name -> storage.NotifierSnapshot
	12, // 6: storage.ReportSnapshot.requester:type_name -> storage.SlimUser
	5,  // 7: storage.ReportSnapshot.snapshot_data:type_name -> storage.ReportSnapshotData
	7,  // 8: storage.ReportSnapshotData.collection_snapshot:type_name -> storage.CollectionSnapshot
	6,  // 9: storage.ReportSnapshotData.compliance_scan_config_snapshot:type_name -> storage.ComplianceScanConfigSnapshot
	13, // 10: storage.NotifierSnapshot.email_config:type_name -> storage.EmailNotifierConfiguration
	1,  // 11: storage.ReportStatus.run_state:type_name -> storage.ReportStatus.RunState
	14, // 12: storage.ReportStatus.queued_at:type_name -> google.protobuf.Timestamp
	14, // 13: storage.ReportStatus.completed_at:type_name -> google.protobuf.Timestamp
...
func file_storage_report_snapshot_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_storage_report_snapshot_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*ReportSnapshotData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_storage_report_snapshot_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*ComplianceScanConfigSnapshot); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_storage_report_snapshot_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_storage_report_snapshot_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	file_storage_report_snapshot_proto_msgTypes[1].OneofWrappers = []any{
		(*ReportSnapshotData_CollectionSnapshot)(nil),
		(*ReportSnapshotData_ComplianceScanConfigSnapshot)(nil),
	}
	file_storage_report_snapshot_proto_msgTypes[4].OneofWrappers = []any{
