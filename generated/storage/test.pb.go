...
type TestSingleKeyStruct struct {
	Key         string                        `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty" sql:"pk"`
...
type TestMultiKeyStruct struct {
	...
	Timestmap   *types.Timestamp             `protobuf:"bytes,9,opt,name=timestmap,proto3" json:"timestmap,omitempty"`
...
func (m *TestMultiKeyStruct) GetTimestmap() *types.Timestamp {
	if m != nil {
		return m.Timestmap
	}
	return nil
...
func (m *TestMultiKeyStruct) Clone() *TestMultiKeyStruct {
	...
	*cloned = *m
	...
	cloned.Timestmap = m.Timestmap.Clone()
	if m.Enums != nil {
...
var fileDescriptor_f80f1f1db1167453 = []byte{
	...
	,
}
...
func (m *TestMultiKeyStruct) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Enums) > 0 {
		dAtA8 := make([]byte, len(m.Enums)*10)
		var j7 int
		for _, num := range m.Enums {
			for num >= 1<<7 {
	...
	if m.Timestmap != nil {
		{
			size, err := m.Timestmap.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TestMultiKeyStruct) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Timestmap", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.Timestmap == nil {
				m.Timestmap = &types.Timestamp{}
			}
			if err := m.Timestmap.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 10:
