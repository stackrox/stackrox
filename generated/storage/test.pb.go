...
type TestOneKeyStruct_Enum int32

const (
	TestOneKeyStruct_ENUM0 TestOneKeyStruct_Enum = 0
	TestOneKeyStruct_ENUM1 TestOneKeyStruct_Enum = 1
	TestOneKeyStruct_ENUM2 TestOneKeyStruct_Enum = 2
)

var TestOneKeyStruct_Enum_name = map[int32]string{
	0: "ENUM0",
	1: "ENUM1",
	2: "ENUM2",
}

var TestOneKeyStruct_Enum_value = map[string]int32{
	"ENUM0": 0,
	"ENUM1": 1,
	"ENUM2": 2,
}

func (x TestOneKeyStruct_Enum) String() string {
	return proto.EnumName(TestOneKeyStruct_Enum_name, int32(x))
}

func (TestOneKeyStruct_Enum) EnumDescriptor() ([]byte, []int) {
...
type TestOneKeyStruct struct {
	...
	Labels      map[string]string         `protobuf:"bytes,8,rep,name=labels,proto3" json:"labels,omitempty" search:"Test Labels" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Timestamp   *types.Timestamp          `protobuf:"bytes,9,opt,name=timestamp,proto3" json:"timestamp,omitempty" search:"Test Timestamp"`
	Enum        TestOneKeyStruct_Enum   `protobuf:"varint,10,opt,name=enum,proto3,enum=storage.TestOneKeyStruct_Enum" json:"enum,omitempty" search:"Test Enum"`
	Enums       []TestOneKeyStruct_Enum `protobuf:"varint,11,rep,packed,name=enums,proto3,enum=storage.TestOneKeyStruct_Enum" json:"enums,omitempty" search:"Test Enum Slice"`
	...
	Embedded           *TestOneKeyStruct_Embedded `protobuf:"bytes,12,opt,name=embedded,proto3" json:"embedded,omitempty"`
	Nested             []*TestOneKeyStruct_Nested `protobuf:"bytes,13,rep,name=nested,proto3" json:"nested,omitempty"`
	// Types that are valid to be assigned to Oneof:
	//
	//	*TestOneKeyStruct_Oneofstring
	//	*TestOneKeyStruct_Oneofnested
	Oneof                isTestOneKeyStruct_Oneof `protobuf_oneof:"oneof"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}

func (m *TestOneKeyStruct) Reset()         { *m = TestOneKeyStruct{} }
func (m *TestOneKeyStruct) String() string { return proto.CompactTextString(m) }
func (*TestOneKeyStruct) ProtoMessage()    {}
func (*TestOneKeyStruct) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80f1f1db1167453, []int{2}
}
func (m *TestOneKeyStruct) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TestOneKeyStruct) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TestOneKeyStruct.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TestOneKeyStruct) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TestOneKeyStruct.Merge(m, src)
}
func (m *TestOneKeyStruct) XXX_Size() int {
	return m.Size()
}
func (m *TestOneKeyStruct) XXX_DiscardUnknown() {
	xxx_messageInfo_TestOneKeyStruct.DiscardUnknown(m)
}

var xxx_messageInfo_TestOneKeyStruct proto.InternalMessageInfo

type isTestOneKeyStruct_Oneof interface {
	isTestOneKeyStruct_Oneof()
	MarshalTo([]byte) (int, error)
	Size() int
	Clone() isTestOneKeyStruct_Oneof
}

type TestOneKeyStruct_Oneofstring struct {
	Oneofstring string `protobuf:"bytes,14,opt,name=oneofstring,proto3,oneof" json:"oneofstring,omitempty"`
}
type TestOneKeyStruct_Oneofnested struct {
	Oneofnested *TestOneKeyStruct_OneOfNested `protobuf:"bytes,15,opt,name=oneofnested,proto3,oneof" json:"oneofnested,omitempty"`
}

func (*TestOneKeyStruct_Oneofstring) isTestOneKeyStruct_Oneof() {}
func (m *TestOneKeyStruct_Oneofstring) Clone() isTestOneKeyStruct_Oneof {
	if m == nil {
		return nil
	}
	cloned := new(TestOneKeyStruct_Oneofstring)
	*cloned = *m

	return cloned
}
func (*TestOneKeyStruct_Oneofnested) isTestOneKeyStruct_Oneof() {}
func (m *TestOneKeyStruct_Oneofnested) Clone() isTestOneKeyStruct_Oneof {
	if m == nil {
		return nil
	}
	cloned := new(TestOneKeyStruct_Oneofnested)
	*cloned = *m
...
func (m *TestOneKeyStruct) GetOneof() isTestOneKeyStruct_Oneof {
	if m != nil {
		return m.Oneof
	}
	return nil
...
func (m *TestOneKeyStruct) GetKey1() string {
	if m != nil {
		return m.Key1
	}
	return ""
...
func (m *TestOneKeyStruct) GetKey2() string {
	if m != nil {
		return m.Key2
	}
	return ""
...
func (m *TestOneKeyStruct) GetStringSlice() []string {
	if m != nil {
		return m.StringSlice
	}
	return nil
...
func (m *TestOneKeyStruct) GetBool() bool {
	if m != nil {
		return m.Bool
	}
	return false
...
func (m *TestOneKeyStruct) GetUint64() uint64 {
	if m != nil {
		return m.Uint64
	}
	return 0
...
func (m *TestOneKeyStruct) GetInt64() int64 {
	if m != nil {
		return m.Int64
	}
	return 0
...
func (m *TestOneKeyStruct) GetFloat() float32 {
	if m != nil {
		return m.Float
	}
	return 0
...
func (m *TestOneKeyStruct) GetLabels() map[string]string {
	if m != nil {
		return m.Labels
	}
	return nil
...
func (m *TestOneKeyStruct) GetTimestamp() *types.Timestamp {
	if m != nil {
		return m.Timestamp
	}
	return nil
...
func (m *TestOneKeyStruct) GetEnum() TestOneKeyStruct_Enum {
	if m != nil {
		return m.Enum
	}
	return TestOneKeyStruct_ENUM0
}

func (m *TestOneKeyStruct) GetEnums() []TestOneKeyStruct_Enum {
	if m != nil {
		return m.Enums
	}
	return nil
...
func (m *TestOneKeyStruct) GetString_() string {
	if m != nil {
		return m.String_
	}
	return ""
...
func (m *TestOneKeyStruct) GetIntSliceDeprecated() []int64 {
	if m != nil {
...
func (m *TestOneKeyStruct) GetInt32Slice() []int32 {
	if m != nil {
		return m.Int32Slice
	}
	return nil
...
func (m *TestOneKeyStruct) GetEmbedded() *TestOneKeyStruct_Embedded {
	if m != nil {
		return m.Embedded
	}
	return nil
...
func (m *TestOneKeyStruct) GetNested() []*TestOneKeyStruct_Nested {
	if m != nil {
		return m.Nested
	}
	return nil
...
func (m *TestOneKeyStruct) GetOneofstring() string {
	if x, ok := m.GetOneof().(*TestOneKeyStruct_Oneofstring); ok {
		return x.Oneofstring
	}
	return ""
}

func (m *TestOneKeyStruct) GetOneofnested() *TestOneKeyStruct_OneOfNested {
	if x, ok := m.GetOneof().(*TestOneKeyStruct_Oneofnested); ok {
		return x.Oneofnested
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*TestOneKeyStruct) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*TestOneKeyStruct_Oneofstring)(nil),
		(*TestOneKeyStruct_Oneofnested)(nil),
	}
}

func (m *TestOneKeyStruct) MessageClone() proto.Message {
	return m.Clone()
}
func (m *TestOneKeyStruct) Clone() *TestOneKeyStruct {
	if m == nil {
		return nil
	}
	cloned := new(TestOneKeyStruct)
	*cloned = *m
	...
	cloned.Timestamp = m.Timestamp.Clone()
	if m.Enums != nil {
		cloned.Enums = make([]TestOneKeyStruct_Enum, len(m.Enums))
		copy(cloned.Enums, m.Enums)
	}
	...
	cloned.Embedded = m.Embedded.Clone()
	if m.Nested != nil {
		cloned.Nested = make([]*TestOneKeyStruct_Nested, len(m.Nested))
		for idx, v := range m.Nested {
			cloned.Nested[idx] = v.Clone()
		}
	}
...
type TestOneKeyStruct_Embedded struct {
	Embedded             string   `protobuf:"bytes,1,opt,name=embedded,proto3" json:"embedded,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *TestOneKeyStruct_Embedded) Reset()         { *m = TestOneKeyStruct_Embedded{} }
func (m *TestOneKeyStruct_Embedded) String() string { return proto.CompactTextString(m) }
func (*TestOneKeyStruct_Embedded) ProtoMessage()    {}
func (*TestOneKeyStruct_Embedded) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80f1f1db1167453, []int{2, 1}
}
func (m *TestOneKeyStruct_Embedded) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TestOneKeyStruct_Embedded) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TestOneKeyStruct_Embedded.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TestOneKeyStruct_Embedded) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TestOneKeyStruct_Embedded.Merge(m, src)
}
func (m *TestOneKeyStruct_Embedded) XXX_Size() int {
	return m.Size()
}
func (m *TestOneKeyStruct_Embedded) XXX_DiscardUnknown() {
	xxx_messageInfo_TestOneKeyStruct_Embedded.DiscardUnknown(m)
}

var xxx_messageInfo_TestOneKeyStruct_Embedded proto.InternalMessageInfo

func (m *TestOneKeyStruct_Embedded) GetEmbedded() string {
	if m != nil {
		return m.Embedded
	}
	return ""
...
func (m *TestOneKeyStruct_Embedded) MessageClone() proto.Message {
	return m.Clone()
}
func (m *TestOneKeyStruct_Embedded) Clone() *TestOneKeyStruct_Embedded {
	if m == nil {
		return nil
	}
	cloned := new(TestOneKeyStruct_Embedded)
	*cloned = *m

	return cloned
}

type TestOneKeyStruct_Embedded_Embedded2 struct {
	Embedded             string   `protobuf:"bytes,2,opt,name=embedded,proto3" json:"embedded,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *TestOneKeyStruct_Embedded_Embedded2) Reset()         { *m = TestOneKeyStruct_Embedded_Embedded2{} }
func (m *TestOneKeyStruct_Embedded_Embedded2) String() string { return proto.CompactTextString(m) }
func (*TestOneKeyStruct_Embedded_Embedded2) ProtoMessage()    {}
func (*TestOneKeyStruct_Embedded_Embedded2) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80f1f1db1167453, []int{2, 1, 0}
}
func (m *TestOneKeyStruct_Embedded_Embedded2) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TestOneKeyStruct_Embedded_Embedded2) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TestOneKeyStruct_Embedded_Embedded2.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TestOneKeyStruct_Embedded_Embedded2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TestOneKeyStruct_Embedded_Embedded2.Merge(m, src)
}
func (m *TestOneKeyStruct_Embedded_Embedded2) XXX_Size() int {
	return m.Size()
}
func (m *TestOneKeyStruct_Embedded_Embedded2) XXX_DiscardUnknown() {
	xxx_messageInfo_TestOneKeyStruct_Embedded_Embedded2.DiscardUnknown(m)
}

var xxx_messageInfo_TestOneKeyStruct_Embedded_Embedded2 proto.InternalMessageInfo

func (m *TestOneKeyStruct_Embedded_Embedded2) GetEmbedded() string {
	if m != nil {
		return m.Embedded
	}
	return ""
...
func (m *TestOneKeyStruct_Embedded_Embedded2) MessageClone() proto.Message {
	return m.Clone()
}
func (m *TestOneKeyStruct_Embedded_Embedded2) Clone() *TestOneKeyStruct_Embedded_Embedded2 {
	if m == nil {
		return nil
	}
	cloned := new(TestOneKeyStruct_Embedded_Embedded2)
	*cloned = *m

	return cloned
}

type TestOneKeyStruct_Nested struct {
	...
	Nested2              *TestOneKeyStruct_Nested_Nested2 `protobuf:"bytes,2,opt,name=nested2,proto3" json:"nested2,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                           `json:"-"`
	XXX_unrecognized     []byte                             `json:"-"`
	XXX_sizecache        int32                              `json:"-"`
}

func (m *TestOneKeyStruct_Nested) Reset()         { *m = TestOneKeyStruct_Nested{} }
func (m *TestOneKeyStruct_Nested) String() string { return proto.CompactTextString(m) }
func (*TestOneKeyStruct_Nested) ProtoMessage()    {}
func (*TestOneKeyStruct_Nested) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80f1f1db1167453, []int{2, 2}
}
func (m *TestOneKeyStruct_Nested) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TestOneKeyStruct_Nested) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TestOneKeyStruct_Nested.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TestOneKeyStruct_Nested) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TestOneKeyStruct_Nested.Merge(m, src)
}
func (m *TestOneKeyStruct_Nested) XXX_Size() int {
	return m.Size()
}
func (m *TestOneKeyStruct_Nested) XXX_DiscardUnknown() {
	xxx_messageInfo_TestOneKeyStruct_Nested.DiscardUnknown(m)
}

var xxx_messageInfo_TestOneKeyStruct_Nested proto.InternalMessageInfo

func (m *TestOneKeyStruct_Nested) GetNested() string {
	if m != nil {
		return m.Nested
	}
	return ""
...
func (m *TestOneKeyStruct_Nested) GetIsNested() bool {
	if m != nil {
		return m.IsNested
	}
	return false
...
func (m *TestOneKeyStruct_Nested) GetInt64() int64 {
	if m != nil {
		return m.Int64
	}
	return 0
...
func (m *TestOneKeyStruct_Nested) GetNested2() *TestOneKeyStruct_Nested_Nested2 {
	if m != nil {
		return m.Nested2
	}
	return nil
...
func (m *TestOneKeyStruct_Nested) MessageClone() proto.Message {
	return m.Clone()
}
func (m *TestOneKeyStruct_Nested) Clone() *TestOneKeyStruct_Nested {
	if m == nil {
		return nil
	}
	cloned := new(TestOneKeyStruct_Nested)
	*cloned = *m
...
type TestOneKeyStruct_Nested_Nested2 struct {
...
func (m *TestOneKeyStruct_Nested_Nested2) Reset()         { *m = TestOneKeyStruct_Nested_Nested2{} }
func (m *TestOneKeyStruct_Nested_Nested2) String() string { return proto.CompactTextString(m) }
func (*TestOneKeyStruct_Nested_Nested2) ProtoMessage()    {}
func (*TestOneKeyStruct_Nested_Nested2) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80f1f1db1167453, []int{2, 2, 0}
}
func (m *TestOneKeyStruct_Nested_Nested2) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TestOneKeyStruct_Nested_Nested2) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TestOneKeyStruct_Nested_Nested2.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TestOneKeyStruct_Nested_Nested2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TestOneKeyStruct_Nested_Nested2.Merge(m, src)
}
func (m *TestOneKeyStruct_Nested_Nested2) XXX_Size() int {
	return m.Size()
}
func (m *TestOneKeyStruct_Nested_Nested2) XXX_DiscardUnknown() {
	xxx_messageInfo_TestOneKeyStruct_Nested_Nested2.DiscardUnknown(m)
}

var xxx_messageInfo_TestOneKeyStruct_Nested_Nested2 proto.InternalMessageInfo

func (m *TestOneKeyStruct_Nested_Nested2) GetNested2() string {
	if m != nil {
		return m.Nested2
	}
	return ""
...
func (m *TestOneKeyStruct_Nested_Nested2) GetIsNested() bool {
	if m != nil {
		return m.IsNested
	}
	return false
...
func (m *TestOneKeyStruct_Nested_Nested2) GetInt64() int64 {
	if m != nil {
		return m.Int64
	}
	return 0
...
func (m *TestOneKeyStruct_Nested_Nested2) MessageClone() proto.Message {
	return m.Clone()
}
func (m *TestOneKeyStruct_Nested_Nested2) Clone() *TestOneKeyStruct_Nested_Nested2 {
	if m == nil {
		return nil
	}
	cloned := new(TestOneKeyStruct_Nested_Nested2)
	*cloned = *m
...
func (m *TestOneKeyStruct_OneOfNested) Reset()         { *m = TestOneKeyStruct_OneOfNested{} }
func (m *TestOneKeyStruct_OneOfNested) String() string { return proto.CompactTextString(m) }
func (*TestOneKeyStruct_OneOfNested) ProtoMessage()    {}
func (*TestOneKeyStruct_OneOfNested) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80f1f1db1167453, []int{2, 3}
}
func (m *TestOneKeyStruct_OneOfNested) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TestOneKeyStruct_OneOfNested) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TestOneKeyStruct_OneOfNested.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TestOneKeyStruct_OneOfNested) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TestOneKeyStruct_OneOfNested.Merge(m, src)
}
func (m *TestOneKeyStruct_OneOfNested) XXX_Size() int {
	return m.Size()
}
func (m *TestOneKeyStruct_OneOfNested) XXX_DiscardUnknown() {
	xxx_messageInfo_TestOneKeyStruct_OneOfNested.DiscardUnknown(m)
}

var xxx_messageInfo_TestOneKeyStruct_OneOfNested proto.InternalMessageInfo

func (m *TestOneKeyStruct_OneOfNested) GetNested() string {
	if m != nil {
		return m.Nested
	}
	return ""
...
func (m *TestOneKeyStruct_OneOfNested) MessageClone() proto.Message {
	return m.Clone()
}
func (m *TestOneKeyStruct_OneOfNested) Clone() *TestOneKeyStruct_OneOfNested {
	if m == nil {
		return nil
	}
	cloned := new(TestOneKeyStruct_OneOfNested)
...
type TestOneKeyStruct_OneOfNested_Nested2 struct {
	Nested2              string   `protobuf:"bytes,2,opt,name=nested2,proto3" json:"nested2,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *TestOneKeyStruct_OneOfNested_Nested2) Reset() {
	*m = TestOneKeyStruct_OneOfNested_Nested2{}
}
func (m *TestOneKeyStruct_OneOfNested_Nested2) String() string { return proto.CompactTextString(m) }
func (*TestOneKeyStruct_OneOfNested_Nested2) ProtoMessage()    {}
func (*TestOneKeyStruct_OneOfNested_Nested2) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80f1f1db1167453, []int{2, 3, 0}
}
func (m *TestOneKeyStruct_OneOfNested_Nested2) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TestOneKeyStruct_OneOfNested_Nested2) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TestOneKeyStruct_OneOfNested_Nested2.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TestOneKeyStruct_OneOfNested_Nested2) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TestOneKeyStruct_OneOfNested_Nested2.Merge(m, src)
}
func (m *TestOneKeyStruct_OneOfNested_Nested2) XXX_Size() int {
	return m.Size()
}
func (m *TestOneKeyStruct_OneOfNested_Nested2) XXX_DiscardUnknown() {
	xxx_messageInfo_TestOneKeyStruct_OneOfNested_Nested2.DiscardUnknown(m)
}

var xxx_messageInfo_TestOneKeyStruct_OneOfNested_Nested2 proto.InternalMessageInfo

func (m *TestOneKeyStruct_OneOfNested_Nested2) GetNested2() string {
	if m != nil {
		return m.Nested2
	}
	return ""
...
func (m *TestOneKeyStruct_OneOfNested_Nested2) MessageClone() proto.Message {
	return m.Clone()
}
func (m *TestOneKeyStruct_OneOfNested_Nested2) Clone() *TestOneKeyStruct_OneOfNested_Nested2 {
	if m == nil {
		return nil
	}
	cloned := new(TestOneKeyStruct_OneOfNested_Nested2)
	*cloned = *m
...
func init() {
	...
	proto.RegisterEnum("storage.TestOneKeyStruct_Enum", TestOneKeyStruct_Enum_name, TestOneKeyStruct_Enum_value)
	...
	proto.RegisterType((*TestOneKeyStruct)(nil), "storage.TestOneKeyStruct")
	proto.RegisterMapType((map[string]string)(nil), "storage.TestOneKeyStruct.LabelsEntry")
	proto.RegisterType((*TestOneKeyStruct_Embedded)(nil), "storage.TestOneKeyStruct.Embedded")
	proto.RegisterType((*TestOneKeyStruct_Embedded_Embedded2)(nil), "storage.TestOneKeyStruct.Embedded.Embedded2")
	proto.RegisterType((*TestOneKeyStruct_Nested)(nil), "storage.TestOneKeyStruct.Nested")
	proto.RegisterType((*TestOneKeyStruct_Nested_Nested2)(nil), "storage.TestOneKeyStruct.Nested.Nested2")
	proto.RegisterType((*TestOneKeyStruct_OneOfNested)(nil), "storage.TestOneKeyStruct.OneOfNested")
	proto.RegisterType((*TestOneKeyStruct_OneOfNested_Nested2)(nil), "storage.TestOneKeyStruct.OneOfNested.Nested2")
...
var fileDescriptor_f80f1f1db1167453 = []byte{
	...
	,
}
...
func (m *TestOneKeyStruct) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TestOneKeyStruct) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestOneKeyStruct) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TestOneKeyStruct_Oneofstring) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestOneKeyStruct_Oneofstring) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Oneofstring)
	copy(dAtA[i:], m.Oneofstring)
	i = encodeVarintTest(dAtA, i, uint64(len(m.Oneofstring)))
...
func (m *TestOneKeyStruct_Oneofnested) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestOneKeyStruct_Oneofnested) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Oneofnested != nil {
		{
			size, err := m.Oneofnested.MarshalToSizedBuffer(dAtA[:i])
...
func (m *TestOneKeyStruct_Embedded) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TestOneKeyStruct_Embedded) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestOneKeyStruct_Embedded) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TestOneKeyStruct_Embedded_Embedded2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TestOneKeyStruct_Embedded_Embedded2) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestOneKeyStruct_Embedded_Embedded2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TestOneKeyStruct_Nested) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TestOneKeyStruct_Nested) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestOneKeyStruct_Nested) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TestOneKeyStruct_Nested_Nested2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TestOneKeyStruct_Nested_Nested2) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestOneKeyStruct_Nested_Nested2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TestOneKeyStruct_OneOfNested) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TestOneKeyStruct_OneOfNested_Nested2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TestOneKeyStruct_OneOfNested_Nested2) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TestOneKeyStruct_OneOfNested_Nested2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TestOneKeyStruct) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestOneKeyStruct_Oneofstring) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestOneKeyStruct_Oneofnested) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestOneKeyStruct_Embedded) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestOneKeyStruct_Embedded_Embedded2) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestOneKeyStruct_Nested) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestOneKeyStruct_Nested_Nested2) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestOneKeyStruct_OneOfNested_Nested2) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TestOneKeyStruct) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TestOneKeyStruct: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TestOneKeyStruct: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 10:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Enum |= TestOneKeyStruct_Enum(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 11:
			if wireType == 0 {
				...
				for shift := uint(0); ; shift += 7 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= TestOneKeyStruct_Enum(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				var elementCount int
				if elementCount != 0 && len(m.Enums) == 0 {
					m.Enums = make([]TestOneKeyStruct_Enum, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v TestOneKeyStruct_Enum
					for shift := uint(0); ; shift += 7 {
		...
		case 12:
			...
			if m.Embedded == nil {
				m.Embedded = &TestOneKeyStruct_Embedded{}
			}
			if err := m.Embedded.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 13:
			...
			m.Nested = append(m.Nested, &TestOneKeyStruct_Nested{})
			if err := m.Nested[len(m.Nested)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 14:
			...
			m.Oneof = &TestOneKeyStruct_Oneofstring{string(dAtA[iNdEx:postIndex])}
			iNdEx = postIndex
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Oneofnested", wireType)
			...
			v := &TestOneKeyStruct_OneOfNested{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Oneof = &TestOneKeyStruct_Oneofnested{v}
			iNdEx = postIndex
		case 16:
			if wireType != 2 {
...
func (m *TestOneKeyStruct_Embedded) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *TestOneKeyStruct_Embedded_Embedded2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *TestOneKeyStruct_Nested) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			if m.Nested2 == nil {
				m.Nested2 = &TestOneKeyStruct_Nested_Nested2{}
			}
			if err := m.Nested2.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *TestOneKeyStruct_Nested_Nested2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *TestOneKeyStruct_OneOfNested) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *TestOneKeyStruct_OneOfNested_Nested2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
