...
type TestMultiKeyStruct struct {
	...
	IntSlice    []int32                      `protobuf:"varint,17,rep,packed,name=int_slice,json=intSlice,proto3" json:"int_slice,omitempty" search:"Test Int32 Slice"`
...
func (m *TestMultiKeyStruct) GetIntSlice() []int32 {
	if m != nil {
		return m.IntSlice
	}
	return nil
...
var fileDescriptor_f80f1f1db1167453 = []byte{
	...
	,
}
