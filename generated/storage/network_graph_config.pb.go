...
func (x *NetworkGraphConfig) ProtoReflect() protoreflect.Message {
	file_storage_network_graph_config_proto_init_ensure()
	mi := &file_storage_network_graph_config_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
const file_storage_network_graph_config_proto_rawDesc = "" +
	"\n" +
	"\"storage/network_graph_config.proto\x12\astorage\"a\n" +
	"\x12NetworkGraphConfig\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\tR\x02id\x12;\n" +
	"\x1ahide_default_external_srcs\x18\x01 \x01(\bR\x17hideDefaultExternalSrcsB.\n" +
	"\x19io.stackrox.proto.storageZ\x11./storage;storageb\x06proto3"

var (
	file_storage_network_graph_config_proto_rawDescOnce sync.Once
	file_storage_network_graph_config_proto_rawDescData []byte
)

func file_storage_network_graph_config_proto_rawDescGZIP() []byte {
	file_storage_network_graph_config_proto_rawDescOnce.Do(func() {
		file_storage_network_graph_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_storage_network_graph_config_proto_rawDesc), len(file_storage_network_graph_config_proto_rawDesc)))
	})
...
var file_storage_network_graph_config_proto_init_once sync.Once
func file_storage_network_graph_config_proto_init_ensure() { file_storage_network_graph_config_proto_init_once.Do(file_storage_network_graph_config_proto_init) }
