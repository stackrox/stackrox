...
func (m *Taint) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *Toleration) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *Toleration) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*Toleration)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *Taint) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TaintEffect != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.TaintEffect))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Value) > 0 {
...
func (m *Taint) SizeVT() (n int) {
	...
	if m.TaintEffect != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.TaintEffect))
	}
...
func (m *Taint) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
