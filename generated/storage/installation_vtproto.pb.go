...
func (m *InstallationInfo) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *InstallationInfo) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*InstallationInfo)
	if !ok {
		return false
	}
...
func (m *InstallationInfo) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
