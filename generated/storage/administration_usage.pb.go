...
func (x *SecuredUnits) ProtoReflect() protoreflect.Message {
	file_storage_administration_usage_proto_init_ensure()
	mi := &file_storage_administration_usage_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
var file_storage_administration_usage_proto_init_once sync.Once
func file_storage_administration_usage_proto_init_ensure() { file_storage_administration_usage_proto_init_once.Do(file_storage_administration_usage_proto_init) }
func init() {} // proto registration is lazy — triggered by first ProtoReflect() call
func file_storage_administration_usage_proto_init() {
	if File_storage_administration_usage_proto != nil || skipProtoInit {
		return
	}
	type x struct{}
