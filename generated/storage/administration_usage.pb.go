...
type SecuredUnits struct {
	...
	// aggregated.
	Timestamp *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=timestamp,proto3" json:"timestamp,omitempty" sql:"unique" search:"Administration Usage Timestamp"` // @gotags: sql:"unique" search:"Administration Usage Timestamp"
	// num_nodes is the maximum number of secured nodes, observed across all
	// registered clusters during last aggregation period.
	NumNodes int64 `protobuf:"varint,3,opt,name=num_nodes,json=numNodes,proto3" json:"num_nodes,omitempty" search:"Administration Usage Nodes"` // @gotags: search:"Administration Usage Nodes"
	...
	NumCpuUnits   int64 `protobuf:"varint,4,opt,name=num_cpu_units,json=numCpuUnits,proto3" json:"num_cpu_units,omitempty" search:"Administration Usage CPU Units"` // @gotags: search:"Administration Usage CPU Units"
