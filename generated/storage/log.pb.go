...
type LogImbue struct {
	...
	Timestamp     *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=timestamp,proto3" json:"timestamp,omitempty" search:"Log Imbue Creation Time"` // @gotags: search:"Log Imbue Creation Time"
