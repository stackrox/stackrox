...
func (x *NodeIntegration) ProtoReflect() protoreflect.Message {
	file_storage_node_integration_proto_init_ensure()
	mi := &file_storage_node_integration_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
const file_storage_node_integration_proto_rawDesc = "" +
	"\n" +
	"\x1estorage/node_integration.proto\x12\astorage\x1a\x1fstorage/image_integration.proto\"\xcf\x01\n" +
...
var (
	...
	file_storage_node_integration_proto_rawDescData []byte
)

func file_storage_node_integration_proto_rawDescGZIP() []byte {
	file_storage_node_integration_proto_rawDescOnce.Do(func() {
		file_storage_node_integration_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_storage_node_integration_proto_rawDesc), len(file_storage_node_integration_proto_rawDesc)))
	})
...
var file_storage_node_integration_proto_init_once sync.Once
func file_storage_node_integration_proto_init_ensure() { file_storage_node_integration_proto_init_once.Do(file_storage_node_integration_proto_init) }
func init() {} // proto registration is lazy — triggered by first ProtoReflect() call
func file_storage_node_integration_proto_init() {
	if File_storage_node_integration_proto != nil || skipProtoInit {
		return
	}
