...
var file_storage_node_integration_proto_goTypes = []interface{}{
...
func file_storage_node_integration_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_storage_node_integration_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	file_storage_node_integration_proto_msgTypes[0].OneofWrappers = []interface{}{
