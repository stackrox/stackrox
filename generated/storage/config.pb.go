...
const file_storage_config_proto_rawDesc = "" +
	...
	"*downloadable_report_global_retention_bytes\x18\x03 \x01(\rR&downloadableReportGlobalRetentionBytes\"\x91\x05\n" +
	...
	"\fapi_requests\x18\x04 \x01(\v2 .storage.PrometheusMetrics.GroupR\vapiRequests\x1a\xbb\x02\n" +
	"\x05Group\x128\n" +
...
var file_storage_config_proto_depIdxs = []int32{
	...
	18, // 18: storage.PlatformComponentConfig.rules:type_name -> storage.PlatformComponentConfig.Rule
	...
	21, // 22: storage.VulnerabilityExceptionConfig.expiry_options:type_name -> storage.VulnerabilityExceptionConfig.ExpiryOptions
	...
	19, // 25: storage.PlatformComponentConfig.Rule.namespace_rule:type_name -> storage.PlatformComponentConfig.Rule.NamespaceRule
	13, // 26: storage.VulnerabilityExceptionConfig.ExpiryOptions.day_options:type_name -> storage.DayOption
	20, // 27: storage.VulnerabilityExceptionConfig.ExpiryOptions.fixable_cve_options:type_name -> storage.VulnerabilityExceptionConfig.FixableCVEOptions
