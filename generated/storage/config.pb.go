...
type PrometheusMetrics struct {
	state                protoimpl.MessageState         `protogen:"open.v1"`
	ImageVulnerabilities *PrometheusMetrics_MetricGroup `protobuf:"bytes,1,opt,name=image_vulnerabilities,json=imageVulnerabilities,proto3" json:"image_vulnerabilities,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *PrometheusMetrics) GetImageVulnerabilities() *PrometheusMetrics_MetricGroup {
	if x != nil {
...
type PrometheusMetrics_MetricGroup struct {
	state                  protoimpl.MessageState                           `protogen:"open.v1"`
	...
	Metrics                map[string]*PrometheusMetrics_MetricGroup_Labels `protobuf:"bytes,2,rep,name=metrics,proto3" json:"metrics,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}

func (x *PrometheusMetrics_MetricGroup) Reset() {
	*x = PrometheusMetrics_MetricGroup{}
	mi := &file_storage_config_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PrometheusMetrics_MetricGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrometheusMetrics_MetricGroup) ProtoMessage() {}

func (x *PrometheusMetrics_MetricGroup) ProtoReflect() protoreflect.Message {
	mi := &file_storage_config_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrometheusMetrics_MetricGroup.ProtoReflect.Descriptor instead.
func (*PrometheusMetrics_MetricGroup) Descriptor() ([]byte, []int) {
	return file_storage_config_proto_rawDescGZIP(), []int{6, 0}
}

func (x *PrometheusMetrics_MetricGroup) GetGatheringPeriodMinutes() uint32 {
	if x != nil {
...
func (x *PrometheusMetrics_MetricGroup) GetMetrics() map[string]*PrometheusMetrics_MetricGroup_Labels {
	if x != nil {
		return x.Metrics
	}
	return nil
...
type PrometheusMetrics_MetricGroup_Labels struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *PrometheusMetrics_MetricGroup_Labels) Reset() {
	*x = PrometheusMetrics_MetricGroup_Labels{}
	mi := &file_storage_config_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PrometheusMetrics_MetricGroup_Labels) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PrometheusMetrics_MetricGroup_Labels) ProtoMessage() {}

func (x *PrometheusMetrics_MetricGroup_Labels) ProtoReflect() protoreflect.Message {
	mi := &file_storage_config_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PrometheusMetrics_MetricGroup_Labels.ProtoReflect.Descriptor instead.
func (*PrometheusMetrics_MetricGroup_Labels) Descriptor() ([]byte, []int) {
	return file_storage_config_proto_rawDescGZIP(), []int{6, 0, 0}
}

func (x *PrometheusMetrics_MetricGroup_Labels) GetLabels() []string {
	if x != nil {
		return x.Labels
	}
	return nil
...
const file_storage_config_proto_rawDesc = "" +
	...
	"*downloadable_report_global_retention_bytes\x18\x03 \x01(\rR&downloadableReportGlobalRetentionBytes\"\x96\x03\n" +
	"\x11PrometheusMetrics\x12[\n" +
	"\x15image_vulnerabilities\x18\x01 \x01(\v2&.storage.PrometheusMetrics.MetricGroupR\x14imageVulnerabilities\x1a\xa3\x02\n" +
	"\vMetricGroup\x128\n" +
	"\x18gathering_period_minutes\x18\x01 \x01(\rR\x16gatheringPeriodMinutes\x12M\n" +
	"\ametrics\x18\x02 \x03(\v23.storage.PrometheusMetrics.MetricGroup.MetricsEntryR\ametrics\x1a \n" +
	"\x06Labels\x12\x16\n" +
	"\x06labels\x18\x01 \x03(\tR\x06labels\x1ai\n" +
	"\fMetricsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12C\n" +
	"\x05value\x18\x02 \x01(\v2-.storage.PrometheusMetrics.MetricGroup.LabelsR\x05value:\x028\x01\"\xb5\x06\n" +
	"\rPrivateConfig\x12X\n" +
...
var file_storage_config_proto_goTypes = []any{
	...
	(*PrometheusMetrics_MetricGroup)(nil),        // 15: storage.PrometheusMetrics.MetricGroup
	(*PrometheusMetrics_MetricGroup_Labels)(nil), // 16: storage.PrometheusMetrics.MetricGroup.Labels
	nil,                                  // 17: storage.PrometheusMetrics.MetricGroup.MetricsEntry
...
var file_storage_config_proto_depIdxs = []int32{
	...
	15, // 8: storage.PrometheusMetrics.image_vulnerabilities:type_name -> storage.PrometheusMetrics.MetricGroup
	...
	17, // 20: storage.PrometheusMetrics.MetricGroup.metrics:type_name -> storage.PrometheusMetrics.MetricGroup.MetricsEntry
	16, // 21: storage.PrometheusMetrics.MetricGroup.MetricsEntry.value:type_name -> storage.PrometheusMetrics.MetricGroup.Labels
