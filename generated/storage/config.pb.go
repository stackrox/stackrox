...
type ReportRetentionConfig struct {
	SnapshotRetentionDurationDays int32    `protobuf:"varint,1,opt,name=snapshot_retention_duration_days,json=snapshotRetentionDurationDays,proto3" json:"snapshot_retention_duration_days,omitempty"`
	XXX_NoUnkeyedLiteral          struct{} `json:"-"`
	XXX_unrecognized              []byte   `json:"-"`
	XXX_sizecache                 int32    `json:"-"`
}
...
func (m *ReportRetentionConfig) GetSnapshotRetentionDurationDays() int32 {
	if m != nil {
		return m.SnapshotRetentionDurationDays
	}
	return 0
}
...
var fileDescriptor_33903d79f8815efc = []byte{
	...
	,
}
...
func (m *ReportRetentionConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SnapshotRetentionDurationDays != 0 {
		i = encodeVarintConfig(dAtA, i, uint64(m.SnapshotRetentionDurationDays))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ReportRetentionConfig) Size() (n int) {
	...
	_ = l
	if m.SnapshotRetentionDurationDays != 0 {
		n += 1 + sovConfig(uint64(m.SnapshotRetentionDurationDays))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *ReportRetentionConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SnapshotRetentionDurationDays", wireType)
			}
			m.SnapshotRetentionDurationDays = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowConfig
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SnapshotRetentionDurationDays |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
