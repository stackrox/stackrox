...
const file_storage_config_proto_rawDesc = "" +
	...
	"*downloadable_report_global_retention_bytes\x18\x03 \x01(\rR&downloadableReportGlobalRetentionBytes\"\x9e\x06\n" +
	...
	"\fapi_requests\x18\x04 \x01(\v2 .storage.PrometheusMetrics.GroupR\vapiRequests\x1a\xc8\x03\n" +
	"\x05Group\x128\n" +
	...
	"\aenabled\x18\x03 \x01(\bR\aenabled\x1a\xac\x01\n" +
	"\x06Labels\x12\x16\n" +
...
var file_storage_config_proto_depIdxs = []int32{
	...
	19, // 18: storage.PlatformComponentConfig.rules:type_name -> storage.PlatformComponentConfig.Rule
	...
	22, // 22: storage.VulnerabilityExceptionConfig.expiry_options:type_name -> storage.VulnerabilityExceptionConfig.ExpiryOptions
	17, // 23: storage.PrometheusMetrics.Group.descriptors:type_name -> storage.PrometheusMetrics.Group.DescriptorsEntry
	18, // 24: storage.PrometheusMetrics.Group.Labels.filters:type_name -> storage.PrometheusMetrics.Group.Labels.FiltersEntry
	16, // 25: storage.PrometheusMetrics.Group.DescriptorsEntry.value:type_name -> storage.PrometheusMetrics.Group.Labels
	20, // 26: storage.PlatformComponentConfig.Rule.namespace_rule:type_name -> storage.PlatformComponentConfig.Rule.NamespaceRule
	13, // 27: storage.VulnerabilityExceptionConfig.ExpiryOptions.day_options:type_name -> storage.DayOption
	21, // 28: storage.VulnerabilityExceptionConfig.ExpiryOptions.fixable_cve_options:type_name -> storage.VulnerabilityExceptionConfig.FixableCVEOptions
