...
var file_storage_config_proto_rawDesc = []byte{
	...
	0x61, 0x62, 0x6c, 0x65, 0x64, 0x42, 0x27, 0x0a, 0x19, 0x69, 0x6f, 0x2e, 0x73, 0x74, 0x61, 0x63,
...
func file_storage_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_storage_config_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
		...
		file_storage_config_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_storage_config_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_storage_config_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_storage_config_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_storage_config_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
	...
	file_storage_config_proto_msgTypes[6].OneofWrappers = []interface{}{
