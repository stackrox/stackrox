...
var file_storage_vuln_requests_proto_rawDesc = []byte{
	...
	0x41, 0x54, 0x45, 0x10, 0x03, 0x42, 0x27, 0x0a, 0x19, 0x69, 0x6f, 0x2e, 0x73, 0x74, 0x61, 0x63,
...
func file_storage_vuln_requests_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_storage_vuln_requests_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_storage_vuln_requests_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_storage_vuln_requests_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_storage_vuln_requests_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
	...
	file_storage_vuln_requests_proto_msgTypes[8].OneofWrappers = []interface{}{
	...
	file_storage_vuln_requests_proto_msgTypes[10].OneofWrappers = []interface{}{
