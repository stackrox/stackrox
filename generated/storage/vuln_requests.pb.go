...
type VulnerabilityRequest_FpUpdate struct {
	FpUpdate *FalsePositiveUpdate `protobuf:"bytes,23,opt,name=fp_update,json=fpUpdate,proto3,oneof" json:"fp_update,omitempty"`
}
...
func (*VulnerabilityRequest_FpUpdate) isVulnerabilityRequest_UpdatedReq() {}
func (m *VulnerabilityRequest_FpUpdate) Clone() isVulnerabilityRequest_UpdatedReq {
	if m == nil {
		return nil
	}
	cloned := new(VulnerabilityRequest_FpUpdate)
	*cloned = *m

	cloned.FpUpdate = m.FpUpdate.Clone()
	return cloned
}
...
func (m *VulnerabilityRequest) GetFpUpdate() *FalsePositiveUpdate {
	if x, ok := m.GetUpdatedReq().(*VulnerabilityRequest_FpUpdate); ok {
		return x.FpUpdate
	}
	return nil
}
...
func (*VulnerabilityRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*VulnerabilityRequest_FpUpdate)(nil),
	}
}
...
func (*VulnerabilityRequest_CVEs) Descriptor() ([]byte, []int) {
	return fileDescriptor_878c2c8004fa26b3, []int{6, 0}
}
...
func (*VulnerabilityRequest_Scope) Descriptor() ([]byte, []int) {
	return fileDescriptor_878c2c8004fa26b3, []int{6, 1}
}
...
func (*VulnerabilityRequest_Scope_Image) Descriptor() ([]byte, []int) {
	return fileDescriptor_878c2c8004fa26b3, []int{6, 1, 0}
}
...
func (*VulnerabilityRequest_Scope_Global) Descriptor() ([]byte, []int) {
	return fileDescriptor_878c2c8004fa26b3, []int{6, 1, 1}
}
...
var fileDescriptor_878c2c8004fa26b3 = []byte{
	...
	,
}
...
func (m *VulnerabilityRequest_FpUpdate) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VulnerabilityRequest_FpUpdate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.FpUpdate != nil {
		{
			size, err := m.FpUpdate.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *VulnerabilityRequest_FpUpdate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VulnerabilityRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FpUpdate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.UpdatedReq = &VulnerabilityRequest_FpUpdate{v}
			iNdEx = postIndex
		case 26:
			if wireType != 2 {
