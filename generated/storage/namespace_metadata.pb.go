...
func (x *NamespaceMetadata) ProtoReflect() protoreflect.Message {
	file_storage_namespace_metadata_proto_init_ensure()
	mi := &file_storage_namespace_metadata_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
var file_storage_namespace_metadata_proto_init_once sync.Once
func file_storage_namespace_metadata_proto_init_ensure() { file_storage_namespace_metadata_proto_init_once.Do(file_storage_namespace_metadata_proto_init) }
