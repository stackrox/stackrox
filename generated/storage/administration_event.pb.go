...
var file_storage_administration_event_proto_rawDesc = []byte{
	...
	0x04, 0x42, 0x27, 0x0a, 0x19, 0x69, 0x6f, 0x2e, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x72, 0x6f, 0x78,
...
var (
	...
	file_storage_administration_event_proto_rawDescData = file_storage_administration_event_proto_rawDesc
)

func file_storage_administration_event_proto_rawDescGZIP() []byte {
	file_storage_administration_event_proto_rawDescOnce.Do(func() {
		file_storage_administration_event_proto_rawDescData = protoimpl.X.CompressGZIP(file_storage_administration_event_proto_rawDescData)
	})
...
var file_storage_administration_event_proto_goTypes = []interface{}{
...
func file_storage_administration_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_storage_administration_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_storage_administration_event_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_storage_administration_event_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_storage_administration_event_proto_rawDesc = nil
