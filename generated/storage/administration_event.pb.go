...
func file_storage_administration_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_storage_administration_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_storage_administration_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
