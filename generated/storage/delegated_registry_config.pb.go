...
func file_storage_delegated_registry_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_storage_delegated_registry_config_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_storage_delegated_registry_config_proto_msgTypes[1].Exporter = func(v any, i int) any {
