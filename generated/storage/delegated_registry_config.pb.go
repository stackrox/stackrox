...
var file_storage_delegated_registry_config_proto_rawDesc = []byte{
	...
	0x46, 0x49, 0x43, 0x10, 0x02, 0x42, 0x27, 0x0a, 0x19, 0x69, 0x6f, 0x2e, 0x73, 0x74, 0x61, 0x63,
...
var file_storage_delegated_registry_config_proto_goTypes = []interface{}{
...
func file_storage_delegated_registry_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_storage_delegated_registry_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_storage_delegated_registry_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
