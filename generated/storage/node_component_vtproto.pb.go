...
func (m *NodeComponent) CloneVT() *NodeComponent {
	if m == nil {
	...
	if m.SetTopCvss != nil {
		r.SetTopCvss = m.SetTopCvss.(interface {
			CloneVT() isNodeComponent_SetTopCvss
		}).CloneVT()
	}
...
func (m *NodeComponent) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *NodeComponent_TopCvss) CloneVT() isNodeComponent_SetTopCvss {
	if m == nil {
		return (*NodeComponent_TopCvss)(nil)
	}
	r := new(NodeComponent_TopCvss)
	r.TopCvss = m.TopCvss
	return r
}

func (this *NodeComponent) EqualVT(that *NodeComponent) bool {
	if this == that {
		return true
	...
	if this.SetTopCvss == nil && that.SetTopCvss != nil {
		...
		if !this.SetTopCvss.(interface {
			EqualVT(isNodeComponent_SetTopCvss) bool
...
func (this *NodeComponent) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*NodeComponent)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *NodeComponent_TopCvss) EqualVT(thatIface isNodeComponent_SetTopCvss) bool {
	that, ok := thatIface.(*NodeComponent_TopCvss)
	if !ok {
		return false
	}
	if this == that {
...
func (m *NodeComponent) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *NodeComponent) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *NodeComponent_TopCvss) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *NodeComponent_TopCvss) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 4
...
func (m *NodeComponent) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *NodeComponent_TopCvss) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *NodeComponent) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 8:
			...
			v = uint32(binary.LittleEndian.Uint32(dAtA[iNdEx:]))
			iNdEx += 4
			m.SetTopCvss = &NodeComponent_TopCvss{TopCvss: float32(math.Float32frombits(v))}
		case 9:
			if wireType != 2 {
