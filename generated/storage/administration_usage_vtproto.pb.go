...
func (m *SecuredUnits) CloneVT() *SecuredUnits {
	if m == nil {
		return (*SecuredUnits)(nil)
	}
	r := new(SecuredUnits)
	r.Id = m.Id
...
func (m *SecuredUnits) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (this *SecuredUnits) EqualVT(that *SecuredUnits) bool {
	if this == that {
		return true
...
func (this *SecuredUnits) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*SecuredUnits)
	if !ok {
		return false
	}
...
func (m *SecuredUnits) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *SecuredUnits) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *SecuredUnits) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SecuredUnits) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
