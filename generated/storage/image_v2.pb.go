...
type ImageV2 struct {
	...
	Id                        string                          `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty" search:"Image ID" sql:"pk"`   // @gotags: search:"Image ID" sql:"pk"
	...
	ComponentCount int32 `protobuf:"varint,8,opt,name=component_count,json=componentCount,proto3" json:"component_count,omitempty" search:"Component Count"` // @gotags: search:"Component Count"
	// Caching cve count to avoid re-calculating it by joining on the cve table.
	CveCount int32 `protobuf:"varint,9,opt,name=cve_count,json=cveCount,proto3" json:"cve_count,omitempty" search:"Image CVE Count"` // @gotags: search:"Image CVE Count"
	// Caching fixable cve count to avoid re-calculating it by joining on the cve table.
	FixableCveCount int32 `protobuf:"varint,10,opt,name=fixable_cve_count,json=fixableCveCount,proto3" json:"fixable_cve_count,omitempty" search:"Fixable CVE Count"` // @gotags: search:"Fixable CVE Count"
	// Caching unknown cve count to avoid re-calculating it by joining on the cve table.
	UnknownCveCount int32 `protobuf:"varint,11,opt,name=unknown_cve_count,json=unknownCveCount,proto3" json:"unknown_cve_count,omitempty" search:"Unknown CVE Count"` // @gotags: search:"Unknown CVE Count"
	// Caching fixable unknown cve count to avoid re-calculating it by joining on the cve table.
	FixableUnknownCveCount int32 `protobuf:"varint,12,opt,name=fixable_unknown_cve_count,json=fixableUnknownCveCount,proto3" json:"fixable_unknown_cve_count,omitempty" search:"Fixable Unknown CVE Count"` // @gotags: search:"Fixable Unknown CVE Count"
	// Caching critical cve count to avoid re-calculating it by joining on the cve table.
	CriticalCveCount int32 `protobuf:"varint,13,opt,name=critical_cve_count,json=criticalCveCount,proto3" json:"critical_cve_count,omitempty" search:"Critical CVE Count"` // @gotags: search:"Critical CVE Count"
	// Caching fixable critical cve count to avoid re-calculating it by joining on the cve table.
	FixableCriticalCveCount int32 `protobuf:"varint,14,opt,name=fixable_critical_cve_count,json=fixableCriticalCveCount,proto3" json:"fixable_critical_cve_count,omitempty" search:"Fixable Critical CVE Count"` // @gotags: search:"Fixable Critical CVE Count"
	// Caching important cve count to avoid re-calculating it by joining on the cve table.
	ImportantCveCount int32 `protobuf:"varint,15,opt,name=important_cve_count,json=importantCveCount,proto3" json:"important_cve_count,omitempty" search:"Important CVE Count"` // @gotags: search:"Important CVE Count"
	// Caching fixable important cve count to avoid re-calculating it by joining on the cve table.
	FixableImportantCveCount int32 `protobuf:"varint,16,opt,name=fixable_important_cve_count,json=fixableImportantCveCount,proto3" json:"fixable_important_cve_count,omitempty" search:"Fixable Important CVE Count"` // @gotags: search:"Fixable Important CVE Count"
	// Caching moderate cve count to avoid re-calculating it by joining on the cve table.
	ModerateCveCount int32 `protobuf:"varint,17,opt,name=moderate_cve_count,json=moderateCveCount,proto3" json:"moderate_cve_count,omitempty" search:"Moderate CVE Count"` // @gotags: search:"Moderate CVE Count"
	// Caching fixable moderate cve count to avoid re-calculating it by joining on the cve table.
	FixableModerateCveCount int32 `protobuf:"varint,18,opt,name=fixable_moderate_cve_count,json=fixableModerateCveCount,proto3" json:"fixable_moderate_cve_count,omitempty" search:"Fixable Moderate CVE Count"` // @gotags: search:"Fixable Moderate CVE Count"
	// Caching low cve count to avoid re-calculating it by joining on the cve table.
	LowCveCount int32 `protobuf:"varint,19,opt,name=low_cve_count,json=lowCveCount,proto3" json:"low_cve_count,omitempty" search:"Low CVE Count"` // @gotags: search:"Low CVE Count"
	// Caching fixable low cve count to avoid re-calculating it by joining on the cve table.
	FixableLowCveCount int32                  `protobuf:"varint,20,opt,name=fixable_low_cve_count,json=fixableLowCveCount,proto3" json:"fixable_low_cve_count,omitempty" search:"Fixable Low CVE Count"` // @gotags: search:"Fixable Low CVE Count"
	LastUpdated        *timestamppb.Timestamp `protobuf:"bytes,21,opt,name=last_updated,json=lastUpdated,proto3" json:"last_updated,omitempty" search:"Last Updated"`                           // @gotags: search:"Last Updated"
	...
	Priority           int64                  `protobuf:"varint,24,opt,name=priority,proto3" json:"priority,omitempty" search:"Image Risk Priority"`                     // @gotags: search:"Image Risk Priority"
	RiskScore          float32                `protobuf:"fixed32,25,opt,name=risk_score,json=riskScore,proto3" json:"risk_score,omitempty" search:"Image Risk Score"` // @gotags: search:"Image Risk Score"
	// Caching top cvss to avoid re-calculating it by joining on the cve table.
	TopCvss       float32        `protobuf:"fixed32,26,opt,name=top_cvss,json=topCvss,proto3" json:"top_cvss,omitempty" search:"Image Top CVSS"` // @gotags: search:"Image Top CVSS"
