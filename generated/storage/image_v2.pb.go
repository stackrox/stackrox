...
func (x *ImageV2) GetBaseImageInfo() []*BaseImageInfo {
	if x != nil {
...
const file_storage_image_v2_proto_rawDesc = "" +
	"\n" +
	"\x16storage/image_v2.proto\x12\astorage\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x13storage/image.proto\"\xd7\v\n" +
	"\aImageV2\x12\x0e\n" +
	...
	"\x05notes\x18\x0f \x03(\x0e2\x15.storage.ImageV2.NoteR\x05notes\x12>\n" +
	"\x0fbase_image_info\x18\x10 \x03(\v2\x16.storage.BaseImageInfoR\rbaseImageInfo\x1a\x80\x05\n" +
	"\tScanStats\x12'\n" +
...
var file_storage_image_v2_proto_goTypes = []any{
	...
	(*BaseImageInfo)(nil),                  // 10: storage.BaseImageInfo
}
var file_storage_image_v2_proto_depIdxs = []int32{
	...
	10, // 8: storage.ImageV2.base_image_info:type_name -> storage.BaseImageInfo
	9,  // 9: storage.ListImageV2.created:type_name -> google.protobuf.Timestamp
	9,  // 10: storage.ListImageV2.last_updated:type_name -> google.protobuf.Timestamp
