...
var file_storage_operation_status_proto_rawDesc = []byte{
...
var (
	...
	file_storage_operation_status_proto_rawDescData = file_storage_operation_status_proto_rawDesc
)

func file_storage_operation_status_proto_rawDescGZIP() []byte {
	file_storage_operation_status_proto_rawDescOnce.Do(func() {
		file_storage_operation_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_storage_operation_status_proto_rawDescData)
	})
...
var file_storage_operation_status_proto_goTypes = []interface{}{
...
func file_storage_operation_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_storage_operation_status_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_storage_operation_status_proto_rawDesc = nil
