...
type Traits struct {
	...
	ExpiresAt      *timestamppb.Timestamp `protobuf:"bytes,4,opt,name=expires_at,json=expiresAt,proto3" json:"expires_at,omitempty" search:"Expires At,hidden"` // @gotags: search:"Expires At,hidden"
...
const file_storage_traits_proto_rawDesc = "" +
	"\n" +
	"\x14storage/traits.proto\x12\astorage\x1a\x1fgoogle/protobuf/timestamp.proto\"\xae\x03\n" +
	"\x06Traits\x12G\n" +
