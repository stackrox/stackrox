...
const (
	...
	Traits_EPHEMERAL            Traits_Origin = 4
)
...
type Traits struct {
	...
	// expires_at specifies when this object should be considered expired and eligible for pruning.
	...
	// that are generated by the internal token API for sensors.
...
func (x *Traits) GetExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
var file_storage_traits_proto_depIdxs = []int32{
	...
	4, // 3: storage.Traits.expires_at:type_name -> google.protobuf.Timestamp
...
var file_storage_traits_proto_init_once sync.Once
func file_storage_traits_proto_init_ensure() { file_storage_traits_proto_init_once.Do(file_storage_traits_proto_init) }
func init() {} // proto registration is lazy — triggered by first ProtoReflect() call
func file_storage_traits_proto_init() {
	if File_storage_traits_proto != nil || skipProtoInit {
		return
	}
	type x struct{}
