...
func (UnimplementedVirtualMachineIndexReportServiceServer) UpsertVirtualMachineIndexReport(context.Context, *UpsertVirtualMachineIndexReportRequest) (*UpsertVirtualMachineIndexReportResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpsertVirtualMachineIndexReport not implemented")
}
...
func RegisterVirtualMachineIndexReportServiceServer(s grpc.ServiceRegistrar, srv VirtualMachineIndexReportServiceServer) {
	// If the following call panics, it indicates UnimplementedVirtualMachineIndexReportServiceServer was
...
func _VirtualMachineIndexReportService_UpsertVirtualMachineIndexReport_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
