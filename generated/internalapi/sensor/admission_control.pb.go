...
type AdmissionControlSettings struct {
	...
	ClusterLabels              map[string]string             `protobuf:"bytes,9,rep,name=cluster_labels,json=clusterLabels,proto3" json:"cluster_labels,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *AdmissionControlSettings) GetFlattenImageData() bool {
	if x != nil {
...
func (x *AdmissionControlSettings) GetClusterLabels() map[string]string {
	if x != nil {
...
func (x *ClusterLabels) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use ClusterLabels.ProtoReflect.Descriptor instead.
func (*ClusterLabels) Descriptor() ([]byte, []int) {
	return file_internalapi_sensor_admission_control_proto_rawDescGZIP(), []int{1}
}

func (x *ClusterLabels) GetLabels() map[string]string {
	if x != nil {
		return x.Labels
	}
	return nil
...
func (*AdmCtrlUpdateResourceRequest) Descriptor() ([]byte, []int) {
	return file_internalapi_sensor_admission_control_proto_rawDescGZIP(), []int{3}
}
...
func (*AdmCtrlUpdateResourceRequest_ResourcesSynced) Descriptor() ([]byte, []int) {
	return file_internalapi_sensor_admission_control_proto_rawDescGZIP(), []int{3, 0}
}
...
const file_internalapi_sensor_admission_control_proto_rawDesc = "" +
	"\n" +
	"*internalapi/sensor/admission_control.proto\x12\x06sensor\x1a\x1fgoogle/protobuf/timestamp.proto\x1a'internalapi/central/sensor_events.proto\x1a\x15storage/cluster.proto\x1a\x18storage/deployment.proto\x1a storage/namespace_metadata.proto\x1a\x14storage/policy.proto\"\xed\x04\n" +
	...
	"\x12flatten_image_data\x18\b \x01(\bR\x10flattenImageData\x12Z\n" +
	"\x0ecluster_labels\x18\t \x03(\v23.sensor.AdmissionControlSettings.ClusterLabelsEntryR\rclusterLabels\x1a@\n" +
...
var file_internalapi_sensor_admission_control_proto_goTypes = []any{
	...
	nil,                                  // 4: sensor.AdmissionControlSettings.ClusterLabelsEntry
...
var file_internalapi_sensor_admission_control_proto_depIdxs = []int32{
	...
	4,  // 4: sensor.AdmissionControlSettings.cluster_labels:type_name -> sensor.AdmissionControlSettings.ClusterLabelsEntry
	5,  // 5: sensor.ClusterLabels.labels:type_name -> sensor.ClusterLabels.LabelsEntry
	10, // 6: sensor.AdmissionControlAlerts.alert_results:type_name -> central.AlertResults
	11, // 7: sensor.AdmCtrlUpdateResourceRequest.action:type_name -> central.ResourceAction
	12, // 8: sensor.AdmCtrlUpdateResourceRequest.deployment:type_name -> storage.Deployment
	13, // 9: sensor.AdmCtrlUpdateResourceRequest.pod:type_name -> storage.Pod
	14, // 10: sensor.AdmCtrlUpdateResourceRequest.namespace:type_name -> storage.NamespaceMetadata
	6,  // 11: sensor.AdmCtrlUpdateResourceRequest.synced:type_name -> sensor.AdmCtrlUpdateResourceRequest.ResourcesSynced
