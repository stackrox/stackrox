...
type AdmissionControlSettings struct {
	...
	FlattenImageDataOnCentral  bool                          `protobuf:"varint,8,opt,name=flatten_image_data_on_central,json=flattenImageDataOnCentral,proto3" json:"flatten_image_data_on_central,omitempty"`
...
func (x *AdmissionControlSettings) GetFlattenImageDataOnCentral() bool {
	if x != nil {
		return x.FlattenImageDataOnCentral
	}
	return false
}
...
const file_internalapi_sensor_admission_control_proto_rawDesc = "" +
	"\n" +
	"*internalapi/sensor/admission_control.proto\x12\x06sensor\x1a\x1fgoogle/protobuf/timestamp.proto\x1a'internalapi/central/sensor_events.proto\x1a\x15storage/cluster.proto\x1a\x18storage/deployment.proto\x1a storage/namespace_metadata.proto\x1a\x14storage/policy.proto\"\xe3\x03\n" +
	...
	"\x1dflatten_image_data_on_central\x18\b \x01(\bR\x19flattenImageDataOnCentral\"T\n" +
