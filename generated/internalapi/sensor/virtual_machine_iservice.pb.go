...
type UpsertVirtualMachineRequest struct {
	...
	VirtualMachine *central.VirtualMachine `protobuf:"bytes,1,opt,name=virtual_machine,json=virtualMachine,proto3" json:"virtual_machine,omitempty"`
...
func (x *UpsertVirtualMachineRequest) GetVirtualMachine() *central.VirtualMachine {
	if x != nil {
...
const file_internalapi_sensor_virtual_machine_iservice_proto_rawDesc = "" +
	"\n" +
	"1internalapi/sensor/virtual_machine_iservice.proto\x12\x06sensor\x1a)internalapi/central/virtual_machine.proto\"_\n" +
	"\x1bUpsertVirtualMachineRequest\x12@\n" +
	"\x0fvirtual_machine\x18\x01 \x01(\v2\x17.central.VirtualMachineR\x0evirtualMachine\"8\n" +
...
var file_internalapi_sensor_virtual_machine_iservice_proto_goTypes = []any{
	...
	(*central.VirtualMachine)(nil),       // 2: central.VirtualMachine
}
var file_internalapi_sensor_virtual_machine_iservice_proto_depIdxs = []int32{
	2, // 0: sensor.UpsertVirtualMachineRequest.virtual_machine:type_name -> central.VirtualMachine
