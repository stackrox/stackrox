...
func (m *AdmissionControlSettings) CloneVT() *AdmissionControlSettings {
	...
	r.FlattenImageDataOnCentral = m.FlattenImageDataOnCentral
...
func (this *AdmissionControlSettings) EqualVT(that *AdmissionControlSettings) bool {
	...
	if this.FlattenImageDataOnCentral != that.FlattenImageDataOnCentral {
		return false
	}
...
func (m *AdmissionControlSettings) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.FlattenImageDataOnCentral {
		i--
		if m.FlattenImageDataOnCentral {
			dAtA[i] = 1
		} else {
...
func (m *AdmissionControlSettings) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FlattenImageDataOnCentral", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FlattenImageDataOnCentral = bool(v != 0)
		default:
			iNdEx = preIndex
