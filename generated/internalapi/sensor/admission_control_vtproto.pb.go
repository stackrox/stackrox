...
func (m *AdmissionControlSettings) CloneVT() *AdmissionControlSettings {
	...
	r := new(AdmissionControlSettings)
...
func (m *AdmissionControlSettings) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (m *ClusterLabels) CloneVT() *ClusterLabels {
	if m == nil {
...
func (m *ClusterLabels) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *AdmissionControlAlerts) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *AdmCtrlUpdateResourceRequest_ResourcesSynced) CloneVT() *AdmCtrlUpdateResourceRequest_ResourcesSynced {
	...
	r := new(AdmCtrlUpdateResourceRequest_ResourcesSynced)
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *AdmCtrlUpdateResourceRequest_ResourcesSynced) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *AdmCtrlUpdateResourceRequest) CloneVT() *AdmCtrlUpdateResourceRequest {
	...
	r := new(AdmCtrlUpdateResourceRequest)
	r.Action = m.Action
	if m.Resource != nil {
...
func (m *AdmCtrlUpdateResourceRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (m *AdmCtrlUpdateResourceRequest_Synced) CloneVT() isAdmCtrlUpdateResourceRequest_Resource {
	...
	r := new(AdmCtrlUpdateResourceRequest_Synced)
...
func (m *AdmCtrlImageCacheInvalidation) CloneVT() *AdmCtrlImageCacheInvalidation {
	if m == nil {
		return (*AdmCtrlImageCacheInvalidation)(nil)
	}
...
func (m *AdmCtrlImageCacheInvalidation) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *AdmissionControlSettings) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*AdmissionControlSettings)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (this *ClusterLabels) EqualVT(that *ClusterLabels) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *ClusterLabels) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*ClusterLabels)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *AdmissionControlAlerts) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*AdmissionControlAlerts)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *AdmCtrlUpdateResourceRequest_ResourcesSynced) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*AdmCtrlUpdateResourceRequest_ResourcesSynced)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *AdmCtrlUpdateResourceRequest) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*AdmCtrlUpdateResourceRequest)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (this *AdmCtrlImageCacheInvalidation) EqualVT(that *AdmCtrlImageCacheInvalidation) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *AdmCtrlImageCacheInvalidation) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*AdmCtrlImageCacheInvalidation)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *AdmissionControlSettings) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.CentralEndpoint) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CentralEndpoint)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.CacheVersion) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CacheVersion)))
		i--
		dAtA[i] = 0x22
	}
	if m.Timestamp != nil {
...
func (m *ClusterLabels) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ClusterLabels) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ClusterLabels) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *AdmCtrlImageCacheInvalidation) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *AdmCtrlImageCacheInvalidation) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *AdmCtrlImageCacheInvalidation) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.ImageKeys) > 0 {
		for iNdEx := len(m.ImageKeys) - 1; iNdEx >= 0; iNdEx-- {
			if vtmsg, ok := interface{}(m.ImageKeys[iNdEx]).(interface {
				...
				encoded, err := proto.Marshal(m.ImageKeys[iNdEx])
				if err != nil {
					return 0, err
				}
				i -= len(encoded)
...
func (m *ClusterLabels) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AdmCtrlImageCacheInvalidation) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ClusterLabels) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ClusterLabels: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ClusterLabels: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *AdmCtrlImageCacheInvalidation) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AdmCtrlImageCacheInvalidation: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AdmCtrlImageCacheInvalidation: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if unmarshal, ok := interface{}(m.ImageKeys[len(m.ImageKeys)-1]).(interface {
				...
				if err := proto.Unmarshal(dAtA[iNdEx:postIndex], m.ImageKeys[len(m.ImageKeys)-1]); err != nil {
					return err
				}
			}
			iNdEx = postIndex
...
func (m *AdmissionControlSettings) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *ClusterLabels) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *AdmissionControlAlerts) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *AdmCtrlImageCacheInvalidation) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
