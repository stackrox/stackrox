...
func file_internalapi_sensor_image_iservice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internalapi_sensor_image_iservice_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_internalapi_sensor_image_iservice_proto_msgTypes[1].Exporter = func(v any, i int) any {
