...
var file_internalapi_sensor_network_connection_info_proto_rawDesc = string([]byte{
...
var (
	...
	file_internalapi_sensor_network_connection_info_proto_rawDescData []byte
)
...
func file_internalapi_sensor_network_connection_info_proto_rawDescGZIP() []byte {
	file_internalapi_sensor_network_connection_info_proto_rawDescOnce.Do(func() {
		file_internalapi_sensor_network_connection_info_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internalapi_sensor_network_connection_info_proto_rawDesc), len(file_internalapi_sensor_network_connection_info_proto_rawDesc)))
	})
