...
type NetworkEndpoint struct {
	...
	Originator           *storage.ProcessSignal `protobuf:"bytes,6,opt,name=originator,proto3" json:"originator,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *NetworkEndpoint) GetOriginator() *storage.ProcessSignal {
	if m != nil {
		return m.Originator
	}
	return nil
...
var fileDescriptor_d36d90689c926f7f = []byte{
	...
	,
}
...
func (m *NetworkEndpoint) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.Originator == nil {
				m.Originator = &storage.ProcessSignal{}
			}
