...
type NetworkFlowsControlMessage struct {
	...
	// Deprecated: Marked as deprecated in internalapi/sensor/network_connection_iservice.proto.
	...
	// Types that are assignable to Msg:
	//
	//	*NetworkFlowsControlMessage_PublicIpAddr
	//	*NetworkFlowsControlMessage_CidrBlocks
	//	*NetworkFlowsControlMessage_CollectorConfig
	Msg isNetworkFlowsControlMessage_Msg `protobuf_oneof:"msg"`
}
...
func (m *NetworkFlowsControlMessage) GetMsg() isNetworkFlowsControlMessage_Msg {
	if m != nil {
		return m.Msg
	}
	return nil
...
func (x *NetworkFlowsControlMessage) GetPublicIpAddr() *IPAddressList {
	if x, ok := x.GetMsg().(*NetworkFlowsControlMessage_PublicIpAddr); ok {
		return x.PublicIpAddr
	}
	return nil
}

func (x *NetworkFlowsControlMessage) GetCidrBlocks() *IPNetworkList {
	if x, ok := x.GetMsg().(*NetworkFlowsControlMessage_CidrBlocks); ok {
		return x.CidrBlocks
	}
	return nil
}

func (x *NetworkFlowsControlMessage) GetCollectorConfig() *CollectorConfig {
	if x, ok := x.GetMsg().(*NetworkFlowsControlMessage_CollectorConfig); ok {
		return x.CollectorConfig
	}
	return nil
}

type isNetworkFlowsControlMessage_Msg interface {
	isNetworkFlowsControlMessage_Msg()
}

type NetworkFlowsControlMessage_PublicIpAddr struct {
	PublicIpAddr *IPAddressList `protobuf:"bytes,3,opt,name=public_ip_addr,json=publicIpAddr,proto3,oneof"`
}

type NetworkFlowsControlMessage_CidrBlocks struct {
	CidrBlocks *IPNetworkList `protobuf:"bytes,4,opt,name=cidr_blocks,json=cidrBlocks,proto3,oneof"`
}

type NetworkFlowsControlMessage_CollectorConfig struct {
	CollectorConfig *CollectorConfig `protobuf:"bytes,5,opt,name=collector_config,json=collectorConfig,proto3,oneof"`
}

func (*NetworkFlowsControlMessage_PublicIpAddr) isNetworkFlowsControlMessage_Msg() {}

func (*NetworkFlowsControlMessage_CidrBlocks) isNetworkFlowsControlMessage_Msg() {}

func (*NetworkFlowsControlMessage_CollectorConfig) isNetworkFlowsControlMessage_Msg() {}
...
var file_internalapi_sensor_network_connection_iservice_proto_rawDesc = []byte{
	...
	0x67, 0x22, 0xe9, 0x02, 0x0a, 0x1a, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x46, 0x6c, 0x6f,
	0x77, 0x73, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x12, 0x49, 0x0a, 0x13, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x69, 0x70, 0x5f, 0x61, 0x64,
	...
	,
...
var file_internalapi_sensor_network_connection_iservice_proto_goTypes = []any{
	...
	(*CollectorConfig)(nil),              // 6: sensor.CollectorConfig
}
var file_internalapi_sensor_network_connection_iservice_proto_depIdxs = []int32{
	...
	2, // 4: sensor.NetworkFlowsControlMessage.public_ip_addr:type_name -> sensor.IPAddressList
	3, // 5: sensor.NetworkFlowsControlMessage.cidr_blocks:type_name -> sensor.IPNetworkList
	6, // 6: sensor.NetworkFlowsControlMessage.collector_config:type_name -> sensor.CollectorConfig
	0, // 7: sensor.NetworkConnectionInfoService.PushNetworkConnectionInfo:input_type -> sensor.NetworkConnectionInfoMessage
	1, // 8: sensor.NetworkConnectionInfoService.PushNetworkConnectionInfo:output_type -> sensor.NetworkFlowsControlMessage
...
func file_internalapi_sensor_network_connection_iservice_proto_init() {
	...
	file_internalapi_sensor_network_connection_iservice_proto_msgTypes[1].OneofWrappers = []any{
		(*NetworkFlowsControlMessage_PublicIpAddr)(nil),
		(*NetworkFlowsControlMessage_CidrBlocks)(nil),
		(*NetworkFlowsControlMessage_CollectorConfig)(nil),
	}
	type x struct{}
