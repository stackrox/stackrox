...
type MsgToCollector struct {
	...
	// Types that are assignable to Msg:
	//
	//	*MsgToCollector_CollectorConfig
...
func (x *MsgToCollector) GetCollectorConfig() *CollectorConfig {
	if x, ok := x.GetMsg().(*MsgToCollector_CollectorConfig); ok {
...
func (x *MsgToCollector) GetPublicIpAddresses() *IPAddressList {
	if x, ok := x.GetMsg().(*MsgToCollector_PublicIpAddresses); ok {
		return x.PublicIpAddresses
	}
	return nil
}
...
func (x *MsgToCollector) GetIpNetworks() *IPNetworkList {
	if x, ok := x.GetMsg().(*MsgToCollector_IpNetworks); ok {
		return x.IpNetworks
	}
	return nil
}
...
type MsgToCollector_CollectorConfig struct {
	CollectorConfig *CollectorConfig `protobuf:"bytes,1,opt,name=collector_config,json=collectorConfig,proto3,oneof"`
}

type MsgToCollector_PublicIpAddresses struct {
	PublicIpAddresses *IPAddressList `protobuf:"bytes,2,opt,name=public_ip_addresses,json=publicIpAddresses,proto3,oneof"`
}

type MsgToCollector_IpNetworks struct {
	IpNetworks *IPNetworkList `protobuf:"bytes,3,opt,name=ip_networks,json=ipNetworks,proto3,oneof"`
}

func (*MsgToCollector_CollectorConfig) isMsgToCollector_Msg() {}
...
func (x *IPNetworkList) Reset() {
	*x = IPNetworkList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_internalapi_sensor_network_connection_iservice_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*IPNetworkList) Descriptor() ([]byte, []int) {
	return file_internalapi_sensor_network_connection_iservice_proto_rawDescGZIP(), []int{4}
}
...
var file_internalapi_sensor_network_connection_iservice_proto_rawDesc = []byte{
	...
	0xe0, 0x01, 0x0a, 0x0e, 0x4d, 0x73, 0x67, 0x54, 0x6f, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x12, 0x44, 0x0a, 0x10, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x5f,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x73,
	0x65, 0x6e, 0x73, 0x6f, 0x72, 0x2e, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x43,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x48, 0x00, 0x52, 0x0f, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x47, 0x0a, 0x13, 0x70, 0x75, 0x62, 0x6c,
	...
	,
}
...
var file_internalapi_sensor_network_connection_iservice_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_internalapi_sensor_network_connection_iservice_proto_goTypes = []any{
	...
	(*MsgToCollector)(nil),               // 2: sensor.MsgToCollector
	(*IPAddressList)(nil),                // 3: sensor.IPAddressList
	(*IPNetworkList)(nil),                // 4: sensor.IPNetworkList
	(*CollectorRegisterRequest)(nil),     // 5: sensor.CollectorRegisterRequest
	(*NetworkConnectionInfo)(nil),        // 6: sensor.NetworkConnectionInfo
	(*CollectorConfig)(nil),              // 7: sensor.CollectorConfig
}
var file_internalapi_sensor_network_connection_iservice_proto_depIdxs = []int32{
	5, // 0: sensor.NetworkConnectionInfoMessage.register:type_name -> sensor.CollectorRegisterRequest
	6, // 1: sensor.NetworkConnectionInfoMessage.info:type_name -> sensor.NetworkConnectionInfo
	3, // 2: sensor.NetworkFlowsControlMessage.public_ip_addresses:type_name -> sensor.IPAddressList
	4, // 3: sensor.NetworkFlowsControlMessage.ip_networks:type_name -> sensor.IPNetworkList
	7, // 4: sensor.MsgToCollector.collector_config:type_name -> sensor.CollectorConfig
	3, // 5: sensor.MsgToCollector.public_ip_addresses:type_name -> sensor.IPAddressList
	4, // 6: sensor.MsgToCollector.ip_networks:type_name -> sensor.IPNetworkList
	0, // 7: sensor.NetworkConnectionInfoService.PushNetworkConnectionInfo:input_type -> sensor.NetworkConnectionInfoMessage
	0, // 8: sensor.NetworkConnectionInfoService.Communicate:input_type -> sensor.NetworkConnectionInfoMessage
	1, // 9: sensor.NetworkConnectionInfoService.PushNetworkConnectionInfo:output_type -> sensor.NetworkFlowsControlMessage
	2, // 10: sensor.NetworkConnectionInfoService.Communicate:output_type -> sensor.MsgToCollector
...
func file_internalapi_sensor_network_connection_iservice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internalapi_sensor_network_connection_iservice_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_internalapi_sensor_network_connection_iservice_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_internalapi_sensor_network_connection_iservice_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_internalapi_sensor_network_connection_iservice_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_internalapi_sensor_network_connection_iservice_proto_msgTypes[4].Exporter = func(v any, i int) any {
	...
	file_internalapi_sensor_network_connection_iservice_proto_msgTypes[2].OneofWrappers = []any{
		(*MsgToCollector_CollectorConfig)(nil),
