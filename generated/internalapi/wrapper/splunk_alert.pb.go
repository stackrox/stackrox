...
var file_internalapi_wrapper_splunk_alert_proto_rawDesc = []byte{
	...
	0x09, 0x5a, 0x07, 0x77, 0x72, 0x61, 0x70, 0x70, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_internalapi_wrapper_splunk_alert_proto_goTypes = []interface{}{
...
func file_internalapi_wrapper_splunk_alert_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internalapi_wrapper_splunk_alert_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SplunkEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
