...
func (this *VirtualMachine) EqualVT(that *VirtualMachine) bool {
	...
	if this.VsockCidSet != that.VsockCidSet {
		return false
	}
...
func (m *VirtualMachine) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VsockCidSet", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
