...
func file_internalapi_central_local_scanner_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internalapi_central_local_scanner_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_internalapi_central_local_scanner_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_internalapi_central_local_scanner_proto_msgTypes[2].Exporter = func(v any, i int) any {
