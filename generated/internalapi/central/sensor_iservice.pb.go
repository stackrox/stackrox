...
var file_internalapi_central_sensor_iservice_proto_rawDesc = []byte{
	...
	0x72, 0x28, 0x01, 0x30, 0x01, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x3b, 0x63, 0x65, 0x6e, 0x74,
...
func file_internalapi_central_sensor_iservice_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_internalapi_central_sensor_iservice_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internalapi_central_sensor_iservice_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internalapi_central_sensor_iservice_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
