...
var file_internalapi_central_sensor_iservice_proto_depIdxs = []int32{
	...
	50, // 43: central.MsgToSensor.issue_secured_cluster_certs_response:type_name -> central.IssueSecuredClusterCertsResponse
	11, // 44: central.DeduperState.resource_hashes:type_name -> central.DeduperState.ResourceHashesEntry
	...
	1,  // 51: central.SensorService.Communicate:input_type -> central.MsgFromSensor
