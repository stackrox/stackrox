...
type MsgToSensor struct {
	...
	//	*MsgToSensor_NotifierSync
	//	*MsgToSensor_TestNotifierRequest
	//	*MsgToSensor_SendNetworkPolicyYaml
	//	*MsgToSensor_UpdatedDelegatedRegistryConfig
...
type MsgToSensor_NotifierSync struct {
	NotifierSync *NotifierSync `protobuf:"bytes,20,opt,name=notifier_sync,json=notifierSync,proto3,oneof" json:"notifier_sync,omitempty"`
}
type MsgToSensor_TestNotifierRequest struct {
	TestNotifierRequest *TestNotifierRequest `protobuf:"bytes,21,opt,name=test_notifier_request,json=testNotifierRequest,proto3,oneof" json:"test_notifier_request,omitempty"`
}
type MsgToSensor_SendNetworkPolicyYaml struct {
	SendNetworkPolicyYaml *SendNetworkPolicyYamlRequest `protobuf:"bytes,22,opt,name=send_network_policy_yaml,json=sendNetworkPolicyYaml,proto3,oneof" json:"send_network_policy_yaml,omitempty"`
}
type MsgToSensor_UpdatedDelegatedRegistryConfig struct {
	UpdatedDelegatedRegistryConfig *DelegatedRegistryConfig `protobuf:"bytes,23,opt,name=updated_delegated_registry_config,json=updatedDelegatedRegistryConfig,proto3,oneof" json:"updated_delegated_registry_config,omitempty"`
}
type MsgToSensor_ScanImage struct {
	ScanImage *ScanImage `protobuf:"bytes,24,opt,name=scan_image,json=scanImage,proto3,oneof" json:"scan_image,omitempty"`
}
...
func (*MsgToSensor_NotifierSync) isMsgToSensor_Msg() {}
func (m *MsgToSensor_NotifierSync) Clone() isMsgToSensor_Msg {
	if m == nil {
		return nil
	}
	cloned := new(MsgToSensor_NotifierSync)
	*cloned = *m

	cloned.NotifierSync = m.NotifierSync.Clone()
	return cloned
}
func (*MsgToSensor_TestNotifierRequest) isMsgToSensor_Msg() {}
func (m *MsgToSensor_TestNotifierRequest) Clone() isMsgToSensor_Msg {
	if m == nil {
		return nil
	}
	cloned := new(MsgToSensor_TestNotifierRequest)
	*cloned = *m

	cloned.TestNotifierRequest = m.TestNotifierRequest.Clone()
	return cloned
}
func (*MsgToSensor_SendNetworkPolicyYaml) isMsgToSensor_Msg() {}
func (m *MsgToSensor_SendNetworkPolicyYaml) Clone() isMsgToSensor_Msg {
	if m == nil {
		return nil
	}
	cloned := new(MsgToSensor_SendNetworkPolicyYaml)
	*cloned = *m

	cloned.SendNetworkPolicyYaml = m.SendNetworkPolicyYaml.Clone()
	return cloned
}
func (*MsgToSensor_UpdatedDelegatedRegistryConfig) isMsgToSensor_Msg() {}
func (m *MsgToSensor_UpdatedDelegatedRegistryConfig) Clone() isMsgToSensor_Msg {
	if m == nil {
		return nil
	}
	cloned := new(MsgToSensor_UpdatedDelegatedRegistryConfig)
	*cloned = *m

	cloned.UpdatedDelegatedRegistryConfig = m.UpdatedDelegatedRegistryConfig.Clone()
	return cloned
}
...
func (m *MsgToSensor) GetNotifierSync() *NotifierSync {
	if x, ok := m.GetMsg().(*MsgToSensor_NotifierSync); ok {
		return x.NotifierSync
	}
	return nil
}

func (m *MsgToSensor) GetTestNotifierRequest() *TestNotifierRequest {
	if x, ok := m.GetMsg().(*MsgToSensor_TestNotifierRequest); ok {
		return x.TestNotifierRequest
	}
	return nil
}

func (m *MsgToSensor) GetSendNetworkPolicyYaml() *SendNetworkPolicyYamlRequest {
	if x, ok := m.GetMsg().(*MsgToSensor_SendNetworkPolicyYaml); ok {
		return x.SendNetworkPolicyYaml
	}
	return nil
}

func (m *MsgToSensor) GetUpdatedDelegatedRegistryConfig() *DelegatedRegistryConfig {
	if x, ok := m.GetMsg().(*MsgToSensor_UpdatedDelegatedRegistryConfig); ok {
		return x.UpdatedDelegatedRegistryConfig
	}
	return nil
}
...
func (*MsgToSensor) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*MsgToSensor_NotifierSync)(nil),
		(*MsgToSensor_TestNotifierRequest)(nil),
		(*MsgToSensor_SendNetworkPolicyYaml)(nil),
		(*MsgToSensor_UpdatedDelegatedRegistryConfig)(nil),
...
var fileDescriptor_9d0a66b7b73dbb5d = []byte{
	...
	,
}
...
func (m *MsgToSensor_NotifierSync) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgToSensor_NotifierSync) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *MsgToSensor_TestNotifierRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgToSensor_TestNotifierRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *MsgToSensor_SendNetworkPolicyYaml) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgToSensor_SendNetworkPolicyYaml) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SendNetworkPolicyYaml != nil {
		{
			size, err := m.SendNetworkPolicyYaml.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MsgToSensor_UpdatedDelegatedRegistryConfig) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgToSensor_UpdatedDelegatedRegistryConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.UpdatedDelegatedRegistryConfig != nil {
		{
			size, err := m.UpdatedDelegatedRegistryConfig.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MsgToSensor_NotifierSync) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgToSensor_TestNotifierRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgToSensor_SendNetworkPolicyYaml) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SendNetworkPolicyYaml != nil {
		l = m.SendNetworkPolicyYaml.Size()
		n += 2 + l + sovSensorIservice(uint64(l))
	}
	return n
}
func (m *MsgToSensor_UpdatedDelegatedRegistryConfig) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.UpdatedDelegatedRegistryConfig != nil {
		l = m.UpdatedDelegatedRegistryConfig.Size()
		n += 2 + l + sovSensorIservice(uint64(l))
	}
	return n
}
...
func (m *MsgToSensor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			...
			m.Msg = &MsgToSensor_NotifierSync{v}
			iNdEx = postIndex
		case 21:
			if wireType != 2 {
			...
			v := &TestNotifierRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Msg = &MsgToSensor_TestNotifierRequest{v}
			iNdEx = postIndex
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SendNetworkPolicyYaml", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &SendNetworkPolicyYamlRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Msg = &MsgToSensor_SendNetworkPolicyYaml{v}
			iNdEx = postIndex
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UpdatedDelegatedRegistryConfig", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Msg = &MsgToSensor_UpdatedDelegatedRegistryConfig{v}
			iNdEx = postIndex
		case 24:
			if wireType != 2 {
