...
func (x *ServiceCertAuth) ProtoReflect() protoreflect.Message {
	file_internalapi_central_auth_proto_init_ensure()
	mi := &file_internalapi_central_auth_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
const file_internalapi_central_auth_proto_rawDesc = "" +
	"\n" +
	"\x1einternalapi/central/auth.proto\x12\acentral\x1a\x1fgoogle/protobuf/timestamp.proto\"k\n" +
	"\x0fServiceCertAuth\x12\x19\n" +
	"\bcert_der\x18\x01 \x01(\fR\acertDer\x12=\n" +
	"\fcurrent_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\vcurrentTimeB\x1fZ\x1d./internalapi/central;centralb\x06proto3"
...
var file_internalapi_central_auth_proto_init_once sync.Once
func file_internalapi_central_auth_proto_init_ensure() { file_internalapi_central_auth_proto_init_once.Do(file_internalapi_central_auth_proto_init) }
