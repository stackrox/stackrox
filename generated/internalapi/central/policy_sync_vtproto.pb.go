...
func (m *PolicySync) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *PolicySync) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*PolicySync)
	if !ok {
		return false
	}
...
func (m *PolicySync) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
