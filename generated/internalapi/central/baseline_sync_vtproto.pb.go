...
func (m *BaselineSync) CloneVT() *BaselineSync {
	if m == nil {
		return (*BaselineSync)(nil)
	}
	r := new(BaselineSync)
...
func (m *BaselineSync) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (this *BaselineSync) EqualVT(that *BaselineSync) bool {
	if this == that {
		return true
...
func (this *BaselineSync) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*BaselineSync)
	if !ok {
		return false
	}
...
func (m *BaselineSync) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *BaselineSync) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *BaselineSync) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BaselineSync) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
