...
var file_internalapi_central_image_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x49, 0x64, 0x73, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x3b, 0x63, 0x65, 0x6e,
...
var file_internalapi_central_image_proto_goTypes = []interface{}{
...
func file_internalapi_central_image_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internalapi_central_image_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internalapi_central_image_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
