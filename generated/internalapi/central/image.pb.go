...
var file_internalapi_central_image_proto_rawDesc = []byte{
...
var (
	...
	file_internalapi_central_image_proto_rawDescData = file_internalapi_central_image_proto_rawDesc
)

func file_internalapi_central_image_proto_rawDescGZIP() []byte {
	file_internalapi_central_image_proto_rawDescOnce.Do(func() {
		file_internalapi_central_image_proto_rawDescData = protoimpl.X.CompressGZIP(file_internalapi_central_image_proto_rawDescData)
	})
...
func file_internalapi_central_image_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internalapi_central_image_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_internalapi_central_image_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*ImageIntegrations); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_internalapi_central_image_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_internalapi_central_image_proto_rawDesc = nil
