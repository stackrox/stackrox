...
func (x *ScanImage) ProtoReflect() protoreflect.Message {
	file_internalapi_central_image_proto_init_ensure()
	mi := &file_internalapi_central_image_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
var file_internalapi_central_image_proto_init_once sync.Once
func file_internalapi_central_image_proto_init_ensure() { file_internalapi_central_image_proto_init_once.Do(file_internalapi_central_image_proto_init) }
func init() {} // proto registration is lazy — triggered by first ProtoReflect() call
func file_internalapi_central_image_proto_init() {
	if File_internalapi_central_image_proto != nil || skipProtoInit {
		return
	}
	type x struct{}
