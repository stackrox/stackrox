...
type SensorEvent struct {
	...
	// Types that are valid to be assigned to HasHash:
	//	*SensorEvent_Hash
	HasHash isSensorEvent_HasHash `protobuf_oneof:"has_hash"`
	...
	//	*SensorEvent_Checkpoint
	//	*SensorEvent_ReconciliationEvent_
...
type isSensorEvent_HasHash interface {
	isSensorEvent_HasHash()
	MarshalTo([]byte) (int, error)
	Size() int
	Clone() isSensorEvent_HasHash
}
...
type SensorEvent_Hash struct {
	Hash uint64 `protobuf:"varint,25,opt,name=hash,proto3,oneof" json:"hash,omitempty"`
}
...
type SensorEvent_Checkpoint struct {
	Checkpoint *SensorEvent_ResourceCheckpoint `protobuf:"bytes,26,opt,name=checkpoint,proto3,oneof" json:"checkpoint,omitempty"`
}
type SensorEvent_ReconciliationEvent_ struct {
	ReconciliationEvent *SensorEvent_ReconciliationEvent `protobuf:"bytes,27,opt,name=reconciliation_event,json=reconciliationEvent,proto3,oneof" json:"reconciliation_event,omitempty"`
}

func (*SensorEvent_Hash) isSensorEvent_HasHash() {}
func (m *SensorEvent_Hash) Clone() isSensorEvent_HasHash {
	if m == nil {
		return nil
	}
	cloned := new(SensorEvent_Hash)
	*cloned = *m
...
func (*SensorEvent_Checkpoint) isSensorEvent_Resource() {}
func (m *SensorEvent_Checkpoint) Clone() isSensorEvent_Resource {
	if m == nil {
		return nil
	}
	cloned := new(SensorEvent_Checkpoint)
	*cloned = *m

	cloned.Checkpoint = m.Checkpoint.Clone()
	return cloned
}
func (*SensorEvent_ReconciliationEvent_) isSensorEvent_Resource() {}
func (m *SensorEvent_ReconciliationEvent_) Clone() isSensorEvent_Resource {
	if m == nil {
		return nil
	}
	cloned := new(SensorEvent_ReconciliationEvent_)
	*cloned = *m

	cloned.ReconciliationEvent = m.ReconciliationEvent.Clone()
	return cloned
}

func (m *SensorEvent) GetHasHash() isSensorEvent_HasHash {
	if m != nil {
		return m.HasHash
	}
	return nil
...
func (m *SensorEvent) GetHash() uint64 {
	if x, ok := m.GetHasHash().(*SensorEvent_Hash); ok {
		return x.Hash
	}
	return 0
}
...
func (m *SensorEvent) GetCheckpoint() *SensorEvent_ResourceCheckpoint {
	if x, ok := m.GetResource().(*SensorEvent_Checkpoint); ok {
		return x.Checkpoint
	}
	return nil
}

func (m *SensorEvent) GetReconciliationEvent() *SensorEvent_ReconciliationEvent {
	if x, ok := m.GetResource().(*SensorEvent_ReconciliationEvent_); ok {
		return x.ReconciliationEvent
	}
	return nil
}
...
func (*SensorEvent) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*SensorEvent_Checkpoint)(nil),
		(*SensorEvent_ReconciliationEvent_)(nil),
	}
}
...
func (m *SensorEvent) Clone() *SensorEvent {
	...
	*cloned = *m
	...
	if m.HasHash != nil {
		cloned.HasHash = m.HasHash.Clone()
	}
...
type SensorEvent_ResourceCheckpoint struct {
	Id                   string   `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *SensorEvent_ResourceCheckpoint) Reset()         { *m = SensorEvent_ResourceCheckpoint{} }
func (m *SensorEvent_ResourceCheckpoint) String() string { return proto.CompactTextString(m) }
func (*SensorEvent_ResourceCheckpoint) ProtoMessage()    {}
func (*SensorEvent_ResourceCheckpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_6ea3082f8d4cc74c, []int{3, 1}
}
func (m *SensorEvent_ResourceCheckpoint) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SensorEvent_ResourceCheckpoint) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SensorEvent_ResourceCheckpoint.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SensorEvent_ResourceCheckpoint) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SensorEvent_ResourceCheckpoint.Merge(m, src)
}
func (m *SensorEvent_ResourceCheckpoint) XXX_Size() int {
	return m.Size()
}
func (m *SensorEvent_ResourceCheckpoint) XXX_DiscardUnknown() {
	xxx_messageInfo_SensorEvent_ResourceCheckpoint.DiscardUnknown(m)
}

var xxx_messageInfo_SensorEvent_ResourceCheckpoint proto.InternalMessageInfo

func (m *SensorEvent_ResourceCheckpoint) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *SensorEvent_ResourceCheckpoint) MessageClone() proto.Message {
	return m.Clone()
}
func (m *SensorEvent_ResourceCheckpoint) Clone() *SensorEvent_ResourceCheckpoint {
	if m == nil {
		return nil
	}
	cloned := new(SensorEvent_ResourceCheckpoint)
	*cloned = *m

	return cloned
}

type SensorEvent_ReconciliationEvent struct {
	Id                   string   `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
...
func (m *SensorEvent_ReconciliationEvent) Reset()         { *m = SensorEvent_ReconciliationEvent{} }
func (m *SensorEvent_ReconciliationEvent) String() string { return proto.CompactTextString(m) }
func (*SensorEvent_ReconciliationEvent) ProtoMessage()    {}
func (*SensorEvent_ReconciliationEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_6ea3082f8d4cc74c, []int{3, 2}
}
func (m *SensorEvent_ReconciliationEvent) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SensorEvent_ReconciliationEvent) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SensorEvent_ReconciliationEvent.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SensorEvent_ReconciliationEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SensorEvent_ReconciliationEvent.Merge(m, src)
}
func (m *SensorEvent_ReconciliationEvent) XXX_Size() int {
	return m.Size()
}
func (m *SensorEvent_ReconciliationEvent) XXX_DiscardUnknown() {
	xxx_messageInfo_SensorEvent_ReconciliationEvent.DiscardUnknown(m)
}

var xxx_messageInfo_SensorEvent_ReconciliationEvent proto.InternalMessageInfo

func (m *SensorEvent_ReconciliationEvent) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *SensorEvent_ReconciliationEvent) GetType() string {
	if m != nil {
		return m.Type
	}
	return ""
...
func (m *SensorEvent_ReconciliationEvent) MessageClone() proto.Message {
	return m.Clone()
}
func (m *SensorEvent_ReconciliationEvent) Clone() *SensorEvent_ReconciliationEvent {
	if m == nil {
		return nil
	}
	cloned := new(SensorEvent_ReconciliationEvent)
	*cloned = *m
...
func init() {
	...
	proto.RegisterType((*SensorEvent_ResourceCheckpoint)(nil), "central.SensorEvent.ResourceCheckpoint")
	proto.RegisterType((*SensorEvent_ReconciliationEvent)(nil), "central.SensorEvent.ReconciliationEvent")
...
var fileDescriptor_6ea3082f8d4cc74c = []byte{
	...
	,
}
	...
	if m.HasHash != nil {
		{
			size := m.HasHash.Size()
			i -= size
			if _, err := m.HasHash.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *SensorEvent_Hash) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SensorEvent_Hash) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarintSensorEvents(dAtA, i, uint64(m.Hash))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0xc8
...
func (m *SensorEvent_Checkpoint) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SensorEvent_Checkpoint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Checkpoint != nil {
		{
...
func (m *SensorEvent_ReconciliationEvent_) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SensorEvent_ReconciliationEvent_) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ReconciliationEvent != nil {
		{
			size, err := m.ReconciliationEvent.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SensorEvent_ResourceCheckpoint) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SensorEvent_ResourceCheckpoint) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SensorEvent_ResourceCheckpoint) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *SensorEvent_ReconciliationEvent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SensorEvent_ReconciliationEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SensorEvent_ReconciliationEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Type) > 0 {
		i -= len(m.Type)
		copy(dAtA[i:], m.Type)
		i = encodeVarintSensorEvents(dAtA, i, uint64(len(m.Type)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Id) > 0 {
...
func (m *SensorEvent_Hash) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 2 + sovSensorEvents(uint64(m.Hash))
	return n
}
func (m *SensorEvent_Checkpoint) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SensorEvent_ReconciliationEvent_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SensorEvent_ResourceCheckpoint) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SensorEvent_ReconciliationEvent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SensorEvent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			...
			v := &SensorEvent_ResourceCheckpoint{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Resource = &SensorEvent_Checkpoint{v}
			iNdEx = postIndex
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReconciliationEvent", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &SensorEvent_ReconciliationEvent{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Resource = &SensorEvent_ReconciliationEvent_{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSensorEvents(dAtA[iNdEx:])
...
func (m *SensorEvent_ResourceCheckpoint) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *SensorEvent_ReconciliationEvent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReconciliationEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReconciliationEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
