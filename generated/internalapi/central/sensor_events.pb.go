...
const (
	...
	AlertResults_NODE_EVENT       AlertResults_Source = 2
)
...
func (x *SensorEvent) GetAiWorkload() *v11.AIWorkload {
	if x != nil {
		if x, ok := x.Resource.(*SensorEvent_AiWorkload); ok {
			return x.AiWorkload
		}
	}
	return nil
...
type SensorEvent_AiWorkload struct {
	AiWorkload *v11.AIWorkload `protobuf:"bytes,37,opt,name=ai_workload,json=aiWorkload,proto3,oneof"`
}
...
func (*SensorEvent_AiWorkload) isSensorEvent_Resource() {}
...
const file_internalapi_central_sensor_events_proto_rawDesc = "" +
	...
	"\x0fvirtual_machine\x18$ \x01(\v2!.virtualmachine.v1.VirtualMachineH\x01R\x0evirtualMachine\x12<\n" +
	"\vai_workload\x18% \x01(\v2\x19.aiworkload.v1.AIWorkloadH\x01R\n" +
	"aiWorkload\x12m\n" +
...
var file_internalapi_central_sensor_events_proto_goTypes = []any{
	...
	(*v11.AIWorkload)(nil),                               // 47: aiworkload.v1.AIWorkload
	(*ComplianceOperatorCheckResultV2)(nil),              // 48: central.ComplianceOperatorCheckResultV2
	(*ComplianceOperatorProfileV2)(nil),                  // 49: central.ComplianceOperatorProfileV2
	(*ComplianceOperatorRuleV2)(nil),                     // 50: central.ComplianceOperatorRuleV2
	(*ComplianceOperatorScanV2)(nil),                     // 51: central.ComplianceOperatorScanV2
	(*ComplianceOperatorScanSettingBindingV2)(nil),       // 52: central.ComplianceOperatorScanSettingBindingV2
	(*ComplianceOperatorSuiteV2)(nil),                    // 53: central.ComplianceOperatorSuiteV2
	(*ComplianceOperatorRemediationV2)(nil),              // 54: central.ComplianceOperatorRemediationV2
	(storage.EnforcementAction)(0),                       // 55: storage.EnforcementAction
	(*compliance.ComplianceReturn)(nil),                  // 56: compliance.ComplianceReturn
	(*storage.NetworkPolicyModification)(nil),            // 57: storage.NetworkPolicyModification
}
var file_internalapi_central_sensor_events_proto_depIdxs = []int32{
	...
	47, // 30: central.SensorEvent.ai_workload:type_name -> aiworkload.v1.AIWorkload
	48, // 31: central.SensorEvent.compliance_operator_result_v2:type_name -> central.ComplianceOperatorCheckResultV2
	49, // 32: central.SensorEvent.compliance_operator_profile_v2:type_name -> central.ComplianceOperatorProfileV2
	50, // 33: central.SensorEvent.compliance_operator_rule_v2:type_name -> central.ComplianceOperatorRuleV2
	51, // 34: central.SensorEvent.compliance_operator_scan_v2:type_name -> central.ComplianceOperatorScanV2
	52, // 35: central.SensorEvent.compliance_operator_scan_setting_binding_v2:type_name -> central.ComplianceOperatorScanSettingBindingV2
	53, // 36: central.SensorEvent.compliance_operator_suite_v2:type_name -> central.ComplianceOperatorSuiteV2
	54, // 37: central.SensorEvent.compliance_operator_remediation_v2:type_name -> central.ComplianceOperatorRemediationV2
	55, // 38: central.SensorEnforcement.enforcement:type_name -> storage.EnforcementAction
	7,  // 39: central.SensorEnforcement.deployment:type_name -> central.DeploymentEnforcement
	8,  // 40: central.SensorEnforcement.container_instance:type_name -> central.ContainerInstanceEnforcement
	7,  // 41: central.ContainerInstanceEnforcement.deployment_enforcement:type_name -> central.DeploymentEnforcement
	10, // 42: central.ScrapeCommand.start_scrape:type_name -> central.StartScrape
	11, // 43: central.ScrapeCommand.kill_scrape:type_name -> central.KillScrape
	56, // 44: central.ScrapeUpdate.compliance_return:type_name -> compliance.ComplianceReturn
	13, // 45: central.ScrapeUpdate.scrape_started:type_name -> central.ScrapeStarted
	14, // 46: central.ScrapeUpdate.scrape_killed:type_name -> central.ScrapeKilled
	19, // 47: central.NetworkPoliciesCommand.payload:type_name -> central.NetworkPoliciesCommand.Payload
	22, // 48: central.NetworkPoliciesResponse.payload:type_name -> central.NetworkPoliciesResponse.Payload
	57, // 49: central.NetworkPoliciesCommand.Apply.modification:type_name -> storage.NetworkPolicyModification
	18, // 50: central.NetworkPoliciesCommand.Payload.apply:type_name -> central.NetworkPoliciesCommand.Apply
	57, // 51: central.NetworkPoliciesResponse.Apply.undo_modification:type_name -> storage.NetworkPolicyModification
	21, // 52: central.NetworkPoliciesResponse.Payload.error:type_name -> central.NetworkPoliciesResponse.Error
	20, // 53: central.NetworkPoliciesResponse.Payload.apply:type_name -> central.NetworkPoliciesResponse.Apply
