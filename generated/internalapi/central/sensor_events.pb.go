...
const (
	...
	AlertResults_SECURITY_EVENT   AlertResults_Source = 3
)
...
const file_internalapi_central_sensor_events_proto_rawDesc = "" +
	...
	"\rdeployment_id\x18\x01 \x01(\tR\fdeploymentId\"\x95\x02\n" +
	"\fAlertResults\x12#\n" +
	...
	"\x06source\x18\x04 \x01(\x0e2\x1c.central.AlertResults.SourceR\x06source\"S\n" +
	"\x06Source\x12\x14\n" +
	"\x10DEPLOYMENT_EVENT\x10\x00\x12\x0f\n" +
	"\vAUDIT_EVENT\x10\x01\x12\x0e\n" +
	"\n" +
	"NODE_EVENT\x10\x02\x12\x12\n" +
	"\x0eSECURITY_EVENT\x10\x03\"Z\n" +
	"\x06Timing\x12\x1e\n" +
	"\n" +
