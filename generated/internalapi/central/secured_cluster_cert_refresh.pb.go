...
func file_internalapi_central_secured_cluster_cert_refresh_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internalapi_central_secured_cluster_cert_refresh_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*SecuredClusterCertsIssueError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_internalapi_central_secured_cluster_cert_refresh_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*IssueSecuredClusterCertsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_internalapi_central_secured_cluster_cert_refresh_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*IssueSecuredClusterCertsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
