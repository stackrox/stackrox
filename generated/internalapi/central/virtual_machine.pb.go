...
func (SourceType) Descriptor() protoreflect.EnumDescriptor {
	return file_internalapi_central_virtual_machine_proto_enumTypes[0].Descriptor()
}

func (SourceType) Type() protoreflect.EnumType {
	return &file_internalapi_central_virtual_machine_proto_enumTypes[0]
}
...
func (x *License) Reset() {
	*x = License{}
	mi := &file_internalapi_central_virtual_machine_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*License) Descriptor() ([]byte, []int) {
	return file_internalapi_central_virtual_machine_proto_rawDescGZIP(), []int{1}
}
...
type VirtualMachineComponent struct {
	...
	Source        SourceType             `protobuf:"varint,4,opt,name=source,proto3,enum=central.SourceType" json:"source,omitempty"`
...
func (x *VirtualMachineComponent) Reset() {
	*x = VirtualMachineComponent{}
	mi := &file_internalapi_central_virtual_machine_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VirtualMachineComponent) Descriptor() ([]byte, []int) {
	return file_internalapi_central_virtual_machine_proto_rawDescGZIP(), []int{2}
}
...
const file_internalapi_central_virtual_machine_proto_rawDesc = "" +
	"\n" +
	")internalapi/central/virtual_machine.proto\x12\acentral\"\xca\x02\n" +
	...
	"\x05facts\x18\x06 \x03(\v2\".central.VirtualMachine.FactsEntryR\x05facts\x12@\n" +
	"\n" +
	"components\x18\a \x03(\v2 .central.VirtualMachineComponentR\n" +
	"components\x1a8\n" +
	"\n" +
	"FactsEntry\x12\x10\n" +
	...
	"\alicense\x18\x03 \x01(\v2\x10.central.LicenseR\alicense\x12+\n" +
	"\x06source\x18\x04 \x01(\x0e2\x13.central.SourceTypeR\x06source\x12\x1a\n" +
	...
	"\x0eINFRASTRUCTURE\x10\x06B\x1fZ\x1d./internalapi/central;centralb\x06proto3"
...
var file_internalapi_central_virtual_machine_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_internalapi_central_virtual_machine_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_internalapi_central_virtual_machine_proto_goTypes = []any{
	(SourceType)(0),                 // 0: central.SourceType
	(*VirtualMachine)(nil),          // 1: central.VirtualMachine
	(*License)(nil),                 // 2: central.License
	(*VirtualMachineComponent)(nil), // 3: central.VirtualMachineComponent
	nil,                             // 4: central.VirtualMachine.FactsEntry
}
var file_internalapi_central_virtual_machine_proto_depIdxs = []int32{
	4, // 0: central.VirtualMachine.facts:type_name -> central.VirtualMachine.FactsEntry
	3, // 1: central.VirtualMachine.components:type_name -> central.VirtualMachineComponent
	2, // 2: central.VirtualMachineComponent.license:type_name -> central.License
	0, // 3: central.VirtualMachineComponent.source:type_name -> central.SourceType
...
func file_internalapi_central_virtual_machine_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_internalapi_central_virtual_machine_proto_enumTypes,
