...
var file_internalapi_scanner_v4_index_report_proto_rawDesc = []byte{
	...
	0x08, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b,
...
var file_internalapi_scanner_v4_index_report_proto_goTypes = []interface{}{
...
func file_internalapi_scanner_v4_index_report_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internalapi_scanner_v4_index_report_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IndexReport); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
