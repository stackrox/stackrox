...
func (b0 GetVulnerabilitiesRequest_builder) Build() *GetVulnerabilitiesRequest {
...
func (b0 GetSBOMRequest_builder) Build() *GetSBOMRequest {
	m0 := &GetSBOMRequest{}
	b, x := &b0, m0
	_, _ = b, x
	x.Id = b.Id
...
func (x *GetSBOMResponse) SetSbom(v []byte) {
	if v == nil {
		v = []byte{}
	}
	x.Sbom = v
...
func (b0 GetSBOMResponse_builder) Build() *GetSBOMResponse {
	m0 := &GetSBOMResponse{}
	b, x := &b0, m0
	_, _ = b, x
	x.Sbom = b.Sbom
...
type Metadata_builder struct {
	...
	LastVulnerabilityUpdate *timestamppb.Timestamp
}
...
const file_internalapi_scanner_v4_matcher_service_proto_rawDesc = "" +
	...
	"scanner.v4\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a#internalapi/scanner/v4/common.proto\x1a1internalapi/scanner/v4/vulnerability_report.proto\x1a!google/protobuf/go_features.proto\"f\n" +
	...
	"\aGetSBOM\x12\x1a.scanner.v4.GetSBOMRequest\x1a\x1b.scanner.v4.GetSBOMResponseB%Z\x1b./internalapi/scanner/v4;v4\x92\x03\x05\xd2>\x02\x10\x02b\beditionsp\xe8\a"
