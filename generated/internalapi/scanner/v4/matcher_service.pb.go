...
func file_internalapi_scanner_v4_matcher_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internalapi_scanner_v4_matcher_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_internalapi_scanner_v4_matcher_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
