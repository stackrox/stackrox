...
var file_internalapi_scanner_v4_matcher_service_proto_rawDesc = []byte{
	...
	0x61, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x76, 0x34, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_internalapi_scanner_v4_matcher_service_proto_goTypes = []interface{}{
...
func file_internalapi_scanner_v4_matcher_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internalapi_scanner_v4_matcher_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internalapi_scanner_v4_matcher_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
