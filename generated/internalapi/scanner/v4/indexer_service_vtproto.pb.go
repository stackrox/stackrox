...
func (m *AddWatchedBaseImageResponse) CloneVT() *AddWatchedBaseImageResponse {
	if m == nil {
		return (*AddWatchedBaseImageResponse)(nil)
	}
	r := new(AddWatchedBaseImageResponse)
	r.Id = m.Id
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *AddWatchedBaseImageResponse) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *AddWatchedBaseImageResponse) EqualVT(that *AddWatchedBaseImageResponse) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *AddWatchedBaseImageResponse) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*AddWatchedBaseImageResponse)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *AddWatchedBaseImageResponse) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *AddWatchedBaseImageResponse) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *AddWatchedBaseImageResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *AddWatchedBaseImageResponse) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AddWatchedBaseImageResponse) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AddWatchedBaseImageResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AddWatchedBaseImageResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *AddWatchedBaseImageResponse) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
