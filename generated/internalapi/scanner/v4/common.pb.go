...
var file_internalapi_scanner_v4_common_proto_rawDesc = []byte{
	...
	0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f,
...
var file_internalapi_scanner_v4_common_proto_goTypes = []interface{}{
...
func file_internalapi_scanner_v4_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_internalapi_scanner_v4_common_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internalapi_scanner_v4_common_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internalapi_scanner_v4_common_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NormalizedVersion); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_internalapi_scanner_v4_common_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internalapi_scanner_v4_common_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internalapi_scanner_v4_common_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_internalapi_scanner_v4_common_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Environment_List); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
