...
var (
	filter_ProcessBaselineService_GetLoadProcessBaseline_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_ProcessBaselineService_GetLoadProcessBaseline_0(ctx context.Context, marshaler runtime.Marshaler, client ProcessBaselineServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetProcessBaselineRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ProcessBaselineService_GetLoadProcessBaseline_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.GetLoadProcessBaseline(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ProcessBaselineService_GetLoadProcessBaseline_0(ctx context.Context, marshaler runtime.Marshaler, server ProcessBaselineServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetProcessBaselineRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetLoadProcessBaseline(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterProcessBaselineServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProcessBaselineServiceServer) error {
	...
	mux.Handle("GET", pattern_ProcessBaselineService_GetLoadProcessBaseline_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_ProcessBaselineService_GetLoadProcessBaseline_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ProcessBaselineService_GetLoadProcessBaseline_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterProcessBaselineServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProcessBaselineServiceClient) error {
	...
	mux.Handle("GET", pattern_ProcessBaselineService_GetLoadProcessBaseline_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ProcessBaselineService_GetLoadProcessBaseline_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ProcessBaselineService_GetLoadProcessBaseline_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "processbaselines", "lazy", "key"}, "", runtime.AssumeColonVerbOpt(false)))
...
var (
	...
	forward_ProcessBaselineService_GetLoadProcessBaseline_0 = runtime.ForwardResponseMessage
