...
func RegisterGRPCPreferencesServiceServer(s grpc.ServiceRegistrar, srv GRPCPreferencesServiceServer) {
	// If the following call panics, it indicates UnimplementedGRPCPreferencesServiceServer was
...
func _GRPCPreferencesService_Get_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
	in := new(Empty)
