...
type ScanImageInternalRequest struct {
	...
	PullSecrets          []string                `protobuf:"bytes,6,rep,name=pull_secrets,json=pullSecrets,proto3" json:"pull_secrets,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func (m *ScanImageInternalRequest) GetPullSecrets() []string {
	if m != nil {
		return m.PullSecrets
	}
	return nil
}
...
func (m *ScanImageInternalRequest) Clone() *ScanImageInternalRequest {
	...
	*cloned = *m
	...
	if m.PullSecrets != nil {
		cloned.PullSecrets = make([]string, len(m.PullSecrets))
		copy(cloned.PullSecrets, m.PullSecrets)
	}
	return cloned
}
...
var fileDescriptor_b4306cfe43028263 = []byte{
	...
	,
}
...
func (m *ScanImageInternalRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PullSecrets) > 0 {
		for iNdEx := len(m.PullSecrets) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.PullSecrets[iNdEx])
			copy(dAtA[i:], m.PullSecrets[iNdEx])
			i = encodeVarintImageService(dAtA, i, uint64(len(m.PullSecrets[iNdEx])))
			i--
			dAtA[i] = 0x32
		}
	}
...
func (m *ScanImageInternalRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PullSecrets", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PullSecrets = append(m.PullSecrets, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipImageService(dAtA[iNdEx:])
