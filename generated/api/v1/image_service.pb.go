...
type EnrichLocalImageInternalRequest struct {
	...
	ImageName            *storage.ImageName      `protobuf:"bytes,2,opt,name=image_name,json=imageName,proto3" json:"image_name,omitempty"`
	Metadata             *storage.ImageMetadata  `protobuf:"bytes,3,opt,name=metadata,proto3" json:"metadata,omitempty"`
	IsClusterLocal       bool                    `protobuf:"varint,4,opt,name=is_cluster_local,json=isClusterLocal,proto3" json:"is_cluster_local,omitempty"`
	...
	ImageSignature       *storage.ImageSignature `protobuf:"bytes,7,opt,name=image_signature,json=imageSignature,proto3" json:"image_signature,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}
...
func (m *EnrichLocalImageInternalRequest) GetIsClusterLocal() bool {
	if m != nil {
		return m.IsClusterLocal
	}
	return false
...
var fileDescriptor_b4306cfe43028263 = []byte{
	...
	,
}
