...
type VerifyImageSignaturesInternalRequest struct {
	ImageId              string                  `protobuf:"bytes,1,opt,name=image_id,json=imageId,proto3" json:"image_id,omitempty"`
	ImageName            *storage.ImageName      `protobuf:"bytes,2,opt,name=image_name,json=imageName,proto3" json:"image_name,omitempty"`
	...
	IsClusterLocal       bool                    `protobuf:"varint,5,opt,name=is_cluster_local,json=isClusterLocal,proto3" json:"is_cluster_local,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}

func (m *VerifyImageSignaturesInternalRequest) Reset()         { *m = VerifyImageSignaturesInternalRequest{} }
func (m *VerifyImageSignaturesInternalRequest) String() string { return proto.CompactTextString(m) }
func (*VerifyImageSignaturesInternalRequest) ProtoMessage()    {}
func (*VerifyImageSignaturesInternalRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_b4306cfe43028263, []int{7}
}
func (m *VerifyImageSignaturesInternalRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VerifyImageSignaturesInternalRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VerifyImageSignaturesInternalRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VerifyImageSignaturesInternalRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VerifyImageSignaturesInternalRequest.Merge(m, src)
}
func (m *VerifyImageSignaturesInternalRequest) XXX_Size() int {
	return m.Size()
}
func (m *VerifyImageSignaturesInternalRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_VerifyImageSignaturesInternalRequest.DiscardUnknown(m)
}

var xxx_messageInfo_VerifyImageSignaturesInternalRequest proto.InternalMessageInfo

func (m *VerifyImageSignaturesInternalRequest) GetImageId() string {
	if m != nil {
		return m.ImageId
	}
	return ""
...
func (m *VerifyImageSignaturesInternalRequest) GetImageName() *storage.ImageName {
	if m != nil {
		return m.ImageName
	}
	return nil
...
func (m *VerifyImageSignaturesInternalRequest) GetImageSignature() *storage.ImageSignature {
	if m != nil {
...
func (m *VerifyImageSignaturesInternalRequest) GetIsClusterLocal() bool {
	if m != nil {
		return m.IsClusterLocal
	}
	return false
...
func (m *VerifyImageSignaturesInternalRequest) MessageClone() proto.Message {
	return m.Clone()
}
func (m *VerifyImageSignaturesInternalRequest) Clone() *VerifyImageSignaturesInternalRequest {
	if m == nil {
		return nil
	}
	cloned := new(VerifyImageSignaturesInternalRequest)
	*cloned = *m
...
type VerifyImageSignaturesInternalResponse struct {
	Image                *storage.Image `protobuf:"bytes,1,opt,name=image,proto3" json:"image,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
...
func (m *VerifyImageSignaturesInternalResponse) Reset()         { *m = VerifyImageSignaturesInternalResponse{} }
func (m *VerifyImageSignaturesInternalResponse) String() string { return proto.CompactTextString(m) }
func (*VerifyImageSignaturesInternalResponse) ProtoMessage()    {}
func (*VerifyImageSignaturesInternalResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_b4306cfe43028263, []int{8}
}
func (m *VerifyImageSignaturesInternalResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VerifyImageSignaturesInternalResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VerifyImageSignaturesInternalResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VerifyImageSignaturesInternalResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VerifyImageSignaturesInternalResponse.Merge(m, src)
}
func (m *VerifyImageSignaturesInternalResponse) XXX_Size() int {
	return m.Size()
}
func (m *VerifyImageSignaturesInternalResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_VerifyImageSignaturesInternalResponse.DiscardUnknown(m)
}

var xxx_messageInfo_VerifyImageSignaturesInternalResponse proto.InternalMessageInfo

func (m *VerifyImageSignaturesInternalResponse) GetImage() *storage.Image {
	if m != nil {
		return m.Image
	}
	return nil
...
func (m *VerifyImageSignaturesInternalResponse) MessageClone() proto.Message {
	return m.Clone()
}
func (m *VerifyImageSignaturesInternalResponse) Clone() *VerifyImageSignaturesInternalResponse {
	if m == nil {
		return nil
	}
	cloned := new(VerifyImageSignaturesInternalResponse)
	*cloned = *m
...
var fileDescriptor_b4306cfe43028263 = []byte{
	...
	,
}
...
func (m *VerifyImageSignaturesInternalRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VerifyImageSignaturesInternalRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VerifyImageSignaturesInternalRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VerifyImageSignaturesInternalResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VerifyImageSignaturesInternalResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VerifyImageSignaturesInternalResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VerifyImageSignaturesInternalRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VerifyImageSignaturesInternalResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VerifyImageSignaturesInternalRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VerifyImageSignaturesInternalRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VerifyImageSignaturesInternalRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *VerifyImageSignaturesInternalResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VerifyImageSignaturesInternalResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VerifyImageSignaturesInternalResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
