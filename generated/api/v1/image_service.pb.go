...
func (c *imageServiceClient) ExportImages(ctx context.Context, in *ExportImageRequest, opts ...grpc.CallOption) (ImageService_ExportImagesClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ImageService_serviceDesc.Streams[0], "/v1.ImageService/ExportImages", opts...)
	if err != nil {
		return nil, err
	}
...
func (*UnimplementedImageServiceServer) ExportImages(req *ExportImageRequest, srv ImageService_ExportImagesServer) error {
