...
type Preferences struct {
	MaxGrpcReceive       uint64   `protobuf:"varint,1,opt,name=max_grpc_receive,json=maxGrpcReceive,proto3" json:"max_grpc_receive,omitempty"`
...
func (m *Preferences) GetMaxGrpcReceive() uint64 {
	if m != nil {
		return m.MaxGrpcReceive
	}
	return 0
}
...
var fileDescriptor_a9b372bab2d89b6f = []byte{
	...
	,
}
...
func (m *Preferences) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MaxGrpcReceive != 0 {
		i = encodeVarintGrpcPreferenceService(dAtA, i, uint64(m.MaxGrpcReceive))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Preferences) Size() (n int) {
	...
	_ = l
	if m.MaxGrpcReceive != 0 {
		n += 1 + sovGrpcPreferenceService(uint64(m.MaxGrpcReceive))
	}
	if m.XXX_unrecognized != nil {
...
func (m *Preferences) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxGrpcReceive", wireType)
			}
			m.MaxGrpcReceive = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxGrpcReceive |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
