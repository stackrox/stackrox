...
func (x *NetworkPolicyNotification) ProtoReflect() protoreflect.Message {
	file_api_v1_notifications_proto_init_ensure()
	mi := &file_api_v1_notifications_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
const file_api_v1_notifications_proto_rawDesc = "" +
	"\n" +
	"\x1aapi/v1/notifications.proto\x12\x02v1\"I\n" +
...
var (
	...
	file_api_v1_notifications_proto_rawDescData []byte
)

func file_api_v1_notifications_proto_rawDescGZIP() []byte {
	file_api_v1_notifications_proto_rawDescOnce.Do(func() {
		file_api_v1_notifications_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1_notifications_proto_rawDesc), len(file_api_v1_notifications_proto_rawDesc)))
	})
...
var file_api_v1_notifications_proto_init_once sync.Once
