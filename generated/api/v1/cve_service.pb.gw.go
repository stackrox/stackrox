...
var filter_ImageCVEService_ListImageCVEs_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}

func request_ImageCVEService_ListImageCVEs_0(ctx context.Context, marshaler runtime.Marshaler, client ImageCVEServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ListImageCVEsRequest
		metadata runtime.ServerMetadata
	)
	if req.Body != nil {
		_, _ = io.Copy(io.Discard, req.Body)
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ImageCVEService_ListImageCVEs_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	msg, err := client.ListImageCVEs(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_ImageCVEService_ListImageCVEs_0(ctx context.Context, marshaler runtime.Marshaler, server ImageCVEServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ListImageCVEsRequest
		metadata runtime.ServerMetadata
	)
	...
	msg, err := server.ListImageCVEs(ctx, &protoReq)
	return msg, metadata, err
}

var filter_ImageCVEService_CountImageCVEs_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}

func request_ImageCVEService_CountImageCVEs_0(ctx context.Context, marshaler runtime.Marshaler, client ImageCVEServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq RawQuery
		metadata runtime.ServerMetadata
	)
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ImageCVEService_CountImageCVEs_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	msg, err := client.CountImageCVEs(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_ImageCVEService_CountImageCVEs_0(ctx context.Context, marshaler runtime.Marshaler, server ImageCVEServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq RawQuery
		metadata runtime.ServerMetadata
	)
	...
	msg, err := server.CountImageCVEs(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterImageCVEServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ImageCVEServiceServer) error {
	mux.Handle(http.MethodGet, pattern_ImageCVEService_ListImageCVEs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/v1.ImageCVEService/ListImageCVEs", runtime.WithHTTPPathPattern("/v1/imagecves"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ImageCVEService_ListImageCVEs_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ImageCVEService_ListImageCVEs_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodGet, pattern_ImageCVEService_CountImageCVEs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/v1.ImageCVEService/CountImageCVEs", runtime.WithHTTPPathPattern("/v1/imagecvescount"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ImageCVEService_CountImageCVEs_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ImageCVEService_CountImageCVEs_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterImageCVEServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ImageCVEServiceClient) error {
	mux.Handle(http.MethodGet, pattern_ImageCVEService_ListImageCVEs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/v1.ImageCVEService/ListImageCVEs", runtime.WithHTTPPathPattern("/v1/imagecves"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ImageCVEService_ListImageCVEs_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle(http.MethodGet, pattern_ImageCVEService_CountImageCVEs_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/v1.ImageCVEService/CountImageCVEs", runtime.WithHTTPPathPattern("/v1/imagecvescount"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ImageCVEService_CountImageCVEs_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ImageCVEService_ListImageCVEs_0  = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "imagecves"}, ""))
	pattern_ImageCVEService_CountImageCVEs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "imagecvescount"}, ""))
)

var (
	forward_ImageCVEService_ListImageCVEs_0  = runtime.ForwardResponseMessage
	forward_ImageCVEService_CountImageCVEs_0 = runtime.ForwardResponseMessage
)
