...
func (m *CollectionConsumer) Reset()         { *m = CollectionConsumer{} }
func (m *CollectionConsumer) String() string { return proto.CompactTextString(m) }
func (*CollectionConsumer) ProtoMessage()    {}
func (*CollectionConsumer) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a4b2c7d805c182, []int{14}
}
func (m *CollectionConsumer) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CollectionConsumer) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CollectionConsumer.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CollectionConsumer) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CollectionConsumer.Merge(m, src)
}
func (m *CollectionConsumer) XXX_Size() int {
	return m.Size()
}
func (m *CollectionConsumer) XXX_DiscardUnknown() {
	xxx_messageInfo_CollectionConsumer.DiscardUnknown(m)
}

var xxx_messageInfo_CollectionConsumer proto.InternalMessageInfo

func (m *CollectionConsumer) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *CollectionConsumer) GetConsumerType() string {
	if m != nil {
...
func (m *CollectionConsumer) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *CollectionConsumer) MessageClone() proto.Message {
	return m.Clone()
}
func (m *CollectionConsumer) Clone() *CollectionConsumer {
	if m == nil {
		return nil
	}
	cloned := new(CollectionConsumer)
	*cloned = *m

	return cloned
}

type CollectionConsumerListResponse struct {
	CollectionConsumer   []*CollectionConsumer `protobuf:"bytes,1,rep,name=collection_consumer,json=collectionConsumer,proto3" json:"collection_consumer,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}

func (m *CollectionConsumerListResponse) Reset()         { *m = CollectionConsumerListResponse{} }
func (m *CollectionConsumerListResponse) String() string { return proto.CompactTextString(m) }
func (*CollectionConsumerListResponse) ProtoMessage()    {}
func (*CollectionConsumerListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_21a4b2c7d805c182, []int{15}
}
func (m *CollectionConsumerListResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CollectionConsumerListResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CollectionConsumerListResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CollectionConsumerListResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CollectionConsumerListResponse.Merge(m, src)
}
func (m *CollectionConsumerListResponse) XXX_Size() int {
	return m.Size()
}
func (m *CollectionConsumerListResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_CollectionConsumerListResponse.DiscardUnknown(m)
}

var xxx_messageInfo_CollectionConsumerListResponse proto.InternalMessageInfo

func (m *CollectionConsumerListResponse) GetCollectionConsumer() []*CollectionConsumer {
	if m != nil {
		return m.CollectionConsumer
	}
	return nil
}

func (m *CollectionConsumerListResponse) MessageClone() proto.Message {
	return m.Clone()
}
func (m *CollectionConsumerListResponse) Clone() *CollectionConsumerListResponse {
	if m == nil {
		return nil
	}
	cloned := new(CollectionConsumerListResponse)
	*cloned = *m

	if m.CollectionConsumer != nil {
		cloned.CollectionConsumer = make([]*CollectionConsumer, len(m.CollectionConsumer))
		for idx, v := range m.CollectionConsumer {
			cloned.CollectionConsumer[idx] = v.Clone()
		}
	}
	return cloned
}
...
func init() {
	...
	proto.RegisterType((*CollectionConsumer)(nil), "v1.CollectionConsumer")
	proto.RegisterType((*CollectionConsumerListResponse)(nil), "v1.CollectionConsumerListResponse")
}
...
var fileDescriptor_21a4b2c7d805c182 = []byte{
	...
	,
}
...
type CollectionServiceClient interface {
	...
	GetConsumers(ctx context.Context, in *ResourceByID, opts ...grpc.CallOption) (*CollectionConsumerListResponse, error)
}
...
func (c *collectionServiceClient) GetConsumers(ctx context.Context, in *ResourceByID, opts ...grpc.CallOption) (*CollectionConsumerListResponse, error) {
	out := new(CollectionConsumerListResponse)
	err := c.cc.Invoke(ctx, "/v1.CollectionService/GetConsumers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CollectionServiceServer interface {
	...
	GetConsumers(context.Context, *ResourceByID) (*CollectionConsumerListResponse, error)
}
...
func (*UnimplementedCollectionServiceServer) GetConsumers(ctx context.Context, req *ResourceByID) (*CollectionConsumerListResponse, error) {
...
func _CollectionService_GetConsumers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResourceByID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CollectionServiceServer).GetConsumers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.CollectionService/GetConsumers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollectionServiceServer).GetConsumers(ctx, req.(*ResourceByID))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _CollectionService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CollectionService_GetConsumers_Handler,
		},
	},
...
func (m *CollectionConsumer) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CollectionConsumer) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CollectionConsumer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ConsumerType) > 0 {
		...
		i = encodeVarintResourceCollectionService(dAtA, i, uint64(len(m.ConsumerType)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Id) > 0 {
...
func (m *CollectionConsumerListResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CollectionConsumerListResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CollectionConsumerListResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.CollectionConsumer) > 0 {
		for iNdEx := len(m.CollectionConsumer) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.CollectionConsumer[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *CollectionConsumer) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CollectionConsumerListResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.CollectionConsumer) > 0 {
		for _, e := range m.CollectionConsumer {
			l = e.Size()
			n += 1 + l + sovResourceCollectionService(uint64(l))
		}
	}
...
func (m *CollectionConsumer) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CollectionConsumer: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CollectionConsumer: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CollectionConsumerListResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CollectionConsumerListResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CollectionConsumerListResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CollectionConsumer", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CollectionConsumer = append(m.CollectionConsumer, &CollectionConsumer{})
			if err := m.CollectionConsumer[len(m.CollectionConsumer)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
