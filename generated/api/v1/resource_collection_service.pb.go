...
func (m *GetCollectionRequest_Options) GetPagination() *Pagination {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func (m *DryRunCollectionRequest_Options) GetWithMatches() bool {
	if m != nil {
		return m.WithMatches
	}
	return false
...
var fileDescriptor_21a4b2c7d805c182 = []byte{
	...
	,
}
