...
type CollectionDeploymentMatchOptions struct {
	...
	MatchesPagination    *Pagination `protobuf:"bytes,2,opt,name=matches_pagination,json=matchesPagination,proto3" json:"matches_pagination,omitempty"`
	XXX_NoUnkeyedLiteral struct{}    `json:"-"`
	XXX_unrecognized     []byte      `json:"-"`
	XXX_sizecache        int32       `json:"-"`
}
...
func (m *CollectionDeploymentMatchOptions) GetMatchesPagination() *Pagination {
	if m != nil {
		return m.MatchesPagination
	}
	return nil
}
...
func (m *CollectionDeploymentMatchOptions) Clone() *CollectionDeploymentMatchOptions {
	...
	*cloned = *m
	...
	cloned.MatchesPagination = m.MatchesPagination.Clone()
	return cloned
}
...
var fileDescriptor_21a4b2c7d805c182 = []byte{
	...
	,
}
...
func (m *CollectionDeploymentMatchOptions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MatchesPagination != nil {
		{
			size, err := m.MatchesPagination.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CollectionDeploymentMatchOptions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MatchesPagination", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MatchesPagination == nil {
				m.MatchesPagination = &Pagination{}
			}
			if err := m.MatchesPagination.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
