...
func (UnimplementedNotifierServiceServer) GetNotifier(context.Context, *ResourceByID) (*storage.Notifier, error) {
	return nil, status.Error(codes.Unimplemented, "method GetNotifier not implemented")
}
