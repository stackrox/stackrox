...
var file_api_v1_probe_upload_service_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x78, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x42, 0x27, 0x0a, 0x18, 0x69, 0x6f, 0x2e,
...
func file_api_v1_probe_upload_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_probe_upload_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_v1_probe_upload_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_api_v1_probe_upload_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_api_v1_probe_upload_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
