...
type GetEventsResponse struct {
	Events               []*storage.Event `protobuf:"bytes,1,rep,name=events,proto3" json:"events,omitempty"`
...
func (m *GetEventsResponse) GetEvents() []*storage.Event {
	if m != nil {
		return m.Events
	}
	return nil
...
func (m *GetEventsResponse) MessageClone() proto.Message {
	return m.Clone()
}
func (m *GetEventsResponse) Clone() *GetEventsResponse {
	if m == nil {
		return nil
	}
	cloned := new(GetEventsResponse)
	*cloned = *m

	if m.Events != nil {
		cloned.Events = make([]*storage.Event, len(m.Events))
...
func init() {
	proto.RegisterType((*GetEventsResponse)(nil), "v1.GetEventsResponse")
}
...
var fileDescriptor_aaf36a9623dbb99d = []byte{
	...
	,
}
...
func (c *eventServiceClient) GetEvents(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*GetEventsResponse, error) {
...
func (*UnimplementedEventServiceServer) GetEvents(ctx context.Context, req *Empty) (*GetEventsResponse, error) {
...
func _EventService_GetEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).GetEvents(ctx, req.(*Empty))
	}
...
func (m *GetEventsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Events = append(m.Events, &storage.Event{})
