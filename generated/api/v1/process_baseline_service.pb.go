...
// Deprecated: Use BulkUpdateProcessBaselinesResponse.ProtoReflect.Descriptor instead.
func (*BulkUpdateProcessBaselinesResponse) Descriptor() ([]byte, []int) {
...
func (*DeleteProcessBaselinesResponse) Descriptor() ([]byte, []int) {
	return file_api_v1_process_baseline_service_proto_rawDescGZIP(), []int{9}
}
