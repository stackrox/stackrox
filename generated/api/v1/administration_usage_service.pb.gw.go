...
func RegisterAdministrationUsageServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AdministrationUsageServiceServer) error {
	...
	mux.Handle("GET", pattern_AdministrationUsageService_GetCurrentSecuredUnitsUsage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_AdministrationUsageService_GetCurrentSecuredUnitsUsage_0(rctx, inboundMarshalVTer, server, req, pathParams)
		...
		forward_AdministrationUsageService_GetCurrentSecuredUnitsUsage_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_AdministrationUsageService_GetMaxSecuredUnitsUsage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_AdministrationUsageService_GetMaxSecuredUnitsUsage_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_AdministrationUsageService_GetMaxSecuredUnitsUsage_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAdministrationUsageServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AdministrationUsageServiceClient) error {
	...
	mux.Handle("GET", pattern_AdministrationUsageService_GetCurrentSecuredUnitsUsage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AdministrationUsageService_GetCurrentSecuredUnitsUsage_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("GET", pattern_AdministrationUsageService_GetMaxSecuredUnitsUsage_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AdministrationUsageService_GetMaxSecuredUnitsUsage_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
