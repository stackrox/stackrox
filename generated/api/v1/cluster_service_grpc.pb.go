...
func (UnimplementedClustersServiceServer) GetKernelSupportAvailable(context.Context, *Empty) (*KernelSupportAvailableResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetKernelSupportAvailable not implemented")
}
func (UnimplementedClustersServiceServer) GetClusterDefaultValues(context.Context, *Empty) (*ClusterDefaultsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetClusterDefaultValues not implemented")
}
