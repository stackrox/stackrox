...
var file_api_v1_mitre_service_proto_rawDesc = []byte{
	...
	0x6b, 0x76, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x42, 0x1e, 0x0a,
...
var (
	...
	file_api_v1_mitre_service_proto_rawDescData = file_api_v1_mitre_service_proto_rawDesc
)

func file_api_v1_mitre_service_proto_rawDescGZIP() []byte {
	file_api_v1_mitre_service_proto_rawDescOnce.Do(func() {
		file_api_v1_mitre_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_v1_mitre_service_proto_rawDescData)
	})
...
var file_api_v1_mitre_service_proto_goTypes = []interface{}{
...
func file_api_v1_mitre_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_mitre_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListMitreAttackVectorsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1_mitre_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetMitreVectorResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_v1_mitre_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_api_v1_mitre_service_proto_rawDesc = nil
