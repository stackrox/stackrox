...
func RegisterVulnMgmtServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client VulnMgmtServiceClient) error {
	...
	mux.Handle("GET", pattern_VulnMgmtService_VulnMgmtExportWorkloads_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_VulnMgmtService_VulnMgmtExportWorkloads_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_VulnMgmtService_VulnMgmtExportWorkloads_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_VulnMgmtService_VulnMgmtExportWorkloads_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "export", "vuln-mgmt", "workloads"}, "", runtime.AssumeColonVerbOpt(false)))
)
