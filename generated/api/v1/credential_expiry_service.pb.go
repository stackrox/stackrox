...
var file_api_v1_credential_expiry_service_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc9, 0x01, 0x0a, 0x0d,
	...
	0x69, 0x72, 0x79, 0x22, 0x32, 0x0a, 0x09, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74,
	...
	0x41, 0x4e, 0x4e, 0x45, 0x52, 0x10, 0x02, 0x32, 0x7f, 0x0a, 0x17, 0x43, 0x72, 0x65, 0x64, 0x65,
	...
	0x61, 0x6c, 0x65, 0x78, 0x70, 0x69, 0x72, 0x79, 0x42, 0x1e, 0x0a, 0x18, 0x69, 0x6f, 0x2e, 0x73,
...
var file_api_v1_credential_expiry_service_proto_goTypes = []interface{}{
...
func file_api_v1_credential_expiry_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_credential_expiry_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCertExpiry); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1_credential_expiry_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCertExpiry_Request); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1_credential_expiry_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetCertExpiry_Response); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
