...
var file_api_v1_empty_proto_rawDesc = []byte{
	...
	0x79, 0x42, 0x21, 0x0a, 0x18, 0x69, 0x6f, 0x2e, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x72, 0x6f, 0x78,
...
var file_api_v1_empty_proto_goTypes = []interface{}{
...
func file_api_v1_empty_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_empty_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
