...
func RegisterSensorUpgradeServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SensorUpgradeServiceServer) error {
	...
	mux.Handle("GET", pattern_SensorUpgradeService_GetSensorUpgradeConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_SensorUpgradeService_GetSensorUpgradeConfig_0(rctx, inboundMarshalVTer, server, req, pathParams)
		...
		forward_SensorUpgradeService_GetSensorUpgradeConfig_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_SensorUpgradeService_UpdateSensorUpgradeConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_SensorUpgradeService_UpdateSensorUpgradeConfig_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_SensorUpgradeService_UpdateSensorUpgradeConfig_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_SensorUpgradeService_TriggerSensorUpgrade_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_SensorUpgradeService_TriggerSensorUpgrade_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_SensorUpgradeService_TriggerSensorUpgrade_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_SensorUpgradeService_TriggerSensorCertRotation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_SensorUpgradeService_TriggerSensorCertRotation_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_SensorUpgradeService_TriggerSensorCertRotation_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterSensorUpgradeServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SensorUpgradeServiceClient) error {
	...
	mux.Handle("GET", pattern_SensorUpgradeService_GetSensorUpgradeConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_SensorUpgradeService_GetSensorUpgradeConfig_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("POST", pattern_SensorUpgradeService_UpdateSensorUpgradeConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_SensorUpgradeService_UpdateSensorUpgradeConfig_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("POST", pattern_SensorUpgradeService_TriggerSensorUpgrade_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_SensorUpgradeService_TriggerSensorUpgrade_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("POST", pattern_SensorUpgradeService_TriggerSensorCertRotation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_SensorUpgradeService_TriggerSensorCertRotation_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
...
var (
	pattern_SensorUpgradeService_GetSensorUpgradeConfig_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "sensorupgrades", "config"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_SensorUpgradeService_UpdateSensorUpgradeConfig_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "sensorupgrades", "config"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_SensorUpgradeService_TriggerSensorUpgrade_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "sensorupgrades", "cluster", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_SensorUpgradeService_TriggerSensorCertRotation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "sensorupgrades", "rotateclustercerts", "id"}, "", runtime.AssumeColonVerbOpt(false)))
)
