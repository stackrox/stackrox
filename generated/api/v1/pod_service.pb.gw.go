...
func RegisterPodServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PodServiceServer) error {
	...
	mux.Handle("GET", pattern_PodService_GetPods_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_PodService_GetPods_0(rctx, inboundMarshalVTer, server, req, pathParams)
		...
		forward_PodService_GetPods_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPodServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PodServiceClient) error {
	...
	mux.Handle("GET", pattern_PodService_GetPods_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PodService_GetPods_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("GET", pattern_PodService_ExportPods_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_PodService_ExportPods_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
		...
		forward_PodService_ExportPods_0(ctx, mux, outboundMarshalVTer, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
