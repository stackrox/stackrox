...
func (UnimplementedCollectionServiceServer) ListCollectionSelectors(context.Context, *Empty) (*ListCollectionSelectorsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListCollectionSelectors not implemented")
}
...
func (UnimplementedCollectionServiceServer) GetCollectionCount(context.Context, *GetCollectionCountRequest) (*GetCollectionCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCollectionCount not implemented")
}
...
func (UnimplementedCollectionServiceServer) DryRunCollection(context.Context, *DryRunCollectionRequest) (*DryRunCollectionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DryRunCollection not implemented")
}
