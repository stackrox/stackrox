...
func RegisterListeningEndpointsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ListeningEndpointsServiceServer) error {
	mux.Handle(http.MethodGet, pattern_ListeningEndpointsService_GetListeningEndpoints_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
