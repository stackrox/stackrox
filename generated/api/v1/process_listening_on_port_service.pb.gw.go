...
func RegisterListeningEndpointsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ListeningEndpointsServiceServer) error {
	...
	mux.Handle("GET", pattern_ListeningEndpointsService_GetListeningEndpoints_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ListeningEndpointsService_GetListeningEndpoints_0(rctx, inboundMarshalVTer, server, req, pathParams)
		...
		forward_ListeningEndpointsService_GetListeningEndpoints_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterListeningEndpointsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ListeningEndpointsServiceClient) error {
	...
	mux.Handle("GET", pattern_ListeningEndpointsService_GetListeningEndpoints_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ListeningEndpointsService_GetListeningEndpoints_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
