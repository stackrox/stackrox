...
type Audit_Message_Request struct {
	...
	Source   *Audit_Message_Request_Source `protobuf:"bytes,5,opt,name=source,proto3" json:"source,omitempty"`
...
func (m *Audit_Message_Request) GetSource() *Audit_Message_Request_Source {
	if m != nil {
		return m.Source
	}
	return nil
...
// Source holds information about the request's source.
type Audit_Message_Request_Source struct {
	// Holds the value of the "X-Forwarded-For" header associated with the request, if it was present.
	XForwardedFor string `protobuf:"bytes,2,opt,name=x_forwarded_for,json=xForwardedFor,proto3" json:"x_forwarded_for,omitempty"`
	// Holds the value of the "Remote-Addr" header associated with the request, if it was present.
	RemoteAddr string `protobuf:"bytes,3,opt,name=remote_addr,json=remoteAddr,proto3" json:"remote_addr,omitempty"`
	// Holds the value of the HTTP request's address. This will always be present, but may not preserve
	// the _actual_ client IP. See source_ip for a more detailed documentation.
	RequestAddr          string   `protobuf:"bytes,4,opt,name=request_addr,json=requestAddr,proto3" json:"request_addr,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *Audit_Message_Request_Source) Reset()         { *m = Audit_Message_Request_Source{} }
func (m *Audit_Message_Request_Source) String() string { return proto.CompactTextString(m) }
func (*Audit_Message_Request_Source) ProtoMessage()    {}
func (*Audit_Message_Request_Source) Descriptor() ([]byte, []int) {
	return fileDescriptor_368902fc694e7fed, []int{0, 0, 0, 0}
}
func (m *Audit_Message_Request_Source) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Audit_Message_Request_Source) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Audit_Message_Request_Source.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Audit_Message_Request_Source) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Audit_Message_Request_Source.Merge(m, src)
}
func (m *Audit_Message_Request_Source) XXX_Size() int {
	return m.Size()
}
func (m *Audit_Message_Request_Source) XXX_DiscardUnknown() {
	xxx_messageInfo_Audit_Message_Request_Source.DiscardUnknown(m)
}

var xxx_messageInfo_Audit_Message_Request_Source proto.InternalMessageInfo

func (m *Audit_Message_Request_Source) GetXForwardedFor() string {
	if m != nil {
...
func (m *Audit_Message_Request_Source) GetRemoteAddr() string {
	if m != nil {
		return m.RemoteAddr
	}
	return ""
...
func (m *Audit_Message_Request_Source) GetRequestAddr() string {
	if m != nil {
...
func (m *Audit_Message_Request_Source) MessageClone() proto.Message {
	return m.Clone()
}
func (m *Audit_Message_Request_Source) Clone() *Audit_Message_Request_Source {
	if m == nil {
		return nil
	}
	cloned := new(Audit_Message_Request_Source)
	*cloned = *m
...
func init() {
	...
	proto.RegisterType((*Audit_Message_Request_Source)(nil), "v1.Audit.Message.Request.Source")
}
...
var fileDescriptor_368902fc694e7fed = []byte{
	...
	,
}
...
func (m *Audit_Message_Request_Source) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Audit_Message_Request_Source) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Audit_Message_Request_Source) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Audit_Message_Request_Source) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Audit_Message_Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.Source == nil {
				m.Source = &Audit_Message_Request_Source{}
			}
...
func (m *Audit_Message_Request_Source) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
