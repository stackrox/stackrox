...
func (Traits_MutabilityMode) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1_traits_proto_enumTypes[0].Descriptor()
}

func (Traits_MutabilityMode) Type() protoreflect.EnumType {
	return &file_api_v1_traits_proto_enumTypes[0]
}
...
func (Traits_Visibility) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1_traits_proto_enumTypes[1].Descriptor()
}

func (Traits_Visibility) Type() protoreflect.EnumType {
	return &file_api_v1_traits_proto_enumTypes[1]
}
...
func (Traits_Origin) Descriptor() protoreflect.EnumDescriptor {
	return file_api_v1_traits_proto_enumTypes[2].Descriptor()
}

func (Traits_Origin) Type() protoreflect.EnumType {
	return &file_api_v1_traits_proto_enumTypes[2]
}
...
func (x *Traits) Reset() {
	*x = Traits{}
	mi := &file_api_v1_traits_proto_msgTypes[0]
...
func (b0 Traits_builder) Build() *Traits {
	m0 := &Traits{}
	b, x := &b0, m0
	_, _ = b, x
...
var File_api_v1_traits_proto protoreflect.FileDescriptor

const file_api_v1_traits_proto_rawDesc = "" +
	"\n" +
	"\x13api/v1/traits.proto\x12\x02v1\x1a!google/protobuf/go_features.proto\"\xe4\x02\n" +
	"\x06Traits\x12B\n" +
	"\x0fmutability_mode\x18\x01 \x01(\x0e2\x19.v1.Traits.MutabilityModeR\x0emutabilityMode\x125\n" +
	"\n" +
	"visibility\x18\x02 \x01(\x0e2\x15.v1.Traits.VisibilityR\n" +
	"visibility\x12)\n" +
	"\x06origin\x18\x03 \x01(\x0e2\x11.v1.Traits.OriginR\x06origin\";\n" +
...
var file_api_v1_traits_proto_goTypes = []any{
	(Traits_MutabilityMode)(0), // 0: v1.Traits.MutabilityMode
	(Traits_Visibility)(0),     // 1: v1.Traits.Visibility
	(Traits_Origin)(0),         // 2: v1.Traits.Origin
	(*Traits)(nil),             // 3: v1.Traits
}
var file_api_v1_traits_proto_depIdxs = []int32{
	0, // 0: v1.Traits.mutability_mode:type_name -> v1.Traits.MutabilityMode
	1, // 1: v1.Traits.visibility:type_name -> v1.Traits.Visibility
	2, // 2: v1.Traits.origin:type_name -> v1.Traits.Origin
...
func file_api_v1_traits_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_v1_traits_proto_rawDesc), len(file_api_v1_traits_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_v1_traits_proto_goTypes,
		DependencyIndexes: file_api_v1_traits_proto_depIdxs,
		EnumInfos:         file_api_v1_traits_proto_enumTypes,
		MessageInfos:      file_api_v1_traits_proto_msgTypes,
	}.Build()
	File_api_v1_traits_proto = out.File
	file_api_v1_traits_proto_goTypes = nil
	file_api_v1_traits_proto_depIdxs = nil
}
