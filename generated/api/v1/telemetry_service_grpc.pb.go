...
func (UnimplementedTelemetryServiceServer) GetTelemetryConfiguration(context.Context, *Empty) (*storage.TelemetryConfiguration, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTelemetryConfiguration not implemented")
}
func (UnimplementedTelemetryServiceServer) ConfigureTelemetry(context.Context, *ConfigureTelemetryRequest) (*storage.TelemetryConfiguration, error) {
	return nil, status.Error(codes.Unimplemented, "method ConfigureTelemetry not implemented")
}
...
func (UnimplementedTelemetryServiceServer) PostConfigReload(context.Context, *Empty) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method PostConfigReload not implemented")
}
