...
func (x *DecommissionedClusterRetentionInfo) HasDaysUntilDeletion() bool {
	if x == nil {
		return false
	}
...
const DecommissionedClusterRetentionInfo_RetentionInfo_not_set_case case_DecommissionedClusterRetentionInfo_RetentionInfo = 0
const DecommissionedClusterRetentionInfo_IsExcluded_case case_DecommissionedClusterRetentionInfo_RetentionInfo = 1
const DecommissionedClusterRetentionInfo_DaysUntilDeletion_case case_DecommissionedClusterRetentionInfo_RetentionInfo = 2

func (x *DecommissionedClusterRetentionInfo) WhichRetentionInfo() case_DecommissionedClusterRetentionInfo_RetentionInfo {
	if x == nil {
...
func (b0 DecommissionedClusterRetentionInfo_builder) Build() *DecommissionedClusterRetentionInfo {
	m0 := &DecommissionedClusterRetentionInfo{}
	b, x := &b0, m0
	_, _ = b, x
	if b.IsExcluded != nil {
...
type case_DecommissionedClusterRetentionInfo_RetentionInfo protoreflect.FieldNumber

func (x case_DecommissionedClusterRetentionInfo_RetentionInfo) String() string {
	md := file_api_v1_cluster_service_proto_msgTypes[0].Descriptor()
	if x == 0 {
		return "not set"
	}
...
func (b0 ClusterResponse_builder) Build() *ClusterResponse {
	m0 := &ClusterResponse{}
	b, x := &b0, m0
	_, _ = b, x
	x.Cluster = b.Cluster
...
func (x *ClusterDefaultsResponse) GetMainImageRepository() string {
	if x != nil && x.MainImageRepository != nil {
...
func (x *ClusterDefaultsResponse) GetCollectorImageRepository() string {
	if x != nil && x.CollectorImageRepository != nil {
...
func (x *ClusterDefaultsResponse) GetKernelSupportAvailable() bool {
	if x != nil && x.KernelSupportAvailable != nil {
...
func (x *ClusterDefaultsResponse) HasMainImageRepository() bool {
	...
	return x.MainImageRepository != nil
}
...
func (x *ClusterDefaultsResponse) HasCollectorImageRepository() bool {
	...
	return x.CollectorImageRepository != nil
}
...
type ClustersList_builder struct {
	...
	// Maps 'UNHEALTHY' clusters' IDs to their retention info
	ClusterIdToRetentionInfo map[string]*DecommissionedClusterRetentionInfo
}

func (b0 ClustersList_builder) Build() *ClustersList {
	m0 := &ClustersList{}
	b, x := &b0, m0
	_, _ = b, x
...
const file_api_v1_cluster_service_proto_rawDesc = "" +
	"\n" +
	"\x1capi/v1/cluster_service.proto\x12\x02v1\x1a\x13api/v1/common.proto\x1a\x12api/v1/empty.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x15storage/cluster.proto\x1a!google/protobuf/go_features.proto\"\x8a\x01\n" +
