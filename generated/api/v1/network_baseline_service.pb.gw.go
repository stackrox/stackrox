...
var (
	pattern_NetworkBaselineService_GetNetworkBaselineStatusForFlows_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "networkbaseline", "deployment_id", "status"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_NetworkBaselineService_GetNetworkBaseline_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "networkbaseline", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_NetworkBaselineService_ModifyBaselineStatusForPeers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "networkbaseline", "deployment_id", "peers"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_NetworkBaselineService_LockNetworkBaseline_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "networkbaseline", "id", "lock"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_NetworkBaselineService_UnlockNetworkBaseline_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "networkbaseline", "id", "unlock"}, "", runtime.AssumeColonVerbOpt(false)))
)
