...
func (Traits_MutabilityMode) Descriptor() protoreflect.EnumDescriptor {
	file_api_v1_traits_proto_init_ensure()
...
func (Traits_MutabilityMode) EnumDescriptor() ([]byte, []int) {
	return file_api_v1_traits_proto_rawDescGZIP(), []int{0, 0}
}
...
func (Traits_Visibility) EnumDescriptor() ([]byte, []int) {
	return file_api_v1_traits_proto_rawDescGZIP(), []int{0, 1}
}
...
func (Traits_Origin) EnumDescriptor() ([]byte, []int) {
	return file_api_v1_traits_proto_rawDescGZIP(), []int{0, 2}
}

type Traits struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	MutabilityMode Traits_MutabilityMode  `protobuf:"varint,1,opt,name=mutability_mode,json=mutabilityMode,proto3,enum=v1.Traits_MutabilityMode" json:"mutability_mode,omitempty"`
	Visibility     Traits_Visibility      `protobuf:"varint,2,opt,name=visibility,proto3,enum=v1.Traits_Visibility" json:"visibility,omitempty"`
	Origin         Traits_Origin          `protobuf:"varint,3,opt,name=origin,proto3,enum=v1.Traits_Origin" json:"origin,omitempty"`
...
func (*Traits) Descriptor() ([]byte, []int) {
	return file_api_v1_traits_proto_rawDescGZIP(), []int{0}
}
...
const file_api_v1_traits_proto_rawDesc = "" +
	"\n" +
	"\x13api/v1/traits.proto\x12\x02v1\"\xe4\x02\n" +
	"\x06Traits\x12B\n" +
...
var (
	file_api_v1_traits_proto_rawDescOnce sync.Once
	file_api_v1_traits_proto_rawDescData []byte
)

func file_api_v1_traits_proto_rawDescGZIP() []byte {
	file_api_v1_traits_proto_rawDescOnce.Do(func() {
		file_api_v1_traits_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_v1_traits_proto_rawDesc), len(file_api_v1_traits_proto_rawDesc)))
	})
	return file_api_v1_traits_proto_rawDescData
}
...
var file_api_v1_traits_proto_init_once sync.Once
func file_api_v1_traits_proto_init_ensure() { file_api_v1_traits_proto_init_once.Do(file_api_v1_traits_proto_init) }
