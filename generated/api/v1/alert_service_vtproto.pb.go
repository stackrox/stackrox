...
func (m *SnoozeAlertRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *SnoozeAlertRequest) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*SnoozeAlertRequest)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *SnoozeAlertRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
