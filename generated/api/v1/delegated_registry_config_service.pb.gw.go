...
func RegisterDelegatedRegistryConfigServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DelegatedRegistryConfigServiceServer) error {
	...
	mux.Handle("GET", pattern_DelegatedRegistryConfigService_GetConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_DelegatedRegistryConfigService_GetConfig_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_DelegatedRegistryConfigService_GetConfig_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_DelegatedRegistryConfigService_GetClusters_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_DelegatedRegistryConfigService_GetClusters_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_DelegatedRegistryConfigService_GetClusters_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDelegatedRegistryConfigServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DelegatedRegistryConfigServiceClient) error {
	...
	mux.Handle("GET", pattern_DelegatedRegistryConfigService_GetConfig_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_DelegatedRegistryConfigService_GetConfig_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_DelegatedRegistryConfigService_GetClusters_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_DelegatedRegistryConfigService_GetClusters_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
