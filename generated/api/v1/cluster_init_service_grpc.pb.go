...
func (UnimplementedClusterInitServiceServer) GenerateInitBundle(context.Context, *InitBundleGenRequest) (*InitBundleGenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateInitBundle not implemented")
}
func (UnimplementedClusterInitServiceServer) GenerateCRS(context.Context, *CRSGenRequest) (*CRSGenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateCRS not implemented")
}
func (UnimplementedClusterInitServiceServer) GenerateCRSExtended(context.Context, *CRSGenRequestExtended) (*CRSGenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateCRSExtended not implemented")
}
...
func RegisterClusterInitServiceServer(s grpc.ServiceRegistrar, srv ClusterInitServiceServer) {
	// If the following call panics, it indicates UnimplementedClusterInitServiceServer was
