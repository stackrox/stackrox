...
func RegisterCentralHealthServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CentralHealthServiceServer) error {
	...
	mux.Handle("GET", pattern_CentralHealthService_GetUpgradeStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_CentralHealthService_GetUpgradeStatus_0(rctx, inboundMarshalVTer, server, req, pathParams)
		...
		forward_CentralHealthService_GetUpgradeStatus_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterCentralHealthServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CentralHealthServiceClient) error {
	...
	mux.Handle("GET", pattern_CentralHealthService_GetUpgradeStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_CentralHealthService_GetUpgradeStatus_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
