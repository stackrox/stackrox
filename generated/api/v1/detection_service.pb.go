...
var file_api_v1_detection_service_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x6c, 0x42, 0x21, 0x0a, 0x18, 0x69, 0x6f, 0x2e, 0x73, 0x74, 0x61, 0x63, 0x6b, 0x72,
	0x6f, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x5a,
	0x05, 0x2e, 0x2f, 0x3b, 0x76, 0x31, 0x58, 0x00, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
func file_api_v1_detection_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1_detection_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeployDetectionRemark); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1_detection_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ResultAggregation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1_detection_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
