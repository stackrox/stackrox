...
func (m *DeployDetectionResponse) GetRemarks() []string {
	if m != nil {
		return m.Remarks
	}
	return nil
...
func (m *DeployDetectionResponse) Clone() *DeployDetectionResponse {
	...
	*cloned = *m
	...
	if m.Remarks != nil {
		cloned.Remarks = make([]string, len(m.Remarks))
		copy(cloned.Remarks, m.Remarks)
	}
	return cloned
}
...
type ResultAggregation struct {
	Alerts               []*storage.Alert `protobuf:"bytes,1,rep,name=alerts,proto3" json:"alerts,omitempty"`
	Remarks              []string         `protobuf:"bytes,2,rep,name=remarks,proto3" json:"remarks,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}
...
func (m *ResultAggregation) GetRemarks() []string {
	if m != nil {
		return m.Remarks
	}
	return nil
...
var fileDescriptor_19377923b2f3baac = []byte{
	...
	,
}
...
func (m *DeployDetectionResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Remarks) > 0 {
		for iNdEx := len(m.Remarks) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintDetectionService(dAtA, i, uint64(len(m.Remarks[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
