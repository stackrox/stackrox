...
func RegisterAdministrationEventServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AdministrationEventServiceServer) error {
	...
	mux.Handle("GET", pattern_AdministrationEventService_CountAdministrationEvents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_AdministrationEventService_CountAdministrationEvents_0(rctx, inboundMarshalVTer, server, req, pathParams)
		...
		forward_AdministrationEventService_CountAdministrationEvents_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_AdministrationEventService_GetAdministrationEvent_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_AdministrationEventService_GetAdministrationEvent_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_AdministrationEventService_GetAdministrationEvent_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_AdministrationEventService_ListAdministrationEvents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_AdministrationEventService_ListAdministrationEvents_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_AdministrationEventService_ListAdministrationEvents_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAdministrationEventServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AdministrationEventServiceClient) error {
	...
	mux.Handle("GET", pattern_AdministrationEventService_CountAdministrationEvents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AdministrationEventService_CountAdministrationEvents_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("GET", pattern_AdministrationEventService_GetAdministrationEvent_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AdministrationEventService_GetAdministrationEvent_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("GET", pattern_AdministrationEventService_ListAdministrationEvents_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AdministrationEventService_ListAdministrationEvents_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
