...
func (c *deploymentServiceClient) ExportDeployments(ctx context.Context, in *ExportDeploymentRequest, opts ...grpc.CallOption) (DeploymentService_ExportDeploymentsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_DeploymentService_serviceDesc.Streams[0], "/v1.DeploymentService/ExportDeployments", opts...)
	if err != nil {
		return nil, err
	}
...
func (*UnimplementedDeploymentServiceServer) ExportDeployments(req *ExportDeploymentRequest, srv DeploymentService_ExportDeploymentsServer) error {
