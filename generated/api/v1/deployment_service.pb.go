...
type ExportDeploymentResponse struct {
	Deployment *storage.Deployment `protobuf:"bytes,1,opt,name=deployment,proto3" json:"deployment,omitempty"`
	// TODO(dhaus): For now in the same response object to have all "in the same entity" which is workload and the
	// related CVEs.
...
func (m *ExportDeploymentResponse) GetImages() []*storage.Image {
	if m != nil {
		return m.Images
	}
	return nil
...
var fileDescriptor_081153b22511ab60 = []byte{
	...
	,
}
