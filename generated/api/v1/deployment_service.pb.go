...
var file_api_v1_deployment_service_proto_rawDesc = []byte{
	...
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x30, 0x01, 0x42, 0x21, 0x0a, 0x18, 0x69, 0x6f, 0x2e, 0x73,
	0x74, 0x61, 0x63, 0x6b, 0x72, 0x6f, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x76, 0x31, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x76, 0x31, 0x58, 0x03, 0x62, 0x06, 0x70,
...
func file_api_v1_deployment_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1_deployment_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExportDeploymentRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1_deployment_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExportDeploymentResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_v1_deployment_service_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
