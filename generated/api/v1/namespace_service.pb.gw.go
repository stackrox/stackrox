...
var filter_NamespaceService_GetNamespaces_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
...
func RegisterNamespaceServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server NamespaceServiceServer) error {
	mux.Handle(http.MethodGet, pattern_NamespaceService_GetNamespaces_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
