...
type GetDeclarativeConfigHealthResponse struct {
	Health               *storage.DeclarativeConfigHealth `protobuf:"bytes,1,opt,name=health,proto3" json:"health,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}

func (m *GetDeclarativeConfigHealthResponse) Reset()         { *m = GetDeclarativeConfigHealthResponse{} }
func (m *GetDeclarativeConfigHealthResponse) String() string { return proto.CompactTextString(m) }
func (*GetDeclarativeConfigHealthResponse) ProtoMessage()    {}
func (*GetDeclarativeConfigHealthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bcfabb16bd33cd5d, []int{1}
}
func (m *GetDeclarativeConfigHealthResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GetDeclarativeConfigHealthResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GetDeclarativeConfigHealthResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GetDeclarativeConfigHealthResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetDeclarativeConfigHealthResponse.Merge(m, src)
}
func (m *GetDeclarativeConfigHealthResponse) XXX_Size() int {
	return m.Size()
}
func (m *GetDeclarativeConfigHealthResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetDeclarativeConfigHealthResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetDeclarativeConfigHealthResponse proto.InternalMessageInfo

func (m *GetDeclarativeConfigHealthResponse) GetHealth() *storage.DeclarativeConfigHealth {
	if m != nil {
		return m.Health
	}
	return nil
...
func (m *GetDeclarativeConfigHealthResponse) MessageClone() proto.Message {
	return m.Clone()
}
func (m *GetDeclarativeConfigHealthResponse) Clone() *GetDeclarativeConfigHealthResponse {
	if m == nil {
		return nil
	}
	cloned := new(GetDeclarativeConfigHealthResponse)
	*cloned = *m

	cloned.Health = m.Health.Clone()
	return cloned
}

func init() {
	proto.RegisterType((*GetDeclarativeConfigHealthsResponse)(nil), "v1.GetDeclarativeConfigHealthsResponse")
	proto.RegisterType((*GetDeclarativeConfigHealthResponse)(nil), "v1.GetDeclarativeConfigHealthResponse")
}
...
var fileDescriptor_bcfabb16bd33cd5d = []byte{
	...
	,
}
...
type DeclarativeConfigHealthServiceClient interface {
	...
	GetDeclarativeConfigHealth(ctx context.Context, in *ResourceByID, opts ...grpc.CallOption) (*GetDeclarativeConfigHealthResponse, error)
}
...
func (c *declarativeConfigHealthServiceClient) GetDeclarativeConfigHealth(ctx context.Context, in *ResourceByID, opts ...grpc.CallOption) (*GetDeclarativeConfigHealthResponse, error) {
	out := new(GetDeclarativeConfigHealthResponse)
	err := c.cc.Invoke(ctx, "/v1.DeclarativeConfigHealthService/GetDeclarativeConfigHealth", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeclarativeConfigHealthServiceServer interface {
	...
	GetDeclarativeConfigHealth(context.Context, *ResourceByID) (*GetDeclarativeConfigHealthResponse, error)
}
...
func (*UnimplementedDeclarativeConfigHealthServiceServer) GetDeclarativeConfigHealth(ctx context.Context, req *ResourceByID) (*GetDeclarativeConfigHealthResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDeclarativeConfigHealth not implemented")
}
...
func _DeclarativeConfigHealthService_GetDeclarativeConfigHealth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResourceByID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeclarativeConfigHealthServiceServer).GetDeclarativeConfigHealth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.DeclarativeConfigHealthService/GetDeclarativeConfigHealth",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeclarativeConfigHealthServiceServer).GetDeclarativeConfigHealth(ctx, req.(*ResourceByID))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _DeclarativeConfigHealthService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetDeclarativeConfigHealth",
			Handler:    _DeclarativeConfigHealthService_GetDeclarativeConfigHealth_Handler,
		},
	},
...
func (m *GetDeclarativeConfigHealthResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GetDeclarativeConfigHealthResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GetDeclarativeConfigHealthResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GetDeclarativeConfigHealthResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GetDeclarativeConfigHealthResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GetDeclarativeConfigHealthResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GetDeclarativeConfigHealthResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Health == nil {
				m.Health = &storage.DeclarativeConfigHealth{}
			}
