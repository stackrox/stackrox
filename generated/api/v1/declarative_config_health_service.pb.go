...
var file_api_v1_declarative_config_health_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x5a, 0x05, 0x2e, 0x2f, 0x3b,
	0x76, 0x31, 0x58, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_api_v1_declarative_config_health_service_proto_goTypes = []interface{}{
...
func file_api_v1_declarative_config_health_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_declarative_config_health_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetDeclarativeConfigHealthsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
