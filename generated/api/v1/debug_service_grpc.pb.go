...
func (UnimplementedDebugServiceServer) StreamAuthzTraces(*Empty, grpc.ServerStreamingServer[AuthorizationTraceResponse]) error {
	return status.Error(codes.Unimplemented, "method StreamAuthzTraces not implemented")
}
func (UnimplementedDebugServiceServer) ResetDBStats(context.Context, *Empty) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ResetDBStats not implemented")
}
