...
const (
	...
	CentralServicesCapabilities_Unknown CentralServicesCapabilities_CapabilityStatus = 0
	...
	CentralServicesCapabilities_Disabled CentralServicesCapabilities_CapabilityStatus = 1
)
...
type CentralServicesCapabilities struct {
	...
	// Services.
	CentralScanningUseContainerIamRoleForEcr CentralServicesCapabilities_CapabilityStatus `protobuf:"varint,1,opt,name=central_scanning_use_container_iam_role_for_ecr,json=centralScanningUseContainerIamRoleForEcr,proto3,enum=v1.CentralServicesCapabilities_CapabilityStatus" json:"central_scanning_use_container_iam_role_for_ecr,omitempty"`
	// Ability to configure and perform Central backups to Amazon S3 or Google Cloud Storage.
	CentralCloudBackupIntegrations CentralServicesCapabilities_CapabilityStatus `protobuf:"varint,2,opt,name=central_cloud_backup_integrations,json=centralCloudBackupIntegrations,proto3,enum=v1.CentralServicesCapabilities_CapabilityStatus" json:"central_cloud_backup_integrations,omitempty"`
	XXX_NoUnkeyedLiteral           struct{}                                     `json:"-"`
	XXX_unrecognized               []byte                                       `json:"-"`
	XXX_sizecache                  int32                                        `json:"-"`
}
...
func (m *CentralServicesCapabilities) GetCentralScanningUseContainerIamRoleForEcr() CentralServicesCapabilities_CapabilityStatus {
	if m != nil {
		return m.CentralScanningUseContainerIamRoleForEcr
	}
	return CentralServicesCapabilities_Unknown
}

func (m *CentralServicesCapabilities) GetCentralCloudBackupIntegrations() CentralServicesCapabilities_CapabilityStatus {
	if m != nil {
		return m.CentralCloudBackupIntegrations
	}
	return CentralServicesCapabilities_Unknown
}
...
var fileDescriptor_1b6865797fbcf5f5 = []byte{
	...
	,
}
...
func (m *CentralServicesCapabilities) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CentralCloudBackupIntegrations != 0 {
		i = encodeVarintMetadataService(dAtA, i, uint64(m.CentralCloudBackupIntegrations))
		i--
		dAtA[i] = 0x10
	}
	if m.CentralScanningUseContainerIamRoleForEcr != 0 {
		i = encodeVarintMetadataService(dAtA, i, uint64(m.CentralScanningUseContainerIamRoleForEcr))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *CentralServicesCapabilities) Size() (n int) {
	...
	_ = l
	if m.CentralScanningUseContainerIamRoleForEcr != 0 {
		n += 1 + sovMetadataService(uint64(m.CentralScanningUseContainerIamRoleForEcr))
	}
	if m.CentralCloudBackupIntegrations != 0 {
		n += 1 + sovMetadataService(uint64(m.CentralCloudBackupIntegrations))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *CentralServicesCapabilities) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CentralScanningUseContainerIamRoleForEcr", wireType)
			}
			m.CentralScanningUseContainerIamRoleForEcr = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadataService
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CentralScanningUseContainerIamRoleForEcr |= CentralServicesCapabilities_CapabilityStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CentralCloudBackupIntegrations", wireType)
			}
			m.CentralCloudBackupIntegrations = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadataService
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CentralCloudBackupIntegrations |= CentralServicesCapabilities_CapabilityStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
