...
type Metadata struct {
	...
	// is_managed_central is set to true in case central is running in the Red Hat cloud and is managed by Red Hat. Otherwise it will be false.
	IsManagedCentral     bool     `protobuf:"varint,5,opt,name=is_managed_central,json=isManagedCentral,proto3" json:"is_managed_central,omitempty"`
...
func (m *Metadata) GetIsManagedCentral() bool {
	if m != nil {
		return m.IsManagedCentral
	}
	return false
}
...
var fileDescriptor_1b6865797fbcf5f5 = []byte{
	...
	,
}
...
func (m *Metadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsManagedCentral", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
