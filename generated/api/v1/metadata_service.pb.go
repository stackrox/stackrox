...
type CentralServicesCapabilities struct {
	...
	// Services.
	UseContainerIamRoleForEcrScanning CentralServicesCapabilities_CapabilityStatus `protobuf:"varint,1,opt,name=use_container_iam_role_for_ecr_scanning,json=useContainerIamRoleForEcrScanning,proto3,enum=v1.CentralServicesCapabilities_CapabilityStatus" json:"use_container_iam_role_for_ecr_scanning,omitempty"`
	// Ability to configure and perform Central backups to Amazon S3 or Google Cloud Storage.
	CloudBackupIntegrations CentralServicesCapabilities_CapabilityStatus `protobuf:"varint,2,opt,name=cloud_backup_integrations,json=cloudBackupIntegrations,proto3,enum=v1.CentralServicesCapabilities_CapabilityStatus" json:"cloud_backup_integrations,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}                                     `json:"-"`
	XXX_unrecognized        []byte                                       `json:"-"`
	XXX_sizecache           int32                                        `json:"-"`
}
...
func (m *CentralServicesCapabilities) GetUseContainerIamRoleForEcrScanning() CentralServicesCapabilities_CapabilityStatus {
	if m != nil {
		return m.UseContainerIamRoleForEcrScanning
	}
	return CentralServicesCapabilities_Unknown
}

func (m *CentralServicesCapabilities) GetCloudBackupIntegrations() CentralServicesCapabilities_CapabilityStatus {
	if m != nil {
		return m.CloudBackupIntegrations
	}
	return CentralServicesCapabilities_Unknown
}
...
var fileDescriptor_1b6865797fbcf5f5 = []byte{
	...
	,
}
...
func (m *CentralServicesCapabilities) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CloudBackupIntegrations != 0 {
		i = encodeVarintMetadataService(dAtA, i, uint64(m.CloudBackupIntegrations))
		i--
		dAtA[i] = 0x10
	}
	if m.UseContainerIamRoleForEcrScanning != 0 {
		i = encodeVarintMetadataService(dAtA, i, uint64(m.UseContainerIamRoleForEcrScanning))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *CentralServicesCapabilities) Size() (n int) {
	...
	_ = l
	if m.UseContainerIamRoleForEcrScanning != 0 {
		n += 1 + sovMetadataService(uint64(m.UseContainerIamRoleForEcrScanning))
	}
	if m.CloudBackupIntegrations != 0 {
		n += 1 + sovMetadataService(uint64(m.CloudBackupIntegrations))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *CentralServicesCapabilities) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field UseContainerIamRoleForEcrScanning", wireType)
			}
			m.UseContainerIamRoleForEcrScanning = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadataService
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.UseContainerIamRoleForEcrScanning |= CentralServicesCapabilities_CapabilityStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CloudBackupIntegrations", wireType)
			}
			m.CloudBackupIntegrations = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadataService
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CloudBackupIntegrations |= CentralServicesCapabilities_CapabilityStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
