...
const (
	// "Maybe" means "not disabled".
	// The reason it's not called "Available" is that extended checks might be required to confirm true ability to
	// use e.g. container AWS IAM role or GCP workload identity, and we can't positively say "Available" while such
	// checks aren't implemented.
	// "Maybe" means the user should be allowed to use the capability (both via UI and API) but an attempt may not
	// be successful if the corresponding configuration does not match the actual environment.
	CentralServicesCapabilities_Maybe CentralServicesCapabilities_CapabilityStatus = 0
...
type CentralServicesCapabilities struct {
	...
	// Ability to accept resources created declaratively by user.
	CentralCanAcceptUserDeclarativeResources CentralServicesCapabilities_CapabilityStatus `protobuf:"varint,3,opt,name=central_can_accept_user_declarative_resources,json=centralCanAcceptUserDeclarativeResources,proto3,enum=v1.CentralServicesCapabilities_CapabilityStatus" json:"central_can_accept_user_declarative_resources,omitempty"`
	XXX_NoUnkeyedLiteral                     struct{}                                     `json:"-"`
	XXX_unrecognized                         []byte                                       `json:"-"`
	XXX_sizecache                            int32                                        `json:"-"`
}
...
func (m *CentralServicesCapabilities) GetCentralScanningCanUseContainerIamRoleForEcr() CentralServicesCapabilities_CapabilityStatus {
	...
	return CentralServicesCapabilities_Maybe
}
...
func (m *CentralServicesCapabilities) GetCentralCanAcceptUserDeclarativeResources() CentralServicesCapabilities_CapabilityStatus {
	if m != nil {
		return m.CentralCanAcceptUserDeclarativeResources
	}
	return CentralServicesCapabilities_Maybe
}
...
var fileDescriptor_1b6865797fbcf5f5 = []byte{
	...
	,
}
...
func (m *CentralServicesCapabilities) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.CentralCanAcceptUserDeclarativeResources != 0 {
		i = encodeVarintMetadataService(dAtA, i, uint64(m.CentralCanAcceptUserDeclarativeResources))
		i--
		dAtA[i] = 0x18
	}
...
func (m *CentralServicesCapabilities) Size() (n int) {
	...
	if m.CentralCanAcceptUserDeclarativeResources != 0 {
		n += 1 + sovMetadataService(uint64(m.CentralCanAcceptUserDeclarativeResources))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *CentralServicesCapabilities) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field CentralCanAcceptUserDeclarativeResources", wireType)
			}
			m.CentralCanAcceptUserDeclarativeResources = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadataService
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CentralCanAcceptUserDeclarativeResources |= CentralServicesCapabilities_CapabilityStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
