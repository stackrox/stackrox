...
var Metadata_ProductBranding_name = map[int32]string{
	0: "STACKROX_BRANDING",
	1: "RHACS_BRANDING",
}

var Metadata_ProductBranding_value = map[string]int32{
	"STACKROX_BRANDING": 0,
	"RHACS_BRANDING":    1,
}

func (x Metadata_ProductBranding) String() string {
	return proto.EnumName(Metadata_ProductBranding_name, int32(x))
}

func (Metadata_ProductBranding) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1b6865797fbcf5f5, []int{0, 1}
}
...
type Metadata struct {
	...
	ProductBranding      Metadata_ProductBranding `protobuf:"varint,5,opt,name=product_branding,json=productBranding,proto3,enum=v1.Metadata_ProductBranding" json:"product_branding,omitempty"`
...
func (m *Metadata) GetProductBranding() Metadata_ProductBranding {
	if m != nil {
		return m.ProductBranding
	}
	return Metadata_STACKROX_BRANDING
}
...
func init() {
	...
	proto.RegisterEnum("v1.Metadata_ProductBranding", Metadata_ProductBranding_name, Metadata_ProductBranding_value)
...
var fileDescriptor_1b6865797fbcf5f5 = []byte{
	...
	,
}
...
func (m *Metadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ProductBranding != 0 {
		i = encodeVarintMetadataService(dAtA, i, uint64(m.ProductBranding))
		i--
		dAtA[i] = 0x28
	}
...
func (m *Metadata) Size() (n int) {
	...
	if m.ProductBranding != 0 {
		n += 1 + sovMetadataService(uint64(m.ProductBranding))
	}
	if m.XXX_unrecognized != nil {
...
func (m *Metadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProductBranding", wireType)
			}
			m.ProductBranding = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ProductBranding |= Metadata_ProductBranding(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
