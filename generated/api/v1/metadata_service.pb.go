...
type Metadata struct {
	...
	ExpiredAt            *types.Timestamp       `protobuf:"bytes,5,opt,name=expired_at,json=expiredAt,proto3" json:"expired_at,omitempty"`
...
func (m *Metadata) GetExpiredAt() *types.Timestamp {
	if m != nil {
		return m.ExpiredAt
	}
	return nil
...
func (m *Metadata) Clone() *Metadata {
	...
	*cloned = *m
	...
	cloned.ExpiredAt = m.ExpiredAt.Clone()
	return cloned
}
...
var fileDescriptor_1b6865797fbcf5f5 = []byte{
	...
	,
}
