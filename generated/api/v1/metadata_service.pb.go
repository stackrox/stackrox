...
func (Metadata_LicenseStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1b6865797fbcf5f5, []int{1, 0}
}

type Marketing struct {
	UserId               string   `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	CentralId            string   `protobuf:"bytes,2,opt,name=central_id,json=centralId,proto3" json:"central_id,omitempty"`
	OrganizationId       string   `protobuf:"bytes,3,opt,name=organization_id,json=organizationId,proto3" json:"organization_id,omitempty"`
	SegmentKey           string   `protobuf:"bytes,4,opt,name=segment_key,json=segmentKey,proto3" json:"segment_key,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *Marketing) Reset()         { *m = Marketing{} }
func (m *Marketing) String() string { return proto.CompactTextString(m) }
func (*Marketing) ProtoMessage()    {}
func (*Marketing) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b6865797fbcf5f5, []int{0}
}
func (m *Marketing) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Marketing) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Marketing.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *Marketing) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Marketing.Merge(m, src)
}
func (m *Marketing) XXX_Size() int {
	return m.Size()
}
func (m *Marketing) XXX_DiscardUnknown() {
	xxx_messageInfo_Marketing.DiscardUnknown(m)
}

var xxx_messageInfo_Marketing proto.InternalMessageInfo

func (m *Marketing) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
func (m *Marketing) GetCentralId() string {
	if m != nil {
		return m.CentralId
	}
	return ""
...
func (m *Marketing) GetOrganizationId() string {
	if m != nil {
...
func (m *Marketing) GetSegmentKey() string {
	if m != nil {
		return m.SegmentKey
	}
	return ""
...
func (m *Marketing) MessageClone() proto.Message {
	return m.Clone()
}
func (m *Marketing) Clone() *Marketing {
	if m == nil {
		return nil
	}
	cloned := new(Marketing)
	*cloned = *m
...
type Metadata struct {
	...
	Marketing            *Marketing             `protobuf:"bytes,5,opt,name=marketing,proto3" json:"marketing,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *Metadata) GetMarketing() *Marketing {
	if m != nil {
		return m.Marketing
	}
	return nil
...
func (m *Metadata) Clone() *Metadata {
	...
	*cloned = *m
	...
	cloned.Marketing = m.Marketing.Clone()
	return cloned
}
...
func init() {
	...
	proto.RegisterType((*Marketing)(nil), "v1.Marketing")
...
var fileDescriptor_1b6865797fbcf5f5 = []byte{
	...
	,
}
...
func (m *Marketing) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *Marketing) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Marketing) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Metadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Marketing != nil {
		{
			size, err := m.Marketing.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Marketing) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: Marketing: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Marketing: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Metadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Marketing", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.Marketing.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
