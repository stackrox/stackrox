...
type Metadata struct {
	...
	// holds various instance identification data, such as central ID
	Marketing            map[string]string `protobuf:"bytes,5,rep,name=marketing,proto3" json:"marketing,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *Metadata) GetMarketing() map[string]string {
	if m != nil {
		return m.Marketing
	}
	return nil
...
func (m *Metadata) Clone() *Metadata {
	...
	*cloned = *m
	...
	if m.Marketing != nil {
		cloned.Marketing = make(map[string]string, len(m.Marketing))
		for k, v := range m.Marketing {
			cloned.Marketing[k] = v
		}
	}
	return cloned
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "v1.Metadata.MarketingEntry")
...
var fileDescriptor_1b6865797fbcf5f5 = []byte{
	...
	,
}
...
func (m *Metadata) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Marketing) > 0 {
		for k := range m.Marketing {
			v := m.Marketing[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
...
func (m *Metadata) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.Marketing == nil {
				m.Marketing = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
