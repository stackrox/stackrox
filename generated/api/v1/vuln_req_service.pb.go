...
type DeferVulnRequest struct {
	...
	// Only one field, `cve` or `cves`, can be set in the request.
	Cves    []string                            `protobuf:"bytes,6,rep,name=cves,proto3" json:"cves,omitempty"`
	...
	ExpiryType           DeferVulnRequest_ExpiryType `protobuf:"varint,7,opt,name=expiry_type,json=expiryType,proto3,enum=v1.DeferVulnRequest_ExpiryType" json:"expiry_type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                    `json:"-"`
	XXX_unrecognized     []byte                      `json:"-"`
	XXX_sizecache        int32                       `json:"-"`
}
...
func (m *DeferVulnRequest) GetCves() []string {
	if m != nil {
		return m.Cves
	}
	return nil
...
func (m *FalsePositiveVulnRequest) GetCves() []string {
	if m != nil {
		return m.Cves
	}
	return nil
...
var fileDescriptor_ce3a30d0c9e6d0c8 = []byte{
	...
	,
}
...
func (m *DeferVulnRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Cves) > 0 {
		for iNdEx := len(m.Cves) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintVulnReqService(dAtA, i, uint64(len(m.Cves[iNdEx])))
			i--
			dAtA[i] = 0x32
		}
	}
