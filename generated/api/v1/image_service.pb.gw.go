...
var (
	filter_ImageService_Export_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_ImageService_Export_0(ctx context.Context, marshaler runtime.Marshaler, client ImageServiceClient, req *http.Request, pathParams map[string]string) (ImageService_ExportClient, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ImageService_Export_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterImageServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ImageServiceServer) error {
	...
	mux.Handle("GET", pattern_ImageService_Export_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterImageServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ImageServiceClient) error {
	...
	mux.Handle("GET", pattern_ImageService_Export_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ImageService_Export_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ImageService_Export_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_ImageService_GetImage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "images", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_ImageService_CountImages_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "imagescount"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_ImageService_ListImages_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "images"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_ImageService_ScanImage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "images", "scan"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_ImageService_InvalidateScanAndRegistryCaches_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "images", "cache", "invalidate"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_ImageService_DeleteImages_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "images"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_ImageService_WatchImage_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "watchedimages"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_ImageService_Export_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "export", "images"}, "", runtime.AssumeColonVerbOpt(false)))
)
...
var (
	...
	forward_ImageService_Export_0 = runtime.ForwardResponseStream
)
