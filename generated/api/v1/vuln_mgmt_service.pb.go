...
func (x *VulnMgmtExportWorkloadsRequest) ProtoReflect() protoreflect.Message {
	file_api_v1_vuln_mgmt_service_proto_init_ensure()
	mi := &file_api_v1_vuln_mgmt_service_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
var file_api_v1_vuln_mgmt_service_proto_init_once sync.Once
func file_api_v1_vuln_mgmt_service_proto_init_ensure() { file_api_v1_vuln_mgmt_service_proto_init_once.Do(file_api_v1_vuln_mgmt_service_proto_init) }
func init() {} // proto registration is lazy — triggered by first ProtoReflect() call
func file_api_v1_vuln_mgmt_service_proto_init() {
	if File_api_v1_vuln_mgmt_service_proto != nil || skipProtoInit {
		return
	}
	type x struct{}
