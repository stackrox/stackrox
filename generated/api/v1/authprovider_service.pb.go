...
type AvailableProviderTypesResponse_AuthProviderType struct {
	...
	AvailableAttributes  []string `protobuf:"bytes,2,rep,name=available_attributes,json=availableAttributes,proto3" json:"available_attributes,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *AvailableProviderTypesResponse_AuthProviderType) GetAvailableAttributes() []string {
	if m != nil {
		return m.AvailableAttributes
	}
	return nil
}
...
func (m *AvailableProviderTypesResponse_AuthProviderType) Clone() *AvailableProviderTypesResponse_AuthProviderType {
	...
	*cloned = *m
	...
	if m.AvailableAttributes != nil {
		cloned.AvailableAttributes = make([]string, len(m.AvailableAttributes))
		copy(cloned.AvailableAttributes, m.AvailableAttributes)
	}
	return cloned
}
...
var fileDescriptor_f38c1bdc0bfe3549 = []byte{
	...
	,
}
...
func (m *AvailableProviderTypesResponse_AuthProviderType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AvailableAttributes) > 0 {
		for iNdEx := len(m.AvailableAttributes) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AvailableAttributes[iNdEx])
			copy(dAtA[i:], m.AvailableAttributes[iNdEx])
			i = encodeVarintAuthproviderService(dAtA, i, uint64(len(m.AvailableAttributes[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *AvailableProviderTypesResponse_AuthProviderType) Size() (n int) {
	...
	if len(m.AvailableAttributes) > 0 {
		for _, s := range m.AvailableAttributes {
			l = len(s)
			n += 1 + l + sovAuthproviderService(uint64(l))
		}
	}
...
func (m *AvailableProviderTypesResponse_AuthProviderType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AvailableAttributes", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AvailableAttributes = append(m.AvailableAttributes, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAuthproviderService(dAtA[iNdEx:])
