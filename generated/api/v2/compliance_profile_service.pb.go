...
type ComplianceProfile struct {
	...
	Standards            []string          `protobuf:"bytes,11,rep,name=standards,proto3" json:"standards,omitempty"`
...
func (m *ComplianceProfile) GetStandards() []string {
	if m != nil {
		return m.Standards
	}
	return nil
...
type ComplianceProfileSummary struct {
	...
	Standards            []string `protobuf:"bytes,7,rep,name=standards,proto3" json:"standards,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ComplianceProfileSummary) GetStandards() []string {
	if m != nil {
		return m.Standards
	}
	return nil
...
var fileDescriptor_1a6d608d8e632533 = []byte{
	...
	,
}
...
func (m *ComplianceProfile) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Standards) > 0 {
		for iNdEx := len(m.Standards) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintComplianceProfileService(dAtA, i, uint64(len(m.Standards[iNdEx])))
			i--
			dAtA[i] = 0x5a
		}
	}
