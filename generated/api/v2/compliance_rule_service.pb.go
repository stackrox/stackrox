...
var file_api_v2_compliance_rule_service_proto_goTypes = []interface{}{
...
func file_api_v2_compliance_rule_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v2_compliance_rule_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
