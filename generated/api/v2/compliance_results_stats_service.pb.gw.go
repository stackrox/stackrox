...
func RegisterComplianceResultsStatsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ComplianceResultsStatsServiceServer) error {
	...
	mux.Handle("GET", pattern_ComplianceResultsStatsService_GetComplianceProfilesClusterStats_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceResultsStatsService_GetComplianceProfilesClusterStats_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_ComplianceResultsStatsService_GetComplianceProfilesClusterStats_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterComplianceResultsStatsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ComplianceResultsStatsServiceClient) error {
	...
	mux.Handle("GET", pattern_ComplianceResultsStatsService_GetComplianceProfilesClusterStats_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceResultsStatsService_GetComplianceProfilesClusterStats_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ComplianceResultsStatsService_GetComplianceProfilesClusterStats_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5, 1, 0, 4, 1, 5, 6}, []string{"v2", "compliance", "scan", "stats", "profiles", "clusters", "cluster_id"}, "", runtime.AssumeColonVerbOpt(false)))
