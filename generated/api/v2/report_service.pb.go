...
type VulnerabilityReportFilters struct {
	...
	IncludeKnownExploit    bool                                   `protobuf:"varint,10,opt,name=include_known_exploit,json=includeKnownExploit,proto3" json:"include_known_exploit,omitempty"`
...
func (x *VulnerabilityReportFilters) GetIncludeKnownExploit() bool {
	if x != nil {
		return x.IncludeKnownExploit
	}
	return false
}
...
const file_api_v2_report_service_proto_rawDesc = "" +
	...
	"\x18include_epss_probability\x18\b \x01(\bR\x16includeEpssProbability\x122\n" +
	"\x15include_known_exploit\x18\n" +
	" \x01(\bR\x13includeKnownExploit\x12)\n" +
