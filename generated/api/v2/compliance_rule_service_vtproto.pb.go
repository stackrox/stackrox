...
func (m *RuleRequest) CloneVT() *RuleRequest {
	if m == nil {
		return (*RuleRequest)(nil)
	}
	r := new(RuleRequest)
...
func (m *RuleRequest) CloneMessageVT() proto.Message {
	return m.CloneVT()
}

func (this *RuleRequest) EqualVT(that *RuleRequest) bool {
	if this == that {
		return true
...
func (this *RuleRequest) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*RuleRequest)
	if !ok {
		return false
	}
	return this.EqualVT(that)
}
func (m *RuleRequest) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *RuleRequest) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *RuleRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *RuleRequest) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RuleRequest) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *RuleRequest) UnmarshalVTUnsafe(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
