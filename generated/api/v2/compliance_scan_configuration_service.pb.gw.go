...
var filter_ComplianceScanConfigurationService_ListComplianceScanConfigOverviews_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}

func request_ComplianceScanConfigurationService_ListComplianceScanConfigOverviews_0(ctx context.Context, marshaler runtime.Marshaler, client ComplianceScanConfigurationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq RawQuery
		metadata runtime.ServerMetadata
	)
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ComplianceScanConfigurationService_ListComplianceScanConfigOverviews_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	msg, err := client.ListComplianceScanConfigOverviews(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_ComplianceScanConfigurationService_ListComplianceScanConfigOverviews_0(ctx context.Context, marshaler runtime.Marshaler, server ComplianceScanConfigurationServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq RawQuery
		metadata runtime.ServerMetadata
	)
	...
	msg, err := server.ListComplianceScanConfigOverviews(ctx, &protoReq)
	return msg, metadata, err
}

func request_ComplianceScanConfigurationService_GetDiscoveredScanConfiguration_0(ctx context.Context, marshaler runtime.Marshaler, client ComplianceScanConfigurationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq DiscoveredScanConfigurationRequest
		metadata runtime.ServerMetadata
		err      error
	)
	if req.Body != nil {
	...
	msg, err := client.GetDiscoveredScanConfiguration(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_ComplianceScanConfigurationService_GetDiscoveredScanConfiguration_0(ctx context.Context, marshaler runtime.Marshaler, server ComplianceScanConfigurationServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq DiscoveredScanConfigurationRequest
		metadata runtime.ServerMetadata
		err      error
	...
	msg, err := server.GetDiscoveredScanConfiguration(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterComplianceScanConfigurationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ComplianceScanConfigurationServiceServer) error {
	...
	mux.Handle(http.MethodGet, pattern_ComplianceScanConfigurationService_ListComplianceScanConfigOverviews_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/v2.ComplianceScanConfigurationService/ListComplianceScanConfigOverviews", runtime.WithHTTPPathPattern("/v2/compliance/scan/configurations/overviews"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ComplianceScanConfigurationService_ListComplianceScanConfigOverviews_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ComplianceScanConfigurationService_ListComplianceScanConfigOverviews_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
	mux.Handle(http.MethodGet, pattern_ComplianceScanConfigurationService_GetDiscoveredScanConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/v2.ComplianceScanConfigurationService/GetDiscoveredScanConfiguration", runtime.WithHTTPPathPattern("/v2/compliance/scan/configurations/discovered/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ComplianceScanConfigurationService_GetDiscoveredScanConfiguration_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ComplianceScanConfigurationService_GetDiscoveredScanConfiguration_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterComplianceScanConfigurationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ComplianceScanConfigurationServiceClient) error {
	...
	mux.Handle(http.MethodGet, pattern_ComplianceScanConfigurationService_ListComplianceScanConfigOverviews_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/v2.ComplianceScanConfigurationService/ListComplianceScanConfigOverviews", runtime.WithHTTPPathPattern("/v2/compliance/scan/configurations/overviews"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ComplianceScanConfigurationService_ListComplianceScanConfigOverviews_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle(http.MethodGet, pattern_ComplianceScanConfigurationService_GetDiscoveredScanConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/v2.ComplianceScanConfigurationService/GetDiscoveredScanConfiguration", runtime.WithHTTPPathPattern("/v2/compliance/scan/configurations/discovered/{name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ComplianceScanConfigurationService_GetDiscoveredScanConfiguration_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ComplianceScanConfigurationService_ListComplianceScanConfigOverviews_0       = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"v2", "compliance", "scan", "configurations", "overviews"}, ""))
	pattern_ComplianceScanConfigurationService_GetDiscoveredScanConfiguration_0          = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5}, []string{"v2", "compliance", "scan", "configurations", "discovered", "name"}, ""))
)
...
var (
	...
	forward_ComplianceScanConfigurationService_ListComplianceScanConfigOverviews_0       = runtime.ForwardResponseMessage
	forward_ComplianceScanConfigurationService_GetDiscoveredScanConfiguration_0          = runtime.ForwardResponseMessage
)
