...
var (
	filter_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0(ctx context.Context, marshaler runtime.Marshaler, client ComplianceScanConfigurationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RawQuery
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.GetComplianceScanConfigurationsCount(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0(ctx context.Context, marshaler runtime.Marshaler, server ComplianceScanConfigurationServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RawQuery
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetComplianceScanConfigurationsCount(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterComplianceScanConfigurationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ComplianceScanConfigurationServiceServer) error {
	...
	mux.Handle("GET", pattern_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/v2.ComplianceScanConfigurationService/GetComplianceScanConfigurationsCount", runtime.WithHTTPPathPattern("/v2/compliance/scan/count/configurations"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterComplianceScanConfigurationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ComplianceScanConfigurationServiceClient) error {
	...
	mux.Handle("GET", pattern_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/v2.ComplianceScanConfigurationService/GetComplianceScanConfigurationsCount", runtime.WithHTTPPathPattern("/v2/compliance/scan/count/configurations"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"v2", "compliance", "scan", "count", "configurations"}, ""))
