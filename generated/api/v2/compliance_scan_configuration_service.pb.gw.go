...
func RegisterComplianceScanConfigurationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ComplianceScanConfigurationServiceServer) error {
	...
	mux.Handle("GET", pattern_ComplianceScanConfigurationService_ListComplianceScanConfigurations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceScanConfigurationService_ListComplianceScanConfigurations_0(rctx, inboundMarshalVTer, server, req, pathParams)
		...
		forward_ComplianceScanConfigurationService_ListComplianceScanConfigurations_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_ComplianceScanConfigurationService_GetComplianceScanConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceScanConfigurationService_GetComplianceScanConfiguration_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_ComplianceScanConfigurationService_GetComplianceScanConfiguration_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_ComplianceScanConfigurationService_CreateComplianceScanConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceScanConfigurationService_CreateComplianceScanConfiguration_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_ComplianceScanConfigurationService_CreateComplianceScanConfiguration_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("PUT", pattern_ComplianceScanConfigurationService_UpdateComplianceScanConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceScanConfigurationService_UpdateComplianceScanConfiguration_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_ComplianceScanConfigurationService_UpdateComplianceScanConfiguration_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("DELETE", pattern_ComplianceScanConfigurationService_DeleteComplianceScanConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceScanConfigurationService_DeleteComplianceScanConfiguration_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_ComplianceScanConfigurationService_DeleteComplianceScanConfiguration_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_ComplianceScanConfigurationService_RunComplianceScanConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceScanConfigurationService_RunComplianceScanConfiguration_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_ComplianceScanConfigurationService_RunComplianceScanConfiguration_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterComplianceScanConfigurationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ComplianceScanConfigurationServiceClient) error {
	...
	mux.Handle("GET", pattern_ComplianceScanConfigurationService_ListComplianceScanConfigurations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceScanConfigurationService_ListComplianceScanConfigurations_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("GET", pattern_ComplianceScanConfigurationService_GetComplianceScanConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceScanConfigurationService_GetComplianceScanConfiguration_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ComplianceScanConfigurationService_CreateComplianceScanConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceScanConfigurationService_CreateComplianceScanConfiguration_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("PUT", pattern_ComplianceScanConfigurationService_UpdateComplianceScanConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceScanConfigurationService_UpdateComplianceScanConfiguration_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("DELETE", pattern_ComplianceScanConfigurationService_DeleteComplianceScanConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceScanConfigurationService_DeleteComplianceScanConfiguration_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("POST", pattern_ComplianceScanConfigurationService_RunComplianceScanConfiguration_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceScanConfigurationService_RunComplianceScanConfiguration_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("GET", pattern_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceScanConfigurationService_GetComplianceScanConfigurationsCount_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
