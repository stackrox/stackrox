...
var (
	filter_ComplianceProfileService_GetComplianceProfileCount_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_ComplianceProfileService_GetComplianceProfileCount_0(ctx context.Context, marshaler runtime.Marshaler, client ComplianceProfileServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ComplianceProfileService_GetComplianceProfileCount_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.GetComplianceProfileCount(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ComplianceProfileService_GetComplianceProfileCount_0(ctx context.Context, marshaler runtime.Marshaler, server ComplianceProfileServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RawQuery
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetComplianceProfileCount(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterComplianceProfileServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ComplianceProfileServiceServer) error {
	...
	mux.Handle("GET", pattern_ComplianceProfileService_GetComplianceProfile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceProfileService_GetComplianceProfile_0(rctx, inboundMarshalVTer, server, req, pathParams)
		...
		forward_ComplianceProfileService_GetComplianceProfile_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_ComplianceProfileService_ListComplianceProfiles_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceProfileService_ListComplianceProfiles_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_ComplianceProfileService_ListComplianceProfiles_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_ComplianceProfileService_ListProfileSummaries_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceProfileService_ListProfileSummaries_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_ComplianceProfileService_ListProfileSummaries_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_ComplianceProfileService_GetComplianceProfileCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_ComplianceProfileService_GetComplianceProfileCount_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_ComplianceProfileService_GetComplianceProfileCount_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterComplianceProfileServiceHandlerFromEndpoint is same as RegisterComplianceProfileServiceHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterComplianceProfileServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
...
// RegisterComplianceProfileServiceHandler registers the http handlers for service ComplianceProfileService to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterComplianceProfileServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterComplianceProfileServiceHandlerClient(ctx, mux, NewComplianceProfileServiceClient(conn))
}

// RegisterComplianceProfileServiceHandlerClient registers the http handlers for service ComplianceProfileService
...
func RegisterComplianceProfileServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ComplianceProfileServiceClient) error {
	...
	mux.Handle("GET", pattern_ComplianceProfileService_GetComplianceProfile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceProfileService_GetComplianceProfile_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("GET", pattern_ComplianceProfileService_ListComplianceProfiles_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceProfileService_ListComplianceProfiles_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("GET", pattern_ComplianceProfileService_ListProfileSummaries_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceProfileService_ListProfileSummaries_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("GET", pattern_ComplianceProfileService_GetComplianceProfileCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceProfileService_GetComplianceProfileCount_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
...
var (
	pattern_ComplianceProfileService_GetComplianceProfile_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"v2", "compliance", "profile", "id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_ComplianceProfileService_ListComplianceProfiles_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v2", "compliance", "profiles", "cluster"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_ComplianceProfileService_ListProfileSummaries_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v2", "compliance", "profiles", "summary"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_ComplianceProfileService_GetComplianceProfileCount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v2", "compliance", "profiles", "count"}, "", runtime.AssumeColonVerbOpt(false)))
)
...
var (
	...
	forward_ComplianceProfileService_GetComplianceProfileCount_0 = runtime.ForwardResponseMessage
)
