...
var file_api_v2_common_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x42, 0x21, 0x0a, 0x18, 0x69, 0x6f, 0x2e, 0x73,
	0x74, 0x61, 0x63, 0x6b, 0x72, 0x6f, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x76, 0x32, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
func file_api_v2_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v2_common_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Empty); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_v2_common_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v2_common_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v2_common_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_api_v2_common_proto_msgTypes[2].OneofWrappers = []interface{}{
