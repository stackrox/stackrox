...
func RegisterComplianceRuleServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ComplianceRuleServiceServer) error {
	...
	mux.Handle("GET", pattern_ComplianceRuleService_GetComplianceRule_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceRuleService_GetComplianceRule_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_ComplianceRuleService_GetComplianceRule_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterComplianceRuleServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ComplianceRuleServiceClient) error {
	...
	mux.Handle("GET", pattern_ComplianceRuleService_GetComplianceRule_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceRuleService_GetComplianceRule_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ComplianceRuleService_GetComplianceRule_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"v2", "compliance", "rule", "summary", "rule_name"}, "", runtime.AssumeColonVerbOpt(false)))
)
