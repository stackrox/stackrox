...
var (
	...
	pattern_ReportService_DeleteReport_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4}, []string{"v2", "reports", "jobs", "report_job_id", "delete"}, "", runtime.AssumeColonVerbOpt(false)))
)
