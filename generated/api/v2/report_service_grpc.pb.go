...
func (UnimplementedReportServiceServer) ListReportConfigurations(context.Context, *RawQuery) (*ListReportConfigurationsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListReportConfigurations not implemented")
}
...
func (UnimplementedReportServiceServer) PostViewBasedReport(context.Context, *ReportRequestViewBased) (*RunReportResponseViewBased, error) {
	return nil, status.Error(codes.Unimplemented, "method PostViewBasedReport not implemented")
}
func (UnimplementedReportServiceServer) GetViewBasedMyReportHistory(context.Context, *GetViewBasedReportHistoryRequest) (*ReportHistoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetViewBasedMyReportHistory not implemented")
}
func (UnimplementedReportServiceServer) GetViewBasedReportHistory(context.Context, *GetViewBasedReportHistoryRequest) (*ReportHistoryResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetViewBasedReportHistory not implemented")
}
