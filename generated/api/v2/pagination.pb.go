...
var file_api_v2_pagination_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x5a, 0x05, 0x2e,
...
var file_api_v2_pagination_proto_goTypes = []interface{}{
...
func file_api_v2_pagination_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v2_pagination_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v2_pagination_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v2_pagination_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
