...
type ComplianceCheckScanStats struct {
	...
	ComplianceCheckRationale string                        `protobuf:"bytes,2,opt,name=compliance_check_rationale,json=complianceCheckRationale,proto3" json:"compliance_check_rationale,omitempty"`
...
func (m *ComplianceCheckScanStats) GetComplianceCheckRationale() string {
	if m != nil {
		return m.ComplianceCheckRationale
	}
	return ""
}
...
var fileDescriptor_fb98f7f6563d14bb = []byte{
	...
	,
}
...
func (m *ComplianceCheckScanStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ComplianceCheckRationale) > 0 {
		i -= len(m.ComplianceCheckRationale)
		copy(dAtA[i:], m.ComplianceCheckRationale)
		i = encodeVarintComplianceResultsService(dAtA, i, uint64(len(m.ComplianceCheckRationale)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *ComplianceCheckScanStats) Size() (n int) {
	...
	l = len(m.ComplianceCheckRationale)
	if l > 0 {
		n += 1 + l + sovComplianceResultsService(uint64(l))
	}
	if len(m.CheckStats) > 0 {
...
func (m *ComplianceCheckScanStats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ComplianceCheckRationale", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ComplianceCheckRationale = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CheckStats", wireType)
