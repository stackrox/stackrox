...
func (c *complianceResultsServiceClient) GetComplianceProfileResults(ctx context.Context, in *ComplianceProfileResultsRequest, opts ...grpc.CallOption) (*ComplianceProfileResults, error) {
	...
	err := c.cc.Invoke(ctx, "/v2.ComplianceResultsService/GetComplianceProfileResults", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedComplianceResultsServiceServer) GetComplianceProfileResults(ctx context.Context, req *ComplianceProfileResultsRequest) (*ComplianceProfileResults, error) {
...
func _ComplianceResultsService_GetComplianceProfileResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v2.ComplianceResultsService/GetComplianceProfileResults",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
>>>>>>> 3e0d15d3d0 (X-Smart-Squash: Squashed 51 commits:)
