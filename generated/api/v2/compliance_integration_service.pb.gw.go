...
func RegisterComplianceIntegrationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ComplianceIntegrationServiceServer) error {
	...
	mux.Handle("GET", pattern_ComplianceIntegrationService_ListComplianceIntegrations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceIntegrationService_ListComplianceIntegrations_0(rctx, inboundMarshalVTer, server, req, pathParams)
		...
		forward_ComplianceIntegrationService_ListComplianceIntegrations_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_ComplianceIntegrationService_GetComplianceIntegrationsCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ComplianceIntegrationService_GetComplianceIntegrationsCount_0(rctx, inboundMarshalVTer, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
		...
		forward_ComplianceIntegrationService_GetComplianceIntegrationsCount_0(ctx, mux, outboundMarshalVTer, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterComplianceIntegrationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ComplianceIntegrationServiceClient) error {
	...
	mux.Handle("GET", pattern_ComplianceIntegrationService_ListComplianceIntegrations_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceIntegrationService_ListComplianceIntegrations_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
	...
	mux.Handle("GET", pattern_ComplianceIntegrationService_GetComplianceIntegrationsCount_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ComplianceIntegrationService_GetComplianceIntegrationsCount_0(rctx, inboundMarshalVTer, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshalVTer, w, req, err)
			return
...
var (
	...
	pattern_ComplianceIntegrationService_GetComplianceIntegrationsCount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v2", "compliance", "integrations", "count"}, "", runtime.AssumeColonVerbOpt(false)))
)
